...
**PM Decision:** FIX
**Notes:** Rebrand to Fabrica.

### Finding 2 — No Arabic locale (Critical)

**PM Decision:** FIX
**Notes:** New feature request — add ar.json (Arabic locale).

### Finding 3 — Missing locale sections (editor/browser) (High)

**PM Decision:** DEFER
**Notes:** Upstream issue — same in orca-baseline. Not a rebrand task.
...
**PM Decision:** FIX
**Notes:** Rebrand all ORCA_* env vars to FABRICA_* and customize to match our changes. Task before last — needs planning with PM.

**Also:** Missing locale sections and untranslated English are upstream issues, not rebrand tasks.