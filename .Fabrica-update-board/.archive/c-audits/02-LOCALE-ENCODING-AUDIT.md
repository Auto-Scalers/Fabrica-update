...
**PM Decision:** FIX
**Notes:** Strip BOM for clean RFC 8259 compliance. Must ensure no functionality impact. Upstream orca-baseline has NO BOM — the BOM was introduced during fork/rebrand.
...
**PM Decision:** FIX
**Notes:** New feature request — add ar.json (Arabic locale). Never existed in any version. All non-English locale files (ko, ja, zh, es, fr) are clean of Orca/Stably branding refs (verified — zero matches).
