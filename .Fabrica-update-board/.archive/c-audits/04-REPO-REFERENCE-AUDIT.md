...
**PM Decision:** FIX
**Notes:** Canonical org is `Auto-Scalers/Fabrica`. Update package.json homepage to use `Auto-Scalers/Fabrica`. All CI workflows already use Auto-Scalers.

### Finding 2 — @stablyai fully eliminated (Info)

**PM Decision:** SKIP
**Notes:** Old fork used @autoscalers, new Fabrica uses @fabrica-ai. Both eliminated @stablyai. No action needed.

### Finding 3 — package.json uses fabrica-ai (Info)

**PM Decision:** FIX
**Notes:** Update package.json homepage to `https://github.com/Auto-Scalers/Fabrica`. Canonical org is Auto-Scalers.
