...
**PM Decision:** FIX
**Notes:** Fully drop Fabrica-relay/ (Cloudflare Workers prototype). Adopt upstream cloud/apps/relay/ (GCE-based production infrastructure). This task should be LAST — needs more planning with PM. Current Fabrica-relay/ is the active relay server; migrating to cloud/ requires infra setup.
