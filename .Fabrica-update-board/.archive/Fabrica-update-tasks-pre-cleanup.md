...
- No historical reference material — start from code alone.
...
*Last recount: 2026-08-30 — fresh start, no progress.*
...
| #   | Task                                                                                                                                                                                      | Status | Notes                                                                                                                                                                                                                           |
| --- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| T1  | Phase 1 — Rebrand diff (`.backup/orca` vs in-scope Fabrica repos) → `REBRAND-DIFF-MAP.md` + `.json` (the "massive file" of mapped code lines + intent tags + our patterns)                | ⬜      | *No progress.*                                                                                                                                                                                                                  |
...
| Field               | Value                                                                                   |
| ------------------- | --------------------------------------------------------------------------------------- |
| **Current Group**   | Phase 1 — Rebrand Diff                                                                  |
| **Current Task**    | T1 ready. No progress recorded.                                                         |
| **Last Action**     | Fresh start — tasks reset, generated files deleted.                                     |
| **Next Action**     | Dispatch T1 (rebrand diff: orca-baseline vs Fabrica-app → REBRAND-DIFF-MAP.md + .json). |
| **Blockers**        | None. PM constraints: discovery + analysis + plans only.                                |
| **Last Checkpoint** | 2026-08-30 (fresh start)                                                                |
