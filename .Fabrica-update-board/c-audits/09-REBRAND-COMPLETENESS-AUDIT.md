...
**PM Decision:** FIX
**Notes:** All should be renamed so the rebrand be full.
...
**PM Decision:** FIX
**Notes:** All should be renamed for full rebrand. Plugin dirs should follow fabrica- convention. All skills have fabrica-* prefix: orca-* dirs → fabrica-*, unprefixed dirs → fabrica-*. Apply to both directories on disk AND registries.

**also:** `ai.autoscalers.fabrica` is the canonical app ID everywhere. No more com.fabrica.fabrica.mobile or com.fabrica-ai.fabrica.
