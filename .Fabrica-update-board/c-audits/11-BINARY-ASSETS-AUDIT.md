...
**PM Decision:** FIX
**Notes:** Rename orca-ide → fabrica (no -ide suffix). Remove all GNOME screen reader mentions from skills, comments, and docs. Update all symlinks, test expectations, and scripts. ~399 references across ~160 files. No functionality loss — the script already searches for 'fabrica' as first Electron binary name.
