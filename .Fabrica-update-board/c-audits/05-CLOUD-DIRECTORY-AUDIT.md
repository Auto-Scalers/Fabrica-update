...
**PM Decision:** FIX
**Notes:** Fully drop Fabrica-relay/ (Cloudflare Workers prototype). Adopt upstream cloud/apps/relay/ (GCE-based production infrastructure with Terraform, Cloud SQL, regional placement). This task should be LAST — needs more planning with PM.
...
**PM Decision:** FIX
**Notes:** Yes, cloud/ is the production server-side relay. We will fully drop Fabrica-relay/ and adopt cloud/apps/relay/. Last task — needs planning.
