...
> Baseline: orca-baseline/ (frozen Orca source Fabrica was rebranded from)
> Upstream: upstream-orca/ (commit f737f3499f â€” latest stablyai/orca)

## Summary

| Category | Count |
|----------|-------|
| Added (upstream-only) | 9875 |
| Deleted (baseline-only) | 423 |
| Modified | 5269 |
| Unchanged | 7503 |
| **Total changed** | **15567** |
...
These files exist in upstream-orca but not in orca-baseline â€” new upstream additions.
- `.github/scripts/pr-test-loc-summary.mjs`
- `.github/scripts/pr-test-loc-table.mjs`
...
- `config/patches/@xterm__addon-ligatures@0.11.0-beta.300.patch`
- `config/patches/@xterm__addon-serialize@0.15.0-beta.300.patch`
- `config/patches/@xterm__addon-webgl@0.20.0-beta.299.patch`
- `config/patches/@xterm__xterm@6.1.0-beta.303.patch`
- `config/patches/lint-staged@16.4.0.patch`
...
- `config/scripts/__fixtures__/node-pty-1.1.0-unix-pty.cc`
- `config/scripts/__fixtures__/websocket-server-wildcard-bind-allowlist.txt`
- `config/scripts/benchmark-sample-summary.mjs`
- `config/scripts/benchmark-sample-summary.test.mjs`
- `config/scripts/build-keyboard-layout-macos.mjs`
...
- `config/scripts/call-site-option-keys.ts`
- `config/scripts/check-react-doctor-changed.test.mjs`
...
- `config/scripts/client-hosted-browser-package-coverage.test.mjs`
- `config/scripts/codex-index-heal-contract-workflow.test.mjs`
- `config/scripts/computer-use-mouse-button-routing.test.mjs`
- `config/scripts/computer-use-windows-horizontal-scroll.test.mjs`
- `config/scripts/counterbalanced-benchmark-schedule.mjs`
- `config/scripts/counterbalanced-benchmark-schedule.test.mjs`
- `config/scripts/daily-e2e-dispatch-contract.test.mjs`
- `config/scripts/dev-channel-windows-workflow-contract.test.mjs`
- `config/scripts/dev-electron-bundle-cache.mjs`
- `config/scripts/dev-electron-bundle-cache.test.ts`
- `config/scripts/dev-electron-bundle-identity.mjs`
- `config/scripts/dev-electron-bundle-identity.test.ts`
- `config/scripts/electron-builder-markdown-associations.test.mjs`
- `config/scripts/electron-builder-runtime-resources.test.mjs`
- `config/scripts/electron-builder-speech-config.test.mjs`
...
- `config/scripts/happy-dom-offscreen-canvas.test.ts`
- `config/scripts/happy-dom-offscreen-canvas.ts`
- `config/scripts/headless-serve-shutdown-workflow.test.mjs`
- `config/scripts/idle-cpu-process-sampling.mjs`
- `config/scripts/idle-cpu-process-sampling.test.mjs`
- `config/scripts/idle-cpu-renderer-scale-fixture.mjs`
- `config/scripts/idle-cpu-renderer-timing-probe.mjs`
- `config/scripts/install-electron-package-binary-test-fixtures.mjs`
- `config/scripts/install-node-dependencies-action.test.mjs`
- `config/scripts/lint-staged-worktree-backup.test.mjs`
- `config/scripts/linux-packaged-node-pty-floor-child.cjs`
...
- `config/scripts/orcad-operations-restart-safety.test.mjs`
- `config/scripts/oxlint-cli-invocation.mjs`
- `config/scripts/oxlint-cli-invocation.test.mjs`
- `config/scripts/packaged-node-pty-prebuild-prune.test.mjs`
- `config/scripts/packaged-source-map-prune.test.mjs`
...
- `config/scripts/pr-test-loc-summary.test.mjs`
- `config/scripts/pty-source-ack-boundary-benchmark.mjs`
- `config/scripts/rebuild-native-deps-node-pty.test.mjs`
- `config/scripts/rebuild-native-deps-test-fixtures.mjs`
- `config/scripts/reclaim-dev-electron-bundles.mjs`
- `config/scripts/reclaim-dev-electron-bundles.test.ts`
- `config/scripts/reclaim-electron-dists.mjs`
- `config/scripts/regenerate-xterm-patches.mjs`
- `config/scripts/regenerate-xterm-patches.test.mjs`
- `config/scripts/relay-artifact-manifest.test.mjs`
- `config/scripts/release-cut-sourcemap-publish.test.mjs`
...
- `config/scripts/run-linux-packaged-node-pty-floor-smoke.mjs`
- `config/scripts/run-linux-packaged-node-pty-floor-smoke.test.mjs`
...
- `config/scripts/run-typecheck-projects-in-parallel.mjs`
- `config/scripts/script-module-dependencies.mjs`
- `config/scripts/shared-electron-dist-cache.mjs`
- `config/scripts/shared-electron-dist-cache.test.ts`
- `config/scripts/shebang-script-line-ending-pin.test.mjs`
- `config/scripts/skill-sharing-release-workflow.test.mjs`
- `config/scripts/skill-update-roundtrip-workflow.test.mjs`
- `config/scripts/space-sharing-copy.mjs`
- `config/scripts/space-sharing-copy.test.ts`
- `config/scripts/static-appimage-package-contract.cjs`
- `config/scripts/static-appimage-package-contract.test.mjs`
...
- `config/scripts/websocket-server-bind-scan.ts`
- `config/scripts/websocket-server-loopback-bind.test.ts`
...
- `config/scripts/windows-pty-native-capability-workflow.test.mjs`
- `config/scripts/xterm-patch-text.mjs`
- `config/scripts/xterm-webgl-runtime-contract.test.mjs`
...
- `docs/reference/admin-agent-skill-sharing.md`
- `docs/reference/agent-skill-provider-paths.md`
- `docs/reference/agent-skill-sharing-threat-model.md`
- `docs/reference/agent-skill-sharing-upstream-boundary.md`
...
- `docs/reference/sharing-agent-skills.md`
...
- `docs/site/.gitignore`
- `docs/site/content/docs/activity.mdx`
- `docs/site/content/docs/agents/claude-code.mdx`
- `docs/site/content/docs/agents/codex.mdx`
- `docs/site/content/docs/agents/codex-hot-swap.mdx`
- `docs/site/content/docs/agents/cursor-cli.mdx`
- `docs/site/content/docs/agents/glm-agent.mdx`
- `docs/site/content/docs/agents/hibernation.mdx`
- `docs/site/content/docs/agents/hooks-memory.mdx`
- `docs/site/content/docs/agents/meta.json`
- `docs/site/content/docs/agents/native-chat.mdx`
- `docs/site/content/docs/agents/session-history.mdx`
- `docs/site/content/docs/agents/supported.mdx`
- `docs/site/content/docs/agents/usage-tracking.mdx`
- `docs/site/content/docs/android-apk.mdx`
- `docs/site/content/docs/browser/design-mode.mdx`
- `docs/site/content/docs/browser/meta.json`
...
- `docs/site/content/docs/cli/computer-use.mdx`
- `docs/site/content/docs/cli/meta.json`
...
- `docs/site/content/docs/editing/markdown.mdx`
- `docs/site/content/docs/editing/meta.json`
- `docs/site/content/docs/editing/monaco.mdx`
- `docs/site/content/docs/editing/viewers.mdx`
- `docs/site/content/docs/first-session.mdx`
- `docs/site/content/docs/github-errors.mdx`
...
- `docs/site/content/docs/model/agents-sessions.mdx`
- `docs/site/content/docs/model/meta.json`
- `docs/site/content/docs/model/quick-open.mdx`
- `docs/site/content/docs/model/session-restore.mdx`
- `docs/site/content/docs/model/tabs-panes-splits.mdx`
- `docs/site/content/docs/model/worktrees.mdx`
- `docs/site/content/docs/notifications.mdx`
- `docs/site/content/docs/recipes/design-mode-fix.mdx`
- `docs/site/content/docs/recipes/jump-worktrees.mdx`
- `docs/site/content/docs/recipes/meta.json`
- `docs/site/content/docs/recipes/parallel-agents.mdx`
- `docs/site/content/docs/recipes/remote-worktrees.mdx`
- `docs/site/content/docs/recipes/review-ai-diff.mdx`
- `docs/site/content/docs/remote-servers.mdx`
- `docs/site/content/docs/review/annotate-ai-diff.mdx`
- `docs/site/content/docs/review/attribution.mdx`
- `docs/site/content/docs/review/commit-push.mdx`
- `docs/site/content/docs/review/diff-viewer.mdx`
- `docs/site/content/docs/review/github.mdx`
- `docs/site/content/docs/review/jira.mdx`
- `docs/site/content/docs/review/linear.mdx`
- `docs/site/content/docs/review/meta.json`
- `docs/site/content/docs/settings.mdx`
- `docs/site/content/docs/ssh.mdx`
- `docs/site/content/docs/telemetry.mdx`
- `docs/site/content/docs/terminal.mdx`
- `docs/site/content/docs/troubleshooting.mdx`
...
- `docs/site/public/docs/annotate-ai-diff.gif`
- `docs/site/public/docs/favicon.ico`
- `docs/site/public/docs/logo.svg`
- `docs/site/public/docs/orca-design-mode.gif`
- `docs/site/public/docs/posters/annotate-ai-diff.jpg`
- `docs/site/public/docs/posters/file-drag.jpg`
- `docs/site/public/docs/posters/orca-design-mode.jpg`
- `docs/site/public/docs/posters/orca-split-screen.jpg`
- `docs/site/public/docs/posters/tab-split.jpg`
- `docs/site/public/docs/privacy-toggle.png`
- `docs/site/public/docs/remote-server-add-client.png`
- `docs/site/public/docs/remote-server-share-desktop.png`
- `docs/site/public/docs/tab-split.gif`
- `docs/site/public/docs/videos/orca-design-mode.mp4`
- `docs/site/public/docs/videos/tab-split.mp4`
- `docs/site/public/docs/ways-to-run-local-sidebar.png`
- `docs/site/public/docs/ways-to-run-per-workspace-env.png`
- `docs/site/public/docs/ways-to-run-run-on.png`
- `docs/site/README.md`
- `docs/site/source.config.ts`
- `docs/site/src/app/docs/[[...slug]]/page.tsx`
- `docs/site/src/app/docs/api/search/route.ts`
- `docs/site/src/app/docs/layout.tsx`
- `docs/site/src/app/docs/og/[[...slug]]/route.tsx`
- `docs/site/src/app/docs/sitemap.ts`
- `docs/site/src/app/globals.css`
- `docs/site/src/app/layout.tsx`
- `docs/site/src/app/page.tsx`
- `docs/site/src/assets/fonts/Geist-Bold.ttf`
- `docs/site/src/assets/fonts/Geist-Regular.ttf`
- `docs/site/src/assets/fonts/Geist-Variable.woff2`
- `docs/site/src/components/AutoplayClip.tsx`
- `docs/site/src/components/docs/DocsMobileNav.tsx`
- `docs/site/src/components/docs/EmptyDocsNavTitle.tsx`
- `docs/site/src/components/docs/prose.tsx`
- `docs/site/src/components/docs/SearchDialog.tsx`
- `docs/site/src/components/docs/search-excerpt.mjs`
- `docs/site/src/components/docs/SearchTrigger.tsx`
- `docs/site/src/components/layout/DocsFooter.tsx`
- `docs/site/src/components/layout/DocsHeader.tsx`
- `docs/site/src/lib/class-names.ts`
- `docs/site/src/lib/demoMedia.mjs`
- `docs/site/src/lib/demoMedia.ts`
- `docs/site/src/lib/docs-og-image.tsx`
- `docs/site/src/lib/source.ts`
- `docs/site/src/mdx-components.tsx`
- `docs/site/tests/docs-package.test.mjs`
- `docs/site/tests/search-excerpt.test.mjs`
- `docs/site/THIRD_PARTY_NOTICES.md`
- `docs/site/tsconfig.json`
- `docs/site/vercel.json`
- `docs/site/versioning.config.ts`
- `mobile/fastlane/fastfile_testflight_arguments_test.rb`
- `mobile/Gemfile.lock`
- `mobile/patches/react-native@0.83.10.patch`
- `mobile/patches/react-native-webview@13.16.2.patch`
- `mobile/scripts/repro-terminal-color-output.ts`
- `mobile/scripts/repro-worktree-startup-output.ts`
- `mobile/src/browser/MobileBrowserAddressField.tsx`
- `mobile/src/browser/mobile-browser-frameless-stream.test.tsx`
- `mobile/src/browser/mobile-browser-frame-state.ts`
- `mobile/src/browser/mobile-browser-pane-styles.ts`
- `mobile/src/browser/MobileBrowserPaneView.tsx`
- `mobile/src/browser/mobile-browser-stream-events.ts`
- `mobile/src/browser/use-mobile-browser-commands.ts`
- `mobile/src/browser/use-mobile-browser-frame-apply.ts`
- `mobile/src/browser/use-mobile-browser-interactions.ts`
- `mobile/src/browser/use-mobile-browser-pane-layers.ts`
- `mobile/src/browser/use-mobile-browser-request.ts`
- `mobile/src/browser/use-mobile-browser-stream.ts`
- `mobile/src/components/agent-monitoring-indicators.test.ts`
- `mobile/src/components/bottom-drawer-window-handback.test.ts`
- `mobile/src/components/ConnectionLog.test.tsx`
- `mobile/src/components/CustomKeyModal.styles.ts`
- `mobile/src/components/HostDiagnosticsLink.tsx`
- `mobile/src/components/MobileRichMarkdownEditor.test.tsx`
- `mobile/src/components/mobile-rich-markdown-editor-body-primary.ts`
- `mobile/src/components/mobile-rich-markdown-editor-body-secondary.ts`
- `mobile/src/components/mobile-rich-markdown-editor-document-suffix.ts`
- `mobile/src/components/mobile-rich-markdown-keyboard-dismiss-script.ts`
- `mobile/src/components/mobile-rich-markdown-selection-script.ts`
- `mobile/src/components/new-workspace-project-targets.test.ts`
- `mobile/src/components/new-workspace-project-targets.ts`
- `mobile/src/components/NewWorkspaceSetupScriptField.tsx`
- `mobile/src/components/NewWorkspaceSshConnectionField.tsx`
- `mobile/src/components/NewWorktreeFormSheet.tsx`
- `mobile/src/components/new-worktree-form-styles.ts`
- `mobile/src/components/NewWorktreeModalDrawers.tsx`
- `mobile/src/components/new-worktree-modal-types.ts`
- `mobile/src/components/NewWorktreeProjectTargetFields.tsx`
- `mobile/src/components/StatusDot.test.ts`
- `mobile/src/components/use-new-workspace-agent-selection.ts`
- `mobile/src/components/use-new-workspace-create-submit.ts`
- `mobile/src/components/use-new-workspace-execution-target.ts`
- `mobile/src/components/use-new-workspace-repositories.ts`
- `mobile/src/components/use-new-workspace-runtime-context.ts`
- `mobile/src/components/use-new-workspace-setup-script.ts`
- `mobile/src/components/use-new-worktree-drawer-navigation.test.ts`
- `mobile/src/components/worktree-name-suggestion.test.ts`
- `mobile/src/diagnostics/connection-diagnostics-analysis.test.ts`
- `mobile/src/diagnostics/connection-diagnostics-analysis.ts`
- `mobile/src/diagnostics/connection-diagnostics-screen-data.test.ts`
- `mobile/src/diagnostics/connection-diagnostics-screen-data.ts`
...
- `mobile/src/diagnostics/connection-log-redaction.ts`
- `mobile/src/diagnostics/troubleshoot-screen-styles.ts`
- `mobile/src/hermes-array-sorting-compat.test.ts`
- `mobile/src/home/home-host-connection-projection.test.ts`
- `mobile/src/home/home-host-connection-projection.ts`
- `mobile/src/home/MobileHomeAccountUsageCards.tsx`
- `mobile/src/home/mobile-home-connection-state.test.ts`
- `mobile/src/home/mobile-home-connection-state.ts`
- `mobile/src/home/MobileHomeEmptyState.tsx`
- `mobile/src/home/MobileHomeHostList.tsx`
- `mobile/src/home/mobile-home-host-requests.ts`
- `mobile/src/home/MobileHomeListFooter.tsx`
- `mobile/src/home/MobileHomeListHeader.tsx`
- `mobile/src/home/MobileHomeResumeCard.tsx`
- `mobile/src/home/MobileHomeScreen.tsx`
- `mobile/src/home/MobileHomeTasksCard.tsx`
- `mobile/src/home/MobileHomeTopBar.tsx`
- `mobile/src/home/use-mobile-home-data.ts`
- `mobile/src/home/use-mobile-home-host-connections.ts`
- `mobile/src/host-screen/host-screen-header.tsx`
- `mobile/src/host-screen/host-screen-overlays.tsx`
- `mobile/src/host-screen/host-screen-primary-styles.ts`
- `mobile/src/host-screen/host-screen-secondary-styles.ts`
- `mobile/src/host-screen/host-screen-styles.ts`
- `mobile/src/host-screen/host-screen-view.tsx`
- `mobile/src/host-screen/host-workspace-list.tsx`
- `mobile/src/host-screen/use-host-repo-metadata.ts`
- `mobile/src/host-screen/use-host-screen-controller.ts`
- `mobile/src/host-screen/use-host-screen-identity.ts`
- `mobile/src/host-screen/use-host-screen-state.ts`
- `mobile/src/host-screen/use-host-view-settings.ts`
- `mobile/src/host-screen/use-host-worktree-actions.ts`
- `mobile/src/host-screen/use-host-worktree-catalog.ts`
- `mobile/src/pair-scan-styles.ts`
- `mobile/src/session/active-session-tab.test.ts`
- `mobile/src/session/active-session-tab.ts`
- `mobile/src/session/agent-send-keyboard-dismissal.test.ts`
- `mobile/src/session/agent-send-keyboard-dismissal.ts`
- `mobile/src/session/agent-send-keyboard-dismissal-wiring.test.ts`
- `mobile/src/session/MobileDiffCommentLineRow.tsx`
- `mobile/src/session/mobile-diff-review-loaders.test.ts`
- `mobile/src/session/MobileMarkdownReader.test.tsx`
- `mobile/src/session/MobileMarkdownReader.tsx`
- `mobile/src/session/mobile-native-chat-draft-edit-generations.ts`
- `mobile/src/session/mobile-native-chat-pending-baseline.test.ts`
- `mobile/src/session/mobile-native-chat-pending-baseline.ts`
- `mobile/src/session/mobile-native-chat-pending-echo.test.ts`
...
- `mobile/src/session/MobileSessionCommandDock.tsx`
- `mobile/src/session/MobileSessionContentRow.tsx`
- `mobile/src/session/MobileSessionDiffLineRow.tsx`
- `mobile/src/session/MobileSessionFileReader.tsx`
- `mobile/src/session/MobileSessionHeader.tsx`
- `mobile/src/session/MobileSessionMarkdownReader.tsx`
- `mobile/src/session/mobile-session-route-parity.test.ts`
- `mobile/src/session/mobile-session-route-source-family.test-support.ts`
- `mobile/src/session/MobileSessionSheets.tsx`
- `mobile/src/session/MobileSessionSurface.tsx`
- `mobile/src/session/mobile-terminal-inventory-request.test.ts`
- `mobile/src/session/mobile-terminal-inventory-request.ts`
- `mobile/src/session/pending-terminal-handle-recovery.test.ts`
- `mobile/src/session/pending-terminal-handle-recovery.ts`
- `mobile/src/session/pending-terminal-handle-recovery-context-cache.test.ts`
- `mobile/src/session/pending-terminal-handle-recovery-poll.test.ts`
- `mobile/src/session/use-agent-send-keyboard-dismissal.ts`
- `mobile/src/session/use-mobile-native-chat-drafts-glued-pending.test.ts`
- `mobile/src/session/use-mobile-native-chat-pinch-gesture.test.ts`
- `mobile/src/session/use-mobile-send-completion-generation.test.ts`
- `mobile/src/session/use-mobile-send-completion-generation.ts`
- `mobile/src/session/use-mobile-session-accessory-selection.ts`
- `mobile/src/session/use-mobile-session-attachments.ts`
- `mobile/src/session/use-mobile-session-bulk-close.ts`
- `mobile/src/session/use-mobile-session-close-actions.ts`
- `mobile/src/session/use-mobile-session-content-create-actions.ts`
- `mobile/src/session/use-mobile-session-controller.ts`
- `mobile/src/session/use-mobile-session-diff-comments.ts`
- `mobile/src/session/use-mobile-session-document-readers.ts`
- `mobile/src/session/use-mobile-session-feedback-capabilities.ts`
- `mobile/src/session/use-mobile-session-file-actions.ts`
- `mobile/src/session/use-mobile-session-foundation.ts`
- `mobile/src/session/use-mobile-session-keyboard-state.ts`
- `mobile/src/session/use-mobile-session-lifecycle.ts`
- `mobile/src/session/use-mobile-session-markdown-actions.ts`
- `mobile/src/session/use-mobile-session-native-chat-dictation.ts`
- `mobile/src/session/use-mobile-session-panel-route-actions.tsx`
- `mobile/src/session/use-mobile-session-preference-focus.ts`
- `mobile/src/session/use-mobile-session-presentation.ts`
- `mobile/src/session/use-mobile-session-screen-state.ts`
- `mobile/src/session/use-mobile-session-startup.ts`
- `mobile/src/session/use-mobile-session-tab-application.ts`
- `mobile/src/session/use-mobile-session-tab-reconciliation.ts`
...
- `mobile/src/session/use-mobile-session-terminal-list.ts`
...
- `mobile/src/session/use-mobile-session-terminal-subscription-foundation.ts`
- `mobile/src/session/use-mobile-session-terminal-webview.ts`
- `mobile/src/session/use-mobile-terminal-inventory-recovery.test.ts`
- `mobile/src/session/use-mobile-terminal-inventory-recovery.ts`
- `mobile/src/tasks/mobile-tasks-chrome-styles.ts`
- `mobile/src/tasks/mobile-tasks-composer-action-styles.ts`
- `mobile/src/tasks/mobile-tasks-create-drawers.tsx`
- `mobile/src/tasks/mobile-tasks-dependencies.ts`
- `mobile/src/tasks/mobile-tasks-detail-styles.ts`
- `mobile/src/tasks/mobile-tasks-diff-comment-styles.ts`
- `mobile/src/tasks/mobile-tasks-execution-parity.test-support.ts`
- `mobile/src/tasks/mobile-tasks-filter-pickers.tsx`
- `mobile/src/tasks/mobile-tasks-github-project-list.tsx`
- `mobile/src/tasks/mobile-tasks-github-project-pickers.tsx`
- `mobile/src/tasks/mobile-tasks-github-view-controls.tsx`
- `mobile/src/tasks/mobile-tasks-hosted-review.ts`
- `mobile/src/tasks/mobile-tasks-item-actions.tsx`
- `mobile/src/tasks/mobile-tasks-item-comments.tsx`
- `mobile/src/tasks/mobile-tasks-item-detail-content.tsx`
- `mobile/src/tasks/mobile-tasks-item-detail-drawer.tsx`
- `mobile/src/tasks/mobile-tasks-item-field-editors.tsx`
- `mobile/src/tasks/mobile-tasks-item-mapping.ts`
- `mobile/src/tasks/mobile-tasks-item-review-sections.tsx`
- `mobile/src/tasks/mobile-tasks-legacy-foundation.tsx`
- `mobile/src/tasks/mobile-tasks-legacy-styles.ts`
- `mobile/src/tasks/MobileTasksLegacySurface.tsx`
- `mobile/src/tasks/mobile-tasks-linear-list.tsx`
- `mobile/src/tasks/mobile-tasks-linear-view-controls.tsx`
- `mobile/src/tasks/mobile-tasks-list-display-pickers.tsx`
- `mobile/src/tasks/mobile-tasks-list-styles.ts`
- `mobile/src/tasks/mobile-tasks-list-surface.tsx`
- `mobile/src/tasks/mobile-tasks-options.tsx`
- `mobile/src/tasks/MobileTasksPrFileDiff.tsx`
- `mobile/src/tasks/mobile-tasks-project-comments.tsx`
- `mobile/src/tasks/mobile-tasks-project-detail-content.tsx`
- `mobile/src/tasks/mobile-tasks-project-detail-drawer.tsx`
- `mobile/src/tasks/mobile-tasks-project-field-editors.tsx`
- `mobile/src/tasks/mobile-tasks-project-fields.ts`
- `mobile/src/tasks/mobile-tasks-project-metadata-editors.tsx`
- `mobile/src/tasks/mobile-tasks-project-picker-styles.ts`
- `mobile/src/tasks/mobile-tasks-project-review-panels.tsx`
- `mobile/src/tasks/mobile-tasks-project-workspace-types.ts`
- `mobile/src/tasks/mobile-tasks-provider-controls.tsx`
- `mobile/src/tasks/mobile-tasks-provider-detail-types.ts`
- `mobile/src/tasks/mobile-tasks-provider-item-list.tsx`
- `mobile/src/tasks/mobile-tasks-provider-pickers.tsx`
- `mobile/src/tasks/mobile-tasks-refactor-parity.test.ts`
- `mobile/src/tasks/mobile-tasks-render-parity.test-support.ts`
- `mobile/src/tasks/mobile-tasks-repository-presentation.ts`
- `mobile/src/tasks/mobile-tasks-reviewer-linear.ts`
- `mobile/src/tasks/mobile-tasks-screen-chrome.tsx`
- `mobile/src/tasks/mobile-tasks-search-control.tsx`
- `mobile/src/tasks/mobile-tasks-source-family.test-support.ts`
- `mobile/src/tasks/mobile-tasks-view-state-types.ts`
- `mobile/src/tasks/mobile-tasks-workspace-create-drawer.tsx`
- `mobile/src/tasks/mobile-tasks-workspace-option-pickers.tsx`
- `mobile/src/tasks/mobile-tasks-workspace-review-styles.ts`
- `mobile/src/tasks/mobile-tasks-workspace-trust-drawers.tsx`
- `mobile/src/tasks/smart-source-paste-concurrency.test.ts`
- `mobile/src/tasks/use-mobile-tasks-client-settings-actions.tsx`
- `mobile/src/tasks/use-mobile-tasks-connection-presentation.tsx`
- `mobile/src/tasks/use-mobile-tasks-detail-comment-renderers.tsx`
- `mobile/src/tasks/use-mobile-tasks-github-check-file-actions.tsx`
- `mobile/src/tasks/use-mobile-tasks-github-reply-merge-actions.tsx`
- `mobile/src/tasks/use-mobile-tasks-gitlab-github-status-actions.tsx`
- `mobile/src/tasks/use-mobile-tasks-hosted-comment-review-actions.tsx`
- `mobile/src/tasks/use-mobile-tasks-hosted-metadata-actions.tsx`
- `mobile/src/tasks/use-mobile-tasks-item-detail-loading.tsx`
- `mobile/src/tasks/use-mobile-tasks-item-detail-metadata-effects.tsx`
- `mobile/src/tasks/use-mobile-tasks-item-state.tsx`
- `mobile/src/tasks/use-mobile-tasks-linear-item-actions.tsx`
- `mobile/src/tasks/use-mobile-tasks-list-and-detail-effects.tsx`
- `mobile/src/tasks/use-mobile-tasks-picker-projection.tsx`
- `mobile/src/tasks/use-mobile-tasks-project-detail-loading.tsx`
- `mobile/src/tasks/use-mobile-tasks-project-file-merge-actions.tsx`
- `mobile/src/tasks/use-mobile-tasks-project-loading-actions.tsx`
- `mobile/src/tasks/use-mobile-tasks-project-metadata-actions.tsx`
- `mobile/src/tasks/use-mobile-tasks-project-metadata-loading.tsx`
- `mobile/src/tasks/use-mobile-tasks-project-projection.tsx`
- `mobile/src/tasks/use-mobile-tasks-project-repository-resolution.tsx`
- `mobile/src/tasks/use-mobile-tasks-project-review-check-actions.tsx`
- `mobile/src/tasks/use-mobile-tasks-project-thread-reply-actions.tsx`
- `mobile/src/tasks/use-mobile-tasks-project-workspace-comment-actions.tsx`
- `mobile/src/tasks/use-mobile-tasks-provider-load-actions.tsx`
- `mobile/src/tasks/use-mobile-tasks-provider-view-projection.tsx`
- `mobile/src/tasks/use-mobile-tasks-route-and-item-state.tsx`
- `mobile/src/tasks/use-mobile-tasks-runtime-hydration.tsx`
- `mobile/src/tasks/use-mobile-tasks-task-create-actions.tsx`
- `mobile/src/tasks/use-mobile-tasks-task-list-loading.tsx`
- `mobile/src/tasks/use-mobile-tasks-task-pagination-actions.tsx`
- `mobile/src/tasks/use-mobile-tasks-workspace-and-project-state.tsx`
- `mobile/src/tasks/use-mobile-tasks-workspace-create-actions.tsx`
- `mobile/src/tasks/use-mobile-tasks-workspace-create-projection.tsx`
...
- `mobile/src/tasks/use-mobile-tasks-workspace-ssh-state.tsx`
- `mobile/src/tasks/worktree-create-idempotency-policy.ts`
- `mobile/src/terminal/buffered-terminal-draft-restoration.test.ts`
- `mobile/src/terminal/buffered-terminal-draft-restoration.ts`
- `mobile/src/terminal/terminal-accessory-repeat.test.ts`
- `mobile/src/terminal/terminal-accessory-repeat.ts`
- `mobile/src/terminal/terminal-key-definitions.ts`
- `mobile/src/terminal/terminal-live-preedit-mirror.test.ts`
- `mobile/src/terminal/terminal-live-preedit-mirror.ts`
- `mobile/src/terminal/terminal-webview-html/document-shell.ts`
- `mobile/src/terminal/terminal-webview-html/host-message-router.ts`
- `mobile/src/terminal/terminal-webview-html/message-bridge-and-document-close.ts`
- `mobile/src/terminal/terminal-webview-html/mouse-mode-decset-scan.ts`
- `mobile/src/terminal/terminal-webview-html/mouse-report-and-scroll-routing.ts`
- `mobile/src/terminal/terminal-webview-html/runtime-state-and-text-scaling.ts`
- `mobile/src/terminal/terminal-webview-html/selection-overlay.ts`
- `mobile/src/terminal/terminal-webview-html/selection-state-and-eviction.ts`
- `mobile/src/terminal/terminal-webview-html/smooth-scroll-and-cell-geometry.ts`
- `mobile/src/terminal/terminal-webview-html/surface-touch-gestures.ts`
- `mobile/src/terminal/terminal-webview-html/terminal-fit-scale.ts`
- `mobile/src/terminal/terminal-webview-html/terminal-init-and-write.ts`
- `mobile/src/terminal/terminal-webview-html/term-observers-and-mode-mirroring.ts`
- `mobile/src/terminal/terminal-webview-html/theme.ts`
- `mobile/src/terminal/terminal-webview-html/write-queue.ts`
- `mobile/src/terminal/terminal-webview-html-source.test-support.ts`
- `mobile/src/terminal/terminal-webview-payload-hash.test.ts`
- `mobile/src/terminal/use-buffered-terminal-drafts.test.tsx`
...
- `mobile/src/transport/host-app-version-store.test.ts`
- `mobile/src/transport/host-app-version-store.ts`
- `mobile/src/transport/host-client-acquisition-registry.ts`
...
- `mobile/src/transport/host-open-retry-scheduler.ts`
- `mobile/src/transport/logical-client-connection-path.ts`
- `mobile/src/transport/mobile-relay-background-grace.test.ts`
- `mobile/src/transport/mobile-relay-background-grace.ts`
- `mobile/src/transport/mobile-relay-background-lifecycle.test.ts`
- `mobile/src/transport/mobile-relay-diagnostic-log.ts`
...
- `mobile/src/transport/mobile-relay-recovery-log.test.ts`
- `mobile/src/transport/mobile-relay-recovery-presentation.ts`
- `mobile/src/transport/mobile-relay-rpc-session-liveness.test.ts`
- `mobile/src/transport/mobile-rpc-request-projection.ts`
- `mobile/src/transport/mobile-runtime-host-platform.ts`
- `mobile/src/transport/pairing-log-path.test.ts`
- `mobile/src/transport/pairing-log-path.ts`
- `mobile/src/transport/persisted-connection-log-store.test.ts`
- `mobile/src/transport/persisted-connection-log-store.ts`
- `mobile/src/transport/relay-credential-eligibility.ts`
- `mobile/src/transport/relay-pairing-rejection-latch.ts`
- `mobile/src/transport/relay-reconnect-preservation.ts`
- `mobile/src/transport/relay-recovery-failure-count.ts`
- `mobile/src/transport/rpc-client-authentication-retry.ts`
- `mobile/src/transport/rpc-client-connection-state.ts`
- `mobile/src/transport/rpc-client-context-contract.ts`
- `mobile/src/transport/rpc-client-reconnect-schedule.ts`
- `mobile/src/transport/rpc-client-reconnect-wait.test.ts`
- `mobile/src/transport/rpc-client-reconnect-wait.ts`
...
- `mobile/src/transport/rpc-client-stream-registry.test.ts`
- `mobile/src/transport/rpc-client-stream-registry.ts`
- `mobile/src/transport/rpc-client-terminal-stream-router.ts`
- `mobile/src/transport/rpc-session-liveness-integration.test.ts`
- `mobile/src/transport/rpc-session-liveness-watchdog.test.ts`
- `mobile/src/transport/rpc-session-liveness-watchdog.ts`
- `mobile/src/transport/rpc-subscription-result-shapes.ts`
- `mobile/src/worktree/use-retired-worktree-names.test.tsx`
- `mobile/src/worktree/use-retired-worktree-names.ts`
- `mobile/src/worktree/worktree-host-row-identity.test.ts`
- `mobile/src/worktree/worktree-host-row-identity.ts`
- `native/computer-use-macos/Sources/OrcaComputerUseMacOSCore/AttributeValueCoercion.swift`
- `native/computer-use-macos/Tests/OrcaComputerUseMacOSTests/AttributeValueCoercionTests.swift`
- `native/keyboard-layout-macos/main.swift`
- `src/cli/automation-destination.ts`
- `src/cli/automation-format.test.ts`
- `src/cli/automation-format.ts`
- `src/cli/automation-owner-conflict-recovery.test.ts`
- `src/cli/automation-owner-conflict-recovery.ts`
- `src/cli/browser-cookie-credentials-empty-value.test.ts`
- `src/cli/browser-storage-empty-value.test.ts`
- `src/cli/cli-command-name-parity.test.ts`
- `src/cli/cli-version.test.ts`
- `src/cli/cli-version.ts`
- `src/cli/computer-format.test.ts`
- `src/cli/execution-host-flag.test.ts`
- `src/cli/execution-host-flag.ts`
- `src/cli/handlers/automation-destination-fencing.test.ts`
- `src/cli/handlers/automation-handler-flags.ts`
- `src/cli/handlers/automation-owner-fencing.test.ts`
- `src/cli/handlers/orchestration/check-keepalive.ts`
...
- `src/cli/handlers/orchestration/message-inbox-handlers.ts`
- `src/cli/handlers/orchestration/message-payload.ts`
- `src/cli/handlers/orchestration/message-send-handler.ts`
- `src/cli/handlers/orchestration/mutation-request.ts`
- `src/cli/handlers/orchestration/mutation-request-show-handler.ts`
- `src/cli/handlers/orchestration/numeric-flags.ts`
- `src/cli/handlers/orchestration/question-handler.ts`
- `src/cli/handlers/orchestration/reset-handler.ts`
- `src/cli/handlers/orchestration/run-handlers.ts`
- `src/cli/handlers/orchestration/runtime-compatibility.ts`
...
- `src/cli/handlers/orchestration-request-show-cli.test.ts`
- `src/cli/handlers/orchestration-send-receipt-warnings.test.ts`
- `src/cli/handlers/orchestration-task-create-cli.test.ts`
- `src/cli/handlers/orchestration-worker-settlement.ts`
- `src/cli/handlers/orchestration-worker-show-wait-cli.test.ts`
- `src/cli/handlers/skill-sharing.test.ts`
- `src/cli/handlers/skill-sharing.ts`
- `src/cli/host-selector-alternatives.test.ts`
- `src/cli/host-selector-alternatives.ts`
- `src/cli/index-automation-identifiers.test.ts`
- `src/cli/index-automation-schedule.test.ts`
- `src/cli/index-automation-session-reuse.test.ts`
- `src/cli/index-automation-source-context.test.ts`
- `src/cli/index-automation-target.test.ts`
- `src/cli/index-device-commands.test.ts`
- `src/cli/index-environment-commands.test.ts`
- `src/cli/index-memory-diagnostics.test.ts`
- `src/cli/index-orchestration.test.ts`
- `src/cli/index-project-setup.test.ts`
- `src/cli/index-serve-command.test.ts`
- `src/cli/index-terminal-commands.test.ts`
- `src/cli/index-terminal-list-host-scope.test.ts`
- `src/cli/index-test-harness.ts`
- `src/cli/index-vm-recipe-doctor.test.ts`
- `src/cli/index-worktree-create-agent.test.ts`
- `src/cli/index-worktree-create-linear.test.ts`
- `src/cli/index-worktree-create-parent.test.ts`
- `src/cli/index-worktree-create-target.test.ts`
- `src/cli/index-worktree-selector-resolution.test.ts`
- `src/cli/index-worktree-set.test.ts`
- `src/cli/orchestration-mutation-recovery.test.ts`
- `src/cli/orchestration-mutation-recovery.ts`
- `src/cli/quote-stripped-json-flag.test.ts`
- `src/cli/quote-stripped-json-flag.ts`
- `src/cli/root-help-text-primary.ts`
- `src/cli/root-help-text-secondary.ts`
- `src/cli/runtime/client-error-recovery.ts`
- `src/cli/runtime/client-recovery.test.ts`
- `src/cli/runtime/orchestration-recovery-command.test.ts`
- `src/cli/runtime/orchestration-recovery-command.ts`
- `src/cli/runtime/websocket-transport-error.test.ts`
- `src/cli/specs/bundled-guide-flags.test.ts`
- `src/cli/specs/orchestration.test.ts`
- `src/cli/specs/skills.test.ts`
- `src/cli/terminal-format-draft.test.ts`
- `src/cli/terminal-list-host-scope-format.test.ts`
- `src/cli/terminal-read-screen.test.ts`
- `src/cli/worktree-selector-wsl-posix-path.test.ts`
- `src/main/__fixtures__/shell-wrapper-snapshots/daemon-bash-rcfile.txt`
- `src/main/__fixtures__/shell-wrapper-snapshots/daemon-fish-init.txt`
- `src/main/__fixtures__/shell-wrapper-snapshots/daemon-zsh-zshenv.txt`
- `src/main/__fixtures__/shell-wrapper-snapshots/local-bash-rcfile.txt`
- `src/main/__fixtures__/shell-wrapper-snapshots/local-fish-init.txt`
- `src/main/__fixtures__/shell-wrapper-snapshots/local-zsh-zshenv.txt`
- `src/main/__fixtures__/shell-wrapper-snapshots/README.md`
- `src/main/__fixtures__/shell-wrapper-snapshots/relay-bash-rcfile.txt`
- `src/main/__fixtures__/shell-wrapper-snapshots/relay-zsh-zshenv.txt`
...
- `src/main/agent-hooks/server.test-fixtures.ts`
- `src/main/agent-hooks/server/server-authority-aliases.ts`
- `src/main/agent-hooks/server/server-authority-evidence.ts`
- `src/main/agent-hooks/server/server-authority-fences.ts`
- `src/main/agent-hooks/server/server-claude-status-rules.ts`
- `src/main/agent-hooks/server/server-cleanup.ts`
- `src/main/agent-hooks/server/server-constants.ts`
- `src/main/agent-hooks/server/server-hydration.ts`
- `src/main/agent-hooks/server/server-ingest-normalization.ts`
...
- `src/main/agent-hooks/server/server-transport-rules.ts`
- `src/main/agent-hooks/server/server-types.ts`
- `src/main/agent-hooks/server-amp-normalization.test.ts`
- `src/main/agent-hooks/server-claude-child-permission-lifecycle.test.ts`
- `src/main/agent-hooks/server-claude-normalization.test.ts`
- `src/main/agent-hooks/server-claude-permission-visibility.test.ts`
- `src/main/agent-hooks/server-closed-tab-suppression.test.ts`
- `src/main/agent-hooks/server-codex-normalization.test.ts`
- `src/main/agent-hooks/server-copilot-normalization.test.ts`
- `src/main/agent-hooks/server-cursor-normalization.test.ts`
- `src/main/agent-hooks/server-droid-normalization.test.ts`
- `src/main/agent-hooks/server-endpoint-file-lifecycle.test.ts`
- `src/main/agent-hooks/server-gemini-normalization.test.ts`
- `src/main/agent-hooks/server-hook-http-ingest.test.ts`
- `src/main/agent-hooks/server-ingest-remote.test.ts`
- `src/main/agent-hooks/server-ingest-terminal-status.test.ts`
- `src/main/agent-hooks/server-interrupt-inference-guards.test.ts`
- `src/main/agent-hooks/server-interrupt-inference-resurrection.test.ts`
- `src/main/agent-hooks/server-interrupt-inference-validation.test.ts`
- `src/main/agent-hooks/server-last-status-hydrate-confirmation.test.ts`
- `src/main/agent-hooks/server-last-status-hydrate-validation.test.ts`
- `src/main/agent-hooks/server-last-status-lead-boundary.test.ts`
- `src/main/agent-hooks/server-last-status-restored-children.test.ts`
- `src/main/agent-hooks/server-last-status-write.test.ts`
- `src/main/agent-hooks/server-observation-provenance.test.ts`
- `src/main/agent-hooks/server-opencode-lifecycle.test.ts`
- `src/main/agent-hooks/server-opencode-normalization.test.ts`
- `src/main/agent-hooks/server-pi-normalization.test.ts`
- `src/main/agent-hooks/server-prompt-sent-telemetry.test.ts`
- `src/main/agent-hooks/server-relay-listener-replay.test.ts`
- `src/main/agent-hooks/server-reminted-pane-key.test.ts`
- `src/main/agent-hooks/server-replay-evidence-clock.test.ts`
- `src/main/agent-hooks/server-retired-pane-new-turn.test.ts`
- `src/main/agent-hooks/server-status-listener-fanout.test.ts`
- `src/main/agent-hooks/server-transport-interference.test.ts`
- `src/main/agent-hooks/spool.test.ts`
- `src/main/agent-hooks/windows-git-bash-path.test-fixture.ts`
- `src/main/agent-hooks/windows-hook-payload-delivery.test.ts`
- `src/main/agent-hooks/windows-hook-post-interpreter.test.ts`
- `src/main/agent-hooks/windows-powershell-hook-launcher.test.ts`
- `src/main/agent-hooks/windows-powershell-hook-launcher.ts`
- `src/main/agent-hooks/wsl-hook-relay-launch.test.ts`
- `src/main/ai-vault/claude-project-dir-encoding.test.ts`
- `src/main/ai-vault/claude-project-dir-encoding.ts`
- `src/main/ai-vault/remote-session-scanner-cline-source.ts`
- `src/main/ai-vault/session-scan-issues.ts`
- `src/main/ai-vault/session-scanner-cline-parser.test.ts`
- `src/main/ai-vault/session-scanner-cline-parser.ts`
- `src/main/ai-vault/session-scanner-codex-fast-path.test.ts`
- `src/main/ai-vault/session-scanner-codex-record-fast-path.ts`
- `src/main/ai-vault/session-scanner-core-parser-wsl-stall.test.ts`
- `src/main/ai-vault/session-scanner-discovery-wsl-gate.test.ts`
- `src/main/ai-vault/session-scanner-fs-import-guard.test.ts`
- `src/main/ai-vault/session-scanner-index-cache-wsl-stall.test.ts`
...
- `src/main/ai-vault/session-scanner-parser-stream-cleanup.test.ts`
- `src/main/ai-vault/session-scanner-parse-wsl-stall.test.ts`
- `src/main/ai-vault/session-title-file-reader-wsl-stall.test.ts`
- `src/main/ai-vault/structured-session-ownership.test.ts`
...
- `src/main/appimage-runtime-identity.test.ts`
- `src/main/appimage-runtime-identity.ts`
- `src/main/artifacts/artifact-cloud-recovery.test.ts`
- `src/main/artifacts/artifact-create-intent-store.test.ts`
- `src/main/artifacts/artifact-create-intent-store.ts`
- `src/main/artifacts/artifact-recovery-directory-fsync.test.ts`
- `src/main/automations/automation-dispatch-host-fence.test.ts`
- `src/main/automations/automation-owner-fencing.test.ts`
- `src/main/automations/automation-owner-migration.test.ts`
- `src/main/automations/automation-owner-migration.ts`
- `src/main/automations/automation-run-terminal-surface.test.ts`
- `src/main/automations/automation-run-writer.test.ts`
- `src/main/automations/automation-run-writer.ts`
- `src/main/automations/automation-skip-coalescing.test.ts`
- `src/main/automations/automation-ssh-readoption-migration.test.ts`
- `src/main/automations/automation-ssh-readoption-migration.ts`
...
- `src/main/automations/external-automation-manager-cache.test.ts`
- `src/main/automations/external-automation-manager-cache.ts`
- `src/main/automations/external-automation-owner-guard.test.ts`
- `src/main/automations/external-automation-owner-guard.ts`
- `src/main/automations/external-automation-probe-scheduler.test.ts`
- `src/main/automations/external-automation-probe-scheduler.ts`
- `src/main/automations/external-manager-discovery.ts`
- `src/main/automations/external-manager-job-id.ts`
- `src/main/automations/external-manager-local-command.ts`
- `src/main/automations/external-manager-mutations.ts`
- `src/main/automations/external-manager-relay.ts`
- `src/main/automations/external-manager-runs.ts`
- `src/main/automations/external-manager-scoped.test.ts`
- `src/main/automations/headless-dispatch-runner.ts`
- `src/main/automations/hermes-cron-output-markdown.ts`
- `src/main/automations/hermes-cron-run-content.ts`
- `src/main/automations/hermes-cron-run-count-cache.ts`
- `src/main/automations/refused-manual-run.test.ts`
- `src/main/automations/refused-manual-run.ts`
- `src/main/automations/retained-run-reconciliation.test.ts`
- `src/main/automations/retained-run-reconciliation.ts`
- `src/main/automations/run-completion-watcher.test.ts`
- `src/main/automations/run-completion-watcher.ts`
- `src/main/automations/runtime-terminal-run-observer.test.ts`
- `src/main/automations/runtime-terminal-run-observer.ts`
- `src/main/bash-prompt-command-composition.ts`
- `src/main/bitbucket/bitbucket-auth-config.ts`
- `src/main/bitbucket/credential-connection.test.ts`
- `src/main/bitbucket/credential-connection.ts`
- `src/main/bitbucket/credential-store.test.ts`
- `src/main/bitbucket/credential-store.ts`
- `src/main/bitbucket/pull-request-creation.test.ts`
- `src/main/bitbucket/pull-request-creation.ts`
- `src/main/bitbucket/resolve-auth.ts`
- `src/main/bitbucket/status-no-decrypt.test.ts`
- `src/main/bitbucket/user-request.ts`
- `src/main/browser/agent-browser-bridge-automation-visibility.test.ts`
- `src/main/browser/agent-browser-bridge-capture-commands.ts`
- `src/main/browser/agent-browser-bridge-command-transport.test.ts`
- `src/main/browser/agent-browser-bridge-core-commands.ts`
- `src/main/browser/agent-browser-bridge-execution.ts`
- `src/main/browser/agent-browser-bridge-input.ts`
- `src/main/browser/agent-browser-bridge-input-commands.ts`
- `src/main/browser/agent-browser-bridge-interaction-commands.ts`
- `src/main/browser/agent-browser-bridge-lifecycle.ts`
- `src/main/browser/agent-browser-bridge-mouse.ts`
- `src/main/browser/agent-browser-bridge-mouse-commands.ts`
- `src/main/browser/agent-browser-bridge-mouse-input.test.ts`
- `src/main/browser/agent-browser-bridge-navigation.test.ts`
- `src/main/browser/agent-browser-bridge-process.ts`
- `src/main/browser/agent-browser-bridge-queue.ts`
- `src/main/browser/agent-browser-bridge-raw-process.ts`
- `src/main/browser/agent-browser-bridge-result.ts`
- `src/main/browser/agent-browser-bridge-session-lifecycle.test.ts`
- `src/main/browser/agent-browser-bridge-shutdown.ts`
- `src/main/browser/agent-browser-bridge-state.ts`
- `src/main/browser/agent-browser-bridge-state-commands.ts`
- `src/main/browser/agent-browser-bridge-tab-routing.test.ts`
- `src/main/browser/agent-browser-bridge-tabs.ts`
- `src/main/browser/agent-browser-bridge-test-harness.ts`
- `src/main/browser/agent-browser-bridge-text-input.test.ts`
- `src/main/browser/agent-browser-bridge-types.ts`
- `src/main/browser/agent-browser-bridge-utility-commands.ts`
- `src/main/browser/agent-browser-orphan-sweep.test.ts`
- `src/main/browser/agent-browser-orphan-sweep.ts`
- `src/main/browser/agent-browser-process-environment.test.ts`
- `src/main/browser/agent-browser-process-environment.ts`
- `src/main/browser/anti-detection-permission-status.test.ts`
- `src/main/browser/browser-client-download-relay.test.ts`
- `src/main/browser/browser-client-download-relay.ts`
- `src/main/browser/browser-client-download-routing.test.ts`
- `src/main/browser/browser-client-download-routing.ts`
- `src/main/browser/browser-client-file-channel-negotiation.test.ts`
- `src/main/browser/browser-client-file-channel-reconnect.test.ts`
- `src/main/browser/browser-client-file-channel-transport.ts`
- `src/main/browser/browser-client-host-attach-request.test.ts`
- `src/main/browser/browser-client-host-attach-request.ts`
- `src/main/browser/browser-client-host-authority-replacement.test.ts`
- `src/main/browser/browser-client-host-authority-replacement.ts`
...
- `src/main/browser/browser-client-host-environment-routes.ts`
- `src/main/browser/browser-client-host-id.test.ts`
- `src/main/browser/browser-client-host-id.ts`
- `src/main/browser/browser-client-host-placement-preparation.test.ts`
- `src/main/browser/browser-client-host-placement-preparation.ts`
- `src/main/browser/browser-client-host-published-url-wiring.test.ts`
- `src/main/browser/browser-client-host-reconciliation-command-order.test.ts`
- `src/main/browser/browser-client-network-route-address.ts`
- `src/main/browser/browser-client-network-route-recovery.ts`
- `src/main/browser/browser-client-network-route-registry.test.ts`
- `src/main/browser/browser-client-network-route-registry.ts`
- `src/main/browser/browser-client-network-route-settlement.ts`
- `src/main/browser/browser-client-page-admission.ts`
- `src/main/browser/browser-client-page-automation-runtime.test.ts`
- `src/main/browser/browser-client-page-automation-runtime.ts`
- `src/main/browser/browser-client-page-availability.ts`
- `src/main/browser/browser-client-page-cleanup.ts`
- `src/main/browser/browser-client-page-command-admission.ts`
...
- `src/main/browser/browser-client-page-command-executor-dependencies.ts`
- `src/main/browser/browser-client-page-command-executor-fencing.test.ts`
- `src/main/browser/browser-client-page-command-executor-test-harness.ts`
- `src/main/browser/browser-client-page-command-failure.ts`
- `src/main/browser/browser-client-page-command-integration.test.ts`
- `src/main/browser/browser-client-page-creation.ts`
- `src/main/browser/browser-client-page-execution-host-supersession.test.ts`
- `src/main/browser/browser-client-page-execution-host-supersession.ts`
- `src/main/browser/browser-client-page-guest-binding.ts`
- `src/main/browser/browser-client-page-inventory.test.ts`
- `src/main/browser/browser-client-page-inventory.ts`
- `src/main/browser/browser-client-page-metadata-transport.test.ts`
- `src/main/browser/browser-client-page-metadata-transport.ts`
- `src/main/browser/browser-client-page-navigation-fence.ts`
- `src/main/browser/browser-client-page-published-url.test.ts`
- `src/main/browser/browser-client-page-reconciliation.ts`
...
- `src/main/browser/browser-client-page-renderer-bridge.ts`
- `src/main/browser/browser-client-page-renderer-bridge-test-rig.ts`
- `src/main/browser/browser-client-page-renderer-lifecycle.electron.test.ts`
- `src/main/browser/browser-client-page-renderer-reply-admission.ts`
- `src/main/browser/browser-client-page-renderer-runtime.test.ts`
- `src/main/browser/browser-client-page-renderer-runtime.ts`
- `src/main/browser/browser-client-page-retained-state.ts`
- `src/main/browser/browser-client-page-unavailability.test.ts`
- `src/main/browser/browser-client-page-upload-routing.test.ts`
- `src/main/browser/browser-client-route-cookie-import.test.ts`
- `src/main/browser/browser-client-route-cookie-import.ts`
- `src/main/browser/browser-client-route-cookie-import-partition-parity.test.ts`
- `src/main/browser/browser-client-upload-command.test.ts`
- `src/main/browser/browser-client-upload-command.ts`
- `src/main/browser/browser-client-upload-staging.test.ts`
- `src/main/browser/browser-client-upload-staging.ts`
- `src/main/browser/browser-client-upload-transfer.test.ts`
- `src/main/browser/browser-client-upload-transfer.ts`
- `src/main/browser/browser-cookie-chromium-finalize.ts`
- `src/main/browser/browser-cookie-chromium-import.ts`
- `src/main/browser/browser-cookie-chromium-prepare.ts`
- `src/main/browser/browser-cookie-chromium-scan.ts`
- `src/main/browser/browser-cookie-chromium-types.ts`
- `src/main/browser/browser-cookie-clear-preserve.test.ts`
- `src/main/browser/browser-cookie-clear-store.test.ts`
- `src/main/browser/browser-cookie-clear-store.ts`
- `src/main/browser/browser-cookie-clear-store-lifecycle.test.ts`
- `src/main/browser/browser-cookie-decryption.ts`
- `src/main/browser/browser-cookie-detection.ts`
- `src/main/browser/browser-cookie-detection-types.ts`
- `src/main/browser/browser-cookie-firefox-import.ts`
- `src/main/browser/browser-cookie-identity-restore.ts`
- `src/main/browser/browser-cookie-import-app-bound-prefix.test.ts`
- `src/main/browser/browser-cookie-import-clear.ts`
- `src/main/browser/browser-cookie-import-clear-atomicity.test.ts`
- `src/main/browser/browser-cookie-import-concurrency.test.ts`
- `src/main/browser/browser-cookie-import-diagnostics.ts`
- `src/main/browser/browser-cookie-import-google-exclusion.test.ts`
- `src/main/browser/browser-cookie-import-partition.electron.test.ts`
- `src/main/browser/browser-cookie-import-partition-fidelity.test.ts`
- `src/main/browser/browser-cookie-import-partition-reland.electron.test.ts`
- `src/main/browser/browser-cookie-import-partition-rollback.electron.test.ts`
- `src/main/browser/browser-cookie-import-partition-success.electron.test.ts`
- `src/main/browser/browser-cookie-import-pipeline.ts`
- `src/main/browser/browser-cookie-import-plan-writes.test.ts`
- `src/main/browser/browser-cookie-import-replace-partition-rollback.electron.test.ts`
- `src/main/browser/browser-cookie-import-route-partition-staging.test.ts`
- `src/main/browser/browser-cookie-import-scope.test.ts`
- `src/main/browser/browser-cookie-import-undecryptable.test.ts`
- `src/main/browser/browser-cookie-import-validated-partition.electron.test.ts`
- `src/main/browser/browser-cookie-import-write.test.ts`
- `src/main/browser/browser-cookie-import-write.ts`
- `src/main/browser/browser-cookie-key.ts`
- `src/main/browser/browser-cookie-registrable-family.test.ts`
- `src/main/browser/browser-cookie-safari-import.ts`
- `src/main/browser/browser-cookie-safari-parser.ts`
- `src/main/browser/browser-cookie-source-partition.test.ts`
- `src/main/browser/browser-cookie-source-partition.ts`
- `src/main/browser/browser-cookie-sqlite.ts`
- `src/main/browser/browser-cookie-staged-import.ts`
- `src/main/browser/browser-cookie-validation.ts`
- `src/main/browser/browser-error.ts`
- `src/main/browser/browser-execution-host-storage-identity.test.ts`
- `src/main/browser/browser-execution-host-storage-identity.ts`
- `src/main/browser/browser-guest-context-menu.ts`
- `src/main/browser/browser-guest-grab-shortcuts.ts`
...
- `src/main/browser/browser-guest-shortcut-forwarding.ts`
- `src/main/browser/browser-guest-wheel-zoom.ts`
- `src/main/browser/browser-guest-wheel-zoom-scroll.test.ts`
- `src/main/browser/browser-host-admission-recovery.ts`
- `src/main/browser/browser-host-client-identity.test.ts`
- `src/main/browser/browser-host-client-identity.ts`
- `src/main/browser/browser-host-command-result-settler.ts`
- `src/main/browser/browser-host-command-result-submission.ts`
- `src/main/browser/browser-host-lease-inventory-refresh.ts`
- `src/main/browser/browser-host-lease-reconnect-attempts.ts`
- `src/main/browser/browser-host-lease-reconnect-delay.test.ts`
- `src/main/browser/browser-host-lease-reconnect-delay.ts`
- `src/main/browser/browser-host-lease-request-sender.ts`
- `src/main/browser/browser-local-https-test-certificate.ts`
- `src/main/browser/browser-manager-annotation-bridge.test.ts`
- `src/main/browser/browser-manager-auth-user-agent.test.ts`
- `src/main/browser/browser-manager-bindings.ts`
- `src/main/browser/browser-manager-client-hosted-downloads.test.ts`
- `src/main/browser/browser-manager-download-creation.ts`
- `src/main/browser/browser-manager-download-lifecycle.ts`
- `src/main/browser/browser-manager-downloads.test.ts`
- `src/main/browser/browser-manager-event-forwarding.ts`
- `src/main/browser/browser-manager-final.ts`
- `src/main/browser/browser-manager-grab.ts`
- `src/main/browser/browser-manager-grab-capture.test.ts`
- `src/main/browser/browser-manager-grab-mode.test.ts`
- `src/main/browser/browser-manager-grab-selection.test.ts`
- `src/main/browser/browser-manager-grab-shortcuts.test.ts`
- `src/main/browser/browser-manager-grab-test-harness.ts`
- `src/main/browser/browser-manager-guest-cleanup.ts`
- `src/main/browser/browser-manager-guest-lifecycle.test.ts`
...
- `src/main/browser/browser-manager-guest-shortcuts.test.ts`
- `src/main/browser/browser-manager-guest-visibility.test.ts`
- `src/main/browser/browser-manager-load-failure-replay.test.ts`
- `src/main/browser/browser-manager-navigation.ts`
- `src/main/browser/browser-manager-popup-child.test.ts`
- `src/main/browser/browser-manager-popup-routing.test.ts`
- `src/main/browser/browser-manager-queries.ts`
- `src/main/browser/browser-manager-registration.ts`
- `src/main/browser/browser-manager-state.ts`
- `src/main/browser/browser-manager-test-harness.ts`
...
- `src/main/browser/browser-manager-viewport-partial-failure.test.ts`
- `src/main/browser/browser-manager-viewport-scroll-state.ts`
- `src/main/browser/browser-manager-viewport-test-fixtures.ts`
- `src/main/browser/browser-manager-visibility.ts`
...
- `src/main/browser/browser-network-execution-route-dispatch.ts`
- `src/main/browser/browser-network-route-reconnect-retry.ts`
- `src/main/browser/browser-network-tunnel-client.test.ts`
- `src/main/browser/browser-network-tunnel-client.ts`
- `src/main/browser/browser-network-tunnel-client-frame-dispatch.ts`
- `src/main/browser/browser-network-tunnel-client-memory-budget.test.ts`
- `src/main/browser/browser-network-tunnel-client-retirement.ts`
- `src/main/browser/browser-network-tunnel-client-stream.ts`
- `src/main/browser/browser-network-tunnel-client-stream-frames.ts`
- `src/main/browser/browser-network-tunnel-conformance.test.ts`
- `src/main/browser/browser-network-tunnel-destination-flow.ts`
- `src/main/browser/browser-network-tunnel-duplex.ts`
- `src/main/browser/browser-network-tunnel-frame-sender.ts`
- `src/main/browser/browser-network-tunnel-heartbeat.ts`
- `src/main/browser/browser-network-tunnel-open-admission.ts`
- `src/main/browser/browser-network-tunnel-outbound-memory-budget.test.ts`
- `src/main/browser/browser-network-tunnel-outbound-memory-budget.ts`
- `src/main/browser/browser-network-tunnel-resource-budget.ts`
- `src/main/browser/browser-network-tunnel-session.test.ts`
- `src/main/browser/browser-network-tunnel-session.ts`
- `src/main/browser/browser-network-tunnel-session-aggregate-memory.test.ts`
- `src/main/browser/browser-network-tunnel-session-stream-scoped-failure.test.ts`
- `src/main/browser/browser-network-tunnel-source-flow.ts`
- `src/main/browser/browser-network-tunnel-source-receive-flow.ts`
- `src/main/browser/browser-network-tunnel-stream-lifecycle.ts`
- `src/main/browser/browser-network-tunnel-stream-state.ts`
- `src/main/browser/browser-page-initiated-tab-budget.test.ts`
- `src/main/browser/browser-page-initiated-tab-budget.ts`
- `src/main/browser/browser-popup-new-tab-intent.ts`
- `src/main/browser/browser-route-dns-prefetch.electron.test.ts`
- `src/main/browser/browser-route-dns-prefetch-electron-main.ts`
- `src/main/browser/browser-route-dns-prefetch-fixture.ts`
- `src/main/browser/browser-route-egress-electron-launch.ts`
- `src/main/browser/browser-route-guest-guard.ts`
- `src/main/browser/browser-route-guest-lifecycle.ts`
- `src/main/browser/browser-route-guest-lifecycle-claim.ts`
- `src/main/browser/browser-route-guest-popup-gesture.ts`
- `src/main/browser/browser-route-guest-popup-ownership.ts`
- `src/main/browser/browser-route-guest-popups.test.ts`
- `src/main/browser/browser-route-guest-popups.ts`
- `src/main/browser/browser-route-guest-popup-window-options.ts`
- `src/main/browser/browser-route-guest-release.ts`
- `src/main/browser/browser-route-h3-egress.electron.test.ts`
- `src/main/browser/browser-route-h3-egress-electron-main.ts`
- `src/main/browser/browser-route-h3-egress-fixture.ts`
- `src/main/browser/browser-route-identity.test.ts`
- `src/main/browser/browser-route-identity.ts`
- `src/main/browser/browser-route-navigation-authority.ts`
- `src/main/browser/browser-route-page-authority.ts`
- `src/main/browser/browser-route-page-availability.ts`
- `src/main/browser/browser-route-partition-binding-capacity.test.ts`
- `src/main/browser/browser-route-partition-binding-file.ts`
- `src/main/browser/browser-route-partition-binding-runtime.ts`
- `src/main/browser/browser-route-partition-binding-store.test.ts`
- `src/main/browser/browser-route-partition-binding-store.ts`
- `src/main/browser/browser-route-partition-binding-store-fake.ts`
- `src/main/browser/browser-route-partition-migration.test.ts`
- `src/main/browser/browser-route-partition-migration.ts`
- `src/main/browser/browser-route-partition-retention.ts`
- `src/main/browser/browser-route-partition-stability.test.ts`
- `src/main/browser/browser-route-partition-storage-dependencies.ts`
- `src/main/browser/browser-route-partition-storage-lifecycle.test.ts`
- `src/main/browser/browser-route-partition-storage-lifecycle.ts`
- `src/main/browser/browser-route-partition-storage-retirement.test.ts`
- `src/main/browser/browser-route-partition-storage-retirement.ts`
- `src/main/browser/browser-route-partition-storage-runtime.test.ts`
- `src/main/browser/browser-route-partition-storage-runtime.ts`
- `src/main/browser/browser-route-persisted-worker-egress.electron.test.ts`
- `src/main/browser/browser-route-persisted-worker-electron-main.ts`
- `src/main/browser/browser-route-persisted-worker-electron-process.ts`
- `src/main/browser/browser-route-persisted-worker-fixture.ts`
- `src/main/browser/browser-route-prepared-page-ledger.ts`
- `src/main/browser/browser-route-prepared-page-rekey.test.ts`
- `src/main/browser/browser-route-renderer-prepare-fence.ts`
- `src/main/browser/browser-route-session-partition-binding.ts`
- `src/main/browser/browser-route-session-policy.ts`
- `src/main/browser/browser-route-session-registry.test.ts`
- `src/main/browser/browser-route-session-registry.ts`
- `src/main/browser/browser-route-session-registry-contract.ts`
- `src/main/browser/browser-route-session-rekey.ts`
- `src/main/browser/browser-route-session-renderer-retirement.ts`
- `src/main/browser/browser-route-session-retirement.ts`
- `src/main/browser/browser-route-session-runtime.ts`
- `src/main/browser/browser-route-session-state.ts`
- `src/main/browser/browser-route-tcp-egress.electron.test.ts`
- `src/main/browser/browser-route-tcp-egress-electron-process.ts`
- `src/main/browser/browser-route-tcp-egress-fixture.ts`
- `src/main/browser/browser-route-tcp-egress-fixture-cleanup.ts`
- `src/main/browser/browser-route-tcp-egress-socks-recorder.ts`
- `src/main/browser/browser-route-webcontents-registration.ts`
- `src/main/browser/browser-route-webcontents-registry.test.ts`
- `src/main/browser/browser-route-webcontents-registry.ts`
- `src/main/browser/browser-route-webcontents-registry-dependencies.ts`
- `src/main/browser/browser-route-webcontents-rekey.ts`
- `src/main/browser/browser-route-webcontents-state.ts`
- `src/main/browser/browser-route-webrtc-egress.electron.test.ts`
- `src/main/browser/browser-route-webrtc-policy.ts`
- `src/main/browser/browser-screencast-cdp-events.ts`
- `src/main/browser/browser-screencast-debugger-command.ts`
- `src/main/browser/browser-screencast-device-metrics.ts`
- `src/main/browser/browser-screencast-frame-budget.ts`
- `src/main/browser/browser-screencast-frame-metadata.ts`
- `src/main/browser/browser-screencast-frame-pacer.ts`
- `src/main/browser/browser-screencast-lifecycle.test.ts`
- `src/main/browser/browser-screencast-snapshot-capture.ts`
- `src/main/browser/browser-screencast-stream-types.ts`
- `src/main/browser/browser-screencast-viewport-fit.ts`
- `src/main/browser/browser-session-cookie-staging.scoped.test.ts`
- `src/main/browser/browser-session-cookie-staging.test.ts`
- `src/main/browser/browser-session-cookie-staging.ts`
- `src/main/browser/browser-session-meta-store.ts`
...
- `src/main/browser/browser-session-persisted-profile-validation.ts`
- `src/main/browser/browser-session-profile-retirement.ts`
- `src/main/browser/browser-session-proxy.test.ts`
- `src/main/browser/browser-session-proxy.ts`
- `src/main/browser/browser-session-route-policies.ts`
- `src/main/browser/browser-webauthn-access.test.ts`
- `src/main/browser/browser-webauthn-account-picker.test.ts`
- `src/main/browser/browser-webauthn-account-picker.ts`
- `src/main/browser/browser-webauthn-profile-delete.test.ts`
- `src/main/browser/cdp-auxiliary-commands.ts`
- `src/main/browser/cdp-bridge-command-module.ts`
- `src/main/browser/cdp-bridge-command-set.ts`
- `src/main/browser/cdp-bridge-state.test.ts`
- `src/main/browser/cdp-bridge-state.ts`
- `src/main/browser/cdp-client-response-writer.ts`
- `src/main/browser/cdp-debugger-channel.ts`
- `src/main/browser/cdp-debugger-events.ts`
- `src/main/browser/cdp-debugger-lifecycle.ts`
- `src/main/browser/cdp-dom-focus-replay.ts`
- `src/main/browser/cdp-element-state-commands.ts`
- `src/main/browser/cdp-navigation-operations.ts`
- `src/main/browser/cdp-page-capture-commands.ts`
- `src/main/browser/cdp-page-commands.ts`
- `src/main/browser/cdp-page-navigation-commands.ts`
- `src/main/browser/cdp-pointer-commands.ts`
- `src/main/browser/cdp-ref-resolution.ts`
- `src/main/browser/cdp-synthetic-session-registry.ts`
- `src/main/browser/cdp-tab-commands.ts`
- `src/main/browser/cdp-target-discovery.ts`
- `src/main/browser/cdp-text-input-commands.ts`
- `src/main/browser/client-route-cookie-import-source-store.test.ts`
- `src/main/browser/client-route-cookie-import-source-store.ts`
- `src/main/browser/doc-preview-download-block-notice.test.ts`
- `src/main/browser/doc-preview-download-block-notice.ts`
- `src/main/browser/doc-preview-failure-notice.test.ts`
- `src/main/browser/doc-preview-failure-notice.ts`
- `src/main/browser/doc-preview-file-reader.test.ts`
- `src/main/browser/doc-preview-file-reader.ts`
- `src/main/browser/doc-preview-grant-registry.test.ts`
- `src/main/browser/doc-preview-grant-registry.ts`
- `src/main/browser/doc-preview-guest-policy.test.ts`
- `src/main/browser/doc-preview-guest-policy.ts`
- `src/main/browser/doc-preview-protocol.test.ts`
- `src/main/browser/doc-preview-protocol.ts`
- `src/main/browser/electron-probe-display-launch.test.ts`
- `src/main/browser/electron-probe-display-launch.ts`
- `src/main/browser/execution-route-socket-duplex.test.ts`
- `src/main/browser/execution-route-socket-duplex.ts`
- `src/main/browser/grab-guest-content-script.ts`
- `src/main/browser/grab-guest-element-context-script.ts`
- `src/main/browser/grab-guest-foundation-script.ts`
- `src/main/browser/grab-guest-overlay-script.ts`
- `src/main/browser/grab-guest-react-script.ts`
- `src/main/browser/grab-guest-selection-scripts.ts`
- `src/main/browser/local-ssh-browser-partition-identity.test.ts`
- `src/main/browser/local-ssh-browser-partitions.probe-cache.test.ts`
...
- `src/main/browser/paired-runtime-browser-client-host-identity-wiring.test.ts`
...
- `src/main/browser/paired-runtime-browser-client-host-registry.ts`
- `src/main/browser/paired-runtime-browser-client-host-route-identity.test.ts`
- `src/main/browser/paired-runtime-browser-client-host-route-sets.ts`
...
- `src/main/browser/paired-runtime-browser-host-command-admission.test.ts`
- `src/main/browser/paired-runtime-browser-host-lease.test.ts`
- `src/main/browser/paired-runtime-browser-host-lease.ts`
- `src/main/browser/paired-runtime-browser-host-lease-connection.ts`
- `src/main/browser/paired-runtime-browser-host-lease-options.ts`
...
- `src/main/browser/paired-runtime-browser-network-transport.ts`
- `src/main/browser/remote-browser-socks-server.test.ts`
- `src/main/browser/remote-browser-socks-server.ts`
- `src/main/browser/snapshot-ax-tree-walk.ts`
- `src/main/browser/snapshot-cursor-interactive-elements.ts`
...
- `src/main/browser/wsl-browser-network-relay-launch.ts`
...
- `src/main/claude-accounts/claude-account-selection.ts`
- `src/main/claude-accounts/claude-account-service-account-selection.test.ts`
- `src/main/claude-accounts/claude-account-service-add-account.test.ts`
- `src/main/claude-accounts/claude-account-service-api-parity.test.ts`
- `src/main/claude-accounts/claude-account-service-config-dir-capture.test.ts`
- `src/main/claude-accounts/claude-account-service-credential-capture.test.ts`
- `src/main/claude-accounts/claude-account-service-login-process.test.ts`
- `src/main/claude-accounts/claude-account-service-reauth-rollback.test.ts`
- `src/main/claude-accounts/claude-account-service-test-harness.ts`
- `src/main/claude-accounts/claude-auth-capture.ts`
...
- `src/main/claude-accounts/claude-windows-interactive-login.test.ts`
- `src/main/claude-accounts/runtime-auth/runtime-auth-credential-identity.ts`
- `src/main/claude-accounts/runtime-auth/runtime-auth-credential-matching.ts`
- `src/main/claude-accounts/runtime-auth/runtime-auth-file-storage.ts`
- `src/main/claude-accounts/runtime-auth/runtime-auth-keychain-snapshots.ts`
...
- `src/main/claude-accounts/runtime-auth/runtime-auth-readback.ts`
- `src/main/claude-accounts/runtime-auth/runtime-auth-runtime-state.ts`
- `src/main/claude-accounts/runtime-auth/runtime-auth-snapshot-capture.ts`
- `src/main/claude-accounts/runtime-auth/runtime-auth-snapshot-restore.ts`
- `src/main/claude-accounts/runtime-auth/runtime-auth-state.ts`
- `src/main/claude-accounts/runtime-auth/runtime-auth-sync.ts`
- `src/main/claude-accounts/runtime-auth/runtime-auth-types.ts`
- `src/main/claude-accounts/runtime-auth-service-account-switching.test.ts`
- `src/main/claude-accounts/runtime-auth-service-deselect-restore.test.ts`
- `src/main/claude-accounts/runtime-auth-service-keychain-snapshots.test.ts`
- `src/main/claude-accounts/runtime-auth-service-launch-refresh.test.ts`
- `src/main/claude-accounts/runtime-auth-service-materialization.test.ts`
- `src/main/claude-accounts/runtime-auth-service-readback-identity.test.ts`
- `src/main/claude-accounts/runtime-auth-service-snapshot-validation.test.ts`
- `src/main/claude-accounts/runtime-auth-service-test-harness.ts`
- `src/main/claude-accounts/runtime-auth-service-wsl-runtime.test.ts`
- `src/main/claude-usage/claude-model-pricing.test.ts`
- `src/main/claude-usage/claude-model-pricing.ts`
- `src/main/claude-usage/claude-usage-automation-attribution.ts`
- `src/main/claude-usage/claude-usage-report-aggregation.test.ts`
- `src/main/claude-usage/claude-usage-report-aggregation.ts`
- `src/main/claude-usage/claude-usage-scope-filters.ts`
- `src/main/claude-usage/claude-usage-session-rows.ts`
...
- `src/main/cli/appimage-cache-layout.ts`
- `src/main/cli/appimage-extracted-root.test.ts`
- `src/main/cli/appimage-extracted-root.ts`
- `src/main/cli/appimage-extraction-pruning.test.ts`
- `src/main/cli/appimage-extraction-pruning.ts`
- `src/main/cli/appimage-payload-removal.reentrancy.test.ts`
- `src/main/cli/appimage-payload-removal.test.ts`
- `src/main/cli/appimage-payload-removal.ts`
- `src/main/cli/appimage-registration-lock.test.ts`
- `src/main/cli/appimage-registration-lock.ts`
- `src/main/cli/appimage-stable-launcher.test.ts`
...
- `src/main/cli/cli-command-privileged-transaction.test.ts`
- `src/main/cli/cli-dev-launcher.ts`
- `src/main/cli/cli-install-constants.ts`
- `src/main/cli/cli-installer-appimage-ownership.test.ts`
- `src/main/cli/cli-installer-appimage-removal.test.ts`
- `src/main/cli/cli-installer-command-conflicts.test.ts`
- `src/main/cli/cli-installer-contracts.ts`
- `src/main/cli/cli-installer-macos-command-path.test.ts`
- `src/main/cli/cli-install-errors.ts`
- `src/main/cli/cli-installer-test-fixtures.ts`
- `src/main/cli/cli-installer-windows-path.test.ts`
- `src/main/cli/cli-install-location.ts`
- `src/main/cli/cli-install-path-format.ts`
- `src/main/cli/cli-path-registration.ts`
- `src/main/cli/cli-privileged-processes.test.ts`
- `src/main/cli/cli-privileged-processes.ts`
- `src/main/cli/legacy-appimage-cli-wrapper.test.ts`
- `src/main/cli/legacy-appimage-cli-wrapper.ts`
- `src/main/cli/native-cli-powershell-argv-boundary.test.ts`
- `src/main/cli/wsl-cli-powershell-boundary.test.ts`
- `src/main/cli/wsl-cli-registration-command.ts`
- `src/main/cli/wsl-cli-status.ts`
- `src/main/codex/codex-ai-vault-session-resume.test.ts`
- `src/main/codex/codex-ai-vault-session-resume.ts`
...
- `src/main/codex/codex-app-server-frame-size-error.ts`
- `src/main/codex/codex-app-server-handshake.ts`
- `src/main/codex/codex-app-server-handshake-exit-proof.ts`
- `src/main/codex/codex-app-server-jsonl.ts`
- `src/main/codex/codex-app-server-notification-schema.ts`
- `src/main/codex/codex-app-server-posix-supervisor.test.ts`
...
- `src/main/codex/codex-app-server-record-prefix.ts`
- `src/main/codex/codex-app-server-record-reader.ts`
- `src/main/codex/codex-app-server-request-error.ts`
- `src/main/codex/codex-app-server-teardown.integration.test.ts`
...
- `src/main/codex/codex-hooks-read-denial-followup.test.ts`
...
- `src/main/codex/codex-pane-account-registry-mutations.test.ts`
- `src/main/codex/codex-pane-account-registry-mutations.ts`
- `src/main/codex/codex-pane-account-registry-types.ts`
...
- `src/main/codex/codex-resume-process-proof.test.ts`
- `src/main/codex/codex-resume-process-proof.ts`
- `src/main/codex/codex-rollout-session-meta.test.ts`
- `src/main/codex/codex-rollout-session-meta.ts`
- `src/main/codex/codex-server-request-disposition.test.ts`
- `src/main/codex/codex-server-request-disposition.ts`
- `src/main/codex/codex-session-backfill-fs-mocks.ts`
- `src/main/codex/codex-session-backfill-marker.test.ts`
- `src/main/codex/codex-session-backfill-scan-dates.test.ts`
- `src/main/codex/codex-session-backfill-scan-dates.ts`
- `src/main/codex/codex-session-index-heal-state.test.ts`
- `src/main/codex/codex-session-ledger-stream.ts`
- `src/main/codex/codex-session-resume-wrong-account.test.ts`
- `src/main/codex/codex-structured-acquisition-exit-proof.test.ts`
- `src/main/codex/codex-structured-acquisition-lifecycle.ts`
- `src/main/codex/codex-structured-acquisition-window.ts`
- `src/main/codex/codex-structured-app-server-args.test.ts`
- `src/main/codex/codex-structured-app-server-args.ts`
...
- `src/main/codex/codex-structured-item-stream-events.ts`
...
- `src/main/codex/codex-structured-journal-prompts.ts`
...
- `src/main/codex/codex-structured-journal-translation-values.ts`
...
- `src/main/codex/codex-structured-owner-identity.test.ts`
- `src/main/codex/codex-structured-owner-identity.ts`
- `src/main/codex/codex-structured-prompt-items.test.ts`
- `src/main/codex/codex-structured-prompt-items.ts`
- `src/main/codex/codex-structured-prompt-replies.test.ts`
- `src/main/codex/codex-structured-prompt-replies.ts`
...
- `src/main/codex/codex-structured-session-options.ts`
- `src/main/codex/codex-structured-session-shutdown.test.ts`
...
- `src/main/codex/codex-trust-config-concurrent-launch.test.ts`
- `src/main/codex/codex-trust-config-mutation-queue.test.ts`
- `src/main/codex/codex-trust-config-mutation-queue.ts`
- `src/main/codex/codex-trust-grant-main-thread-boundary.test.ts`
- `src/main/codex/codex-trust-identity.ts`
- `src/main/codex/codex-tui-resume-real-binary.integration.test.ts`
- `src/main/codex/codex-tui-rollout-proof.test.ts`
- `src/main/codex/codex-tui-rollout-proof.ts`
...
- `src/main/codex/config-toml-trust-api-parity.test.ts`
- `src/main/codex/config-toml-trust-hash.test.ts`
- `src/main/codex/config-toml-trust-hook-read.test.ts`
- `src/main/codex/config-toml-trust-hook-removal.test.ts`
- `src/main/codex/config-toml-trust-hook-upsert.test.ts`
- `src/main/codex/config-toml-trust-key.test.ts`
- `src/main/codex/config-toml-trust-project.test.ts`
- `src/main/codex/config-toml-trust-test-fixtures.ts`
- `src/main/codex/hook-service-concurrent-launch-install.test.ts`
- `src/main/codex/hook-service-legacy-cleanup.test.ts`
- `src/main/codex/hook-service-managed-install.test.ts`
- `src/main/codex/hook-service-runtime-trust-repair.test.ts`
- `src/main/codex/hook-service-test-harness.ts`
- `src/main/codex/hook-service-user-hook-mirroring.test.ts`
- `src/main/codex/managed-home-shell-preflight.test.ts`
- `src/main/codex/managed-home-shell-preflight.ts`
- `src/main/codex/managed-wsl-codex-home-registry.ts`
- `src/main/codex/managed-wsl-home-shell-preflight.ts`
- `src/main/codex/sta-4735-hook-trust-provenance-overwrite.test.ts`
- `src/main/codex/sta-4737-unreadable-is-not-absent.test.ts`
- `src/main/codex/sta-4823-shared-state-survives-a-failed-read.test.ts`
- `src/main/codex/wsl-codex-session-bridge-script.ts`
- `src/main/codex-accounts/codex-account-identity.ts`
- `src/main/codex-accounts/codex-account-identity-api-key-guard.test.ts`
- `src/main/codex-accounts/codex-account-registration.ts`
- `src/main/codex-accounts/codex-account-selection.ts`
- `src/main/codex-accounts/codex-account-service-types.ts`
- `src/main/codex-accounts/codex-config-mirror.ts`
- `src/main/codex-accounts/codex-login-session.ts`
- `src/main/codex-accounts/codex-managed-home-lifecycle.ts`
- `src/main/codex-accounts/codex-managed-home-path.ts`
- `src/main/codex-accounts/codex-reset-credit-coordinator.ts`
- `src/main/codex-accounts/codex-reset-credit-ledger.ts`
- `src/main/codex-accounts/codex-reset-credit-scope-validation.ts`
- `src/main/codex-accounts/codex-windows-interactive-login.test.ts`
- `src/main/codex-accounts/legacy-wsl-runtime-auth-drain.test.ts`
- `src/main/codex-accounts/legacy-wsl-runtime-auth-drain.ts`
- `src/main/codex-accounts/legacy-wsl-runtime-auth-drain-apply-script.test.ts`
- `src/main/codex-accounts/legacy-wsl-runtime-auth-drain-exit-codes.ts`
- `src/main/codex-accounts/legacy-wsl-runtime-auth-drain-recovery-script-harness.ts`
- `src/main/codex-accounts/legacy-wsl-runtime-auth-drain-rollback-script.test.ts`
- `src/main/codex-accounts/legacy-wsl-runtime-auth-drain-script-fixtures.ts`
...
- `src/main/codex-accounts/legacy-wsl-runtime-auth-drain-script-run-types.ts`
- `src/main/codex-accounts/legacy-wsl-runtime-auth-drain-scripts.ts`
- `src/main/codex-accounts/legacy-wsl-runtime-auth-drain-shell-commands.ts`
- `src/main/codex-accounts/legacy-wsl-runtime-auth-finalize-script.ts`
- `src/main/codex-accounts/runtime-home-legacy-migration.test.ts`
- `src/main/codex-accounts/runtime-home-managed-auth-recovery.test.ts`
- `src/main/codex-accounts/runtime-home-per-account-homes.test.ts`
- `src/main/codex-accounts/runtime-home-real-home-lane-routing.test.ts`
- `src/main/codex-accounts/runtime-home-resume-selection-gate.test.ts`
- `src/main/codex-accounts/runtime-home-retained-auth-provenance.test.ts`
- `src/main/codex-accounts/runtime-home-service-auth-core.ts`
- `src/main/codex-accounts/runtime-home-service-auth-provenance.ts`
- `src/main/codex-accounts/runtime-home-service-auth-sync.ts`
- `src/main/codex-accounts/runtime-home-service-auth-sync-identity.ts`
- `src/main/codex-accounts/runtime-home-service-home-routing.ts`
- `src/main/codex-accounts/runtime-home-service-launch.ts`
- `src/main/codex-accounts/runtime-home-service-legacy-migration.ts`
- `src/main/codex-accounts/runtime-home-service-managed-home.ts`
- `src/main/codex-accounts/runtime-home-service-paths.ts`
- `src/main/codex-accounts/runtime-home-service-state.ts`
- `src/main/codex-accounts/runtime-home-service-sync.ts`
- `src/main/codex-accounts/runtime-home-service-test-harness.ts`
- `src/main/codex-accounts/runtime-home-service-types.ts`
- `src/main/codex-accounts/runtime-home-service-wsl.ts`
- `src/main/codex-accounts/runtime-home-service-wsl-core.ts`
- `src/main/codex-accounts/runtime-home-session-migration-pass.test.ts`
- `src/main/codex-accounts/runtime-home-settings-test-fixtures.ts`
- `src/main/codex-accounts/runtime-home-system-default-mirror-readback.test.ts`
- `src/main/codex-accounts/runtime-home-system-default-snapshot.test.ts`
- `src/main/codex-accounts/runtime-home-system-resource-materialization.test.ts`
- `src/main/codex-accounts/runtime-home-wsl-managed-accounts.test.ts`
- `src/main/codex-accounts/runtime-home-wsl-session-bridge.test.ts`
- `src/main/codex-accounts/runtime-home-wsl-system-default.test.ts`
- `src/main/codex-accounts/service-account-add-login.test.ts`
- `src/main/codex-accounts/service-account-selection-and-removal.test.ts`
- `src/main/codex-accounts/service-add-account-from-home.test.ts`
- `src/main/codex-accounts/service-hook-trust-test-fixtures.ts`
- `src/main/codex-accounts/service-login-process-teardown.test.ts`
- `src/main/codex-accounts/service-managed-home-removal-retries.test.ts`
- `src/main/codex-accounts/service-quota-refresh-decoupling.test.ts`
- `src/main/codex-accounts/service-reauthenticate-activation.test.ts`
- `src/main/codex-accounts/service-reset-credit-durability.test.ts`
- `src/main/codex-accounts/service-reset-credit-home-ownership.test.ts`
- `src/main/codex-accounts/service-reset-credit-target-routing.test.ts`
- `src/main/codex-accounts/service-reset-credit-test-fixtures.ts`
- `src/main/codex-accounts/service-system-default-identity.test.ts`
- `src/main/codex-accounts/service-test-harness.ts`
- `src/main/codex-accounts/service-wsl-accounts.test.ts`
- `src/main/codex-accounts/sta-4422-transient-ownership-error.test.ts`
- `src/main/codex-accounts/sta-4734-login-rollback-deletes-authenticated-home.test.ts`
- `src/main/codex-accounts/sta-4735-unreadable-host-lane-writes.test.ts`
- `src/main/codex-accounts/wsl-codex-auth-batch-reader.ts`
- `src/main/codex-cli/codex-read-only-app-server-args.ts`
- `src/main/codex-usage/codex-automation-run-attribution.ts`
- `src/main/codex-usage/codex-model-pricing.ts`
- `src/main/codex-usage/codex-session-file-discovery.ts`
- `src/main/codex-usage/codex-usage-cost-estimate.ts`
- `src/main/codex-usage/codex-usage-event-attribution.ts`
- `src/main/codex-usage/codex-usage-record-parser.ts`
- `src/main/codex-usage/codex-usage-rollup-projections.ts`
- `src/main/codex-usage/codex-usage-scope-filters.ts`
- `src/main/codex-usage/codex-usage-session-rows.ts`
- `src/main/codex-usage/codex-usage-token-delta.ts`
- `src/main/codex-usage/store-automation-usage.test.ts`
- `src/main/codex-usage/store-model-pricing.test.ts`
- `src/main/codex-usage/store-orca-scope.test.ts`
- `src/main/codex-usage/store-persistence.test.ts`
- `src/main/codex-usage/store-test-harness.ts`
- `src/main/computer/computer-action-verification-normalization.test.ts`
...
- `src/main/crash-reporting/crash-breadcrumb-renderer-attribution.test.ts`
- `src/main/crash-reporting/crash-breadcrumb-store-orphan-cleanup.test.ts`
- `src/main/crash-reporting/crashpad-capture.test.ts`
- `src/main/crash-reporting/crashpad-capture.ts`
- `src/main/crash-reporting/gone-time-system-memory.ts`
- `src/main/crash-reporting/gpu-crash-diagnostics.test.ts`
- `src/main/crash-reporting/gpu-crash-diagnostics.ts`
...
- `src/main/crash-reporting/gpu-fallback-engagement.ts`
- `src/main/crash-reporting/gpu-fallback-recovered-launch.test.ts`
- `src/main/crash-reporting/gpu-fallback-recovered-launch.ts`
- `src/main/crash-reporting/minidump-crashpad-annotations.ts`
- `src/main/crash-reporting/minidump-crash-signature.test.ts`
- `src/main/crash-reporting/minidump-crash-signature.ts`
- `src/main/crash-reporting/minidump-stream-reader.ts`
- `src/main/crash-reporting/process-gone-sibling-attribution.ts`
- `src/main/crash-reporting/process-gone-sibling-correlation.test.ts`
- `src/main/crash-reporting/process-gone-sibling-correlation.ts`
- `src/main/crash-reporting/suppressed-process-gone-breadcrumb.test.ts`
- `src/main/crash-reporting/suppressed-process-gone-breadcrumb.ts`
- `src/main/cursor/hook-events.ts`
- `src/main/cursor/hook-script.ts`
- `src/main/daemon/__fixtures__/terminal-wide-cell-grid.ts`
- `src/main/daemon/bash-prompt-command-composition.test.ts`
- `src/main/daemon/daemon-adoption-telemetry-event.test.ts`
- `src/main/daemon/daemon-adoption-telemetry-event.ts`
- `src/main/daemon/daemon-attach-only-retirement.ts`
- `src/main/daemon/daemon-bash-shell-ready-rcfile.ts`
- `src/main/daemon/daemon-bash-wrapper-osc133-fixture.ts`
- `src/main/daemon/daemon-bundle-staleness.ts`
- `src/main/daemon/daemon-checkpoint-session-queue.test.ts`
- `src/main/daemon/daemon-checkpoint-session-queue.ts`
- `src/main/daemon/daemon-client-connections.ts`
- `src/main/daemon/daemon-client-hello-handshake.ts`
- `src/main/daemon/daemon-client-listener-registry.ts`
- `src/main/daemon/daemon-client-ndjson-readers.ts`
- `src/main/daemon/daemon-client-notify-settlement.ts`
- `src/main/daemon/daemon-client-pending-requests.ts`
- `src/main/daemon/daemon-client-rpc-request.test.ts`
- `src/main/daemon/daemon-client-rpc-request.ts`
- `src/main/daemon/daemon-client-socket-connect.ts`
- `src/main/daemon/daemon-durable-history-ownership-seed.test.ts`
- `src/main/daemon/daemon-durable-history-snapshot.ts`
- `src/main/daemon/daemon-endpoint-adoption.ts`
- `src/main/daemon/daemon-endpoint-errors.ts`
- `src/main/daemon/daemon-endpoint-incarnation.ts`
- `src/main/daemon/daemon-endpoint-lifecycle.ts`
- `src/main/daemon/daemon-entry-path-layouts.test.ts`
- `src/main/daemon/daemon-history-recovery-freeze.ts`
- `src/main/daemon/daemon-init-child-readiness.test.ts`
- `src/main/daemon/daemon-init-child-startup-failure.test.ts`
- `src/main/daemon/daemon-init-dependency-mocks.ts`
- `src/main/daemon/daemon-init-endpoint-adoption.test.ts`
- `src/main/daemon/daemon-init-fresh-import.ts`
- `src/main/daemon/daemon-init-live-session-preservation.test.ts`
- `src/main/daemon/daemon-init-mock-types.ts`
- `src/main/daemon/daemon-init-packaged-bundle-staleness.test.ts`
- `src/main/daemon/daemon-init-provider-installation.test.ts`
- `src/main/daemon/daemon-init-replacement-reporting.test.ts`
- `src/main/daemon/daemon-init-restart-sequence.test.ts`
- `src/main/daemon/daemon-init-test-harness.ts`
- `src/main/daemon/daemon-init-wedged-daemon-grace.test.ts`
- `src/main/daemon/daemon-launched-child.ts`
- `src/main/daemon/daemon-launch-paths.ts`
- `src/main/daemon/daemon-legacy-adapters.ts`
- `src/main/daemon/daemon-listener-registry.ts`
- `src/main/daemon/daemon-native-pty-exception.test.ts`
- `src/main/daemon/daemon-native-pty-exception.ts`
- `src/main/daemon/daemon-out-of-process-launcher.ts`
- `src/main/daemon/daemon-pid-file-parse.test.ts`
- `src/main/daemon/daemon-pid-file-parse.ts`
- `src/main/daemon/daemon-pid-identity.ts`
- `src/main/daemon/daemon-pid-record-quarantine.ts`
- `src/main/daemon/daemon-process-identity-query.ts`
- `src/main/daemon/daemon-process-start-time.ts`
- `src/main/daemon/daemon-protocol-cleanup.ts`
- `src/main/daemon/daemon-provider-init.ts`
- `src/main/daemon/daemon-provider-restart.ts`
- `src/main/daemon/daemon-provider-routing.ts`
- `src/main/daemon/daemon-provider-state.ts`
- `src/main/daemon/daemon-pty-adapter-cold-restore-reanchor.test.ts`
- `src/main/daemon/daemon-pty-adapter-cold-restore-seed.test.ts`
- `src/main/daemon/daemon-pty-adapter-concurrent-recovery.test.ts`
- `src/main/daemon/daemon-pty-adapter-daemon-recovery.test.ts`
- `src/main/daemon/daemon-pty-adapter-history-checkpoints.test.ts`
- `src/main/daemon/daemon-pty-adapter-inventory-respawn.test.ts`
- `src/main/daemon/daemon-pty-adapter-protocol-compatibility.test.ts`
- `src/main/daemon/daemon-pty-adapter-replacement-exit-race.test.ts`
- `src/main/daemon/daemon-pty-adapter-session-adoption.test.ts`
- `src/main/daemon/daemon-pty-adapter-test-harness.ts`
- `src/main/daemon/daemon-pty-applied-size.ts`
- `src/main/daemon/daemon-pty-buffer-snapshots.ts`
...
- `src/main/daemon/daemon-pty-daemon-recovery.ts`
- `src/main/daemon/daemon-pty-event-subscriptions.ts`
- `src/main/daemon/daemon-pty-lifecycle-errors.ts`
- `src/main/daemon/daemon-pty-process-inspection.ts`
- `src/main/daemon/daemon-pty-provider-sequence.ts`
...
- `src/main/daemon/daemon-pty-spawn-request.ts`
- `src/main/daemon/daemon-pty-spawn-result.ts`
- `src/main/daemon/daemon-reattach-checkpoint-isolation.test.ts`
- `src/main/daemon/daemon-recovery-budget.ts`
- `src/main/daemon/daemon-replacement-preflight.ts`
- `src/main/daemon/daemon-request-deadline.ts`
- `src/main/daemon/daemon-request-router.ts`
- `src/main/daemon/daemon-respawn-throttle.test.ts`
- `src/main/daemon/daemon-respawn-throttle.ts`
- `src/main/daemon/daemon-restart-state.ts`
- `src/main/daemon/daemon-restore-scrollback-depth.test.ts`
- `src/main/daemon/daemon-restore-scrollback-depth.ts`
- `src/main/daemon/daemon-server-async-spawn-cancellation.test.ts`
- `src/main/daemon/daemon-server-attachment-lifecycle.test.ts`
- `src/main/daemon/daemon-server-lifecycle.ts`
- `src/main/daemon/daemon-server-options.ts`
- `src/main/daemon/daemon-session-attachments.ts`
- `src/main/daemon/daemon-session-background-routing.ts`
- `src/main/daemon/daemon-session-scrollback-window.test.ts`
- `src/main/daemon/daemon-session-scrollback-window.ts`
- `src/main/daemon/daemon-shell-ready-marker.ts`
- `src/main/daemon/daemon-shell-ready-wrapper-fileset.ts`
- `src/main/daemon/daemon-shutdown-final-checkpoint-caller-deadline.test.ts`
- `src/main/daemon/daemon-stale-kill.ts`
- `src/main/daemon/daemon-tcc-attribution.ts`
- `src/main/daemon/daemon-tcc-attribution-main-thread.test.ts`
- `src/main/daemon/daemon-terminal-admission.ts`
- `src/main/daemon/daemon-transport-attachment-release.test.ts`
- `src/main/daemon/daemon-zsh-shell-ready-wrapper-spec.ts`
- `src/main/daemon/hangul-cell-width-agreement.test.ts`
- `src/main/daemon/headless-emulator-modes.ts`
- `src/main/daemon/headless-emulator-restored-osc-links.test.ts`
- `src/main/daemon/headless-emulator-wide-char-repaint.test.ts`
- `src/main/daemon/headless-emulator-wide-char-snapshot.test.ts`
- `src/main/daemon/node-pty-windows-input-error.win32.test.ts`
- `src/main/daemon/pty-subprocess/foreground-fallback-process.ts`
- `src/main/daemon/pty-subprocess/foreground-process-tracker.ts`
- `src/main/daemon/pty-subprocess/native-pty-spawn.ts`
- `src/main/daemon/pty-subprocess/pre-listener-events.ts`
- `src/main/daemon/pty-subprocess/pty-shell-foreground-confirmation.ts`
...
- `src/main/daemon/pty-subprocess-foreground-identity.test.ts`
- `src/main/daemon/pty-subprocess-git-credential-guard.test.ts`
- `src/main/daemon/pty-subprocess-handle-lifecycle.test.ts`
- `src/main/daemon/pty-subprocess-managed-agent-env.test.ts`
- `src/main/daemon/pty-subprocess-test-harness.ts`
...
- `src/main/daemon/session-options.ts`
- `src/main/daemon/session-output-pipeline.ts`
- `src/main/daemon/session-output-plane.ts`
- `src/main/daemon/session-powershell-prompt-repaint.ts`
...
- `src/main/daemon/session-subprocess-handle.ts`
- `src/main/daemon/session-termination-controller.ts`
- `src/main/daemon/shell-ready-bash-wrapper.test.ts`
- `src/main/daemon/terminal-attach-cancellation.ts`
- `src/main/daemon/terminal-cursor-line-context.test.ts`
- `src/main/daemon/terminal-host-concurrent-create.test.ts`
- `src/main/daemon/terminal-host-cwd-readability.test.ts`
- `src/main/daemon/terminal-host-readiness-reporting.test.ts`
- `src/main/daemon/terminal-host-teardown-recreate.test.ts`
- `src/main/daemon/terminal-shell-clean-exit-confirmation.ts`
- `src/main/daemon/terminal-shell-lifecycle-scanner.test.ts`
- `src/main/daemon/terminal-shell-lifecycle-scanner.ts`
- `src/main/daemon/terminal-shell-recovery-barrier.test.ts`
- `src/main/daemon/terminal-shell-recovery-barrier.ts`
- `src/main/daemon/terminal-shell-recovery-clean-exit-retirement.test.ts`
- `src/main/effective-hook-config.ts`
- `src/main/emulator/emulator-device-inventory.ts`
- `src/main/emulator/emulator-start-lease-registry.test.ts`
- `src/main/emulator/emulator-start-lease-registry.ts`
- `src/main/emulator/serve-sim-execution.test.ts`
- `src/main/ephemeral-vm-failed-start-cleanup.ts`
- `src/main/ephemeral-vm-provisioned-root-source.ts`
- `src/main/ephemeral-vm-resume-integrity.test.ts`
- `src/main/ephemeral-vm-resume-integrity.ts`
- `src/main/ephemeral-vm-runtime-attachment.ts`
- `src/main/ephemeral-vm-runtime-cleanup-control.ts`
- `src/main/ephemeral-vm-runtime-provisioning-persistence.ts`
- `src/main/ephemeral-vm-runtime-ssh-cleanup.test.ts`
- `src/main/ephemeral-vm-runtime-ssh-cleanup.ts`
- `src/main/fish-history-session.test.ts`
- `src/main/fish-history-session.ts`
- `src/main/folder-workspace-diff-comments.ts`
- `src/main/git/add-sparse-worktree.test.ts`
- `src/main/git/admission-tier-plumbing.test.ts`
- `src/main/git/canonical-repo-key.test.ts`
- `src/main/git/canonical-repo-key.ts`
- `src/main/git/command-runner/abort-error.ts`
- `src/main/git/command-runner/command-exec-file.ts`
- `src/main/git/command-runner/exec-file-capture.ts`
- `src/main/git/command-runner/gh-exec-file.ts`
- `src/main/git/command-runner/gh-host-args.ts`
- `src/main/git/command-runner/gh-idempotency.ts`
- `src/main/git/command-runner/gh-retry-policy.ts`
- `src/main/git/command-runner/git-admission-candidate-heap.ts`
- `src/main/git/command-runner/git-admission-output-parity.test.ts`
- `src/main/git/command-runner/git-admission-span.test.ts`
- `src/main/git/command-runner/git-admission-state.ts`
- `src/main/git/command-runner/git-admission-storm-measurement.test.ts`
- `src/main/git/command-runner/git-admission-waiter-queue.ts`
- `src/main/git/command-runner/git-command-resolution.ts`
- `src/main/git/command-runner/git-command-timeout.test.ts`
- `src/main/git/command-runner/git-command-timeout.ts`
- `src/main/git/command-runner/git-command-timeout-behavior.test.ts`
- `src/main/git/command-runner/git-exec-admission-lifetime.test.ts`
- `src/main/git/command-runner/git-exec-file.ts`
- `src/main/git/command-runner/git-exec-options.ts`
- `src/main/git/command-runner/github-cli-host-fallback.ts`
- `src/main/git/command-runner/git-process-env.ts`
- `src/main/git/command-runner/git-spawn.ts`
- `src/main/git/command-runner/git-spawn-admission-lifetime.test.ts`
- `src/main/git/command-runner/git-ssh-policy-env.ts`
- `src/main/git/command-runner/git-stream-admission-lifetime.test.ts`
- `src/main/git/command-runner/git-stream-stdout.ts`
- `src/main/git/command-runner/git-subprocess-admission.test.ts`
...
- `src/main/git/command-runner/windows-host-git-environment.ts`
- `src/main/git/command-runner/wsl-aware-spawn.ts`
- `src/main/git/command-runner/wsl-command-resolution.ts`
- `src/main/git/command-runner/wsl-path-translation.ts`
- `src/main/git/exact-ref-probe.test.ts`
- `src/main/git/exact-ref-probe.ts`
- `src/main/git/fork-remote-refspec.test.ts`
- `src/main/git/fork-remote-refspec.ts`
- `src/main/git/fork-remote-stale-branch-refspec.test.ts`
- `src/main/git/fork-remote-stale-branch-refspec.ts`
- `src/main/git/git-upstream-status-read-owner.test.ts`
- `src/main/git/git-upstream-status-read-owner.ts`
- `src/main/git/local-repo-ref-maintenance.test.ts`
- `src/main/git/local-repo-ref-maintenance.ts`
- `src/main/git/pack-refs-lock-ownership.test.ts`
- `src/main/git/pack-refs-lock-ownership.ts`
- `src/main/git/remote-rebase.ts`
- `src/main/git/remove-worktree-branch-cleanup.test.ts`
- `src/main/git/remove-worktree-clean-preflight.test.ts`
- `src/main/git/remove-worktree-test-harness.ts`
- `src/main/git/repo-api-parity.test.ts`
- `src/main/git/repo-base-ref-search.ts`
- `src/main/git/repo-branch-conflict.test.ts`
- `src/main/git/repo-branch-conflict.ts`
- `src/main/git/repo-branch-conflict-real-git.test.ts`
- `src/main/git/repo-default-base-ref.ts`
- `src/main/git/repo-default-remote.test.ts`
- `src/main/git/repo-detection.ts`
- `src/main/git/repo-git-marker-scan.ts`
- `src/main/git/repo-ref-maintenance-real-git.test.ts`
- `src/main/git/runner-windows-host-environment.test.ts`
- `src/main/git/runner-wsl-login-shell-capture.test.ts`
- `src/main/git/runner-wsl-read-routing.test.ts`
- `src/main/git/settled-diff-cache-bounds.test.ts`
- `src/main/git/source-control/branch-change-entries.ts`
- `src/main/git/source-control/branch-compare.ts`
- `src/main/git/source-control/branch-diff.ts`
- `src/main/git/source-control/bulk-pathspec-command-line-budget.test.ts`
- `src/main/git/source-control/commit-changes.ts`
- `src/main/git/source-control/commit-compare.ts`
- `src/main/git/source-control/commit-diff.ts`
- `src/main/git/source-control/compare-ref-oids.ts`
- `src/main/git/source-control/diff-result.ts`
- `src/main/git/source-control/discard-changes.ts`
- `src/main/git/source-control/effective-upstream-status-cache.ts`
- `src/main/git/source-control/effective-upstream-status-probe.ts`
- `src/main/git/source-control/file-diff.ts`
- `src/main/git/source-control/get-status-options.ts`
- `src/main/git/source-control/git-blob-read.ts`
- `src/main/git/source-control/git-conflict-operation.ts`
- `src/main/git/source-control/git-pathspec.ts`
- `src/main/git/source-control/git-read-cache-invalidation.ts`
- `src/main/git/source-control/git-runtime-options-cache-key.ts`
- `src/main/git/source-control/git-show-max-bytes.ts`
- `src/main/git/source-control/previewable-binary-mime-types.ts`
- `src/main/git/source-control/resolved-upstream-name-cache.ts`
- `src/main/git/source-control/resolve-git-dir.test.ts`
- `src/main/git/source-control/resolve-git-dir.ts`
- `src/main/git/source-control/settled-diff-cache.ts`
- `src/main/git/source-control/staged-commit-context.ts`
- `src/main/git/source-control/staging.ts`
- `src/main/git/source-control/status-branch-line-total-input.ts`
- `src/main/git/source-control/status-conflict-entries.ts`
- `src/main/git/source-control/status-line-stats.ts`
- `src/main/git/source-control/status-read.ts`
- `src/main/git/source-control/submodule-diff.ts`
- `src/main/git/source-control/submodule-gitlink-oid.ts`
- `src/main/git/source-control/submodule-paths.ts`
- `src/main/git/source-control/submodule-status.ts`
- `src/main/git/source-control/worktree-diff-stamp.ts`
- `src/main/git/source-control/worktree-filesystem-path.ts`
- `src/main/git/source-control/wsl-tracked-pathspec-banner.test.ts`
- `src/main/git/status-branch-compare.test.ts`
- `src/main/git/status-conflict-operations.test.ts`
- `src/main/git/status-diff.test.ts`
- `src/main/git/status-diff-settled-cache.test.ts`
- `src/main/git/status-discard-and-bulk-staging.test.ts`
- `src/main/git/status-line-stats-host-paths.test.ts`
- `src/main/git/status-read-coalescing.test.ts`
- `src/main/git/status-submodule.test.ts`
- `src/main/git/status-test-harness.ts`
- `src/main/git/upstream-deferred-fork-remote-real.test.ts`
...
- `src/main/git/worktree-base-divergence.test.ts`
- `src/main/git/worktree-base-divergence.ts`
- `src/main/git/worktree-base-divergence-real-git.test.ts`
- `src/main/git/worktree-base-ref-probe.test.ts`
...
- `src/main/git/worktree-common-dir-comparison.test.ts`
- `src/main/git/worktree-configured-paths-concurrency.test.ts`
- `src/main/git/worktree-created-description-real-git.test.ts`
- `src/main/git/worktree-create-preparation.ts`
- `src/main/git/worktree-create-preparation-real-git.test.ts`
- `src/main/git/worktree-diff-stamp-guest-gitdir.test.ts`
- `src/main/git/worktree-diff-stamp-host-paths.test.ts`
- `src/main/git/worktree-graph-listing.test.ts`
- `src/main/git/worktree-listing.ts`
- `src/main/git/worktree-listing-created-sparse-distro.test.ts`
- `src/main/git/worktree-listing-sparse-distro.test.ts`
- `src/main/git/worktree-list-parser.ts`
- `src/main/git/worktree-list-porcelain.test.ts`
- `src/main/git/worktree-list-reader.ts`
- `src/main/git/worktree-move.test.ts`
- `src/main/git/worktree-move.ts`
- `src/main/git/worktree-mutation-route-invalidation.test.ts`
- `src/main/git/worktree-operation-options.ts`
- `src/main/git/worktree-path-comparison.ts`
- `src/main/git/worktree-porcelain-parsing.test.ts`
- `src/main/git/worktree-removal.ts`
- `src/main/git/worktree-removal-preflight.ts`
- `src/main/git/worktree-remove-branch-deletion.test.ts`
- `src/main/git/worktree-scan-cache.ts`
- `src/main/git/worktree-scan-cache-annotation-reuse.test.ts`
- `src/main/git/worktree-scan-cache-sharing.test.ts`
- `src/main/git/worktree-sparse-add.ts`
- `src/main/git/worktree-sparse-checkout-cache.test.ts`
- `src/main/git/worktree-sparse-checkout-cache.ts`
- `src/main/git/worktree-sparse-state.ts`
- `src/main/git/worktree-sparse-state-host-paths.test.ts`
- `src/main/git/worktree-symlink-detection.test.ts`
- `src/main/git/worktree-test-harness.ts`
- `src/main/git/wsl-direct-git-read-commands.test.ts`
- `src/main/git/wsl-direct-git-read-commands.ts`
- `src/main/git/wsl-linked-worktree-git-route-invalidation.test.ts`
- `src/main/git/wsl-linked-worktree-git-route-probe.ts`
- `src/main/git/wsl-process-group-termination.test.ts`
- `src/main/git/wsl-process-group-termination.ts`
- `src/main/github/client/check/check-detail-field-mapping.ts`
- `src/main/github/client/check/check-details-abort.ts`
- `src/main/github/client/check/check-job-log-tails.ts`
- `src/main/github/client/check/get-pr-check-details.ts`
- `src/main/github/client/check/get-pr-checks.ts`
- `src/main/github/client/check/pr-checks-graphql-query.ts`
- `src/main/github/client/check/pr-checks-response-mapping.ts`
- `src/main/github/client/check/rerun-pr-checks.ts`
- `src/main/github/client/create/add-pr-review-comment.ts`
- `src/main/github/client/create/create-github-pull-request.ts`
- `src/main/github/client/create/create-pr-error-classification.ts`
- `src/main/github/client/create/pull-request-template.ts`
- `src/main/github/client/detect/hydrate-work-item-merge-metadata.ts`
- `src/main/github/client/detect/repository-merge-metadata.ts`
- `src/main/github/client/detect/repository-merge-metadata-cache.ts`
- `src/main/github/client/fetch/authenticated-viewer.ts`
- `src/main/github/client/fetch/get-pr-comments.ts`
- `src/main/github/client/fetch/get-work-item.ts`
- `src/main/github/client/fetch/orca-star.ts`
- `src/main/github/client/fetch/pr-review-threads-query.ts`
- `src/main/github/client/fetch/repo-slug-upstream.ts`
- `src/main/github/client/fetch/work-item-fetch.ts`
- `src/main/github/client/gh-error-predicates.ts`
- `src/main/github/client/github-exec-scope.ts`
- `src/main/github/client/list/count-work-items.ts`
- `src/main/github/client/list/list-work-items.ts`
- `src/main/github/client/list/work-item-list-request.ts`
- `src/main/github/client/list/work-item-pages.ts`
- `src/main/github/client/list/work-item-search-query.ts`
- `src/main/github/client/lookup/branch-lookup-derived-data.ts`
- `src/main/github/client/lookup/branch-lookup-resolution.ts`
- `src/main/github/client/lookup/get-pr-for-branch.ts`
- `src/main/github/client/lookup/pr-branch-lookup.ts`
- `src/main/github/client/lookup/pr-for-branch-outcome.ts`
- `src/main/github/client/lookup/pr-lookup-rate-limit.ts`
- `src/main/github/client/lookup/pr-number-lookup.ts`
- `src/main/github/client/lookup/pr-refresh-outcome-assembly.ts`
- `src/main/github/client/lookup/pr-stack-summary-cache.ts`
- `src/main/github/client/lookup/pull-request-lookup-data.ts`
- `src/main/github/client/lookup/pull-request-lookup-hydration.ts`
- `src/main/github/client/lookup/pull-request-push-target.ts`
- `src/main/github/client/lookup/rest-stack-metadata-validation.ts`
- `src/main/github/client/lookup/tracked-upstream-branch.ts`
- `src/main/github/client/lookup/tracked-upstream-cache.ts`
- `src/main/github/client/map/review-comment-response.ts`
- `src/main/github/client/map/work-item.ts`
- `src/main/github/client/map/work-item-field-coercion.ts`
- `src/main/github/client/merge/merge-pr.ts`
- `src/main/github/client/merge/pr-auto-merge.ts`
- `src/main/github/client/pull-request-lookup-candidates.ts`
- `src/main/github/client/update/pr-comment-reaction.ts`
- `src/main/github/client/update/pr-details.ts`
- `src/main/github/client/update/pr-file-viewed.ts`
- `src/main/github/client/update/pr-ready.ts`
- `src/main/github/client/update/pr-reviewers.ts`
- `src/main/github/client/update/pr-state.ts`
- `src/main/github/client/update/resolve-review-thread.ts`
- `src/main/github/client-merged-pr-visibility.test.ts`
- `src/main/github/client-merge-queue-auto-merge.test.ts`
- `src/main/github/client-pr-branch-discovery.test.ts`
- `src/main/github/client-pr-comment-reactions.test.ts`
- `src/main/github/client-pr-conflict-summary.test.ts`
- `src/main/github/client-pr-fallback-number.test.ts`
- `src/main/github/client-pr-linked-lookup.test.ts`
- `src/main/github/client-pr-push-target.test.ts`
- `src/main/github/client-pr-state.test.ts`
- `src/main/github/client-rate-limit-block.test.ts`
- `src/main/github/client-ssh-provider-execution-boundary.test.ts`
- `src/main/github/client-stack-merge-guard.test.ts`
- `src/main/github/client-starred.test.ts`
- `src/main/github/client-test-harness.ts`
- `src/main/github/client-test-mocks.ts`
- `src/main/github/client-tracked-upstream-fork-owner.test.ts`
- `src/main/github/client-tracked-upstream-snapshot.test.ts`
- `src/main/github/github-api-repository-probe.ts`
- `src/main/github/github-api-repository-validation.ts`
- `src/main/github/github-repository-host.ts`
- `src/main/github/github-repository-identity.signed-cache.test.ts`
- `src/main/github/github-stack-api-responses.ts`
- `src/main/github/issue-comment.ts`
- `src/main/github/issue-create.ts`
- `src/main/github/issue-field-options.ts`
- `src/main/github/issue-timeline.ts`
- `src/main/github/issue-update.ts`
- `src/main/github/issue-work-item-details.ts`
- `src/main/github/project-view/issue-comment-mutations.ts`
- `src/main/github/project-view/issue-type-mutation.ts`
- `src/main/github/project-view/project-field-mutations.test.ts`
- `src/main/github/project-view/project-field-mutations.ts`
- `src/main/github/project-view/project-view-cache.ts`
- `src/main/github/project-view/project-view-config.ts`
- `src/main/github/project-view/project-view-discovery.ts`
- `src/main/github/project-view/project-view-field-normalization.ts`
- `src/main/github/project-view/project-view-item-normalization.ts`
- `src/main/github/project-view/project-view-item-page.ts`
- `src/main/github/project-view/project-view-items.ts`
- `src/main/github/project-view/project-view-listing.ts`
- `src/main/github/project-view/project-view-query-fragments.ts`
- `src/main/github/project-view/project-view-reference.ts`
- `src/main/github/project-view/project-view-table.ts`
- `src/main/github/project-view/pull-request-mutation.ts`
- `src/main/github/project-view/repository-field-options.test.ts`
- `src/main/github/project-view/repository-field-options.ts`
- `src/main/github/project-view/work-item-details.ts`
- `src/main/github/pr-refresh-candidate-policy.ts`
- `src/main/github/pr-refresh-coordinator-active-burst-pacing.test.ts`
- `src/main/github/pr-refresh-coordinator-active-visible-priority.test.ts`
- `src/main/github/pr-refresh-coordinator-alias-coalescing.test.ts`
- `src/main/github/pr-refresh-coordinator-rate-limit-budget.test.ts`
- `src/main/github/pr-refresh-coordinator-refresh-events.test.ts`
- `src/main/github/pr-refresh-coordinator-test-harness.ts`
- `src/main/github/pr-refresh-coordinator-test-mocks.ts`
- `src/main/github/pr-refresh-coordinator-visible-follow-up.test.ts`
- `src/main/github/pr-refresh-event-publisher.ts`
- `src/main/github/pr-refresh-pacing.ts`
- `src/main/github/pr-refresh-queue.ts`
- `src/main/github/pr-refresh-queue-drainer.ts`
- `src/main/github/pr-refresh-queue-growth-bound.test.ts`
- `src/main/github/pr-refresh-rate-limit-gate.ts`
- `src/main/github/pr-refresh-retry-state.ts`
- `src/main/github/pr-refresh-visibility.ts`
- `src/main/github/pull-request-file-contents.ts`
- `src/main/github/pull-request-file-data.ts`
- `src/main/github/stacked-pr-creation.test.ts`
- `src/main/github/stacked-pr-creation.ts`
- `src/main/github/work-item-details-api-parity.test.ts`
- `src/main/github/work-item-participants.ts`
- `src/main/gitlab/client-mr-auth-rate-limit.test.ts`
- `src/main/gitlab/client-mr-branch-lookup.test.ts`
- `src/main/gitlab/client-mr-job-ci.test.ts`
- `src/main/gitlab/client-mr-listing.test.ts`
- `src/main/gitlab/client-mr-review-actions.test.ts`
- `src/main/gitlab/client-mr-test-harness.ts`
- `src/main/gitlab/gitlab-assignable-user-mapping.ts`
- `src/main/gitlab/gitlab-auth-and-rate-limit.ts`
- `src/main/gitlab/gitlab-known-host-probe.test.ts`
- `src/main/gitlab/gitlab-known-host-probe-wsl-fallback.test.ts`
- `src/main/gitlab/issue-update.ts`
- `src/main/gitlab/merge-request-draft-title.ts`
- `src/main/gitlab/merge-request-list.ts`
- `src/main/gitlab/merge-request-lookup.ts`
- `src/main/gitlab/merge-request-project-resolution.ts`
- `src/main/gitlab/merge-request-review-mutations.ts`
- `src/main/gitlab/merge-request-state-mutations.ts`
- `src/main/gitlab/merge-request-update.ts`
- `src/main/gitlab/mr-discussion-notes.ts`
- `src/main/gitlab/mr-file-diffs.ts`
- `src/main/gitlab/mr-reviewers-and-approvals.ts`
- `src/main/gitlab/pipeline-job-graph.ts`
- `src/main/gitlab/pipeline-job-mutations.ts`
- `src/main/gitlab/project-label-and-member-lookup.ts`
- `src/main/gitlab/project-path-encoding.ts`
- `src/main/gitlab/work-item-queries.ts`
...
- `src/main/grok/grok-hook-owners.test.ts`
- `src/main/grok/grok-hook-owners.ts`
- `src/main/grok/grok-hook-remnant-removal.test.ts`
...
- `src/main/grok/windows-hook-launcher-chain.test.ts`
...
- `src/main/hook-runtime-target.ts`
- `src/main/hooks-effective-hook-resolution.test.ts`
- `src/main/hooks-issue-command.test.ts`
- `src/main/hooks-orca-yaml-parsing.test.ts`
- `src/main/hooks-setup-runner-script.test.ts`
- `src/main/hooks-test-fixtures.ts`
- `src/main/host/deferred-secret-protection-report.test.ts`
- `src/main/host/deferred-secret-protection-report.ts`
- `src/main/host/electron-app-environment.ts`
- `src/main/host/electron-browser-commands.ts`
- `src/main/host/electron-http-client.ts`
- `src/main/host/electron-runtime-desktop-surface.ts`
- `src/main/host/electron-secret-store.test.ts`
- `src/main/host/electron-secret-store.ts`
- `src/main/host/electron-speech-services.ts`
- `src/main/host/secret-protection-report.test.ts`
- `src/main/host/secret-protection-report.ts`
- `src/main/in-flight-run-dedupe.ts`
- `src/main/ipc/agent-status-row-teardown-ipc.ts`
- `src/main/ipc/automations-external-scope.test.ts`
- `src/main/ipc/bitbucket.ts`
- `src/main/ipc/browser-client-page-metadata-ipc.test.ts`
- `src/main/ipc/browser-grab-ipc.ts`
- `src/main/ipc/browser-guest-view-ipc.ts`
- `src/main/ipc/browser-preview-tool-authorization.test.ts`
- `src/main/ipc/browser-renderer-trust.ts`
- `src/main/ipc/browser-session-profile-ipc.ts`
- `src/main/ipc/browser-tab-registration-wait.test.ts`
- `src/main/ipc/browser-tab-registration-wait.ts`
- `src/main/ipc/cli-appimage-stale-registration.test.ts`
- `src/main/ipc/crash-reporting-renderer-breadcrumbs.ts`
- `src/main/ipc/crash-reporting-renderer-error-report.ts`
- `src/main/ipc/crash-reporting-renderer-error-report-attribution.test.ts`
- `src/main/ipc/crash-reporting-sendable-reports.ts`
- `src/main/ipc/crash-reporting-submission.ts`
- `src/main/ipc/created-worktree-root-prune.test.ts`
- `src/main/ipc/desktop-runtime-sender-lifecycle.ts`
- `src/main/ipc/doc-preview-grant-ipc.test.ts`
- `src/main/ipc/doc-preview-grant-ipc.ts`
...
- `src/main/ipc/filesystem/filesystem-download-handlers.ts`
- `src/main/ipc/filesystem/filesystem-download-promotion.ts`
- `src/main/ipc/filesystem/filesystem-file-content-inspection.ts`
- `src/main/ipc/filesystem/filesystem-git-commit-generation-handlers.ts`
- `src/main/ipc/filesystem/filesystem-git-commit-handlers.ts`
- `src/main/ipc/filesystem/filesystem-git-diff-handlers.ts`
- `src/main/ipc/filesystem/filesystem-git-index-handlers.ts`
- `src/main/ipc/filesystem/filesystem-git-model-discovery-handlers.ts`
- `src/main/ipc/filesystem/filesystem-git-pull-request-generation-handlers.ts`
- `src/main/ipc/filesystem/filesystem-git-remote-handlers.ts`
- `src/main/ipc/filesystem/filesystem-git-status-handlers.ts`
- `src/main/ipc/filesystem/filesystem-git-url-handlers.ts`
- `src/main/ipc/filesystem/filesystem-handler-context.ts`
- `src/main/ipc/filesystem/filesystem-read-handlers.ts`
- `src/main/ipc/filesystem/filesystem-search-handlers.ts`
- `src/main/ipc/filesystem/filesystem-source-control-ai-targets.ts`
- `src/main/ipc/filesystem/filesystem-write-handlers.ts`
- `src/main/ipc/filesystem/git-remote/branch-mutation-handlers.ts`
- `src/main/ipc/filesystem/git-remote/compare-handlers.ts`
- `src/main/ipc/filesystem/git-remote/sync-handlers.ts`
- `src/main/ipc/filesystem-allowed-roots.ts`
- `src/main/ipc/filesystem-branch-compare-diff.test.ts`
- `src/main/ipc/filesystem-commit-message-generation.test.ts`
- `src/main/ipc/filesystem-commit-message-model-discovery.test.ts`
- `src/main/ipc/filesystem-conflict-operation-routing.test.ts`
- `src/main/ipc/filesystem-create-path-guards.ts`
- `src/main/ipc/filesystem-download-transfers.test.ts`
- `src/main/ipc/filesystem-git-commit-dispatch.test.ts`
- `src/main/ipc/filesystem-git-status-staging.test.ts`
- `src/main/ipc/filesystem-import-local.ts`
- `src/main/ipc/filesystem-import-local-tree-copy.ts`
- `src/main/ipc/filesystem-import-result-types.ts`
- `src/main/ipc/filesystem-markdown-document-listing.test.ts`
- `src/main/ipc/filesystem-path-containment.ts`
- `src/main/ipc/filesystem-path-containment-remote-enoent.test.ts`
- `src/main/ipc/filesystem-pull-request-field-generation.test.ts`
- `src/main/ipc/filesystem-runtime-upload-staging.ts`
- `src/main/ipc/filesystem-search-file-paths.test.ts`
- `src/main/ipc/filesystem-search-file-paths.ts`
- `src/main/ipc/filesystem-test-harness.ts`
- `src/main/ipc/filesystem-watcher-batch-control.ts`
- `src/main/ipc/filesystem-watcher-canonical-root-paths.test.ts`
- `src/main/ipc/filesystem-watcher-handlers.ts`
- `src/main/ipc/filesystem-watcher-lifecycle-state.ts`
- `src/main/ipc/filesystem-watcher-listener-lifecycle.ts`
- `src/main/ipc/filesystem-watcher-local-capacity.ts`
- `src/main/ipc/filesystem-watcher-local-events.test.ts`
- `src/main/ipc/filesystem-watcher-local-events.ts`
- `src/main/ipc/filesystem-watcher-local-install.ts`
- `src/main/ipc/filesystem-watcher-local-removal.ts`
- `src/main/ipc/filesystem-watcher-local-subscription.ts`
- `src/main/ipc/filesystem-watcher-paths.ts`
- `src/main/ipc/filesystem-watcher-remote-controller.ts`
- `src/main/ipc/filesystem-watcher-remote-desired.ts`
- `src/main/ipc/filesystem-watcher-remote-dormant.ts`
- `src/main/ipc/filesystem-watcher-remote-install.ts`
- `src/main/ipc/filesystem-watcher-remote-provider-rearm.ts`
- `src/main/ipc/filesystem-watcher-remote-removal.ts`
- `src/main/ipc/filesystem-watcher-remote-resync.ts`
- `src/main/ipc/filesystem-watcher-remote-retry.ts`
- `src/main/ipc/filesystem-watcher-shutdown.ts`
- `src/main/ipc/folder-repo-git-upgrade.test.ts`
- `src/main/ipc/folder-repo-git-upgrade.ts`
- `src/main/ipc/folder-repo-git-upgrade-wake.ts`
- `src/main/ipc/github-account-handlers.ts`
- `src/main/ipc/github-ipc-channel-parity.test.ts`
- `src/main/ipc/github-ipc-module-mocks.ts`
- `src/main/ipc/github-ipc-test-harness.ts`
- `src/main/ipc/github-issue-mutation-handlers.ts`
- `src/main/ipc/github-issue-source-preference.test.ts`
- `src/main/ipc/github-pr-mutation-handlers.ts`
- `src/main/ipc/github-project-view-handlers.ts`
- `src/main/ipc/github-pr-read-handlers.ts`
- `src/main/ipc/github-pr-refresh-handlers.ts`
- `src/main/ipc/github-pr-refresh-routing.test.ts`
- `src/main/ipc/github-pr-review-handlers.ts`
- `src/main/ipc/github-repo-access-guards.test.ts`
- `src/main/ipc/github-repo-routing.ts`
- `src/main/ipc/github-ssh-connection-routing.test.ts`
- `src/main/ipc/github-star-telemetry.test.ts`
- `src/main/ipc/github-work-item-handlers.ts`
- `src/main/ipc/github-work-item-mutation-events.ts`
- `src/main/ipc/github-wsl-runtime-routing.test.ts`
- `src/main/ipc/gitlab-ci-job-handlers.ts`
- `src/main/ipc/gitlab-issue-handlers.ts`
- `src/main/ipc/gitlab-merge-request-mutation-handlers.ts`
- `src/main/ipc/gitlab-merge-request-query-handlers.ts`
- `src/main/ipc/gitlab-repo-access.test.ts`
- `src/main/ipc/gitlab-repo-access.ts`
- `src/main/ipc/gitlab-work-item-handlers.ts`
- `src/main/ipc/hooks/register-worktree-hook-check-handler.ts`
- `src/main/ipc/hooks/register-worktree-hook-file-handlers.ts`
- `src/main/ipc/hooks/register-worktree-hook-inspection-handler.ts`
- `src/main/ipc/hooks/register-worktree-hook-runner-handler.ts`
- `src/main/ipc/linear-custom-view-handlers.ts`
- `src/main/ipc/linear-ipc-args.ts`
- `src/main/ipc/linear-issue-handlers.ts`
- `src/main/ipc/linear-project-handlers.ts`
- `src/main/ipc/linear-team-handlers.ts`
- `src/main/ipc/macos-keyboard-layout-change-notifications.test.ts`
- `src/main/ipc/macos-keyboard-layout-change-notifications.ts`
- `src/main/ipc/macos-keyboard-layout-snapshot.test.ts`
- `src/main/ipc/macos-keyboard-layout-snapshot.ts`
- `src/main/ipc/macos-symbolic-hotkeys-probe.ts`
- `src/main/ipc/native-notification-delivery.ts`
- `src/main/ipc/native-notification-lifecycle.ts`
- `src/main/ipc/notification-burst-cooldown.ts`
- `src/main/ipc/notification-permission-probe.ts`
- `src/main/ipc/notifications-custom-sound.test.ts`
- `src/main/ipc/notifications-delivery-gating.test.ts`
- `src/main/ipc/notifications-message-formatting.test.ts`
- `src/main/ipc/notifications-mobile-fanout.test.ts`
- `src/main/ipc/notification-sound-ipc.ts`
- `src/main/ipc/notification-sound-selection.ts`
- `src/main/ipc/notifications-permission-onboarding.test.ts`
- `src/main/ipc/notifications-retention-lifecycle.test.ts`
- `src/main/ipc/notifications-test-harness.ts`
- `src/main/ipc/notification-system-settings-link.ts`
- `src/main/ipc/parcel-watcher-root-path-rewrite.test.ts`
- `src/main/ipc/parcel-watcher-shallow-subscription.test.ts`
- `src/main/ipc/parcel-watcher-shallow-subscription.ts`
- `src/main/ipc/pet-bundle-import.ts`
- `src/main/ipc/pet-bundle-manifest-schema.ts`
- `src/main/ipc/pet-bundle-sprite-metadata.ts`
- `src/main/ipc/pet-bundle-spritesheet-source.ts`
- `src/main/ipc/pet-image-formats.ts`
- `src/main/ipc/pet-import-size-limits.ts`
- `src/main/ipc/pet-storage-paths.ts`
- `src/main/ipc/pet-symlink-safe-copy.ts`
- `src/main/ipc/preflight-agent-detection.test.ts`
- `src/main/ipc/preflight-agent-refresh.test.ts`
- `src/main/ipc/preflight-host-cli-status.test.ts`
- `src/main/ipc/preflight-remote-ssh.test.ts`
- `src/main/ipc/preflight-test-harness.ts`
- `src/main/ipc/preflight-wsl-command.test.ts`
- `src/main/ipc/pty/agent-session-write-refusal-report.ts`
- `src/main/ipc/pty/delivery/accept.ts`
- `src/main/ipc/pty/delivery/accounting.ts`
- `src/main/ipc/pty/delivery/constants.ts`
- `src/main/ipc/pty/delivery/debug.ts`
- `src/main/ipc/pty/delivery/debug-snapshot.ts`
- `src/main/ipc/pty/delivery/exit.ts`
- `src/main/ipc/pty/delivery/flush.ts`
- `src/main/ipc/pty/delivery/hidden-transition.ts`
- `src/main/ipc/pty/delivery/interactive.ts`
- `src/main/ipc/pty/delivery/lifecycle-reset.ts`
- `src/main/ipc/pty/delivery/payload.ts`
- `src/main/ipc/pty/delivery/pending.ts`
- `src/main/ipc/pty/delivery/producer-sync.ts`
- `src/main/ipc/pty/delivery/ssh-intake.ts`
- `src/main/ipc/pty/delivery/visibility-state.ts`
- `src/main/ipc/pty/delivery/wire-session.ts`
- `src/main/ipc/pty/host-env/assembly.ts`
- `src/main/ipc/pty/host-env/codex-home.ts`
- `src/main/ipc/pty/host-env/codex-resume.ts`
- `src/main/ipc/pty/host-env/fresh-spawn-routing.ts`
- `src/main/ipc/pty/host-env/path.ts`
- `src/main/ipc/pty/host-env/pi-agent.ts`
- `src/main/ipc/pty/host-env/spawn-cwd.ts`
- `src/main/ipc/pty/host-env/spawn-env-keys.ts`
- `src/main/ipc/pty/host-env/types.ts`
- `src/main/ipc/pty/ipc/inspect.ts`
- `src/main/ipc/pty/ipc/renderer-kill.ts`
- `src/main/ipc/pty/ipc/resize-visibility.ts`
- `src/main/ipc/pty/ipc/serialize-buffer.ts`
- `src/main/ipc/pty/ipc/snapshot.ts`
- `src/main/ipc/pty/ipc/spawn.ts`
- `src/main/ipc/pty/ipc/spawn-begin.ts`
- `src/main/ipc/pty/ipc/spawn-commit.ts`
- `src/main/ipc/pty/ipc/spawn-commit-persist.ts`
- `src/main/ipc/pty/ipc/spawn-env.ts`
- `src/main/ipc/pty/ipc/spawn-env-codex.ts`
- `src/main/ipc/pty/ipc/spawn-execute.ts`
- `src/main/ipc/pty/ipc/spawn-options.ts`
- `src/main/ipc/pty/ipc/spawn-preflight.ts`
- `src/main/ipc/pty/ipc/spawn-push-target-materialization.test.ts`
- `src/main/ipc/pty/ipc/spawn-push-target-materialization.ts`
- `src/main/ipc/pty/ipc/spawn-push-target-materialization-real-git.test.ts`
- `src/main/ipc/pty/ipc/spawn-run.ts`
- `src/main/ipc/pty/ipc/spawn-state.ts`
...
- `src/main/ipc/pty/pane/agent-session-owners.ts`
- `src/main/ipc/pty/pane/key-state.ts`
- `src/main/ipc/pty/pane/launch-authority.test.ts`
- `src/main/ipc/pty/pane/launch-authority.ts`
- `src/main/ipc/pty/pane/serializer-state.ts`
- `src/main/ipc/pty/pane/spawn-reservation.ts`
- `src/main/ipc/pty/pane/stable-owner.ts`
- `src/main/ipc/pty/pane/stable-pane-relay-absence-respawn.test.ts`
- `src/main/ipc/pty/provider/bind-listeners.ts`
- `src/main/ipc/pty/provider/listener-lifecycle.ts`
- `src/main/ipc/pty/provider/liveness.ts`
- `src/main/ipc/pty/provider/local-configure.ts`
- `src/main/ipc/pty/provider/ownership-state.ts`
- `src/main/ipc/pty/provider/registry.ts`
- `src/main/ipc/pty/provider/shutdown-detect.ts`
- `src/main/ipc/pty/provider/state-cleanup.ts`
- `src/main/ipc/pty/register-handlers.ts`
- `src/main/ipc/pty/register-headless-runtime.test.ts`
- `src/main/ipc/pty/register-headless-runtime.ts`
- `src/main/ipc/pty/runtime/controller.ts`
- `src/main/ipc/pty/runtime/controller-deps.ts`
- `src/main/ipc/pty/runtime/kill.ts`
- `src/main/ipc/pty/runtime/operations.ts`
- `src/main/ipc/pty/runtime/spawn.ts`
- `src/main/ipc/pty/runtime/spawn-commit.ts`
- `src/main/ipc/pty/runtime/spawn-early.ts`
...
- `src/main/ipc/pty/runtime/undelivered-ssh-kill.ts`
- `src/main/ipc/pty/session.ts`
- `src/main/ipc/pty-agent-session-write-gate.test.ts`
- `src/main/ipc/pty-applied-size-reporting.test.ts`
- `src/main/ipc/pty-buffer-snapshot-dispatch.test.ts`
- `src/main/ipc/pty-codex-account-attribution.test.ts`
- `src/main/ipc/pty-controller-owner-recovery.test.ts`
- `src/main/ipc/pty-controller-ownership-routing.test.ts`
- `src/main/ipc/pty-controller-process-inventory.test.ts`
- `src/main/ipc/pty-controller-spawn-admission.test.ts`
- `src/main/ipc/pty-cumulative-ack-accounting.test.ts`
- `src/main/ipc/pty-daemon-controller-teardown.test.ts`
- `src/main/ipc/pty-daemon-spawn-agent-home-env.test.ts`
- `src/main/ipc/pty-daemon-spawn-codex-auth.test.ts`
- `src/main/ipc/pty-daemon-spawn-session-identity.test.ts`
- `src/main/ipc/pty-daemon-spawn-wsl-runtime.test.ts`
- `src/main/ipc/pty-daemon-ssh-lease-lifecycle.test.ts`
- `src/main/ipc/pty-dead-owner-respawn.test.ts`
- `src/main/ipc/pty-delivery-health-heal.test.ts`
- `src/main/ipc/pty-dispatcher-handshake-osc-answers.test.ts`
- `src/main/ipc/pty-global-renderer-credit.test.ts`
- `src/main/ipc/pty-hidden-at-spawn-mark.test.ts`
- `src/main/ipc/pty-host-bindings.ts`
- `src/main/ipc/pty-ipc-daemon-provider-fixtures.ts`
- `src/main/ipc/pty-ipc-hidden-delivery-gate.test.ts`
- `src/main/ipc/pty-ipc-listener-accessors.ts`
- `src/main/ipc/pty-ipc-mock-registry.ts`
- `src/main/ipc/pty-ipc-process-env-scope.ts`
- `src/main/ipc/pty-ipc-producer-flow-control.test.ts`
- `src/main/ipc/pty-ipc-provider-fixtures.ts`
- `src/main/ipc/pty-ipc-spawn-drivers.ts`
- `src/main/ipc/pty-ipc-suite-environment.ts`
- `src/main/ipc/pty-ipc-test-constants.ts`
- `src/main/ipc/pty-ipc-test-harness.ts`
- `src/main/ipc/pty-ipc-test-surface.ts`
...
- `src/main/ipc/pty-output-drain-rounds.test.ts`
- `src/main/ipc/pty-pane-claim-arbitration.test.ts`
- `src/main/ipc/pty-pane-materialization-race.test.ts`
- `src/main/ipc/pty-pane-reservation-settlement.test.ts`
- `src/main/ipc/pty-pending-output-cap.test.ts`
...
- `src/main/ipc/pty-renderer-liveness-guard.test.ts`
- `src/main/ipc/pty-renderer-send-failure-recovery.test.ts`
- `src/main/ipc/pty-restored-appimage-cli-shim-refresh.test.ts`
- `src/main/ipc/pty-restore-record-seeding.test.ts`
- `src/main/ipc/pty-runtime-kill-and-exit.test.ts`
- `src/main/ipc/pty-runtime-ssh-binding-persistence.test.ts`
- `src/main/ipc/pty-serializer-settlement-mapping.test.ts`
- `src/main/ipc/pty-session-liveness-and-ownership.test.ts`
- `src/main/ipc/pty-spawn-codex-home-unavailable.test.ts`
- `src/main/ipc/pty-spawn-cwd-fallback.test.ts`
- `src/main/ipc/pty-spawn-env-agent-overlays.test.ts`
- `src/main/ipc/pty-spawn-env-codex-home-routing.test.ts`
- `src/main/ipc/pty-spawn-env-codex-resume-provenance.test.ts`
- `src/main/ipc/pty-spawn-env-terminal-basics.test.ts`
- `src/main/ipc/pty-spawn-runtime-handle-binding.test.ts`
- `src/main/ipc/pty-ssh-stop-verdict.test.ts`
- `src/main/ipc/pty-ssh-undelivered-kill.test.ts`
- `src/main/ipc/pty-startup-barrier-and-listing.test.ts`
- `src/main/ipc/pty-startup-swap-window-presence.test.ts`
- `src/main/ipc/pty-windows-shell-selection.test.ts`
...
- `src/main/ipc/registered-worktree-roots-cache.ts`
- `src/main/ipc/remote-workspace-client-identity.ts`
- `src/main/ipc/remote-workspace-connected-clients.ts`
- `src/main/ipc/remote-workspace-patch-queue.ts`
- `src/main/ipc/remote-workspace-relay-sync.ts`
- `src/main/ipc/remote-workspace-snapshot-cache.ts`
- `src/main/ipc/remote-workspace-snapshot-normalization.test.ts`
- `src/main/ipc/remote-workspace-snapshot-normalization.ts`
- `src/main/ipc/repos/base-ref-query-handlers.ts`
- `src/main/ipc/repos/clone-path-lock.ts`
- `src/main/ipc/repos/folder-workspace-handlers.ts`
- `src/main/ipc/repos/host-repo-catalog-snapshot.ts`
...
- `src/main/ipc/repos/project-group-handlers.ts`
- `src/main/ipc/repos/project-host-setup-handlers.ts`
- `src/main/ipc/repos/remote-home-path.ts`
- `src/main/ipc/repos/remote-repo-clone.ts`
- `src/main/ipc/repos/remote-repo-creation.ts`
- `src/main/ipc/repos/remote-repo-registration.ts`
- `src/main/ipc/repos/repo-added-telemetry.ts`
- `src/main/ipc/repos/repo-catalog-handlers.ts`
- `src/main/ipc/repos/repo-clone-lifecycle.ts`
- `src/main/ipc/repos/repo-creation-handlers.ts`
- `src/main/ipc/repos/repo-folder-picker-handlers.ts`
- `src/main/ipc/repos/repo-git-username-handler.ts`
- `src/main/ipc/repos/repo-ipc-arg-schemas.ts`
- `src/main/ipc/repos/repos-changed-notification.ts`
- `src/main/ipc/repos/repo-update-handler.ts`
- `src/main/ipc/repos/sparse-preset-handlers.ts`
- `src/main/ipc/repos-execution-host-catalog.test.ts`
- `src/main/ipc/repos-local-add-and-project-setup.test.ts`
- `src/main/ipc/repos-local-clone-lifecycle.test.ts`
- `src/main/ipc/repos-nested-import.test.ts`
- `src/main/ipc/repos-nested-scan.test.ts`
- `src/main/ipc/repos-remote-base-ref-queries.test.ts`
- `src/main/ipc/repos-remote-git-username.test.ts`
- `src/main/ipc/repos-remote-test-harness.ts`
- `src/main/ipc/runtime-environment-abortable-requests.ts`
- `src/main/ipc/runtime-environment-browser-client-host-handler.test.ts`
- `src/main/ipc/runtime-environment-browser-client-host-handler.ts`
- `src/main/ipc/runtime-environment-capability-evidence.test.ts`
- `src/main/ipc/runtime-environment-capability-evidence.ts`
- `src/main/ipc/runtime-environment-diagnostics-broadcast.test.ts`
- `src/main/ipc/runtime-environment-diagnostics-broadcast.ts`
- `src/main/ipc/runtime-environment-federated-read-routing.test.ts`
- `src/main/ipc/runtime-environment-federated-read-transport.bench.test.ts`
- `src/main/ipc/runtime-environment-manual-disconnect.ts`
- `src/main/ipc/runtime-environment-removal-storage.test.ts`
...
- `src/main/ipc/runtime-environments-ipc-test-harness.ts`
...
- `src/main/ipc/runtime-subscribe-lifecycle.test.ts`
- `src/main/ipc/shallow-watch-delivery-probe.test.ts`
- `src/main/ipc/shallow-watch-delivery-probe.ts`
- `src/main/ipc/single-flight-promise.ts`
- `src/main/ipc/skill-cloud-install-ipc-schemas.test.ts`
- `src/main/ipc/skill-cloud-install-ipc-schemas.ts`
- `src/main/ipc/skill-cloud-ipc-handlers.test.ts`
- `src/main/ipc/skill-cloud-ipc-handlers.ts`
- `src/main/ipc/skill-delete/handlers.ts`
- `src/main/ipc/skill-install-management-ipc-handlers.test.ts`
- `src/main/ipc/skill-install-management-ipc-handlers.ts`
- `src/main/ipc/skill-install-progress-ipc.test.ts`
- `src/main/ipc/skill-install-progress-ipc.ts`
- `src/main/ipc/skill-ipc-main-window.test.ts`
- `src/main/ipc/skill-ipc-main-window.ts`
- `src/main/ipc/skill-share-publishing-ipc-schemas.ts`
- `src/main/ipc/ssh-active-relay-sessions.ts`
- `src/main/ipc/ssh-advertised-url-refresh.ts`
- `src/main/ipc/ssh-app-shutdown.test.ts`
- `src/main/ipc/ssh-connect-attempt-registry.ts`
- `src/main/ipc/ssh-connect-flow.ts`
- `src/main/ipc/ssh-connection-handlers.ts`
- `src/main/ipc/ssh-connection-state-callbacks.ts`
- `src/main/ipc/ssh-disconnect-cancellation.test.ts`
- `src/main/ipc/ssh-handler-reregistration.test.ts`
- `src/main/ipc/ssh-host-sleep-reconnect.ts`
- `src/main/ipc/ssh-ipc-context.ts`
- `src/main/ipc/ssh-ipc-mock-shapes.ts`
- `src/main/ipc/ssh-ipc-module-mocks.ts`
- `src/main/ipc/ssh-ipc-test-harness.ts`
- `src/main/ipc/ssh-passphrase.test.ts`
- `src/main/ipc/ssh-port-forward-handlers.ts`
- `src/main/ipc/ssh-port-forward-persistence.ts`
- `src/main/ipc/ssh-pty-consumer-identity.test.ts`
- `src/main/ipc/ssh-relay-lost-backoff.ts`
- `src/main/ipc/ssh-relay-reset-resume.test.ts`
- `src/main/ipc/ssh-relay-session-callbacks.ts`
- `src/main/ipc/ssh-renderer-broadcast.ts`
- `src/main/ipc/ssh-session-teardown.ts`
- `src/main/ipc/ssh-shutdown-drain.ts`
- `src/main/ipc/ssh-state-broadcast-fanout.test.ts`
- `src/main/ipc/ssh-target-crud-handlers.ts`
- `src/main/ipc/ssh-target-lifecycle-queue.ts`
...
- `src/main/ipc/watched-worktree-catalog-notification.ts`
- `src/main/ipc/watcher-aliased-root-fixture.ts`
- `src/main/ipc/watcher-event-root-path-rewrite.test.ts`
- `src/main/ipc/watcher-event-root-path-rewrite.ts`
- `src/main/ipc/workspace-cleanup-broad-scan.test.ts`
- `src/main/ipc/workspace-cleanup-folder-workspaces.ts`
- `src/main/ipc/workspace-cleanup-process-preflight.test.ts`
- `src/main/ipc/workspace-cleanup-progress-emitter.ts`
- `src/main/ipc/workspace-cleanup-scan-eligibility.ts`
- `src/main/ipc/workspace-cleanup-scan-targets.ts`
- `src/main/ipc/workspace-cleanup-snapshot-ipc.test.ts`
- `src/main/ipc/workspace-cleanup-worktree-listing.ts`
...
- `src/main/ipc/worktree-base-directory-watch-events.ts`
- `src/main/ipc/worktree-base-directory-watch-targets.test.ts`
- `src/main/ipc/worktree-create-lineage.test.ts`
- `src/main/ipc/worktree-display-name.ts`
- `src/main/ipc/worktree-git-common-metadata-files.ts`
- `src/main/ipc/worktree-git-common-narrow-watch.ts`
- `src/main/ipc/worktree-git-common-polling.test.ts`
- `src/main/ipc/worktree-git-common-primary-watch.ts`
- `src/main/ipc/worktree-git-common-snapshot-diff.ts`
- `src/main/ipc/worktree-git-common-watch-reconciliation.ts`
- `src/main/ipc/worktree-head-identity-reader-concurrency.test.ts`
- `src/main/ipc/worktree-head-identity-reader-incremental.test.ts`
- `src/main/ipc/worktree-head-identity-refresh.test.ts`
- `src/main/ipc/worktree-head-identity-scope.ts`
- `src/main/ipc/worktree-metadata-merge.test.ts`
- `src/main/ipc/worktree-push-target-reconciliation.test.ts`
- `src/main/ipc/worktree-push-target-reconciliation.ts`
- `src/main/ipc/worktree-push-target-reconciliation-real-git.test.ts`
- `src/main/ipc/worktree-push-target-refspec-migration.test.ts`
- `src/main/ipc/worktree-push-target-refspec-migration.ts`
- `src/main/ipc/worktree-push-target-refspec-real-git.test.ts`
- `src/main/ipc/worktree-remote-push-target-materialization.test.ts`
- `src/main/ipc/worktree-remote-ssh-branch-conflict.test.ts`
- `src/main/ipc/worktrees/create/folder-workspace-creation.ts`
- `src/main/ipc/worktrees/create/register-review-base-handlers.ts`
...
- `src/main/ipc/worktrees/folder-workspace-model.ts`
- `src/main/ipc/worktrees/ipc-context-schemas.ts`
- `src/main/ipc/worktrees/listing/authoritative-local-worktree-metadata-pruning.ts`
...
- `src/main/ipc/worktrees/listing/host-qualified-worktree-listing.ts`
- `src/main/ipc/worktrees/listing/register-detected-worktree-handlers.ts`
- `src/main/ipc/worktrees/listing/register-detected-worktree-scan-invalidation.ts`
- `src/main/ipc/worktrees/listing/register-host-catalog-handlers.ts`
- `src/main/ipc/worktrees/listing/register-sparse-checkout-cache-invalidation.test.ts`
- `src/main/ipc/worktrees/listing/register-sparse-checkout-cache-invalidation.ts`
...
- `src/main/ipc/worktrees/listing/worktree-host-ownership.ts`
- `src/main/ipc/worktrees/listing/worktree-listing-diagnostics.ts`
- `src/main/ipc/worktrees/metadata/host-lineage-listing.ts`
- `src/main/ipc/worktrees/metadata/lineage-owner-resolution.ts`
- `src/main/ipc/worktrees/metadata/register-worktree-metadata-handlers.ts`
- `src/main/ipc/worktrees/metadata/workspace-lineage-filtering.ts`
- `src/main/ipc/worktrees/removal/execute-worktree-removal.ts`
- `src/main/ipc/worktrees/removal/preserved-branch-cleanup.ts`
- `src/main/ipc/worktrees/removal/register-worktree-forget-handlers.ts`
- `src/main/ipc/worktrees/removal/register-worktree-removal-handlers.ts`
- `src/main/ipc/worktrees/removal/remove-folder-workspace.ts`
- `src/main/ipc/worktrees/removal/remove-registered-local-worktree.ts`
- `src/main/ipc/worktrees/removal/remove-registered-remote-worktree.ts`
- `src/main/ipc/worktrees/removal/remove-unregistered-worktree.ts`
- `src/main/ipc/worktrees/removal/worktree-archive-hook.ts`
- `src/main/ipc/worktrees/removal/worktree-removal-coordinator.ts`
- `src/main/ipc/worktrees/removal/worktree-removal-filesystem.ts`
- `src/main/ipc/worktrees/removal/worktree-removal-ownership.ts`
- `src/main/ipc/worktrees/repo-host-ownership.ts`
- `src/main/ipc/worktrees/worktree-ipc-context.ts`
- `src/main/ipc/worktrees-authoritative-local-metadata-pruning.test.ts`
- `src/main/ipc/worktrees-create-metadata-persistence.test.ts`
- `src/main/ipc/worktrees-delete-pty-teardown.test.ts`
- `src/main/ipc/worktrees-detected-scan-cache.test.ts`
- `src/main/ipc/worktrees-discovery-metadata-backfill.test.ts`
- `src/main/ipc/worktrees-existing-branch-checkout.test.ts`
- `src/main/ipc/worktrees-forget-local.test.ts`
- `src/main/ipc/worktrees-issue-command-overrides.test.ts`
- `src/main/ipc/worktrees-lineage-hydration.test.ts`
- `src/main/ipc/worktrees-listing-fallback-rows.test.ts`
- `src/main/ipc/worktrees-local-base-ref-resolution.test.ts`
- `src/main/ipc/worktrees-local-create-flow.test.ts`
- `src/main/ipc/worktrees-orphan-directory-cleanup.test.ts`
- `src/main/ipc/worktrees-preserved-branch-fork-remote.test.ts`
- `src/main/ipc/worktrees-removal-recovery.test.ts`
- `src/main/ipc/worktrees-remove-archive-hooks.test.ts`
- `src/main/ipc/worktrees-remove-host-disambiguation.test.ts`
- `src/main/ipc/worktrees-remove-preflight.test.ts`
- `src/main/ipc/worktrees-setup-launch-sparse-checkout.test.ts`
- `src/main/ipc/worktrees-ssh-base-ref-resolution.test.ts`
- `src/main/ipc/worktrees-ssh-branch-conflict-suffixing.test.ts`
- `src/main/ipc/worktrees-ssh-create-base-prefetch.test.ts`
- `src/main/ipc/worktrees-ssh-fork-push-target-remote.test.ts`
- `src/main/ipc/worktrees-ssh-local-base-refresh.test.ts`
- `src/main/ipc/worktrees-ssh-pr-head-fetch.test.ts`
- `src/main/ipc/worktrees-ssh-provider-authority.test.ts`
- `src/main/ipc/worktrees-ssh-repo-owner-resolution.test.ts`
- `src/main/ipc/worktrees-ssh-setup-launch.test.ts`
- `src/main/ipc/worktrees-test-fixtures.ts`
- `src/main/ipc/worktrees-test-harness.ts`
- `src/main/ipc/worktrees-test-ipc-surface.ts`
- `src/main/ipc/worktrees-test-metadata-pruning-store.ts`
- `src/main/ipc/worktrees-test-module-mocks.ts`
- `src/main/ipc/worktrees-test-runtime-stub.ts`
- `src/main/ipc/worktrees-wsl-runtime-routing.test.ts`
- `src/main/ipc/worktree-watcher-removal.ts`
- `src/main/ipc/worktree-watcher-removal-binding.test.ts`
- `src/main/issue-command-file.ts`
- `src/main/jira/authenticated-request.ts`
- `src/main/jira/jira-issue-comments.ts`
- `src/main/jira/jira-issue-create-metadata.ts`
- `src/main/jira/jira-issue-mapping.ts`
- `src/main/jira/jira-issue-media.ts`
- `src/main/jira/jira-issue-mutations.test.ts`
- `src/main/jira/jira-issue-mutations.ts`
- `src/main/jira/jira-issue-read.ts`
- `src/main/jira/jira-issue-search.ts`
- `src/main/jira/jira-project-queries.ts`
- `src/main/jira/jira-read-failure.ts`
- `src/main/jira/jira-record-pages.ts`
- `src/main/jira/jira-transition-queries.ts`
- `src/main/jira/request-queue.ts`
- `src/main/jira/site-credential-store.ts`
- `src/main/jira/site-identity.ts`
- `src/main/keybindings/keybinding-file-parser.ts`
- `src/main/linear/issue-search-summary.test.ts`
- `src/main/linear/linear-credential-paths.ts`
- `src/main/linear/linear-custom-view-graphql.ts`
- `src/main/linear/linear-custom-view-queries.ts`
- `src/main/linear/linear-issue-comments.ts`
- `src/main/linear/linear-issue-listing.ts`
- `src/main/linear/linear-issue-lookups.ts`
- `src/main/linear/linear-issue-mutations.ts`
- `src/main/linear/linear-issue-query-documents.ts`
- `src/main/linear/linear-issue-query-support.ts`
- `src/main/linear/linear-issue-write-support.ts`
- `src/main/linear/linear-legacy-viewer-store.ts`
- `src/main/linear/linear-project-collection-read.ts`
- `src/main/linear/linear-project-graphql.ts`
- `src/main/linear/linear-project-issue-queries.ts`
- `src/main/linear/linear-project-models.ts`
- `src/main/linear/linear-project-nodes.ts`
- `src/main/linear/linear-project-queries.ts`
- `src/main/linear/linear-project-team-queries.ts`
- `src/main/linear/linear-request-concurrency.ts`
- `src/main/linear/linear-token-store.ts`
- `src/main/linear/linear-workspace-record.ts`
- `src/main/linear/linear-workspace-registry.ts`
- `src/main/linear/mcp-issue-list-cursor.ts`
- `src/main/linear/mcp-issue-list-filter.ts`
- `src/main/linear/mcp-issue-list-pagination.test.ts`
- `src/main/line-editor-ready-output-scanner.test.ts`
- `src/main/line-editor-ready-output-scanner.ts`
- `src/main/linux-package-downloaded-status.ts`
- `src/main/local-worktree-filesystem-wsl-banner.wsl.test.ts`
- `src/main/local-worktree-metadata-prune-gate.test.ts`
- `src/main/local-worktree-metadata-prune-gate.ts`
- `src/main/local-worktree-path-presence.test.ts`
- `src/main/local-worktree-path-presence.ts`
- `src/main/local-worktree-scan-generation.ts`
...
- `src/main/memory/memory-snapshot-values.ts`
- `src/main/memory/windows-process-sample-parsing.test.ts`
- `src/main/memory/windows-process-sample-parsing.ts`
- `src/main/native-chat/agent-session-journal/journal-blob-store.ts`
- `src/main/native-chat/agent-session-journal/journal-compaction.ts`
- `src/main/native-chat/agent-session-journal/journal-corruption-quarantine.ts`
- `src/main/native-chat/agent-session-journal/journal-crash-boundary.test.ts`
- `src/main/native-chat/agent-session-journal/journal-cursor.test.ts`
...
- `src/main/native-chat/agent-session-journal/journal-item-identity.test.ts`
- `src/main/native-chat/agent-session-journal/journal-legacy-identity.ts`
...
- `src/main/native-chat/agent-session-journal/journal-lifecycle-admission.ts`
...
- `src/main/native-chat/agent-session-journal/journal-lifecycle-capacity.test.ts`
- `src/main/native-chat/agent-session-journal/journal-lifecycle-capacity.ts`
- `src/main/native-chat/agent-session-journal/journal-log-file.test.ts`
- `src/main/native-chat/agent-session-journal/journal-log-file.ts`
...
- `src/main/native-chat/agent-session-journal/journal-physical-quota.test.ts`
- `src/main/native-chat/agent-session-journal/journal-physical-quota.ts`
...
- `src/main/native-chat/agent-session-journal/journal-row-schema.test.ts`
...
- `src/main/native-chat/agent-session-journal/journal-row-writer-read-only-latch.test.ts`
...
- `src/main/native-chat/agent-session-journal/journal-store-factory.ts`
...
- `src/main/native-chat/agent-session-journal/journal-submission-reconciler.ts`
- `src/main/native-chat/agent-session-journal/journal-tool-output-fallback.ts`
...
- `src/main/native-chat/agent-session-wire/structured-agent-session-dead-tui-recovery.ts`
...
- `src/main/native-chat/agent-session-wire/structured-agent-session-eviction-deadline.ts`
...
- `src/main/native-chat/agent-session-wire/structured-agent-session-handoff-flow-context.ts`
...
- `src/main/native-chat/agent-session-wire/structured-agent-session-handoff-state.ts`
- `src/main/native-chat/agent-session-wire/structured-agent-session-handoff-status.ts`
...
- `src/main/native-chat/agent-session-wire/structured-agent-session-hold-resume.ts`
...
- `src/main/native-chat/agent-session-wire/structured-agent-session-host-tabs.ts`
- `src/main/native-chat/agent-session-wire/structured-agent-session-host-test-data.ts`
- `src/main/native-chat/agent-session-wire/structured-agent-session-host-types.ts`
- `src/main/native-chat/agent-session-wire/structured-agent-session-launch-env.test.ts`
...
- `src/main/native-chat/agent-session-wire/structured-agent-session-lease-renewer.ts`
...
- `src/main/native-chat/agent-session-wire/structured-agent-session-option-error.ts`
...
- `src/main/native-chat/agent-session-wire/structured-agent-session-recovery-resolution.test.ts`
- `src/main/native-chat/agent-session-wire/structured-agent-session-recovery-resolution.ts`
...
- `src/main/native-chat/agent-session-wire/structured-agent-session-release-clock.ts`
- `src/main/native-chat/agent-session-wire/structured-agent-session-replay-outcome.ts`
- `src/main/native-chat/agent-session-wire/structured-agent-session-restart-reconcile.test.ts`
- `src/main/native-chat/agent-session-wire/structured-agent-session-restart-reconcile.ts`
...
- `src/main/native-chat/agent-session-wire/structured-agent-session-restart-restore-gate.test.ts`
- `src/main/native-chat/agent-session-wire/structured-agent-session-restart-restore-gate.ts`
- `src/main/native-chat/agent-session-wire/structured-agent-session-resume-eligibility.ts`
...
- `src/main/native-chat/agent-session-wire/structured-agent-session-task-queue.test.ts`
...
- `src/main/native-chat/agent-session-wire/structured-provider-session-ownership.ts`
- `src/main/native-chat/agent-session-wire/structured-tui-transcript-boundary.ts`
...
- `src/main/native-chat/native-chat-file-provenance.test.ts`
- `src/main/native-chat/native-chat-file-provenance.ts`
- `src/main/native-chat/transcript-line-decoders-claude-control-bytes.test.ts`
- `src/main/native-chat/transcript-line-decoders-claude-image-companion.test.ts`
- `src/main/native-chat/transcript-read-cache-refusal-recovery.test.ts`
- `src/main/native-chat/transcript-read-cache-wsl-stall.test.ts`
- `src/main/native-chat/transcript-reader-wsl-stall.test.ts`
- `src/main/native-chat/transcript-tail-boundary.ts`
- `src/main/native-chat/transcript-tail-reader-wsl-gate.test.ts`
- `src/main/native-chat/transcript-unavailable-snapshot.ts`
- `src/main/native-chat/transcript-watch-engine-wsl-lifecycle.test.ts`
- `src/main/native-chat/transcript-watcher-count.ts`
- `src/main/native-chat/transcript-watcher-install-probe.ts`
- `src/main/native-chat/transcript-watch-unflushed-settle.test.ts`
- `src/main/native-chat/transcript-watch-wsl-stall.test.ts`
- `src/main/native-chat/transcript-window-tool-attribution.test.ts`
- `src/main/native-chat/wsl-transcript-fs-access.test.ts`
- `src/main/native-chat/wsl-transcript-fs-access.ts`
- `src/main/native-chat/wsl-transcript-fs-error.ts`
- `src/main/native-chat/wsl-transcript-fs-process-client.test.ts`
- `src/main/native-chat/wsl-transcript-fs-process-client.ts`
- `src/main/native-chat/wsl-transcript-fs-process-decode.ts`
- `src/main/native-chat/wsl-transcript-fs-process-dispatch.ts`
- `src/main/native-chat/wsl-transcript-fs-process-entry.ts`
- `src/main/native-chat/wsl-transcript-fs-process-handle-owner.ts`
- `src/main/native-chat/wsl-transcript-fs-process-lane-pool.ts`
- `src/main/native-chat/wsl-transcript-fs-process-operations.test.ts`
- `src/main/native-chat/wsl-transcript-fs-process-operations.ts`
- `src/main/native-chat/wsl-transcript-fs-process-protocol.ts`
- `src/main/native-chat/wsl-transcript-fs-process-send.ts`
- `src/main/native-chat/wsl-transcript-fs-process-slot.ts`
- `src/main/native-chat/wsl-transcript-fs-process-spawn.ts`
- `src/main/native-chat/wsl-transcript-fs-route.test.ts`
- `src/main/native-chat/wsl-transcript-fs-route.ts`
- `src/main/native-chat/wsl-transcript-fs-route-quarantine.test.ts`
- `src/main/native-chat/wsl-transcript-fs-route-quarantine.ts`
- `src/main/native-chat/wsl-transcript-running-observer.test.ts`
- `src/main/native-chat/wsl-transcript-running-observer.ts`
- `src/main/native-chat/wsl-transcript-watcher-running-guard.ts`
- `src/main/network/bounded-proxy-application.ts`
- `src/main/network/electron-default-proxy-session.ts`
- `src/main/network/electron-proxy-credentials.ts`
- `src/main/network/electron-proxy-request-guard.test.ts`
- `src/main/network/electron-proxy-request-guard.ts`
- `src/main/network/http-client.ts`
- `src/main/network/proxy-policy-resolution.ts`
- `src/main/network/proxy-settings-session.test.ts`
- `src/main/opencode/hook-plugin-background-child-completion.test.ts`
- `src/main/opencode/hook-plugin-module-contract.test.ts`
- `src/main/opencode/status-plugin-delivery-source.ts`
- `src/main/opencode/status-plugin-endpoint-source.ts`
- `src/main/opencode/status-plugin-factory-source.ts`
- `src/main/opencode/status-plugin-lifecycle-source.ts`
- `src/main/opencode/status-plugin-message-preview-source.ts`
- `src/main/opencode/status-plugin-ownership-source.ts`
- `src/main/opencode/status-plugin-post-source.ts`
- `src/main/opencode/status-plugin-runtime-state-source.ts`
- `src/main/opencode/status-plugin-session-lineage-source.ts`
- `src/main/opencode-usage/opencode-database-discovery.ts`
- `src/main/opencode-usage/opencode-usage-row-parsing.ts`
- `src/main/opencode-usage/opencode-usage-row-queries.ts`
- `src/main/opencode-usage/opencode-usage-worktree-attribution.ts`
- `src/main/opencode-usage/persisted-state-normalization.ts`
- `src/main/opencode-usage/scanner-wsl-gate.test.ts`
- `src/main/opencode-usage/scope-range-filter.ts`
- `src/main/opencode-usage/snapshot-rollups.ts`
- `src/main/orcad/__fixtures__/fake-orcad-electron-sidecar.cjs`
- `src/main/orcad/electron-serve-browser-process.test.ts`
- `src/main/orcad/electron-serve-browser-process.ts`
- `src/main/orcad/electron-serve-provider-selection.test.ts`
- `src/main/orcad/electron-sidecar-method-routing.test.ts`
- `src/main/orcad/electron-sidecar-method-routing.ts`
- `src/main/orcad/electron-sidecar-tab-registry.test.ts`
- `src/main/orcad/electron-sidecar-tab-registry.ts`
- `src/main/orcad/external-chromium-browser-process.integration.test.ts`
- `src/main/orcad/external-chromium-browser-process.ts`
- `src/main/orcad/external-chromium-browser-session.test.ts`
...
- `src/main/orcad/main-preflight-order.test.ts`
- `src/main/orcad/native-host-abi.test.ts`
- `src/main/orcad/native-host-abi.ts`
- `src/main/orcad/node-pty-loader-diagnosis.ts`
- `src/main/orcad/node-pty-prebuilt-slot.test.ts`
- `src/main/orcad/node-pty-prebuilt-slot.ts`
- `src/main/orcad/node-pty-precondition.test.ts`
- `src/main/orcad/node-pty-precondition.ts`
- `src/main/orcad/orcad-agent-browser-binary.ts`
- `src/main/orcad/orcad-app-paths.test.ts`
- `src/main/orcad/orcad-app-paths.ts`
- `src/main/orcad/orcad-bind-address.test.ts`
- `src/main/orcad/orcad-bind-address.ts`
- `src/main/orcad/orcad-browser-provider.test.ts`
- `src/main/orcad/orcad-browser-provider.ts`
- `src/main/orcad/orcad-bundle-native-load-order.test.ts`
- `src/main/orcad/orcad-daemon-supervision.test.ts`
- `src/main/orcad/orcad-daemon-supervision.ts`
- `src/main/orcad/orcad-entry.ts`
- `src/main/orcad/orcad-forked-child-paths.test.ts`
- `src/main/orcad/orcad-health.test.ts`
- `src/main/orcad/orcad-health.ts`
- `src/main/orcad/orcad-instance-lock.test.ts`
- `src/main/orcad/orcad-instance-lock.ts`
- `src/main/orcad/orcad-launch-contract.test.ts`
- `src/main/orcad/orcad-native-preflight.test.ts`
- `src/main/orcad/orcad-native-preflight.ts`
- `src/main/orcad/orcad-sidecar-runtime-client.ts`
- `src/main/orca-profiles/profile-artifact-cloud-cleanup.test.ts`
- `src/main/orca-profiles/profile-artifact-cloud-cleanup.ts`
- `src/main/orca-profiles/profile-project-retired-name-transfer.ts`
- `src/main/orca-profiles/profile-project-session-field-disposition.test.ts`
- `src/main/orca-profiles/profile-project-session-field-disposition.ts`
- `src/main/orca-profiles/profile-project-state-file.test.ts`
- `src/main/orca-profiles/profile-project-transfer-worktree-ids.ts`
- `src/main/persistence/applying-settings/feature-interaction-recording.ts`
- `src/main/persistence/applying-settings/onboarding-normalization.ts`
- `src/main/persistence/applying-settings/settings-update.ts`
- `src/main/persistence/applying-settings/source-control-settings.ts`
- `src/main/persistence/applying-settings/terminal-settings-migrations.test.ts`
...
- `src/main/persistence/leasing-ssh-ptys/canonical-worktree-host-reassignment.ts`
- `src/main/persistence/leasing-ssh-ptys/secret-validation.ts`
...
- `src/main/persistence/leasing-ssh-ptys/ssh-pty-consumer-recovery.ts`
...
- `src/main/persistence/leasing-ssh-ptys/ssh-target-reassignment.ts`
- `src/main/persistence/leasing-ssh-ptys/ssh-target-state.ts`
- `src/main/persistence/loading-store/automation-persistence.ts`
- `src/main/persistence/loading-store/backup-recovery-rotation.ts`
- `src/main/persistence/loading-store/loaded-cohort-migrations.ts`
- `src/main/persistence/loading-store/loaded-state-adaptation.ts`
...
- `src/main/persistence/loading-store/metadata-lineage-operations.ts`
- `src/main/persistence/loading-store/mobile-tab-selection-persistence.ts`
...
- `src/main/persistence/loading-store/normalize-loaded-project-catalog.test.ts`
- `src/main/persistence/loading-store/normalize-loaded-state-collections.ts`
- `src/main/persistence/loading-store/normalize-loaded-ui-state.ts`
- `src/main/persistence/loading-store/prepare-loaded-profile-settings.ts`
- `src/main/persistence/loading-store/prepare-loaded-terminal-settings.ts`
- `src/main/persistence/loading-store/primary-state-writes.ts`
- `src/main/persistence/loading-store/profile-preferences.ts`
- `src/main/persistence/loading-store/project-collection-operations.ts`
...
- `src/main/persistence/loading-store/retired-name-registry-normalization.ts`
- `src/main/persistence/loading-store/retired-worktree-name-persistence.ts`
...
- `src/main/persistence/loading-store/sparse-preset-persistence.ts`
- `src/main/persistence/loading-store/ssh-lease-recovery-operations.ts`
- `src/main/persistence/loading-store/ssh-profile-operations.ts`
- `src/main/persistence/loading-store/state-serialization-secret-handling.ts`
- `src/main/persistence/loading-store/store.ts`
- `src/main/persistence/loading-store/store-domain-composition.ts`
- `src/main/persistence/loading-store/store-prune-gate-signals.test.ts`
- `src/main/persistence/loading-store/store-runtime-authored-session-writes.test.ts`
- `src/main/persistence/loading-store/store-runtime-state.ts`
- `src/main/persistence/loading-store/terminal-binding-recovery.ts`
- `src/main/persistence/loading-store/terminal-session-cleanup.ts`
- `src/main/persistence/loading-store/user-data-path.ts`
- `src/main/persistence/loading-store/workspace-session-partitions.ts`
...
- `src/main/persistence/loading-store/worktree-identity-metadata.ts`
- `src/main/persistence/loading-store/worktree-meta-write-normalization.test.ts`
- `src/main/persistence/loading-store/worktree-meta-write-normalization.ts`
- `src/main/persistence/loading-store/write-flush-barriers.ts`
- `src/main/persistence/loading-store/write-scheduling.ts`
- `src/main/persistence/restoring-sessions/cross-host-pane-tab-ids.ts`
- `src/main/persistence/restoring-sessions/floating-workspace-normalization.ts`
- `src/main/persistence/restoring-sessions/folder-scope-migration.ts`
- `src/main/persistence/restoring-sessions/folder-workspace-operations.ts`
- `src/main/persistence/restoring-sessions/pane-alias-normalization.test.ts`
- `src/main/persistence/restoring-sessions/pane-alias-normalization.ts`
- `src/main/persistence/restoring-sessions/pane-identity-migration.ts`
- `src/main/persistence/restoring-sessions/session-owner-fields.test.ts`
...
- `src/main/persistence/restoring-sessions/session-worktree-ownership.test.ts`
- `src/main/persistence/restoring-sessions/session-worktree-ownership.ts`
- `src/main/persistence/restoring-sessions/terminal-layout-normalization.test.ts`
- `src/main/persistence/restoring-sessions/terminal-layout-normalization.ts`
- `src/main/persistence/restoring-sessions/workspace-pane-normalization.ts`
- `src/main/persistence/restoring-sessions/workspace-pane-normalization-index.test.ts`
- `src/main/persistence/runtime-authored-workspace-session-fields.test.ts`
- `src/main/persistence/runtime-authored-workspace-session-fields.ts`
...
- `src/main/persistence/scheduling-automations/automation-owner-projection.ts`
...
- `src/main/persistence/tracking-repos/local-worktree-metadata-scan-expectation.ts`
...
- `src/main/persistence/tracking-repos/probeable-local-worktree-metadata-candidates.test.ts`
- `src/main/persistence/tracking-repos/project-group-operations.ts`
- `src/main/persistence/tracking-repos/project-host-compatibility.test.ts`
...
- `src/main/persistence/tracking-repos/project-host-setup-update.ts`
- `src/main/persistence/tracking-repos/repo-hydration.ts`
- `src/main/persistence/tracking-repos/repo-order-operations.ts`
- `src/main/persistence/tracking-repos/repo-sanitization.ts`
- `src/main/persistence/tracking-repos/repo-update-operations.ts`
- `src/main/persistence/tracking-repos/repo-worktree-pruning.ts`
...
- `src/main/persistence/tracking-repos/worktree-metadata-normalization.ts`
- `src/main/persistence-automations.test.ts`
- `src/main/persistence-clipboard-selection-migration.test.ts`
- `src/main/persistence-cohort-and-identity-migration.test.ts`
- `src/main/persistence-cross-host-pane-identity.test.ts`
- `src/main/persistence-deregistered-repo-residue.test.ts`
- `src/main/persistence-floating-terminal-trust.test.ts`
- `src/main/persistence-flush-and-save-scheduling.test.ts`
- `src/main/persistence-folder-workspace-notes.test.ts`
- `src/main/persistence-host-admitted-terminal-membership.test.ts`
- `src/main/persistence-host-partitioned-sessions.test.ts`
- `src/main/persistence-initial-load.test.ts`
- `src/main/persistence-layout-binding-recovery.test.ts`
- `src/main/persistence-loading-store-extraction.test.ts`
- `src/main/persistence-loading-store-write-risks.test.ts`
- `src/main/persistence-load-repair-durability.test.ts`
- `src/main/persistence-native-chat-tab-view-mode.test.ts`
- `src/main/persistence-pane-identity-migration.test.ts`
- `src/main/persistence-pty-binding-reconciliation.test.ts`
- `src/main/persistence-repo-lifecycle.test.ts`
- `src/main/persistence-session-fixtures.ts`
- `src/main/persistence-settings-ui-defaults.test.ts`
- `src/main/persistence-settings-update.test.ts`
- `src/main/persistence-source-control-ai-migration.test.ts`
- `src/main/persistence-split-pane-incarnation.test.ts`
- `src/main/persistence-ssh-pending-pty-kill.test.ts`
- `src/main/persistence-ssh-readoption-automation-migration.test.ts`
- `src/main/persistence-ssh-remote-pty-binding-replay.test.ts`
- `src/main/persistence-ssh-remote-pty-leases.test.ts`
- `src/main/persistence-ssh-targets-and-pane-keys.test.ts`
- `src/main/persistence-terminal-option-key-migration.test.ts`
- `src/main/persistence-test-harness.ts`
- `src/main/persistence-ui-state.test.ts`
- `src/main/persistence-update-repo.test.ts`
- `src/main/persistence-workspace-pinned-automation-fence.test.ts`
- `src/main/persistence-workspace-repin-automation-owner.test.ts`
- `src/main/persistence-workspace-session-scrollback.test.ts`
- `src/main/persistence-workspace-status-fixtures.ts`
- `src/main/persistence-workspace-status-workflow.test.ts`
- `src/main/persistence-worktree-card-properties.test.ts`
- `src/main/persistence-worktree-deletion-fencing.test.ts`
- `src/main/persistence-worktree-lineage-and-backups.test.ts`
- `src/main/persistence-worktree-meta-and-folder-workspaces.test.ts`
- `src/main/persistence-worktree-name-retirement.test.ts`
- `src/main/persistence-worktree-visibility.test.ts`
- `src/main/pi/agent-status-extension-omp-lifecycle.test.ts`
- `src/main/pi/agent-status-extension-test-harness.ts`
- `src/main/pi/agent-status-omp-approval-forwarding.test.ts`
- `src/main/pi/titlebar-extension-source.test.ts`
- `src/main/plugins/plugin-client-list.ts`
- `src/main/ports/advertised-url-cache-update.ts`
- `src/main/ports/advertised-url-parsing.ts`
- `src/main/ports/advertised-url-reconciliation.ts`
...
- `src/main/providers/agent-foreground-process-batch.test.ts`
- `src/main/providers/agent-foreground-process-batch.ts`
- `src/main/providers/agent-foreground-process-windows-job-rejection.test.ts`
...
- `src/main/providers/local-pty-provider-io-events.test.ts`
...
- `src/main/providers/local-pty-provider-spawn-cwd-safety.test.ts`
...
- `src/main/providers/local-pty-provider-test-harness.ts`
- `src/main/providers/local-pty-provider-types.ts`
- `src/main/providers/local-pty-provider-windows-shell-launch.test.ts`
- `src/main/providers/local-pty-session-activation.ts`
- `src/main/providers/local-pty-session-operations.ts`
- `src/main/providers/local-pty-shell-readiness-session.ts`
- `src/main/providers/local-pty-shell-ready-bash-rcfile.ts`
- `src/main/providers/local-pty-shell-ready-marker.ts`
...
- `src/main/providers/local-pty-shell-ready-test-harness.ts`
- `src/main/providers/local-pty-shell-ready-wrapper-fileset.ts`
- `src/main/providers/local-pty-shell-ready-wrapper-generation.test.ts`
- `src/main/providers/local-pty-shell-ready-wrapper-generation.ts`
- `src/main/providers/local-pty-shell-ready-wrapper-root.ts`
- `src/main/providers/local-pty-shell-ready-zsh-launch-environment.test.ts`
- `src/main/providers/local-pty-shell-startup-command.node-pty.test.ts`
- `src/main/providers/local-pty-spawn.ts`
- `src/main/providers/local-pty-spawn-environment.ts`
- `src/main/providers/local-pty-spawn-state.ts`
- `src/main/providers/local-pty-termination.ts`
...
- `src/main/providers/ssh-filesystem-doc-preview.test.ts`
- `src/main/providers/ssh-filesystem-doc-preview.ts`
- `src/main/providers/ssh-filesystem-provider-capabilities.test.ts`
- `src/main/providers/ssh-filesystem-provider-capabilities.ts`
- `src/main/providers/ssh-filesystem-provider-range.test.ts`
- `src/main/providers/ssh-filesystem-range-read.ts`
- `src/main/providers/ssh-filesystem-terminal-artifact.ts`
- `src/main/providers/ssh-git-noninteractive-provider.ts`
- `src/main/providers/ssh-git-provider-api.test.ts`
- `src/main/providers/ssh-git-provider-commit-message.test.ts`
- `src/main/providers/ssh-git-provider-diff.test.ts`
- `src/main/providers/ssh-git-provider-exec.test.ts`
- `src/main/providers/ssh-git-provider-remote-sync.test.ts`
- `src/main/providers/ssh-git-provider-staging.test.ts`
- `src/main/providers/ssh-git-provider-status.test.ts`
- `src/main/providers/ssh-git-provider-status-lease.test.ts`
- `src/main/providers/ssh-git-provider-test-harness.ts`
- `src/main/providers/ssh-git-provider-upstream-lease.test.ts`
- `src/main/providers/ssh-git-provider-worktree.test.ts`
- `src/main/providers/ssh-git-read-provider.ts`
- `src/main/providers/ssh-git-relay-errors.ts`
- `src/main/providers/ssh-git-remote-sync-provider.ts`
- `src/main/providers/ssh-git-review-head-provider.ts`
- `src/main/providers/ssh-git-working-tree-provider.ts`
- `src/main/providers/ssh-git-worktree-provider.ts`
- `src/main/providers/ssh-pty-provider-mock-multiplexer.ts`
- `src/main/providers/ssh-pty-provider-spawn.test.ts`
- `src/main/providers/ssh-pty-provider-terminal-repair.test.ts`
- `src/main/providers/ssh-pty-relay-absence-verdict.test.ts`
- `src/main/providers/ssh-pty-spawn-repair.ts`
- `src/main/providers/ssh-pty-write.test.ts`
- `src/main/providers/ssh-pty-write.ts`
- `src/main/providers/ssh-worktree-catalog-authority.test.ts`
- `src/main/providers/windows-cached-agent-revalidation.test.ts`
- `src/main/providers/windows-cached-agent-revalidation.ts`
...
- `src/main/pty/posix-shell-startup-command.ts`
- `src/main/pty/windows-path-registry-change.test.ts`
- `src/main/pty/windows-path-registry-change.ts`
- `src/main/pty/windows-path-registry-fallback.test.ts`
- `src/main/pty/windows-path-registry-fallback.ts`
- `src/main/pty/windows-path-segment-merge.ts`
- `src/main/pty-descendant-exit-verification.ts`
- `src/main/pty-descendant-termination-job-coverage.test.ts`
- `src/main/quit-teardown-agent-browser-daemons.test.ts`
...
- `src/main/rate-limits/claude-cli-usage-fetch.ts`
- `src/main/rate-limits/claude-fetcher-cli-fallback.test.ts`
- `src/main/rate-limits/claude-fetcher-fable-usage.test.ts`
- `src/main/rate-limits/claude-fetcher-keychain-credentials.test.ts`
- `src/main/rate-limits/claude-fetcher-managed-account-usage.test.ts`
- `src/main/rate-limits/claude-fetcher-test-harness.ts`
- `src/main/rate-limits/claude-managed-account-credentials.ts`
- `src/main/rate-limits/claude-managed-account-usage.ts`
- `src/main/rate-limits/claude-managed-usage-panel.ts`
- `src/main/rate-limits/claude-oauth-credentials.ts`
- `src/main/rate-limits/claude-oauth-recovery.ts`
- `src/main/rate-limits/claude-oauth-usage-request.ts`
- `src/main/rate-limits/claude-pty-stop-markers.ts`
- `src/main/rate-limits/claude-pty-usage-parser.ts`
- `src/main/rate-limits/claude-usage-fetch-options.ts`
- `src/main/rate-limits/claude-usage-result.ts`
- `src/main/rate-limits/codex-backend-auth.ts`
- `src/main/rate-limits/codex-backend-usage-client.ts`
- `src/main/rate-limits/codex-fetcher-process-contract.test.ts`
- `src/main/rate-limits/codex-fetcher-rpc-exit-diagnostics.test.ts`
- `src/main/rate-limits/codex-fetcher-runtime-pairing.test.ts`
- `src/main/rate-limits/codex-pty-rate-limit-probe.test.ts`
- `src/main/rate-limits/codex-pty-rate-limit-probe.ts`
- `src/main/rate-limits/codex-pty-status-parser.test.ts`
- `src/main/rate-limits/codex-pty-status-parser.ts`
- `src/main/rate-limits/codex-rate-limit-fetch-options.ts`
- `src/main/rate-limits/codex-rate-limit-fetch-result.ts`
- `src/main/rate-limits/codex-rate-limit-window-mapper.ts`
- `src/main/rate-limits/codex-reset-credit-client.ts`
- `src/main/rate-limits/codex-rpc-rate-limit-probe.test.ts`
- `src/main/rate-limits/codex-rpc-rate-limit-probe.ts`
- `src/main/rate-limits/hidden-rate-limit-shell.ts`
...
- `src/main/rate-limits/service/service-fetch-control.ts`
- `src/main/rate-limits/service/service-fetch-policy.ts`
- `src/main/rate-limits/service/service-fetch-queue.ts`
...
- `src/main/rate-limits/service/service-inactive-accounts.ts`
- `src/main/rate-limits/service/service-polling.ts`
- `src/main/rate-limits/service/service-provider-cycles.ts`
- `src/main/rate-limits/service/service-result-policy.ts`
...
- `src/main/remote-worktree-history-cleanup.test.ts`
- `src/main/remote-worktree-history-cleanup.ts`
- `src/main/repo-maintenance-idle-gate.test.ts`
- `src/main/repo-maintenance-idle-gate.ts`
- `src/main/runtime/__fixtures__/cursor-agent-approval-prompt.txt`
- `src/main/runtime/__fixtures__/cursor-agent-idle-after-approval.txt`
- `src/main/runtime/__fixtures__/cursor-agent-long-tool-call.txt`
- `src/main/runtime/__fixtures__/orca-runtime-terminal-close-continuity-fixtures.ts`
- `src/main/runtime/__fixtures__/orca-runtime-terminal-close-continuity-graph-fixture.ts`
- `src/main/runtime/__fixtures__/orca-runtime-terminal-close-continuity-state-fixture.ts`
- `src/main/runtime/agent-prompt-submission-runtime.test.ts`
- `src/main/runtime/agent-prompt-submission-runtime-test-fixture.ts`
...
- `src/main/runtime/agent-session-backup-recovery.test.ts`
- `src/main/runtime/agent-session-backup-recovery-fence.ts`
- `src/main/runtime/agent-session-handoff-lease-transitions.test.ts`
- `src/main/runtime/agent-session-handoff-lease-transitions.ts`
- `src/main/runtime/agent-session-handoff-record-transitions.ts`
- `src/main/runtime/agent-session-launch-env-admission.test.ts`
- `src/main/runtime/agent-session-lease-renewal.test.ts`
- `src/main/runtime/agent-session-lease-renewal.ts`
- `src/main/runtime/agent-session-lease-transitions.ts`
- `src/main/runtime/agent-session-operation-admission.ts`
- `src/main/runtime/agent-session-orphan-child-reaper.test.ts`
...
- `src/main/runtime/agent-session-processless-reservation.ts`
...
- `src/main/runtime/agent-session-pty-write-gate.test.ts`
- `src/main/runtime/agent-session-pty-write-gate.ts`
- `src/main/runtime/agent-session-reconciliation-target.ts`
- `src/main/runtime/agent-session-record-options.test.ts`
- `src/main/runtime/agent-session-record-options.ts`
...
- `src/main/runtime/agent-session-record-store-security.test.ts`
- `src/main/runtime/agent-session-record-store-security.ts`
- `src/main/runtime/agent-session-record-unsupported-schema.test.ts`
- `src/main/runtime/agent-session-recovery-publish-fault.test.ts`
- `src/main/runtime/agent-session-reservation-admission.ts`
- `src/main/runtime/agent-session-restart-handoff-adjudication.test.ts`
...
- `src/main/runtime/agent-session-restart-reconciliation.ts`
- `src/main/runtime/agent-session-spawn-token-process-scan.test.ts`
- `src/main/runtime/agent-session-spawn-token-process-scan.ts`
- `src/main/runtime/agent-session-spawn-token-readback.test.ts`
- `src/main/runtime/agent-session-spawn-token-readback.ts`
- `src/main/runtime/agent-session-store-serialization.ts`
...
- `src/main/runtime/agent-session-unreadable-record-salvage.test.ts`
- `src/main/runtime/agent-session-visible-tab-index.ts`
- `src/main/runtime/automation-change-publication.test.ts`
- `src/main/runtime/browser-client-download-transfers.test.ts`
- `src/main/runtime/browser-client-download-transfers.ts`
- `src/main/runtime/browser-client-download-transfer-store.ts`
- `src/main/runtime/browser-execution-host-grant-registry.ts`
- `src/main/runtime/browser-execution-host-key-resolution.test.ts`
- `src/main/runtime/browser-host-capability-selection.test.ts`
- `src/main/runtime/browser-host-capability-selection.ts`
- `src/main/runtime/browser-host-client-page-adoption.test.ts`
- `src/main/runtime/browser-host-client-page-adoption.ts`
- `src/main/runtime/browser-host-client-page-adoption-grants.test.ts`
- `src/main/runtime/browser-host-client-page-command-issue.ts`
- `src/main/runtime/browser-host-client-page-connection.ts`
- `src/main/runtime/browser-host-client-page-creation.test.ts`
- `src/main/runtime/browser-host-client-page-creation.ts`
- `src/main/runtime/browser-host-client-page-placement.ts`
...
- `src/main/runtime/browser-host-command-replay.ts`
- `src/main/runtime/browser-host-command-result-cache.ts`
- `src/main/runtime/browser-host-command-result-replay.ts`
- `src/main/runtime/browser-host-command-retirement.ts`
- `src/main/runtime/browser-host-command-state.ts`
- `src/main/runtime/browser-host-file-channel-admission.test.ts`
- `src/main/runtime/browser-host-generation-counter.ts`
- `src/main/runtime/browser-host-lease-attachment.ts`
- `src/main/runtime/browser-host-lease-download-transfer-cleanup.test.ts`
- `src/main/runtime/browser-host-lease-fence.ts`
- `src/main/runtime/browser-host-lease-fence-dispatch.ts`
- `src/main/runtime/browser-host-lease-fenced-page-release.test.ts`
- `src/main/runtime/browser-host-lease-fencing.ts`
- `src/main/runtime/browser-host-lease-placement-retirement.test.ts`
- `src/main/runtime/browser-host-lease-reconnect.ts`
- `src/main/runtime/browser-host-lease-records.ts`
- `src/main/runtime/browser-host-lease-registry.test.ts`
- `src/main/runtime/browser-host-lease-registry.ts`
- `src/main/runtime/browser-host-lease-registry-instance.ts`
- `src/main/runtime/browser-host-lease-state-resolution.ts`
- `src/main/runtime/browser-host-page-authority.ts`
- `src/main/runtime/browser-host-page-command-admission.ts`
- `src/main/runtime/browser-host-page-inventory-snapshot.ts`
- `src/main/runtime/browser-host-page-placement.test.ts`
- `src/main/runtime/browser-host-page-placement.ts`
- `src/main/runtime/browser-host-page-placement-replacement.test.ts`
- `src/main/runtime/browser-host-page-placement-validation.ts`
- `src/main/runtime/browser-host-page-reconciliation-actions.ts`
- `src/main/runtime/browser-host-page-reconciliation-executor.test.ts`
- `src/main/runtime/browser-host-page-reconciliation-executor.ts`
...
- `src/main/runtime/browser-host-page-reconciliation-plan.ts`
- `src/main/runtime/browser-host-page-reconciliation-preconditions.test.ts`
- `src/main/runtime/browser-host-page-retirement.test.ts`
- `src/main/runtime/browser-host-page-retirement-completion.ts`
- `src/main/runtime/browser-host-tunnel-registry.ts`
- `src/main/runtime/browser-network-tunnel-paired-runtime.integration.test.ts`
- `src/main/runtime/browser-screencast-driver-attribution.test.ts`
- `src/main/runtime/browser-screencast-driver-scope.test.ts`
- `src/main/runtime/browser-screencast-driver-scope.ts`
- `src/main/runtime/browser-screencast-ghost-subscriber-eviction.test.ts`
- `src/main/runtime/browser-screencast-ghost-subscriber-eviction.ts`
- `src/main/runtime/browser-screencast-remote-viewer-retention.test.ts`
- `src/main/runtime/browser-screencast-subscriber-test-harness.ts`
...
- `src/main/runtime/browser-tab-create-caller-navigation.test.ts`
- `src/main/runtime/browser-tab-create-publication.test.ts`
- `src/main/runtime/browser-tab-create-publication.ts`
- `src/main/runtime/client-hosted-browser-page-persistence.integration.test.ts`
- `src/main/runtime/client-hosted-browser-page-persistence.test.ts`
- `src/main/runtime/client-hosted-browser-page-persistence.ts`
- `src/main/runtime/client-hosted-browser-row-hydration-census.test.ts`
- `src/main/runtime/client-hosted-browser-row-projection.test.ts`
- `src/main/runtime/client-hosted-browser-row-projection.ts`
- `src/main/runtime/client-hosted-browser-row-publication.test.ts`
- `src/main/runtime/client-hosted-browser-row-publication.ts`
- `src/main/runtime/client-hosted-browser-row-push.integration.test.ts`
- `src/main/runtime/client-hosted-page-reconciliation-hold.integration.test.ts`
- `src/main/runtime/client-hosted-page-reconciliation-window.test.ts`
- `src/main/runtime/client-hosted-page-reconciliation-window.ts`
- `src/main/runtime/client-session-tab-closed-selection.ts`
...
- `src/main/runtime/graph-sync-deletion-fence.test.ts`
- `src/main/runtime/graph-sync-live-daemon-pty-tab-preservation.test.ts`
- `src/main/runtime/headless-tab-order-stability.test.ts`
- `src/main/runtime/headless-terminal-dispose-write-ordering.test.ts`
- `src/main/runtime/host-terminal-close-persistence-durability.test.ts`
- `src/main/runtime/mobile-agent-status-permission-renewal.test.ts`
- `src/main/runtime/mobile-session-browser-equality.ts`
- `src/main/runtime/mobile-session-browser-group-projection.ts`
- `src/main/runtime/mobile-session-layout-projection.ts`
- `src/main/runtime/mobile-session-lifecycle-close-adjudication.ts`
- `src/main/runtime/mobile-session-snapshot-equality.ts`
- `src/main/runtime/mobile-session-tab-close-outcome.ts`
- `src/main/runtime/mobile-session-tab-merge.ts`
- `src/main/runtime/mobile-session-tabs-churn-coalescing.test.ts`
- `src/main/runtime/mobile-session-terminal-projection.ts`
...
- `src/main/runtime/native-terminal-availability.ts`
- `src/main/runtime/opencode-finished-session-authority.test.ts`
...
- `src/main/runtime/orca-runtime-browser-ghost-session-row-close.test.ts`
- `src/main/runtime/orca-runtime-browser-headless.test.ts`
- `src/main/runtime/orca-runtime-browser-screencast-fanout.test.ts`
- `src/main/runtime/orca-runtime-build-controller-terminal-identities.ts`
...
- `src/main/runtime/orca-runtime-files-mobile-explorer-reads.test.ts`
- `src/main/runtime/orca-runtime-files-mock-registry.ts`
- `src/main/runtime/orca-runtime-files-preview-budget.test.ts`
- `src/main/runtime/orca-runtime-files-rename-authority.test.ts`
- `src/main/runtime/orca-runtime-files-search.test.ts`
- `src/main/runtime/orca-runtime-files-ssh-chunk-reads.test.ts`
- `src/main/runtime/orca-runtime-files-terminal-artifact-fixtures.ts`
- `src/main/runtime/orca-runtime-files-terminal-artifact-grants.test.ts`
- `src/main/runtime/orca-runtime-files-terminal-artifact-io.test.ts`
- `src/main/runtime/orca-runtime-files-terminal-link-host-translation.test.ts`
- `src/main/runtime/orca-runtime-files-terminal-path-resolution.test.ts`
- `src/main/runtime/orca-runtime-files-test-harness.ts`
- `src/main/runtime/orca-runtime-files-watch-host-scope.test.ts`
...
- `src/main/runtime/orca-runtime-module-size.test.ts`
...
- `src/main/runtime/orca-runtime-provider-reattach-launch-identity.test.ts`
...
- `src/main/runtime/orca-runtime-report-pty-spawn-commit.ts`
...
- `src/main/runtime/orca-runtime-skill-recovery.test.ts`
...
- `src/main/runtime/orca-runtime-tab-id-collision.test.ts`
...
- `src/main/runtime/orca-runtime-test-fragment-coverage.test.ts`
- `src/main/runtime/orca-runtime-test-lifecycle.spec.ts`
- `src/main/runtime/orca-runtime-test-mocks.spec.ts`
- `src/main/runtime/orca-runtime-test-mocks/imported-values.spec.ts`
- `src/main/runtime/orca-runtime-test-mocks/setup.spec.ts`
- `src/main/runtime/orca-runtime-tests/agent-status-and-waits.spec.ts`
- `src/main/runtime/orca-runtime-tests/agent-status-and-waits-part-02.spec.ts`
- `src/main/runtime/orca-runtime-tests/agent-status-and-waits-part-03.spec.ts`
- `src/main/runtime/orca-runtime-tests/browser-capabilities.spec.ts`
- `src/main/runtime/orca-runtime-tests/browser-capabilities-part-02.spec.ts`
- `src/main/runtime/orca-runtime-tests/dedupe-worktree-create.spec.ts`
- `src/main/runtime/orca-runtime-tests/gitlab-and-pr-bases.spec.ts`
- `src/main/runtime/orca-runtime-tests/gitlab-and-pr-bases-part-02.spec.ts`
- `src/main/runtime/orca-runtime-tests/gitlab-and-pr-bases-part-03.spec.ts`
- `src/main/runtime/orca-runtime-tests/headless-snapshots.spec.ts`
- `src/main/runtime/orca-runtime-tests/headless-snapshots-part-02.spec.ts`
- `src/main/runtime/orca-runtime-tests/hooks-and-hosted-review.spec.ts`
- `src/main/runtime/orca-runtime-tests/hooks-and-hosted-review-part-02.spec.ts`
- `src/main/runtime/orca-runtime-tests/hooks-and-hosted-review-part-03.spec.ts`
- `src/main/runtime/orca-runtime-tests/lineage-and-scan-cache.spec.ts`
- `src/main/runtime/orca-runtime-tests/lineage-and-scan-cache-part-02.spec.ts`
- `src/main/runtime/orca-runtime-tests/lineage-and-scan-cache-part-03.spec.ts`
- `src/main/runtime/orca-runtime-tests/lineage-and-scan-cache-part-04.spec.ts`
- `src/main/runtime/orca-runtime-tests/lineage-and-scan-cache-part-05.spec.ts`
- `src/main/runtime/orca-runtime-tests/lineage-and-scan-cache-part-06.spec.ts`
...
- `src/main/runtime/orca-runtime-tests/mobile-creation-and-orchestration.spec.ts`
...
- `src/main/runtime/orca-runtime-tests/mobile-session-tabs.spec.ts`
- `src/main/runtime/orca-runtime-tests/mobile-session-tabs-part-02.spec.ts`
- `src/main/runtime/orca-runtime-tests/mobile-session-tabs-part-03.spec.ts`
- `src/main/runtime/orca-runtime-tests/mobile-session-tabs-part-04.spec.ts`
- `src/main/runtime/orca-runtime-tests/mobile-session-tabs-part-05.spec.ts`
- `src/main/runtime/orca-runtime-tests/mobile-session-tabs-part-06.spec.ts`
- `src/main/runtime/orca-runtime-tests/mobile-session-tabs-part-07.spec.ts`
- `src/main/runtime/orca-runtime-tests/mobile-session-tabs-part-08.spec.ts`
- `src/main/runtime/orca-runtime-tests/mobile-session-tabs-part-09.spec.ts`
- `src/main/runtime/orca-runtime-tests/mobile-session-tabs-part-10.spec.ts`
- `src/main/runtime/orca-runtime-tests/mobile-session-tabs-part-11.spec.ts`
- `src/main/runtime/orca-runtime-tests/mobile-session-tabs-part-12.spec.ts`
- `src/main/runtime/orca-runtime-tests/mobile-session-tabs-part-13.spec.ts`
...
- `src/main/runtime/orca-runtime-tests/mobile-summaries-part-04.spec.ts`
- `src/main/runtime/orca-runtime-tests/paired-settings.spec.ts`
- `src/main/runtime/orca-runtime-tests/pty-title-status.spec.ts`
- `src/main/runtime/orca-runtime-tests/repository-project-operations.spec.ts`
- `src/main/runtime/orca-runtime-tests/repository-project-operations-part-02.spec.ts`
- `src/main/runtime/orca-runtime-tests/runtime-availability.spec.ts`
- `src/main/runtime/orca-runtime-tests/ssh-worktree-lifecycle.spec.ts`
- `src/main/runtime/orca-runtime-tests/ssh-worktree-lifecycle-part-02.spec.ts`
- `src/main/runtime/orca-runtime-tests/ssh-worktree-lifecycle-part-03.spec.ts`
- `src/main/runtime/orca-runtime-tests/targeting-and-resilience.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-creation-and-readiness.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-creation-and-readiness-part-02.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-creation-and-readiness-part-03.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-creation-and-readiness-part-04.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-creation-and-readiness-part-05.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-creation-and-readiness-part-06.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-creation-and-readiness-part-07.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-creation-and-readiness-part-08.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-creation-and-readiness-part-09.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-creation-and-readiness-part-10.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-creation-and-readiness-part-11.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-creation-and-readiness-part-12.spec.ts`
...
- `src/main/runtime/orca-runtime-tests/terminal-handles-and-agent-status-part-02.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-handles-and-agent-status-part-03.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-handles-and-agent-status-part-04.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-handles-and-agent-status-part-05.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-handles-and-agent-status-part-06.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-handles-part-02.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-listing.spec.ts`
...
- `src/main/runtime/orca-runtime-tests/terminal-output-and-worker-recovery-part-07.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-side-effect-facts.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-side-effect-facts-part-02.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-side-effect-facts-part-03.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-sleep-and-teardown.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-sleep-and-teardown-part-02.spec.ts`
- `src/main/runtime/orca-runtime-tests/terminal-sleep-and-teardown-part-03.spec.ts`
- `src/main/runtime/orca-runtime-tests/window-authority.spec.ts`
- `src/main/runtime/orca-runtime-tests/worktree-removal-and-reconciliation.spec.ts`
- `src/main/runtime/orca-runtime-tests/worktree-removal-and-reconciliation-part-02.spec.ts`
- `src/main/runtime/orca-runtime-tests/worktree-removal-and-reconciliation-part-03.spec.ts`
- `src/main/runtime/orca-runtime-tests/worktree-removal-and-reconciliation-part-04.spec.ts`
- `src/main/runtime/orca-runtime-tests/worktree-scan-cache-ttl.spec.ts`
- `src/main/runtime/orca-runtime-tests/worktree-selector-resolution.spec.ts`
- `src/main/runtime/orca-runtime-tests/worktree-setup-and-startup.spec.ts`
- `src/main/runtime/orca-runtime-tests/worktree-setup-and-startup-part-02.spec.ts`
- `src/main/runtime/orca-runtime-tests/worktree-setup-and-startup-part-03.spec.ts`
- `src/main/runtime/orca-runtime-tests/worktree-setup-and-startup-part-04.spec.ts`
- `src/main/runtime/orca-runtime-tests/worktree-setup-and-startup-part-05.spec.ts`
- `src/main/runtime/orca-runtime-test-scenario-builders.spec.ts`
...
- `src/main/runtime/orchestration/coordinator-dag-convergence.ts`
- `src/main/runtime/orchestration/coordinator-decision-gates.test.ts`
- `src/main/runtime/orchestration/coordinator-decision-gates.ts`
...
- `src/main/runtime/orchestration/coordinator-escalation-triage.ts`
- `src/main/runtime/orchestration/coordinator-runtime-contract.ts`
- `src/main/runtime/orchestration/coordinator-stale-base-flag.ts`
- `src/main/runtime/orchestration/coordinator-task-dispatch.ts`
- `src/main/runtime/orchestration/db/attach-orchestration-db-methods.ts`
- `src/main/runtime/orchestration/db/contract-constants.ts`
- `src/main/runtime/orchestration/db/coordinator-runs/coordinator-run-store.ts`
- `src/main/runtime/orchestration/db/database-file-permissions.ts`
...
- `src/main/runtime/orchestration/db/dispatch-context/dispatch-circuit-breaker.ts`
...
- `src/main/runtime/orchestration/db/dispatch-context/dispatch-lookup.ts`
- `src/main/runtime/orchestration/db/dispatch-context/task-dispatch-reconciliation.ts`
...
- `src/main/runtime/orchestration/db/federated-worker-report-outcome.test.ts`
- `src/main/runtime/orchestration/db/federated-worker-report-outcome.ts`
- `src/main/runtime/orchestration/db/federation/federated-dispatch-store.ts`
- `src/main/runtime/orchestration/db/federation/federation-relay-ack.ts`
- `src/main/runtime/orchestration/db/federation/federation-relay-enqueue.ts`
- `src/main/runtime/orchestration/db/federation/federation-relay-import.ts`
- `src/main/runtime/orchestration/db/federation/federation-relay-item.ts`
- `src/main/runtime/orchestration/db/federation/remote-dispatch-attachment-authority.ts`
- `src/main/runtime/orchestration/db/federation/remote-dispatch-attachment-create.ts`
- `src/main/runtime/orchestration/db/federation/remote-dispatch-attachment-stop.ts`
- `src/main/runtime/orchestration/db/federation/remote-question-store.ts`
- `src/main/runtime/orchestration/db/generated-id.ts`
- `src/main/runtime/orchestration/db/legacy/legacy-ask-operation.ts`
- `src/main/runtime/orchestration/db/legacy/legacy-compatibility-candidates.ts`
- `src/main/runtime/orchestration/db/legacy/legacy-compatibility-principals.ts`
- `src/main/runtime/orchestration/db/legacy/legacy-lifecycle-operation.ts`
- `src/main/runtime/orchestration/db/legacy/legacy-mail-acknowledge.ts`
- `src/main/runtime/orchestration/db/legacy/legacy-question-acknowledge.ts`
- `src/main/runtime/orchestration/db/legacy/legacy-question-lookup.ts`
- `src/main/runtime/orchestration/db/legacy/legacy-recovery-cohort.ts`
- `src/main/runtime/orchestration/db/legacy/legacy-reply-operation.ts`
- `src/main/runtime/orchestration/db/legacy/legacy-worker-completion.ts`
- `src/main/runtime/orchestration/db/legacy-question-identity.test.ts`
- `src/main/runtime/orchestration/db/legacy-question-identity.ts`
...
- `src/main/runtime/orchestration/db/messages/direct-mailbox-routing.ts`
- `src/main/runtime/orchestration/db/messages/foreign-direct-mailbox-routing.ts`
- `src/main/runtime/orchestration/db/messages/mailbox-routing-page.ts`
...
- `src/main/runtime/orchestration/db/orchestration-db-methods.ts`
- `src/main/runtime/orchestration/db/pane-key-match.test.ts`
- `src/main/runtime/orchestration/db/pane-key-match.ts`
- `src/main/runtime/orchestration/db/questions/question-threads.ts`
- `src/main/runtime/orchestration/db/reset/orchestration-reset.ts`
- `src/main/runtime/orchestration/db/root-dispatch-test-fixture.ts`
- `src/main/runtime/orchestration/db/run-list-cursor.test.ts`
- `src/main/runtime/orchestration/db/run-list-cursor.ts`
- `src/main/runtime/orchestration/db/run-list-page.ts`
- `src/main/runtime/orchestration/db/runs/legacy-coordinator-mail-takeover.ts`
...
- `src/main/runtime/orchestration/db/schema/backfill-legacy-question-threads.ts`
...
- `src/main/runtime/orchestration/db/schema/migrate-legacy-contract-storage.ts`
- `src/main/runtime/orchestration/db/schema/migrate-v13-v30.ts`
- `src/main/runtime/orchestration/db/schema/migrate-v2-v12.ts`
- `src/main/runtime/orchestration/db/schema/schema-column-probes.ts`
- `src/main/runtime/orchestration/db/tasks/task-status-transition.ts`
- `src/main/runtime/orchestration/db/tasks/task-store.ts`
- `src/main/runtime/orchestration/db/utc-timestamp.ts`
- `src/main/runtime/orchestration/db/worker-dispatch/federated-worker-start-reconcile.ts`
- `src/main/runtime/orchestration/db/worker-dispatch/worker-dispatch-abandon.ts`
...
- `src/main/runtime/orchestration/db/worker-dispatch/worker-dispatch-stage.ts`
...
- `src/main/runtime/orchestration/db/worker-dispatch/worker-terminal-recovery.ts`
- `src/main/runtime/orchestration/db/worker-terminal/worker-terminal-archive.ts`
- `src/main/runtime/orchestration/db/worker-terminal/worker-terminal-listing.ts`
- `src/main/runtime/orchestration/db/worker-terminal/worker-terminal-release.ts`
- `src/main/runtime/orchestration/db/worker-terminal/worker-terminal-resource-store.ts`
- `src/main/runtime/orchestration/db/worker-terminal/worker-terminal-transfer.ts`
...
- `src/main/runtime/orchestration/dispatch-message-binding.ts`
...
- `src/main/runtime/orchestration/federation-lifecycle-settlement.test.ts`
- `src/main/runtime/orchestration/federation-lifecycle-settlement.ts`
- `src/main/runtime/orchestration/federation-terminal-recovery.test.ts`
- `src/main/runtime/orchestration/federation-worker-report-payload.ts`
...
- `src/main/runtime/orchestration/mailbox-owner.ts`
- `src/main/runtime/orchestration/mailbox-pointer-delivery.ts`
- `src/main/runtime/orchestration/mailbox-pointer-eligibility.ts`
- `src/main/runtime/orchestration/mailbox-pointer-state.ts`
...
- `src/main/runtime/orchestration/task-deps-flag.test.ts`
- `src/main/runtime/orchestration/task-deps-flag.ts`
...
- `src/main/runtime/orchestration-worker-workspace-resolution.test.ts`
- `src/main/runtime/paired-client-navigation-test-harness.ts`
- `src/main/runtime/pty-exit-agent-status-reconciliation.test.ts`
- `src/main/runtime/pty-inventory-liveness-verdict.test.ts`
- `src/main/runtime/pty-inventory-partial-relay-liveness.test.ts`
- `src/main/runtime/pty-shell-ownership-mirror.test.ts`
- `src/main/runtime/pty-shell-ownership-mirror.ts`
- `src/main/runtime/quarter-circle-title-send-authorization.test.ts`
- `src/main/runtime/relay/desktop-relay-service-broker-liveness.test.ts`
- `src/main/runtime/relay/relay-assign-rate-gate.ts`
- `src/main/runtime/relay/relay-region-preference.test.ts`
- `src/main/runtime/relay/relay-region-preference.ts`
- `src/main/runtime/remote-desktop-terminal-floor.ts`
...
- `src/main/runtime/rpc/dispatcher-browser-client-automation.test.ts`
- `src/main/runtime/rpc/dispatcher-caller-fingerprint.ts`
- `src/main/runtime/rpc/dispatcher-client-browser-routing.ts`
- `src/main/runtime/rpc/dispatcher-request-parsing.test.ts`
- `src/main/runtime/rpc/dispatcher-request-parsing.ts`
- `src/main/runtime/rpc/dispatcher-streaming-feature-emitter.ts`
- `src/main/runtime/rpc/methods/agent-hooks.test.ts`
- `src/main/runtime/rpc/methods/agent-hooks.ts`
- `src/main/runtime/rpc/methods/agent-skill-sharing-capability-grant.test.ts`
...
- `src/main/runtime/rpc/methods/browser-client-page-metadata.test.ts`
...
- `src/main/runtime/rpc/methods/files-doc-preview.test.ts`
- `src/main/runtime/rpc/methods/files-list-all-page-size.test.ts`
- `src/main/runtime/rpc/methods/files-mutation-methods.ts`
- `src/main/runtime/rpc/methods/files-preview-transport-budget.test.ts`
- `src/main/runtime/rpc/methods/files-remote-content-budget.ts`
- `src/main/runtime/rpc/methods/files-target-schemas.ts`
- `src/main/runtime/rpc/methods/files-terminal-artifact-methods.ts`
- `src/main/runtime/rpc/methods/git-admission-tier-schema.ts`
- `src/main/runtime/rpc/methods/git-commit-message-generation-methods.ts`
- `src/main/runtime/rpc/methods/git-diff-methods.ts`
- `src/main/runtime/rpc/methods/git-diff-transport-budget.test.ts`
- `src/main/runtime/rpc/methods/github-issue-methods.ts`
- `src/main/runtime/rpc/methods/github-issue-update-schema.ts`
- `src/main/runtime/rpc/methods/github-project-methods.ts`
- `src/main/runtime/rpc/methods/github-pr-refresh-reason.test.ts`
...
- `src/main/runtime/rpc/methods/github-repo-target-schemas.ts`
- `src/main/runtime/rpc/methods/github-repo-work-item-methods.ts`
- `src/main/runtime/rpc/methods/orchestration-ask.test.ts`
- `src/main/runtime/rpc/methods/orchestration-ask-methods.ts`
- `src/main/runtime/rpc/methods/orchestration-ask-remote.ts`
- `src/main/runtime/rpc/methods/orchestration-check.test.ts`
- `src/main/runtime/rpc/methods/orchestration-check-direct.ts`
- `src/main/runtime/rpc/methods/orchestration-check-methods.ts`
- `src/main/runtime/rpc/methods/orchestration-check-run.ts`
- `src/main/runtime/rpc/methods/orchestration-check-worker.ts`
- `src/main/runtime/rpc/methods/orchestration-cli-runtime-boundary.test.ts`
- `src/main/runtime/rpc/methods/orchestration-composed-workers.test.ts`
- `src/main/runtime/rpc/methods/orchestration-dispatch-creator.ts`
- `src/main/runtime/rpc/methods/orchestration-dispatch-methods.ts`
- `src/main/runtime/rpc/methods/orchestration-federated-attach-receipt.test.ts`
- `src/main/runtime/rpc/methods/orchestration-federated-attach-receipt.ts`
- `src/main/runtime/rpc/methods/orchestration-federated-worker-start-receipt.test.ts`
- `src/main/runtime/rpc/methods/orchestration-federated-worker-start-unknown-receipt.ts`
...
- `src/main/runtime/rpc/methods/orchestration-gates.test.ts`
- `src/main/runtime/rpc/methods/orchestration-inject-rejection-message.test.ts`
- `src/main/runtime/rpc/methods/orchestration-inject-rejection-message.ts`
- `src/main/runtime/rpc/methods/orchestration-manual-dispatch-observation.test.ts`
- `src/main/runtime/rpc/methods/orchestration-message-methods.ts`
- `src/main/runtime/rpc/methods/orchestration-mutation-request-show.ts`
- `src/main/runtime/rpc/methods/orchestration-recipient-routing.test.ts`
- `src/main/runtime/rpc/methods/orchestration-recipient-routing.ts`
- `src/main/runtime/rpc/methods/orchestration-reset-methods.ts`
- `src/main/runtime/rpc/methods/orchestration-routing.ts`
...
- `src/main/runtime/rpc/methods/orchestration-send-dispatch-authority.test.ts`
- `src/main/runtime/rpc/methods/orchestration-send-group.ts`
- `src/main/runtime/rpc/methods/orchestration-send-invalid-type.test.ts`
...
- `src/main/runtime/rpc/methods/orchestration-send-remote.ts`
- `src/main/runtime/rpc/methods/orchestration-settled-dispatch-mail.test.ts`
...
- `src/main/runtime/rpc/methods/orchestration-worker-release-liveness-verdict.test.ts`
- `src/main/runtime/rpc/methods/orchestration-worker-start-budgets.test.ts`
- `src/main/runtime/rpc/methods/orchestration-worker-start-budgets.ts`
...
- `src/main/runtime/rpc/methods/orchestration-worker-stop-capability.test.ts`
- `src/main/runtime/rpc/methods/orchestration-worker-stop-liveness-verdict.test.ts`
- `src/main/runtime/rpc/methods/paired-caller-host-id.test.ts`
- `src/main/runtime/rpc/methods/paired-caller-host-id.ts`
- `src/main/runtime/rpc/methods/project-host-setup-self-host-stamp.test.ts`
...
- `src/main/runtime/rpc/methods/session-tab-browser-placement-projection.ts`
...
- `src/main/runtime/rpc/methods/session-tabs-inventory-rpc.test.ts`
- `src/main/runtime/rpc/methods/session-tabs-unsubscribe.test.ts`
...
- `src/main/runtime/rpc/methods/terminal/terminal-input-delivery.ts`
- `src/main/runtime/rpc/methods/terminal/terminal-legacy-binary-control-frames.ts`
- `src/main/runtime/rpc/methods/terminal/terminal-legacy-simple-subscriptions.ts`
- `src/main/runtime/rpc/methods/terminal/terminal-legacy-subscribe-binary.ts`
- `src/main/runtime/rpc/methods/terminal/terminal-legacy-subscribe-live.ts`
- `src/main/runtime/rpc/methods/terminal/terminal-legacy-subscribe-snapshot.ts`
- `src/main/runtime/rpc/methods/terminal/terminal-legacy-subscription-types.ts`
- `src/main/runtime/rpc/methods/terminal/terminal-lifecycle-methods.ts`
- `src/main/runtime/rpc/methods/terminal/terminal-multiplex-cleanup.ts`
- `src/main/runtime/rpc/methods/terminal/terminal-multiplex-connection.ts`
...
- `src/main/runtime/rpc/methods/terminal/terminal-multiplex-initial-snapshot.ts`
- `src/main/runtime/rpc/methods/terminal/terminal-multiplex-live-stream.ts`
- `src/main/runtime/rpc/methods/terminal/terminal-multiplex-method.ts`
- `src/main/runtime/rpc/methods/terminal/terminal-multiplex-slot-frames.ts`
- `src/main/runtime/rpc/methods/terminal/terminal-multiplex-stream-initialization.ts`
- `src/main/runtime/rpc/methods/terminal/terminal-multiplex-subscribe-frame.ts`
- `src/main/runtime/rpc/methods/terminal/terminal-multiplex-subscribe-resolution.ts`
...
- `src/main/runtime/rpc/methods/terminal/terminal-snapshot-publication.ts`
- `src/main/runtime/rpc/methods/terminal/terminal-stream-replay.ts`
- `src/main/runtime/rpc/methods/terminal/terminal-stream-types.ts`
- `src/main/runtime/rpc/methods/terminal/terminal-subscribe-method.ts`
- `src/main/runtime/rpc/methods/terminal/terminal-subscription-stream-id.ts`
- `src/main/runtime/rpc/methods/terminal/terminal-viewport-methods.ts`
- `src/main/runtime/rpc/methods/terminal/terminal-viewport-update.ts`
- `src/main/runtime/rpc/methods/terminal/unary-schemas.ts`
- `src/main/runtime/rpc/methods/terminal/viewport-schemas.ts`
- `src/main/runtime/rpc/methods/terminal-legacy-stream-id-characterization.test.ts`
- `src/main/runtime/rpc/methods/terminal-manifest-characterization.test.ts`
- `src/main/runtime/rpc/methods/terminal-read-screen-cursor.test.ts`
- `src/main/runtime/rpc/methods/terminal-stream-extraction-characterization.test.ts`
- `src/main/runtime/rpc/methods/workspace-cleanup-ui-schema.test.ts`
- `src/main/runtime/rpc/methods/workspace-cleanup-ui-schema.ts`
- `src/main/runtime/rpc/methods/worktree-catalog-methods.ts`
- `src/main/runtime/rpc/methods/worktree-create-args.test.ts`
- `src/main/runtime/rpc/methods/worktree-create-args.ts`
- `src/main/runtime/rpc/methods/worktree-create-navigation.test.ts`
- `src/main/runtime/rpc/methods/worktree-create-schemas.ts`
- `src/main/runtime/rpc/methods/worktree-github-pr-suppression.test.ts`
- `src/main/runtime/rpc/methods/worktree-retired-names.test.ts`
- `src/main/runtime/rpc/methods/worktree-rm-host-qualification.test.ts`
- `src/main/runtime/rpc/methods/worktree-visibility-defaults-schema.ts`
...
- `src/main/runtime/rpc/orchestration-mutation-request-show-legacy.test.ts`
- `src/main/runtime/rpc/orchestration-task-dispatch-invariant.test.ts`
- `src/main/runtime/rpc/repo-visibility-projection.ts`
- `src/main/runtime/rpc/rpc-streaming-dispatcher.ts`
- `src/main/runtime/rpc/subscription-registry-test-double.ts`
- `src/main/runtime/rpc/terminal-agent-prompt-send.test.ts`
- `src/main/runtime/rpc/terminal-lease-stale-handle-survival.test.ts`
- `src/main/runtime/rpc/terminal-list-host-scope-transport.test.ts`
...
- `src/main/runtime/rpc/terminal-multiplex-desktop-resize-routing.test.ts`
- `src/main/runtime/rpc/terminal-multiplex-end-verdict.test.ts`
...
- `src/main/runtime/rpc/terminal-multiplex-source-range-fixtures.ts`
- `src/main/runtime/rpc/terminal-multiplex-subscribe-slot-recovery.test.ts`
- `src/main/runtime/rpc/terminal-multiplex-test-harness.ts`
- `src/main/runtime/rpc/terminal-opencode-send-guard.integration.test.ts`
- `src/main/runtime/rpc/terminal-send-agent-session-lease.test.ts`
...
- `src/main/runtime/rpc/terminal-subscribe-relay-drop-lease-survival.test.ts`
- `src/main/runtime/rpc/worktree-visibility-client-capability.ts`
- `src/main/runtime/runtime-account-controller.ts`
- `src/main/runtime/runtime-agent-launch-resolution.ts`
- `src/main/runtime/runtime-agent-orchestration-projection.ts`
- `src/main/runtime/runtime-agent-row-store.ts`
- `src/main/runtime/runtime-ai-vault-commands.ts`
- `src/main/runtime/runtime-artifact-controller.ts`
- `src/main/runtime/runtime-async-boundaries.ts`
- `src/main/runtime/runtime-automation-controller.ts`
- `src/main/runtime/runtime-binary-message-router.test.ts`
- `src/main/runtime/runtime-binary-message-router.ts`
- `src/main/runtime/runtime-browser-client-automation.test.ts`
- `src/main/runtime/runtime-browser-client-automation.ts`
- `src/main/runtime/runtime-browser-client-page-adoption.test.ts`
- `src/main/runtime/runtime-browser-client-page-adoption.ts`
- `src/main/runtime/runtime-browser-client-page-creation.test.ts`
- `src/main/runtime/runtime-browser-client-page-creation.ts`
- `src/main/runtime/runtime-browser-client-page-recovery.test.ts`
- `src/main/runtime/runtime-browser-client-page-recovery.ts`
- `src/main/runtime/runtime-browser-client-page-release.ts`
- `src/main/runtime/runtime-browser-client-page-restored-recovery.test.ts`
...
- `src/main/runtime/runtime-browser-driver-controller.ts`
- `src/main/runtime/runtime-browser-network-execution-host.test.ts`
- `src/main/runtime/runtime-browser-network-execution-host.ts`
- `src/main/runtime/runtime-browser-page-registry.test.ts`
- `src/main/runtime/runtime-browser-page-registry.ts`
- `src/main/runtime/runtime-browser-screencast-controller.ts`
- `src/main/runtime/runtime-client-event-bus.ts`
- `src/main/runtime/runtime-client-settings.ts`
- `src/main/runtime/runtime-desktop-surface.ts`
- `src/main/runtime/runtime-edge-command-controller.ts`
- `src/main/runtime/runtime-extraction-regressions.test.ts`
...
- `src/main/runtime/runtime-file-command-surface.ts`
...
- `src/main/runtime/runtime-file-paths.ts`
- `src/main/runtime/runtime-file-watcher-leases.ts`
- `src/main/runtime/runtime-file-watcher-removal.ts`
- `src/main/runtime/runtime-folder-worktree-create.ts`
- `src/main/runtime/runtime-git-api-contract.test.ts`
- `src/main/runtime/runtime-git-branch-compare-admission.test.ts`
- `src/main/runtime/runtime-git-command-surface.ts`
- `src/main/runtime/runtime-git-command-target.ts`
- `src/main/runtime/runtime-git-conflict-operation-routing.test.ts`
- `src/main/runtime/runtime-git-diff-commands.ts`
- `src/main/runtime/runtime-git-execution-host-ownership.test.ts`
- `src/main/runtime/runtime-git-generation-admission.test.ts`
- `src/main/runtime/runtime-git-generation-commands.ts`
- `src/main/runtime/runtime-git-generation-context.ts`
- `src/main/runtime/runtime-github-issue-comment-commands.ts`
- `src/main/runtime/runtime-github-project-commands.ts`
- `src/main/runtime/runtime-github-repository-query-commands.ts`
- `src/main/runtime/runtime-github-review-mutation-commands.ts`
- `src/main/runtime/runtime-github-review-query-commands.ts`
- `src/main/runtime/runtime-github-worktree-base.ts`
- `src/main/runtime/runtime-gitlab-fork-mr-base.ts`
- `src/main/runtime/runtime-gitlab-issue-source-remote.ts`
- `src/main/runtime/runtime-gitlab-mutation-commands.ts`
- `src/main/runtime/runtime-gitlab-query-commands.ts`
- `src/main/runtime/runtime-gitlab-worktree-base.ts`
- `src/main/runtime/runtime-git-staging-commands.ts`
- `src/main/runtime/runtime-git-status-admission.test.ts`
- `src/main/runtime/runtime-git-status-commands.ts`
- `src/main/runtime/runtime-git-sync-commands.test.ts`
- `src/main/runtime/runtime-git-sync-commands.ts`
- `src/main/runtime/runtime-graph-reload-lifecycle.test.ts`
- `src/main/runtime/runtime-graph-reload-lifecycle.ts`
- `src/main/runtime/runtime-hosted-review-commands.ts`
- `src/main/runtime/runtime-jira-commands.ts`
- `src/main/runtime/runtime-legacy-worker-terminal-recovery-candidate.ts`
...
- `src/main/runtime/runtime-linear-browse-commands.ts`
- `src/main/runtime/runtime-linear-command-base.ts`
- `src/main/runtime/runtime-linear-command-dependencies.ts`
- `src/main/runtime/runtime-linear-command-surface.ts`
- `src/main/runtime/runtime-linear-comment-commands.ts`
- `src/main/runtime/runtime-linear-comment-lookup-commands.ts`
- `src/main/runtime/runtime-linear-connection-commands.ts`
- `src/main/runtime/runtime-linear-context-commands.ts`
- `src/main/runtime/runtime-linear-create-commands.ts`
- `src/main/runtime/runtime-linear-dedupe-commands.ts`
- `src/main/runtime/runtime-linear-label-write-commands.ts`
- `src/main/runtime/runtime-linear-project-write-commands.ts`
- `src/main/runtime/runtime-linear-read-commands.test.ts`
- `src/main/runtime/runtime-linear-read-commands.ts`
- `src/main/runtime/runtime-linear-retry-commands.ts`
- `src/main/runtime/runtime-linear-save-commands.ts`
- `src/main/runtime/runtime-linear-save-fields-commands.ts`
- `src/main/runtime/runtime-linear-state-commands.ts`
- `src/main/runtime/runtime-linear-task-fields-commands.ts`
- `src/main/runtime/runtime-linear-team-write-commands.ts`
- `src/main/runtime/runtime-linear-write-result-commands.ts`
- `src/main/runtime/runtime-local-git-worktree-create.ts`
- `src/main/runtime/runtime-local-worktree-create.ts`
- `src/main/runtime/runtime-local-worktree-create-candidate.ts`
- `src/main/runtime/runtime-local-worktree-materialization.test.ts`
- `src/main/runtime/runtime-local-worktree-materialization.ts`
- `src/main/runtime/runtime-local-worktree-setup.ts`
- `src/main/runtime/runtime-local-worktree-terminal-startup.ts`
- `src/main/runtime/runtime-managed-worktree-create-types.ts`
- `src/main/runtime/runtime-managed-worktree-metadata.test.ts`
- `src/main/runtime/runtime-managed-worktree-metadata.ts`
...
- `src/main/runtime/runtime-mobile-speech-catalog.ts`
- `src/main/runtime/runtime-native-chat-draft-resolutions.ts`
...
- `src/main/runtime/runtime-preserved-branch-cleanup.ts`
- `src/main/runtime/runtime-project-group-controller.ts`
- `src/main/runtime/runtime-project-group-controller-folder-delete.test.ts`
- `src/main/runtime/runtime-project-host-setup-controller.ts`
- `src/main/runtime/runtime-pty-controller-contract.ts`
- `src/main/runtime/runtime-pty-foreground-agent.ts`
- `src/main/runtime/runtime-registered-local-worktree-removal.ts`
- `src/main/runtime/runtime-registered-remote-worktree-removal.ts`
- `src/main/runtime/runtime-remote-fetch-controller.ts`
- `src/main/runtime/runtime-remote-fetch-ref-maintenance.test.ts`
- `src/main/runtime/runtime-remote-managed-worktree-create.ts`
- `src/main/runtime/runtime-remote-worktree-create-request.ts`
- `src/main/runtime/runtime-remote-worktree-create-result.ts`
...
- `src/main/runtime/runtime-repository-hooks-commands.ts`
- `src/main/runtime/runtime-repository-issue-command.ts`
- `src/main/runtime/runtime-repository-ref-queries.ts`
- `src/main/runtime/runtime-repository-registration-controller.ts`
- `src/main/runtime/runtime-repository-settings-controller.ts`
- `src/main/runtime/runtime-repository-sparse-presets.ts`
- `src/main/runtime/runtime-resolved-worktree-cache.ts`
- `src/main/runtime/runtime-restored-orchestration-authority-sweep.ts`
- `src/main/runtime/runtime-review-command-surface.ts`
- `src/main/runtime/runtime-rpc/runtime-rpc-binary-routing.ts`
...
- `src/main/runtime/runtime-rpc/runtime-rpc-mobile-pairing.ts`
...
- `src/main/runtime/runtime-rpc/runtime-rpc-socket-metadata.ts`
...
- `src/main/runtime/runtime-rpc-device-revocation.test.ts`
...
- `src/main/runtime/runtime-rpc-mobile-method-allowlist-fixtures.ts`
- `src/main/runtime/runtime-rpc-mobile-terminal-streaming.test.ts`
- `src/main/runtime/runtime-rpc-mobile-ws-test-harness.ts`
- `src/main/runtime/runtime-rpc-orchestration-db-migration.test.ts`
- `src/main/runtime/runtime-rpc-pairing-mode-persistence.test.ts`
...
- `src/main/runtime/runtime-rpc-test-harness.ts`
...
- `src/main/runtime/runtime-rpc-worktree-store-fixtures.ts`
- `src/main/runtime/runtime-server-environment-commands.ts`
- `src/main/runtime/runtime-service-command-surface.ts`
- `src/main/runtime/runtime-skill-command-contract.ts`
- `src/main/runtime/runtime-skill-command-surface.ts`
- `src/main/runtime/runtime-skill-install-authority.test.ts`
- `src/main/runtime/runtime-skill-install-authority.ts`
- `src/main/runtime/runtime-skill-install-commands.test.ts`
- `src/main/runtime/runtime-skill-install-commands.ts`
- `src/main/runtime/runtime-skill-install-queries.test.ts`
- `src/main/runtime/runtime-skill-install-queries.ts`
- `src/main/runtime/runtime-skill-types.ts`
...
- `src/main/runtime/runtime-terminal-agent-status-query.ts`
- `src/main/runtime/runtime-terminal-contracts.ts`
- `src/main/runtime/runtime-terminal-driver-controller.ts`
- `src/main/runtime/runtime-terminal-idle-polls.ts`
- `src/main/runtime/runtime-terminal-list.ts`
- `src/main/runtime/runtime-terminal-orphan-adoption.ts`
...
- `src/main/runtime/runtime-terminal-spawn-push-target-materialization.test.ts`
- `src/main/runtime/runtime-terminal-spawn-push-target-materialization.ts`
- `src/main/runtime/runtime-terminal-state-records.ts`
- `src/main/runtime/runtime-terminal-stream-consumers.ts`
- `src/main/runtime/runtime-terminal-view-subscribers.ts`
- `src/main/runtime/runtime-terminal-visual-layout.ts`
- `src/main/runtime/runtime-terminal-wait.ts`
- `src/main/runtime/runtime-terminal-waiter-registry.ts`
- `src/main/runtime/runtime-terminal-writer.ts`
...
- `src/main/runtime/runtime-worktree-base-reconciliation.ts`
- `src/main/runtime/runtime-worktree-binding-index.ts`
- `src/main/runtime/runtime-worktree-create-git.ts`
- `src/main/runtime/runtime-worktree-drift-probe.ts`
- `src/main/runtime/runtime-worktree-filesystem.ts`
- `src/main/runtime/runtime-worktree-lifecycle-events.ts`
- `src/main/runtime/runtime-worktree-lineage-controller.ts`
- `src/main/runtime/runtime-worktree-lineage-recording.ts`
- `src/main/runtime/runtime-worktree-lineage-resolution.ts`
- `src/main/runtime/runtime-worktree-path-identity.ts`
- `src/main/runtime/runtime-worktree-ps-activity.ts`
- `src/main/runtime/runtime-worktree-ps-summaries.test.ts`
- `src/main/runtime/runtime-worktree-ps-summaries.ts`
- `src/main/runtime/runtime-worktree-removal-in-flight.ts`
- `src/main/runtime/runtime-worktree-removal-target.ts`
- `src/main/runtime/runtime-worktree-scan-cache.ts`
- `src/main/runtime/runtime-worktree-selection.ts`
- `src/main/runtime/runtime-worktree-startup-readiness.ts`
- `src/main/runtime/runtime-worktree-status-projection.ts`
- `src/main/runtime/runtime-worktree-summary-paths.ts`
- `src/main/runtime/runtime-worktree-terminal-provisioning.ts`
- `src/main/runtime/saved-structured-agent-session-restoration.test.ts`
- `src/main/runtime/saved-structured-agent-session-restoration.ts`
...
- `src/main/runtime/structured-agent-session-pty-binding.test.ts`
...
- `src/main/runtime/structured-tui-exit-proof.test.ts`
- `src/main/runtime/structured-tui-exit-proof.ts`
- `src/main/runtime/structured-tui-idle-evidence.test.ts`
- `src/main/runtime/structured-tui-idle-evidence.ts`
- `src/main/runtime/structured-tui-process-identity.test.ts`
- `src/main/runtime/structured-tui-process-identity.ts`
- `src/main/runtime/structured-tui-recovery-claim-match.test.ts`
- `src/main/runtime/structured-tui-recovery-claim-match.ts`
...
- `src/main/runtime/terminal-projection.test.ts`
- `src/main/runtime/terminal-pty-exit-waiter.test.ts`
- `src/main/runtime/terminal-send-payload.ts`
- `src/main/runtime/terminal-tail-buffer.ts`
- `src/main/runtime/terminal-tail-limits.ts`
- `src/main/runtime/terminal-tail-line-controls.ts`
- `src/main/runtime/terminal-tail-read.ts`
- `src/main/runtime/terminal-tail-redraw-buffer.ts`
- `src/main/runtime/terminal-tail-restore-seed.ts`
- `src/main/runtime/terminal-tail-state.ts`
- `src/main/runtime/terminal-viewport.ts`
- `src/main/runtime/terminal-wait-detection.ts`
- `src/main/runtime/terminal-wait-results.test.ts`
- `src/main/runtime/terminal-wait-results.ts`
- `src/main/runtime/terminal-wait-tail-state.ts`
- `src/main/runtime/workspace-session-worktree-id.ts`
- `src/main/runtime/worktree-browser-client-page-close.ts`
- `src/main/runtime/worktree-path-selector-wsl-posix.test.ts`
- `src/main/runtime/worktree-rm-id-selector-path-spelling.test.ts`
- `src/main/runtime/worktree-scan-admin-fingerprint-gate.test.ts`
- `src/main/runtime/worktree-terminal-mutation-lock.test.ts`
- `src/main/runtime/worktree-terminal-mutation-lock.ts`
- `src/main/serve-update-handoff.app-environment.test.ts`
...
- `src/main/shell-startup-identity-scanner.ts`
- `src/main/shell-startup-launch-intent-fixtures.ts`
...
- `src/main/shell-wrapper-content-address.ts`
- `src/main/shell-wrapper-file-writer.ts`
- `src/main/shell-wrapper-generated-file-snapshot.test.ts`
- `src/main/sidecar-snapshot-file.ts`
- `src/main/skills/agent-skill-selection.test.ts`
- `src/main/skills/agent-skill-selection.ts`
...
- `src/main/skills/skill-bundle-install-request-service.ts`
- `src/main/skills/skill-bundle-install-service.test.ts`
- `src/main/skills/skill-bundle-install-service.ts`
- `src/main/skills/skill-bundle-observability-summary.test.ts`
- `src/main/skills/skill-bundle-observability-summary.ts`
- `src/main/skills/skill-bundle-process-termination.integration.test.ts`
- `src/main/skills/skill-bundle-process-termination-child.test.ts`
- `src/main/skills/skill-bundle-ssh-relay-service.test.ts`
- `src/main/skills/skill-bundle-ssh-relay-service.ts`
- `src/main/skills/skill-candidate-concurrency.test.ts`
- `src/main/skills/skill-client-mediated-transfer.test.ts`
- `src/main/skills/skill-client-mediated-transfer.ts`
- `src/main/skills/skill-client-mediated-transfer-cancellation.test.ts`
- `src/main/skills/skill-cloud-auth.ts`
- `src/main/skills/skill-cloud-deadline.ts`
- `src/main/skills/skill-cloud-direct-upload.test.ts`
- `src/main/skills/skill-cloud-direct-upload.ts`
- `src/main/skills/skill-cloud-grant-installation.test.ts`
- `src/main/skills/skill-cloud-grant-installation.ts`
- `src/main/skills/skill-cloud-grant-version.ts`
- `src/main/skills/skill-cloud-install-target.test.ts`
- `src/main/skills/skill-cloud-install-target.ts`
- `src/main/skills/skill-cloud-request.test.ts`
- `src/main/skills/skill-cloud-request.ts`
- `src/main/skills/skill-cloud-service.test.ts`
- `src/main/skills/skill-cloud-service.ts`
- `src/main/skills/skill-delete/enumeration.ts`
- `src/main/skills/skill-delete/guards.ts`
- `src/main/skills/skill-delete/plan.test.ts`
- `src/main/skills/skill-delete/plan.ts`
- `src/main/skills/skill-delete/recovery.test.ts`
- `src/main/skills/skill-delete/recovery.ts`
- `src/main/skills/skill-delete/request-service.ts`
- `src/main/skills/skill-delete/roots.ts`
- `src/main/skills/skill-delete/service.test.ts`
- `src/main/skills/skill-delete/service.ts`
- `src/main/skills/skill-delete/staging.ts`
- `src/main/skills/skill-delete/staging-names.ts`
- `src/main/skills/skill-delete/staging-visibility.test.ts`
- `src/main/skills/skill-delete/wsl-enumeration-protocol.test.ts`
- `src/main/skills/skill-delete/wsl-enumeration-protocol.ts`
- `src/main/skills/skill-discovery-concurrency.test.ts`
- `src/main/skills/skill-discovery-target.test.ts`
- `src/main/skills/skill-discovery-wsl-script-roundtrip.test.ts`
- `src/main/skills/skill-extraction-recovery.ts`
- `src/main/skills/skill-filesystem-retry.ts`
- `src/main/skills/skill-install-destinations.test.ts`
- `src/main/skills/skill-install-destinations.ts`
- `src/main/skills/skill-install-discovery-verification.test.ts`
- `src/main/skills/skill-install-discovery-verification.ts`
- `src/main/skills/skill-install-filesystem.ts`
- `src/main/skills/skill-install-historical-provider-roots.ts`
- `src/main/skills/skill-install-journal-transition.ts`
- `src/main/skills/skill-install-lock.test.ts`
- `src/main/skills/skill-install-lock.ts`
- `src/main/skills/skill-install-lock-owner.ts`
- `src/main/skills/skill-install-lock-release.test.ts`
- `src/main/skills/skill-install-lock-release.ts`
- `src/main/skills/skill-install-management-service.test.ts`
- `src/main/skills/skill-install-management-service.ts`
- `src/main/skills/skill-install-operation-error.ts`
- `src/main/skills/skill-install-planner.ts`
- `src/main/skills/skill-install-progress-polling.ts`
- `src/main/skills/skill-install-provenance.test.ts`
- `src/main/skills/skill-install-provenance.ts`
- `src/main/skills/skill-install-recovery.test.ts`
- `src/main/skills/skill-install-recovery.ts`
- `src/main/skills/skill-install-request-service.test.ts`
- `src/main/skills/skill-install-request-service.ts`
- `src/main/skills/skill-install-service.test.ts`
- `src/main/skills/skill-install-service.ts`
- `src/main/skills/skill-install-transaction.test.ts`
- `src/main/skills/skill-install-transaction.ts`
- `src/main/skills/skill-install-transaction-result.ts`
- `src/main/skills/skill-operation-observability.test.ts`
- `src/main/skills/skill-operation-observability.ts`
- `src/main/skills/skill-package-creation.test.ts`
- `src/main/skills/skill-package-creation.ts`
- `src/main/skills/skill-package-deterministic-gzip.test.ts`
- `src/main/skills/skill-package-deterministic-gzip.ts`
- `src/main/skills/skill-package-download.test.ts`
- `src/main/skills/skill-package-download.ts`
- `src/main/skills/skill-package-download-availability.ts`
- `src/main/skills/skill-package-extraction.ts`
- `src/main/skills/skill-package-tar.test.ts`
- `src/main/skills/skill-package-tar.ts`
- `src/main/skills/skill-placement-alias-repair.test.ts`
- `src/main/skills/skill-placement-artifact-recovery.ts`
- `src/main/skills/skill-placement-copy.ts`
- `src/main/skills/skill-placement-copy-drift.test.ts`
- `src/main/skills/skill-placement-reconciliation.test.ts`
- `src/main/skills/skill-placement-reconciliation.ts`
- `src/main/skills/skill-placement-recovery-journal.ts`
- `src/main/skills/skill-placement-transaction.test.ts`
- `src/main/skills/skill-placement-transaction.ts`
- `src/main/skills/skill-placement-transaction-controller.ts`
- `src/main/skills/skill-process-contention.integration.test.ts`
- `src/main/skills/skill-process-contention-child.test.ts`
- `src/main/skills/skill-process-termination.integration.test.ts`
- `src/main/skills/skill-process-termination-child.test.ts`
- `src/main/skills/skill-provider-destinations.test.ts`
- `src/main/skills/skill-provider-destinations.ts`
- `src/main/skills/skill-provider-runtime-roots.test.ts`
- `src/main/skills/skill-provider-runtime-roots.ts`
- `src/main/skills/skill-remote-error-category-parity.test.ts`
- `src/main/skills/skill-remote-install-cancellation.test.ts`
- `src/main/skills/skill-remote-install-cancellation.ts`
- `src/main/skills/skill-remote-install-service.test.ts`
- `src/main/skills/skill-remote-install-service.ts`
- `src/main/skills/skill-removable-placement.ts`
- `src/main/skills/skill-remove-recovery.ts`
- `src/main/skills/skill-remove-transaction.test.ts`
- `src/main/skills/skill-remove-transaction.ts`
- `src/main/skills/skill-root-file-walk.test.ts`
- `src/main/skills/skill-root-file-walk.ts`
- `src/main/skills/skill-runtime-capability.test.ts`
- `src/main/skills/skill-runtime-capability.ts`
- `src/main/skills/skill-scan-coalescer.test.ts`
- `src/main/skills/skill-scan-coalescer.ts`
- `src/main/skills/skill-share-preparation-service.test.ts`
- `src/main/skills/skill-share-preparation-service.ts`
- `src/main/skills/skill-ssh-package-transfer.ts`
- `src/main/skills/skill-ssh-relay-client.ts`
- `src/main/skills/skill-ssh-relay-destination.ts`
- `src/main/skills/skill-ssh-relay-service.test.ts`
- `src/main/skills/skill-ssh-relay-service.ts`
- `src/main/skills/skill-transaction-recovery-observability.ts`
- `src/main/skills/skill-transaction-startup-recovery.test.ts`
- `src/main/skills/skill-transaction-startup-recovery.ts`
- `src/main/skills/skill-transfer-rpc-retry.ts`
- `src/main/skills/skill-upload-archive-hash.ts`
- `src/main/skills/skill-upload-operation-lifecycle.ts`
...
- `src/main/skills/skill-upload-retained-paths.ts`
- `src/main/skills/skill-upload-session-admission-regression.test.ts`
- `src/main/skills/skill-upload-session-record.ts`
- `src/main/skills/skill-upload-session-service.test.ts`
- `src/main/skills/skill-upload-session-service.ts`
- `src/main/skills/skill-upload-session-service-options.ts`
...
- `src/main/skills/skill-wsl-install-filesystem.test.ts`
...
- `src/main/skills/skill-wsl-provider-detection.test.ts`
- `src/main/skills/skill-wsl-provider-detection.ts`
- `src/main/source-control/hosted-review-base-ref-suffix.test.ts`
- `src/main/source-control/hosted-review-creation-blocking.ts`
...
- `src/main/source-control/stacked-hosted-review-creation.test.ts`
- `src/main/source-control/stacked-hosted-review-creation.ts`
- `src/main/speech/speech-model-download-cleanup.ts`
- `src/main/speech/speech-model-download-response.test.ts`
- `src/main/speech/speech-model-download-response.ts`
- `src/main/speech/speech-model-download-transport.ts`
- `src/main/speech/speech-model-http-download.ts`
- `src/main/speech/stt-session-start.ts`
- `src/main/speech/stt-session-state.ts`
- `src/main/speech/stt-session-stop.ts`
- `src/main/speech/stt-session-timeouts.ts`
- `src/main/speech/stt-worker-paths.ts`
- `src/main/speech/stt-worker-startup.ts`
- `src/main/speech/stt-worker-stop.ts`
- `src/main/sqlite/sqlite-read-failure.test.ts`
- `src/main/sqlite/sqlite-read-failure.ts`
- `src/main/ssh/__tests__/ssh-connection-test-client.ts`
- `src/main/ssh/build-toolchain-diagnosis.ts`
- `src/main/ssh/orcad-activation-gate.test.ts`
- `src/main/ssh/orcad-activation-gate.ts`
- `src/main/ssh/orcad-activation-record.test.ts`
- `src/main/ssh/orcad-activation-record.ts`
- `src/main/ssh/orcad-activation-record-store.ts`
- `src/main/ssh/orcad-local-build-hash.ts`
- `src/main/ssh/orcad-remote-deploy.test.ts`
- `src/main/ssh/orcad-remote-deploy.ts`
- `src/main/ssh/orcad-remote-gc.test.ts`
- `src/main/ssh/orcad-remote-gc.ts`
- `src/main/ssh/orcad-remote-host-support.ts`
- `src/main/ssh/orcad-remote-launch.test.ts`
- `src/main/ssh/orcad-remote-launch.ts`
- `src/main/ssh/orcad-remote-process-control.ts`
- `src/main/ssh/orcad-remote-rollback.test.ts`
- `src/main/ssh/orcad-remote-rollback.ts`
- `src/main/ssh/orcad-remote-shell-commands.integration.test.ts`
- `src/main/ssh/orcad-state-snapshot.test.ts`
- `src/main/ssh/orcad-state-snapshot.ts`
- `src/main/ssh/orcad-update-plan.test.ts`
- `src/main/ssh/orcad-update-plan.ts`
- `src/main/ssh/relay-native-dependency-coverage.test.ts`
- `src/main/ssh/remote-install-coexistence.test.ts`
- `src/main/ssh/remote-install-coexistence.ts`
- `src/main/ssh/remote-install-gc.ts`
- `src/main/ssh/remote-install-model.test.ts`
- `src/main/ssh/remote-install-model.ts`
- `src/main/ssh/removed-ssh-target-tombstone-retention.test.ts`
- `src/main/ssh/removed-ssh-target-tombstone-retention.ts`
- `src/main/ssh/ssh-connection-auth-fallback.test.ts`
- `src/main/ssh/ssh-connection-channel-open.test.ts`
- `src/main/ssh/ssh-connection-direct-startup.test.ts`
- `src/main/ssh/ssh-connection-file-transfer.test.ts`
- `src/main/ssh/ssh-connection-github-probe.test.ts`
- `src/main/ssh/ssh-connection-gssapi-fallback.test.ts`
- `src/main/ssh/ssh-connection-host-key-store-wiring.test.ts`
- `src/main/ssh/ssh-connection-host-key-verification.test.ts`
- `src/main/ssh/ssh-connection-manager-registry.test.ts`
- `src/main/ssh/ssh-connection-reconnect-ladder.test.ts`
- `src/main/ssh/ssh-connection-system-transport.test.ts`
- `src/main/ssh/ssh-connection-test-fixtures.ts`
- `src/main/ssh/ssh-connection-test-harness.ts`
- `src/main/ssh/ssh-file-stream-read-cap.ts`
- `src/main/ssh/ssh-host-key-decision.test.ts`
- `src/main/ssh/ssh-host-key-decision.ts`
- `src/main/ssh/ssh-host-key-store.test.ts`
- `src/main/ssh/ssh-host-key-store.ts`
- `src/main/ssh/ssh-host-key-verifier.test.ts`
- `src/main/ssh/ssh-host-key-verifier.ts`
- `src/main/ssh/ssh-known-hosts.test.ts`
- `src/main/ssh/ssh-known-hosts.ts`
- `src/main/ssh/ssh-known-hosts-source.test.ts`
- `src/main/ssh/ssh-known-hosts-source.ts`
- `src/main/ssh/ssh-pending-pty-kill-replay.test.ts`
- `src/main/ssh/ssh-pending-pty-kill-replay.ts`
...
- `src/main/ssh/ssh-relay-native-deps-cache.test.ts`
- `src/main/ssh/ssh-relay-native-deps-cache.ts`
- `src/main/ssh/ssh-relay-native-deps-cache-commands.ts`
- `src/main/ssh/ssh-relay-native-deps-cache-deploy.test.ts`
- `src/main/ssh/ssh-relay-native-deps-cache-gc.ts`
- `src/main/ssh/ssh-relay-native-deps-cache-install.ts`
- `src/main/ssh/ssh-relay-native-deps-cache-shell.test.ts`
- `src/main/ssh/ssh-relay-native-deps-probe-verdict.test.ts`
- `src/main/ssh/ssh-relay-node-pty-repair.test.ts`
- `src/main/ssh/ssh-relay-node-pty-repair.ts`
- `src/main/ssh/ssh-relay-node-pty-spawn-repair.test.ts`
- `src/main/ssh/ssh-relay-pty-master-cloexec-install.test.ts`
- `src/main/ssh/ssh-relay-session-pending-kill-replay.test.ts`
- `src/main/ssh/ssh-relay-superseded-endpoints.test.ts`
- `src/main/ssh/ssh-relay-superseded-endpoints.ts`
- `src/main/ssh/ssh-remote-cli-terminal-host-scope.test.ts`
- `src/main/ssh/ssh-remote-linear-truncation-output.test.ts`
- `src/main/ssh/ssh-remote-windows-command-line-limit.test.ts`
- `src/main/ssh/ssh-target-identity.ts`
...
- `src/main/star-nag/service-direct-star.test.ts`
- `src/main/star-nag/service-force-show-races.test.ts`
- `src/main/star-nag/service-outcome-telemetry.test.ts`
- `src/main/star-nag/service-prompt-moments.test.ts`
- `src/main/star-nag/service-test-harness.ts`
- `src/main/star-nag/service-threshold-prompt.test.ts`
- `src/main/startup/branch-rename-hook.ts`
- `src/main/startup/cli-command-names.ts`
- `src/main/startup/cli-launch-redirect.test.ts`
- `src/main/startup/cli-launch-redirect.ts`
- `src/main/startup/codex-launch-preparation.ts`
- `src/main/startup/codex-session-resume-launch.ts`
- `src/main/startup/disabled-chromium-features.ts`
- `src/main/startup/gpu-lifecycle.ts`
- `src/main/startup/headless-pty-hydration-ordering.test.ts`
- `src/main/startup/host-port-bootstrap-wiring.test.ts`
- `src/main/startup/login-shell-environment.test.ts`
- `src/main/startup/login-shell-environment.ts`
- `src/main/startup/main-process-account-services.ts`
- `src/main/startup/main-process-automations.ts`
- `src/main/startup/main-process-i18n-menu.ts`
- `src/main/startup/main-process-ipc-bootstrap.ts`
...
- `src/main/startup/main-process-pty-startup.ts`
...
- `src/main/startup/main-process-serve.ts`
...
- `src/main/startup/main-window-lifecycle-flags.ts`
- `src/main/startup/main-window-service-readiness.ts`
- `src/main/startup/os-opened-markdown-delivery.test.ts`
- `src/main/startup/os-opened-markdown-files.test.ts`
- `src/main/startup/os-opened-markdown-files.ts`
- `src/main/startup/os-opened-markdown-wiring.test.ts`
- `src/main/startup/secret-protection-report-deferral-wiring.test.ts`
- `src/main/startup/secure-dns-census.test.ts`
- `src/main/startup/serve-options.test.ts`
- `src/main/startup/serve-options.ts`
- `src/main/startup/serve-signal-handlers.test.ts`
- `src/main/startup/serve-signal-handlers.ts`
- `src/main/startup/skill-share-deep-link-state.test.ts`
- `src/main/startup/skill-share-deep-link-state.ts`
- `src/main/startup/synthetic-title-runtime.ts`
- `src/main/startup/web-contents-timed-flag.ts`
- `src/main/startup/windows-desktop-shell-path-startup.test.ts`
- `src/main/startup/windows-desktop-shell-path-startup.ts`
- `src/main/startup/windows-install-dir-acl.test-fixture.ts`
- `src/main/startup/windows-install-dir-acl-probe.test.ts`
...
- `src/main/startup/windows-shell-path-ownership.test.ts`
...
- `src/main/stats/stats-title-detection-independence.test.ts`
- `src/main/terminal-history-fish-session.node-pty.test.ts`
- `src/main/terminal-history-id.ts`
- `src/main/text-generation/commit-message-command-backslash-mode.test.ts`
- `src/main/text-generation/commit-message-model-discovery.ts`
- `src/main/text-generation/commit-message-model-discovery-policy.ts`
- `src/main/text-generation/commit-message-text-generation-branch-name.test.ts`
- `src/main/text-generation/commit-message-text-generation-cancellation.test.ts`
- `src/main/text-generation/commit-message-text-generation-failure-sanitization.test.ts`
- `src/main/text-generation/commit-message-text-generation-generated-output.test.ts`
- `src/main/text-generation/commit-message-text-generation-linked-issue.test.ts`
- `src/main/text-generation/commit-message-text-generation-local-subprocess.test.ts`
...
- `src/main/text-generation/commit-message-text-generation-remote-execution.test.ts`
- `src/main/text-generation/commit-message-text-generation-settings.test.ts`
- `src/main/text-generation/commit-message-text-generation-test-harness.ts`
- `src/main/text-generation/pull-request-remote-ref-probes.ts`
- `src/main/text-generation/source-control-agent-failure.ts`
- `src/main/text-generation/source-control-agent-launch.ts`
- `src/main/text-generation/source-control-generation-lanes.ts`
- `src/main/text-generation/source-control-generation-limits.ts`
- `src/main/text-generation/source-control-local-generation.ts`
- `src/main/text-generation/source-control-local-process.ts`
- `src/main/text-generation/source-control-remote-generation.ts`
- `src/main/text-generation/source-control-text-generation-requests.ts`
- `src/main/text-generation/source-control-text-generation-types.ts`
- `src/main/updater.build-channel-selection.test.ts`
- `src/main/updater.check-preflight.test.ts`
- `src/main/updater.check-settlement.test.ts`
- `src/main/updater.linux-externally-managed.test.ts`
- `src/main/updater.linux-root-package-install.test.ts`
- `src/main/updater.nudge-campaign.test.ts`
- `src/main/updater.prerelease-fallback.test.ts`
...
- `src/main/updater/updater-build-selection.ts`
- `src/main/updater/updater-check-failure.ts`
- `src/main/updater/updater-check-state.ts`
- `src/main/updater/updater-download-install.ts`
- `src/main/updater/updater-install-execution.ts`
- `src/main/updater/updater-install-support.ts`
- `src/main/updater/updater-menu-checks.ts`
- `src/main/updater/updater-nudge.ts`
- `src/main/updater/updater-package-recovery.ts`
- `src/main/updater/updater-release-feed.ts`
- `src/main/updater/updater-remote-status.ts`
- `src/main/updater/updater-scheduling.ts`
- `src/main/updater/updater-setup.ts`
- `src/main/updater/updater-state.ts`
- `src/main/updater/updater-status.ts`
- `src/main/updater/updater-types.ts`
- `src/main/updater-net-request.fixture.ts`
- `src/main/updater-test-harness.leaked-timers.test.ts`
- `src/main/updater-test-harness.ts`
- `src/main/updater-test-module-loader.test.ts`
- `src/main/updater-test-module-loader.ts`
- `src/main/updater-test-timer-tracking.ts`
- `src/main/window/clipboard-remote-file-cleanup.bench.test.ts`
- `src/main/window/clipboard-remote-file-copy.test.ts`
- `src/main/window/clipboard-remote-file-staging.test.ts`
- `src/main/window/clipboard-remote-file-staging.ts`
- `src/main/window/clipboard-remote-file-staging-fs.test.ts`
- `src/main/window/createMainWindow-close-confirmation.test.ts`
- `src/main/window/createMainWindow-markdown-editor-focus.test.ts`
- `src/main/window/createMainWindow-renderer-crash-recovery.test.ts`
- `src/main/window/createMainWindow-startup-reveal.test.ts`
- `src/main/window/createMainWindow-system-resume-relay.test.ts`
- `src/main/window/createMainWindow-terminal-focus-shortcuts.test.ts`
- `src/main/window/createMainWindow-test-harness.ts`
- `src/main/window/createMainWindow-tray-minimize-close.test.ts`
- `src/main/window/createMainWindow-zoom-and-tab-switch-shortcuts.test.ts`
...
- `src/main/window/history-gc-profile-worktree-ids.ts`
...
- `src/main/window/main-window-shortcut-actions.ts`
- `src/main/window/main-window-shortcut-routing.ts`
- `src/main/window/main-window-state-lifecycle.ts`
- `src/main/window/main-window-updater.ts`
- `src/main/window/main-window-visual-lifecycle.ts`
...
- `src/main/window/renderer-document-navigation.ts`
...
- `src/main/window/runtime-renderer-notification-sender.ts`
- `src/main/window/runtime-window-lifecycle.ts`
- `src/main/window/session-tab-close-request-relay.test.ts`
- `src/main/window/session-tab-close-request-relay.ts`
- `src/main/windows/windows-host-job.win32.test.ts`
- `src/main/windows/windows-process-table.test.ts`
- `src/main/windows/windows-process-table.ts`
- `src/main/windows/windows-process-table-cim-scan.test.ts`
...
- `src/main/workspace-cleanup-removal-snapshot-prune.test.ts`
- `src/main/workspace-cleanup-removal-snapshot-prune.ts`
- `src/main/workspace-cleanup-scan-snapshot.test.ts`
- `src/main/workspace-cleanup-scan-snapshot.ts`
- `src/main/workspace-snapshot-prune-index.ts`
- `src/main/workspace-snapshot-pruning.bench.test.ts`
- `src/main/workspace-space-analysis-snapshot.test.ts`
- `src/main/workspace-space-analysis-snapshot.ts`
- `src/main/workspace-space-local-scan.ts`
- `src/main/workspace-space-remote-scan.ts`
- `src/main/workspace-space-repo-scan.test.ts`
- `src/main/workspace-space-repo-scan.ts`
- `src/main/workspace-space-scan-control.test.ts`
- `src/main/workspace-space-scan-control.ts`
- `src/main/workspace-space-worktree-row.ts`
- `src/main/worktree-create-base-prefetch.test.ts`
- `src/main/worktree-create-candidates.test.ts`
- `src/main/worktree-create-preparation.test.ts`
- `src/main/worktree-create-preparation.ts`
- `src/main/worktree-create-preparation-burst.ts`
- `src/main/worktree-create-preparation-claim.test.ts`
- `src/main/worktree-create-preparation-claim.ts`
- `src/main/worktree-create-preparation-pool.ts`
- `src/main/worktree-create-preparation-stale-cleanup.ts`
- `src/main/worktree-create-preparation-wsl-root.test.ts`
- `src/main/worktree-history-file-path.ts`
- `src/main/worktree-identity-persistence.test.ts`
- `src/main/worktree-metadata-ownership.test.ts`
- `src/main/worktree-metadata-ownership.ts`
- `src/main/worktree-name-retirement.test.ts`
- `src/main/worktree-name-retirement.ts`
- `src/main/worktree-preparation-discard-retry.ts`
- `src/main/worktree-removal-repo-owner.test.ts`
- `src/main/worktree-removal-repo-owner.ts`
- `src/main/worktree-retention-path-comparison.ts`
- `src/main/worktree-retirement-backfill-scan.test.ts`
- `src/main/worktree-retirement-backfill-scan.ts`
- `src/main/worktree-retirement-backfill-stall.test.ts`
- `src/main/worktree-retirement-discovery.test.ts`
- `src/main/worktree-retirement-discovery.ts`
- `src/main/worktree-retirement-discovery-wsl.test.ts`
- `src/main/worktree-retirement-namespace.test.ts`
- `src/main/worktree-retirement-namespace.ts`
- `src/main/worktree-runner-script.ts`
- `src/main/wsl/__fixtures__/wsl-invocation-allowlist.txt`
- `src/main/wsl/__fixtures__/wsl-probe-failure-swallow-allowlist.txt`
- `src/main/wsl/wsl-executable-path.ts`
...
- `src/main/wsl/wsl-probe-failure-semantics.test.ts`
...
- `src/main/wsl-distro-list-single-flight.test.ts`
- `src/main/wsl-fish-history-cleanup.test.ts`
- `src/main/wsl-fish-history-cleanup.ts`
- `src/main/wsl-interop-spawn-directory.test.ts`
- `src/main/wsl-interop-spawn-directory.ts`
- `src/main/wsl-running-distro-cache.ts`
- `src/main/wsl-running-distros.test.ts`
...
- `src/main/zsh-user-config-dir-fixture.ts`
- `src/main/zsh-wrapper-dir-ownership.ts`
...
- `src/preload/api/agent-hook-api.ts`
- `src/preload/api/agent-skill-api.ts`
- `src/preload/api/agent-status-api.ts`
- `src/preload/api/agent-status-bridge.ts`
- `src/preload/api/agent-trust-bridge.ts`
- `src/preload/api/agent-usage-api.ts`
- `src/preload/api/ai-vault-api.ts`
- `src/preload/api/ai-vault-bridge.ts`
- `src/preload/api/app-api.ts`
- `src/preload/api/app-bridge.ts`
- `src/preload/api/automation-api.ts`
- `src/preload/api/automations-bridge.ts`
- `src/preload/api/bitbucket-bridge.ts`
- `src/preload/api/browser-api.ts`
- `src/preload/api/browser-bridge.ts`
- `src/preload/api/browser-bridge-guest-registration-and-downloads.ts`
- `src/preload/api/browser-bridge-page-interaction-and-sessions.ts`
- `src/preload/api/cache-bridge.ts`
- `src/preload/api/claude-accounts-bridge.ts`
- `src/preload/api/claude-usage-bridge.ts`
- `src/preload/api/cli-bridge.ts`
- `src/preload/api/cli-install-api.ts`
- `src/preload/api/codex-accounts-bridge.ts`
- `src/preload/api/codex-config-sync-bridge.ts`
- `src/preload/api/codex-usage-bridge.ts`
- `src/preload/api/computer-use-permissions-bridge.ts`
- `src/preload/api/crash-report-api.ts`
- `src/preload/api/crash-reports-bridge.ts`
- `src/preload/api/dashboard-api.ts`
- `src/preload/api/dashboard-bridge.ts`
- `src/preload/api/developer-permissions-bridge.ts`
- `src/preload/api/diagnostics-bridge.ts`
- `src/preload/api/doc-preview-api.ts`
- `src/preload/api/doc-preview-bridge.ts`
- `src/preload/api/e2e-bridge.ts`
- `src/preload/api/emulator-api.ts`
- `src/preload/api/emulator-bridge.ts`
- `src/preload/api/ephemeral-vm-api.ts`
- `src/preload/api/ephemeral-vm-bridge.ts`
- `src/preload/api/export-bridge.ts`
- `src/preload/api/feedback-bridge.ts`
- `src/preload/api/filesystem-api.ts`
- `src/preload/api/folder-workspaces-bridge.ts`
- `src/preload/api/fs-bridge.ts`
- `src/preload/api/gh-bridge.ts`
- `src/preload/api/gh-bridge-mutations-and-projects.ts`
- `src/preload/api/gh-bridge-pull-requests-and-work-items.ts`
- `src/preload/api/git-bash-bridge.ts`
- `src/preload/api/git-bridge.ts`
- `src/preload/api/github-pull-request-api.ts`
- `src/preload/api/github-work-item-api.ts`
- `src/preload/api/git-inspection-api.ts`
- `src/preload/api/gitlab-api.ts`
- `src/preload/api/git-operation-api.ts`
- `src/preload/api/gl-bridge.ts`
- `src/preload/api/grok-accounts-bridge.ts`
- `src/preload/api/hooks-bridge.ts`
- `src/preload/api/hosted-review-api.ts`
- `src/preload/api/hosted-review-bridge.ts`
- `src/preload/api/jira-api.ts`
- `src/preload/api/jira-bridge.ts`
- `src/preload/api/keybindings-bridge.ts`
- `src/preload/api/linear-api.ts`
- `src/preload/api/linear-bridge.ts`
- `src/preload/api/localhost-worktree-labels-bridge.ts`
- `src/preload/api/macos-tcc-prompts-bridge.ts`
- `src/preload/api/memory-bridge.ts`
- `src/preload/api/minimax-credentials-bridge.ts`
- `src/preload/api/mobile-api.ts`
- `src/preload/api/mobile-bridge.ts`
- `src/preload/api/native-chat-api.ts`
- `src/preload/api/native-chat-bridge.ts`
- `src/preload/api/notebook-bridge.ts`
- `src/preload/api/notifications-bridge.ts`
- `src/preload/api/onboarding-api.ts`
- `src/preload/api/onboarding-bridge.ts`
- `src/preload/api/open-code-usage-bridge.ts`
- `src/preload/api/orca-profile-api.ts`
- `src/preload/api/orca-profiles-bridge.ts`
- `src/preload/api/os-permission-api.ts`
- `src/preload/api/pet-api.ts`
- `src/preload/api/pet-bridge.ts`
- `src/preload/api/platform-bridge.ts`
- `src/preload/api/plugin-host-api.ts`
- `src/preload/api/plugins-bridge.ts`
- `src/preload/api/preflight-api.ts`
- `src/preload/api/preflight-bridge.ts`
- `src/preload/api/project-groups-bridge.ts`
- `src/preload/api/projects-bridge.ts`
...
- `src/preload/api/pty-management-api.ts`
- `src/preload/api/pwsh-bridge.ts`
- `src/preload/api/rate-limits-bridge.ts`
- `src/preload/api/remote-workspace-bridge.ts`
- `src/preload/api/repos-bridge.ts`
- `src/preload/api/repository-api.ts`
- `src/preload/api/runtime-api.ts`
- `src/preload/api/runtime-bridge.ts`
- `src/preload/api/runtime-environments-bridge.ts`
- `src/preload/api/session-bridge.ts`
- `src/preload/api/settings-api.ts`
- `src/preload/api/settings-bridge.ts`
- `src/preload/api/shell-api.ts`
- `src/preload/api/shell-bridge.ts`
- `src/preload/api/skills-bridge.ts`
- `src/preload/api/sparse-presets-bridge.ts`
- `src/preload/api/speech-api.ts`
- `src/preload/api/speech-bridge.ts`
- `src/preload/api/ssh-api.ts`
- `src/preload/api/ssh-bridge.ts`
- `src/preload/api/star-nag-bridge.ts`
- `src/preload/api/stats-bridge.ts`
- `src/preload/api/telemetry-api.ts`
- `src/preload/api/terminal-preview-bridge.ts`
- `src/preload/api/ui-bridge.ts`
- `src/preload/api/ui-bridge-clipboard-and-window-controls.ts`
- `src/preload/api/ui-bridge-state-and-menu-commands.ts`
- `src/preload/api/ui-bridge-tab-and-browser-commands.ts`
- `src/preload/api/ui-bridge-terminal-and-session-tabs.ts`
- `src/preload/api/ui-command-event-api.ts`
- `src/preload/api/ui-window-api.ts`
- `src/preload/api/updater-api.ts`
- `src/preload/api/updater-bridge.ts`
- `src/preload/api/workspace-cleanup-api.ts`
- `src/preload/api/workspace-cleanup-bridge.ts`
- `src/preload/api/workspace-port-api.ts`
- `src/preload/api/workspace-ports-bridge.ts`
- `src/preload/api/workspace-session-api.ts`
- `src/preload/api/workspace-space-bridge.ts`
- `src/preload/api/worktree-api.ts`
- `src/preload/api/worktrees-bridge.ts`
- `src/preload/api/wsl-bridge.ts`
...
- `src/preload/doc-preview-link.ts`
- `src/preload/doc-preview-link-interception.test.ts`
- `src/preload/doc-preview-link-interception.ts`
...
- `src/relay/agent-hook-cached-pane-status.ts`
- `src/relay/agent-hook-endpoint-coordinates.ts`
- `src/relay/agent-hook-envelope-build.ts`
- `src/relay/agent-hook-result-retry-scheduler.ts`
- `src/relay/agent-hook-retired-pane-suppression.test.ts`
- `src/relay/dispatcher-capacity-signals.ts`
- `src/relay/dispatcher-client-lifecycle.ts`
- `src/relay/dispatcher-client-state.ts`
- `src/relay/dispatcher-contract.ts`
- `src/relay/dispatcher-frame-codec.ts`
- `src/relay/dispatcher-notification-ownership.test.ts`
- `src/relay/dispatcher-notification-publication.ts`
- `src/relay/dispatcher-producer-capacity.ts`
- `src/relay/dispatcher-producer-transport.ts`
- `src/relay/dispatcher-pty-publication.ts`
- `src/relay/dispatcher-rpc-routing.ts`
- `src/relay/dispatcher-structured-error.test.ts`
- `src/relay/external-automation-command-executor.ts`
- `src/relay/external-automation-provider.ts`
- `src/relay/external-automation-provider-catalog.test.ts`
- `src/relay/external-automation-provider-catalog.ts`
- `src/relay/external-automation-storage-paths.ts`
- `src/relay/fs-handler-doc-preview.test.ts`
- `src/relay/fs-handler-file-range.test.ts`
- `src/relay/fs-handler-file-range.ts`
- `src/relay/fs-handler-file-range-dispatch.test.ts`
- `src/relay/fs-list-files-fallback-chain.ts`
- `src/relay/fs-list-files-large-response.integration.test.ts`
- `src/relay/fs-path-metadata-requests.test.ts`
- `src/relay/fs-path-metadata-requests.ts`
- `src/relay/fs-path-mutation-requests.ts`
- `src/relay/git-handler-command-termination.ts`
- `src/relay/git-handler-comparison-operations.ts`
- `src/relay/git-handler-diff-read-coalescing.test.ts`
- `src/relay/git-handler-discard-operations.ts`
- `src/relay/git-handler-exec-operations.ts`
- `src/relay/git-handler-fetch-operations.ts`
- `src/relay/git-handler-file-diff.test.ts`
- `src/relay/git-handler-fork-remote-exec.test.ts`
- `src/relay/git-handler-object-diff-operations.ts`
- `src/relay/git-handler-operation-context.ts`
- `src/relay/git-handler-operation-set.ts`
- `src/relay/git-handler-read-operations.ts`
- `src/relay/git-handler-registration.ts`
- `src/relay/git-handler-remote-sync.test.ts`
- `src/relay/git-handler-sync-operations.ts`
- `src/relay/git-handler-termination.test.ts`
- `src/relay/git-handler-test-harness.ts`
- `src/relay/git-handler-working-tree-changes.test.ts`
- `src/relay/git-handler-worktree-change-operations.ts`
- `src/relay/git-handler-worktree-inspection.test.ts`
- `src/relay/git-handler-worktree-list-authority.test.ts`
- `src/relay/git-handler-worktree-operations.ts`
- `src/relay/git-handler-worktree-provisioning.test.ts`
- `src/relay/hermes-output-run-files.ts`
- `src/relay/hermes-run-correlation.test.ts`
- `src/relay/hermes-run-correlation.ts`
- `src/relay/hermes-run-history.test.ts`
- `src/relay/hermes-run-history.ts`
- `src/relay/hermes-session-run-database.ts`
- `src/relay/node-pty-binding-survey.test.ts`
- `src/relay/node-pty-binding-survey.ts`
- `src/relay/node-pty-unavailable-diagnosis.test.ts`
- `src/relay/node-pty-unavailable-diagnosis.ts`
- `src/relay/pty-handler-attach-replay.test.ts`
- `src/relay/pty-handler-dispose-lifecycle.test.ts`
- `src/relay/pty-handler-grace-timer.test.ts`
- `src/relay/pty-handler-inventory-process-evidence.test.ts`
- `src/relay/pty-handler-output-streaming.test.ts`
- `src/relay/pty-handler-retired-pane-surface.test.ts`
- `src/relay/pty-handler-revive.test.ts`
- `src/relay/pty-handler-shell-resolution.test.ts`
...
- `src/relay/pty-handler-test-harness.ts`
- `src/relay/pty-shell-overlay-wrappers.ts`
- `src/relay/pty-source-credit-retention.ts`
- `src/relay/pty-source-sent-boundaries.test.ts`
- `src/relay/pty-source-sent-boundaries.ts`
- `src/relay/relay-agent-hook-runtime.ts`
- `src/relay/relay-connect-channel.ts`
...
- `src/relay/relay-launch-options.ts`
- `src/relay/relay-orca-cli-channel.ts`
- `src/relay/relay-primary-channel.ts`
- `src/relay/relay-pty-source-superseded-activation.test.ts`
- `src/relay/relay-reconnect-listener.ts`
- `src/relay/relay-runtime-services.ts`
- `src/relay/relay-socket-ownership.ts`
- `src/relay/retired-pane-surfaces.test.ts`
- `src/relay/retired-pane-surfaces.ts`
- `src/relay/skill-install-handler.test.ts`
- `src/relay/skill-install-handler.ts`
- `src/relay/skill-upload-multi-relay.integration.test.ts`
- `src/relay/terminal-history.test.ts`
- `src/relay/terminal-history.ts`
- `src/relay/terminal-history-wsl.test.ts`
- `src/relay/wsl-browser-network-relay.ts`
- `src/renderer/src/app-shell/AppBackgroundServices.tsx`
- `src/renderer/src/app-shell/app-command-handlers.ts`
- `src/renderer/src/app-shell/app-command-handlers-workspace-delete.test.ts`
- `src/renderer/src/app-shell/AppRootSurfaces.tsx`
- `src/renderer/src/app-shell/app-root-surface-settings.test.tsx`
- `src/renderer/src/app-shell/app-root-surface-settings.ts`
- `src/renderer/src/app-shell/app-window-chrome.ts`
- `src/renderer/src/app-shell/AppWorkspaceShell.tsx`
- `src/renderer/src/app-shell/reconcile-hydrated-workspace-tab-models.test.ts`
- `src/renderer/src/app-shell/reconcile-hydrated-workspace-tab-models.ts`
- `src/renderer/src/app-shell/remote-workspace-unplaced-upload-suppression.test.tsx`
- `src/renderer/src/app-shell/shutdown-checkpoint-persist.test.ts`
- `src/renderer/src/app-shell/shutdown-checkpoint-persist.ts`
- `src/renderer/src/app-shell/shutdown-checkpoint-restart-lifecycle.test.ts`
...
- `src/renderer/src/app-shell/TitlebarMainStrip.tsx`
- `src/renderer/src/app-shell/use-app-chrome-layout.ts`
- `src/renderer/src/app-shell/use-app-session-persistence.ts`
- `src/renderer/src/app-shell/use-app-shell-services.ts`
- `src/renderer/src/app-shell/use-app-startup-actions.ts`
- `src/renderer/src/app-shell/use-app-startup-hydration.ts`
- `src/renderer/src/app-shell/use-document-appearance.test.tsx`
- `src/renderer/src/app-shell/use-document-appearance.ts`
...
- `src/renderer/src/app-shell/use-runtime-graph-sync.ts`
- `src/renderer/src/app-shell/use-window-visibility-effects.ts`
- `src/renderer/src/app-shell/WindowControls.tsx`
- `src/renderer/src/app-shell/window-visibility-actions-selector.test.ts`
- `src/renderer/src/app-shell/window-visibility-actions-selector.ts`
- `src/renderer/src/app-shell/workspace-view-cross-client-sync.test.tsx`
- `src/renderer/src/components/activity/activity-auto-mark-read-loop.react185.test.tsx`
- `src/renderer/src/components/activity/activity-event-builder.ts`
- `src/renderer/src/components/activity/activity-event-cap.ts`
- `src/renderer/src/components/activity/activity-filter-focus-shortcut.ts`
- `src/renderer/src/components/activity/ActivityPrototypePage.filter-focus-shortcut.test.ts`
- `src/renderer/src/components/activity/ActivityPrototypePage.thread-grouping.test.ts`
...
- `src/renderer/src/components/activity/activity-terminal-portal-status.ts`
...
- `src/renderer/src/components/activity/activity-thread-controls.tsx`
- `src/renderer/src/components/activity/activity-thread-detail-pane.tsx`
...
- `src/renderer/src/components/AgentQuestionIcon.tsx`
- `src/renderer/src/components/artifacts/ArtifactDetailDrawer.tsx`
- `src/renderer/src/components/artifacts/artifact-display-labels.test.ts`
- `src/renderer/src/components/artifacts/ArtifactListRows.tsx`
- `src/renderer/src/components/artifacts/artifact-list-search.test.ts`
- `src/renderer/src/components/artifacts/artifact-list-search.ts`
- `src/renderer/src/components/artifacts/ArtifactListSearchField.tsx`
- `src/renderer/src/components/artifacts/ArtifactListTableHeader.tsx`
- `src/renderer/src/components/artifacts/ArtifactListToolbar.tsx`
- `src/renderer/src/components/artifacts/ArtifactsPageSkeleton.tsx`
- `src/renderer/src/components/artifacts/ArtifactsPageStates.tsx`
- `src/renderer/src/components/artifacts/artifacts-table-layout.ts`
- `src/renderer/src/components/automations/automation-authority-identity.test.ts`
- `src/renderer/src/components/automations/automation-authority-identity.ts`
- `src/renderer/src/components/automations/automation-capability-probe.ts`
- `src/renderer/src/components/automations/automation-captured-owner.test.ts`
- `src/renderer/src/components/automations/automation-captured-owner.ts`
- `src/renderer/src/components/automations/automation-create-destination.test.ts`
- `src/renderer/src/components/automations/automation-create-destination.ts`
- `src/renderer/src/components/automations/automation-create-projects.test.ts`
- `src/renderer/src/components/automations/automation-create-projects.ts`
- `src/renderer/src/components/automations/automation-delete-confirm-preference.ts`
- `src/renderer/src/components/automations/AutomationDestinationField.test.tsx`
- `src/renderer/src/components/automations/AutomationDestinationField.tsx`
- `src/renderer/src/components/automations/AutomationDetail.host.test.tsx`
- `src/renderer/src/components/automations/AutomationDetail.test.tsx`
- `src/renderer/src/components/automations/automation-detail-tab-navigation.test.ts`
...
- `src/renderer/src/components/automations/AutomationEditorPromptEditor.test.tsx`
...
- `src/renderer/src/components/automations/automation-editor-prompt-options.ts`
- `src/renderer/src/components/automations/AutomationEditorSettingsSidebar.tsx`
- `src/renderer/src/components/automations/automation-external-target-match.test.ts`
- `src/renderer/src/components/automations/automation-external-target-match.ts`
- `src/renderer/src/components/automations/automation-hermes-save.ts`
- `src/renderer/src/components/automations/AutomationHostBadges.test.tsx`
- `src/renderer/src/components/automations/AutomationHostBadges.tsx`
- `src/renderer/src/components/automations/automation-host-cache.test.ts`
- `src/renderer/src/components/automations/automation-host-cache.ts`
- `src/renderer/src/components/automations/automation-host-cache-controller.test.ts`
- `src/renderer/src/components/automations/automation-host-cache-controller.ts`
- `src/renderer/src/components/automations/automation-host-cache-error.ts`
- `src/renderer/src/components/automations/automation-host-cache-health.test.ts`
- `src/renderer/src/components/automations/automation-host-cache-health.ts`
- `src/renderer/src/components/automations/automation-host-cache-rows.ts`
- `src/renderer/src/components/automations/automation-host-cache-types.ts`
- `src/renderer/src/components/automations/automation-host-catalog.test.ts`
- `src/renderer/src/components/automations/automation-host-catalog.ts`
- `src/renderer/src/components/automations/automation-host-catalog-generation.test.ts`
- `src/renderer/src/components/automations/automation-host-catalog-generation.ts`
- `src/renderer/src/components/automations/automation-host-catalog-order.test.ts`
- `src/renderer/src/components/automations/automation-host-catalog-order.ts`
- `src/renderer/src/components/automations/automation-host-catalog-source.test.ts`
- `src/renderer/src/components/automations/automation-host-catalog-source.ts`
- `src/renderer/src/components/automations/automation-host-catalog-types.ts`
- `src/renderer/src/components/automations/automation-host-detail-display.test.ts`
- `src/renderer/src/components/automations/automation-host-detail-display.ts`
- `src/renderer/src/components/automations/automation-host-diagnostics.test.ts`
- `src/renderer/src/components/automations/automation-host-diagnostics.ts`
- `src/renderer/src/components/automations/automation-host-fetch-target.ts`
- `src/renderer/src/components/automations/AutomationHostFilterNotice.test.tsx`
- `src/renderer/src/components/automations/AutomationHostFilterNotice.tsx`
- `src/renderer/src/components/automations/automation-host-filter-resolution.test.ts`
- `src/renderer/src/components/automations/automation-host-filter-resolution.ts`
- `src/renderer/src/components/automations/automation-host-health.test.ts`
- `src/renderer/src/components/automations/automation-host-health.ts`
- `src/renderer/src/components/automations/automation-host-invalidation.test.ts`
- `src/renderer/src/components/automations/automation-host-invalidation.ts`
- `src/renderer/src/components/automations/automation-host-invalidation-window-events.test.ts`
- `src/renderer/src/components/automations/automation-host-invalidation-window-events.ts`
- `src/renderer/src/components/automations/automation-host-list-rows.test.ts`
- `src/renderer/src/components/automations/automation-host-list-rows.ts`
- `src/renderer/src/components/automations/automation-host-orphan-entry.test.ts`
- `src/renderer/src/components/automations/automation-host-picker-groups.test.ts`
- `src/renderer/src/components/automations/automation-host-picker-groups.ts`
- `src/renderer/src/components/automations/automation-host-recovery.test.ts`
- `src/renderer/src/components/automations/automation-host-recovery.ts`
- `src/renderer/src/components/automations/automation-host-request-instrumentation.ts`
- `src/renderer/src/components/automations/automation-host-retry-schedule.ts`
- `src/renderer/src/components/automations/automation-host-scale-gates.test.ts`
- `src/renderer/src/components/automations/automation-host-scheduler.test.ts`
- `src/renderer/src/components/automations/automation-host-scheduler.ts`
- `src/renderer/src/components/automations/automation-host-scheduler-plan.ts`
- `src/renderer/src/components/automations/automation-host-scheduler-queue.ts`
- `src/renderer/src/components/automations/automation-host-scope-descriptors.ts`
- `src/renderer/src/components/automations/automation-host-status-descriptors.test.ts`
- `src/renderer/src/components/automations/automation-host-status-descriptors.ts`
- `src/renderer/src/components/automations/automation-list-empty-state.test.ts`
- `src/renderer/src/components/automations/automation-list-empty-state.ts`
- `src/renderer/src/components/automations/AutomationListEmptyView.test.tsx`
- `src/renderer/src/components/automations/AutomationListEmptyView.tsx`
- `src/renderer/src/components/automations/AutomationListFilterMenu.tsx`
- `src/renderer/src/components/automations/automation-list-focus-recovery.test.ts`
- `src/renderer/src/components/automations/automation-list-focus-recovery.ts`
- `src/renderer/src/components/automations/AutomationListHostGroups.test.tsx`
- `src/renderer/src/components/automations/AutomationListHostGroups.tsx`
- `src/renderer/src/components/automations/automation-list-keyboard-navigation.test.ts`
- `src/renderer/src/components/automations/automation-list-keyboard-navigation.ts`
- `src/renderer/src/components/automations/automation-list-last-run.test.ts`
- `src/renderer/src/components/automations/automation-list-last-run.ts`
- `src/renderer/src/components/automations/AutomationListLastRunCell.tsx`
- `src/renderer/src/components/automations/automation-list-row-identity.test.ts`
- `src/renderer/src/components/automations/automation-list-row-identity.ts`
- `src/renderer/src/components/automations/automation-list-search-query.ts`
- `src/renderer/src/components/automations/automation-list-search-rows.test.ts`
...
- `src/renderer/src/components/automations/automation-management-actions.ts`
- `src/renderer/src/components/automations/automation-notice-recovery-host.ts`
- `src/renderer/src/components/automations/automation-orca-save.ts`
- `src/renderer/src/components/automations/automation-orca-save-operations.ts`
- `src/renderer/src/components/automations/automation-owner-action-runner.ts`
- `src/renderer/src/components/automations/AutomationOwnerConflictNotice.test.tsx`
- `src/renderer/src/components/automations/AutomationOwnerConflictNotice.tsx`
- `src/renderer/src/components/automations/AutomationPromptDisclosure.test.tsx`
- `src/renderer/src/components/automations/AutomationPromptDisclosure.tsx`
- `src/renderer/src/components/automations/automation-row-action-dispatch.ts`
- `src/renderer/src/components/automations/automation-run-actions.ts`
- `src/renderer/src/components/automations/AutomationRunHistory.test.tsx`
- `src/renderer/src/components/automations/automation-run-history-keyboard-navigation.test.ts`
- `src/renderer/src/components/automations/automation-run-history-keyboard-navigation.ts`
- `src/renderer/src/components/automations/automation-run-occurrences.ts`
- `src/renderer/src/components/automations/automation-run-workspace-action.ts`
- `src/renderer/src/components/automations/automation-save-action.ts`
- `src/renderer/src/components/automations/automation-save-context.ts`
- `src/renderer/src/components/automations/automation-schedule-label.ts`
- `src/renderer/src/components/automations/AutomationSchedulePicker.render.test.tsx`
- `src/renderer/src/components/automations/automation-scoped-list-client.test.ts`
- `src/renderer/src/components/automations/automation-scoped-list-client.ts`
- `src/renderer/src/components/automations/AutomationsDetailPane.run-count.test.tsx`
- `src/renderer/src/components/automations/AutomationsDetailPane.test.tsx`
...
- `src/renderer/src/components/automations/AutomationsPage.escape-precedence.test.tsx`
...
- `src/renderer/src/components/automations/AutomationsPage.save-visibility.test.tsx`
- `src/renderer/src/components/automations/AutomationsPage.strict-mode-save-visibility.test.tsx`
- `src/renderer/src/components/automations/AutomationsPage.test.tsx`
- `src/renderer/src/components/automations/automations-page-action-context.ts`
- `src/renderer/src/components/automations/automations-page-fixtures.ts`
- `src/renderer/src/components/automations/automations-page-runtime-fixtures.ts`
...
- `src/renderer/src/components/automations/AutomationTemplateEmptyState.tsx`
- `src/renderer/src/components/automations/AutomationTimeField.test.tsx`
- `src/renderer/src/components/automations/AutomationTimeField.tsx`
- `src/renderer/src/components/automations/AutomationWorkspaceField.tsx`
- `src/renderer/src/components/automations/automation-write-invalidation.test.ts`
- `src/renderer/src/components/automations/automation-write-invalidation.ts`
- `src/renderer/src/components/automations/external-automation-display.test.ts`
- `src/renderer/src/components/automations/external-automation-scope-client.ts`
- `src/renderer/src/components/automations/external-automation-scope-gating.test.ts`
- `src/renderer/src/components/automations/external-automation-scope-gating.ts`
- `src/renderer/src/components/automations/external-automation-scope-keys.test.ts`
- `src/renderer/src/components/automations/external-automation-scope-keys.ts`
- `src/renderer/src/components/automations/external-automation-unchecked-hosts.ts`
- `src/renderer/src/components/automations/use-automation-create-destination.ts`
- `src/renderer/src/components/automations/use-automation-desktop-ssh-registrations.ts`
- `src/renderer/src/components/automations/use-automation-draft-effects.ts`
- `src/renderer/src/components/automations/use-automation-editor-actions.ts`
- `src/renderer/src/components/automations/use-automation-host-catalog.test.tsx`
- `src/renderer/src/components/automations/use-automation-host-catalog.ts`
- `src/renderer/src/components/automations/use-automation-host-catalog-readoption.test.tsx`
- `src/renderer/src/components/automations/use-automation-host-catalog-source-state.ts`
- `src/renderer/src/components/automations/use-automation-list-focus-recovery.test.tsx`
- `src/renderer/src/components/automations/use-automation-list-focus-recovery.ts`
- `src/renderer/src/components/automations/use-automation-list-search.test.tsx`
- `src/renderer/src/components/automations/use-automation-run-page-state.ts`
- `src/renderer/src/components/automations/use-automation-source-availability.ts`
- `src/renderer/src/components/automations/use-automation-source-host-availability.ts`
- `src/renderer/src/components/automations/use-automations-page-controller.ts`
- `src/renderer/src/components/automations/use-automations-page-destination-form.ts`
- `src/renderer/src/components/automations/use-automations-page-destination-state.ts`
...
- `src/renderer/src/components/automations/use-automations-page-presentation-state.ts`
- `src/renderer/src/components/automations/use-automations-page-refresh.ts`
- `src/renderer/src/components/automations/use-automations-page-setup-state.ts`
- `src/renderer/src/components/automations/use-automations-page-store-state.ts`
- `src/renderer/src/components/automations/use-external-automation-actions.ts`
- `src/renderer/src/components/automations/use-external-automation-scope-retention.test.tsx`
- `src/renderer/src/components/automations/use-external-automation-scope-retention.ts`
- `src/renderer/src/components/automations/use-scoped-external-automations.ts`
- `src/renderer/src/components/automations/use-selected-automation-run-history.test.tsx`
- `src/renderer/src/components/automations/use-selected-automation-run-history.ts`
- `src/renderer/src/components/BrowserCookieImportDisclosure.tsx`
- `src/renderer/src/components/browser-cookie-import-google-disclosure.test.tsx`
- `src/renderer/src/components/BrowserCookieImportMachineNotice.tsx`
- `src/renderer/src/components/browser-pane/annotate/browser-annotation-output.test.ts`
...
- `src/renderer/src/components/browser-pane/annotate/BrowserAnnotationSendMenuContent.tsx`
- `src/renderer/src/components/browser-pane/annotate/browser-guest-annotate-overlays.tsx`
- `src/renderer/src/components/browser-pane/annotate/browser-page-annotation-tray.test.tsx`
...
- `src/renderer/src/components/browser-pane/annotate/browser-page-grab-toast.tsx`
- `src/renderer/src/components/browser-pane/annotate/GrabConfirmationSheet.test.ts`
- `src/renderer/src/components/browser-pane/annotate/GrabConfirmationSheet.tsx`
- `src/renderer/src/components/browser-pane/annotate/guest-annotation-viewport-bridge.ts`
- `src/renderer/src/components/browser-pane/annotate/markup-base-image.ts`
- `src/renderer/src/components/browser-pane/annotate/markup-canvas-render.ts`
- `src/renderer/src/components/browser-pane/annotate/markup-clipboard-delivery.ts`
- `src/renderer/src/components/browser-pane/annotate/MarkupDrawButton.tsx`
- `src/renderer/src/components/browser-pane/annotate/markup-drawing-model.test.ts`
- `src/renderer/src/components/browser-pane/annotate/markup-drawing-model.ts`
- `src/renderer/src/components/browser-pane/annotate/MarkupOverlay.tsx`
- `src/renderer/src/components/browser-pane/annotate/markup-screenshot-compose.test.ts`
- `src/renderer/src/components/browser-pane/annotate/markup-screenshot-compose.ts`
- `src/renderer/src/components/browser-pane/annotate/markup-shape-render.test.ts`
- `src/renderer/src/components/browser-pane/annotate/markup-shape-render.ts`
- `src/renderer/src/components/browser-pane/annotate/MarkupToolbar.tsx`
- `src/renderer/src/components/browser-pane/annotate/pending-browser-annotation-card.tsx`
- `src/renderer/src/components/browser-pane/annotate/prevent-agent-send-target-outside-dismiss.ts`
- `src/renderer/src/components/browser-pane/annotate/use-browser-page-annotation-send.ts`
- `src/renderer/src/components/browser-pane/annotate/use-browser-page-annotation-viewport-tracking.ts`
- `src/renderer/src/components/browser-pane/annotate/use-browser-page-grab-annotations.ts`
- `src/renderer/src/components/browser-pane/annotate/use-browser-page-markup-capture.ts`
- `src/renderer/src/components/browser-pane/annotate/useGrabMode.test.ts`
- `src/renderer/src/components/browser-pane/annotate/useGrabMode.ts`
- `src/renderer/src/components/browser-pane/annotate/use-markup-draw-hint.test.ts`
- `src/renderer/src/components/browser-pane/annotate/use-markup-draw-hint.ts`
- `src/renderer/src/components/browser-pane/annotate/useMarkupEditor.test.ts`
- `src/renderer/src/components/browser-pane/annotate/useMarkupEditor.ts`
- `src/renderer/src/components/browser-pane/annotate/useMarkupKeyboardShortcuts.ts`
- `src/renderer/src/components/browser-pane/annotate/useMarkupMode.ts`
- `src/renderer/src/components/browser-pane/annotate/useMarkupPointerHandlers.test.ts`
- `src/renderer/src/components/browser-pane/annotate/useMarkupPointerHandlers.ts`
- `src/renderer/src/components/browser-pane/assemble-chrome/BrowserAddressBar.test.tsx`
...
- `src/renderer/src/components/browser-pane/assemble-chrome/browser-detected-browsers-summary.test.ts`
- `src/renderer/src/components/browser-pane/assemble-chrome/browser-detected-browsers-summary.ts`
- `src/renderer/src/components/browser-pane/assemble-chrome/browser-egress-indicator.test.tsx`
- `src/renderer/src/components/browser-pane/assemble-chrome/browser-egress-indicator.tsx`
- `src/renderer/src/components/browser-pane/assemble-chrome/BrowserFind.test.tsx`
- `src/renderer/src/components/browser-pane/assemble-chrome/BrowserFind.tsx`
- `src/renderer/src/components/browser-pane/assemble-chrome/BrowserImportHintButton.tsx`
- `src/renderer/src/components/browser-pane/assemble-chrome/browser-import-hint-visibility.test.ts`
- `src/renderer/src/components/browser-pane/assemble-chrome/browser-import-hint-visibility.ts`
- `src/renderer/src/components/browser-pane/assemble-chrome/BrowserMobileDriverOverlay.tsx`
- `src/renderer/src/components/browser-pane/assemble-chrome/browser-navigation-control-row.test.tsx`
...
- `src/renderer/src/components/browser-pane/assemble-chrome/browser-page-guest-focus.ts`
...
- `src/renderer/src/components/browser-pane/assemble-chrome/BrowserPane.render-ipc.test.ts`
- `src/renderer/src/components/browser-pane/assemble-chrome/BrowserPane.webview-preferences.test.ts`
- `src/renderer/src/components/browser-pane/assemble-chrome/BrowserPaneOverlayLayer.test.tsx`
- `src/renderer/src/components/browser-pane/assemble-chrome/BrowserPaneOverlayLayer.tsx`
- `src/renderer/src/components/browser-pane/assemble-chrome/browser-pane-page-selection.test.ts`
- `src/renderer/src/components/browser-pane/assemble-chrome/browser-pane-page-selection.ts`
...
- `src/renderer/src/components/browser-pane/assemble-chrome/browser-toolbar-profile-dialogs.tsx`
- `src/renderer/src/components/browser-pane/assemble-chrome/browser-workspace-pane.adoption-chrome.test.tsx`
...
- `src/renderer/src/components/browser-pane/assemble-chrome/context-menu-positioning.test.ts`
- `src/renderer/src/components/browser-pane/assemble-chrome/ssh-routed-browser-page-gate.test.tsx`
- `src/renderer/src/components/browser-pane/assemble-chrome/ssh-routed-browser-page-gate.tsx`
- `src/renderer/src/components/browser-pane/assemble-chrome/use-browser-address-bar-dismissal.ts`
- `src/renderer/src/components/browser-pane/assemble-chrome/use-browser-address-bar-edit-session.ts`
- `src/renderer/src/components/browser-pane/assemble-chrome/use-browser-page-chrome-focus.test.tsx`
- `src/renderer/src/components/browser-pane/assemble-chrome/use-browser-page-chrome-focus.ts`
- `src/renderer/src/components/browser-pane/assemble-chrome/use-browser-page-find-shortcuts.ts`
- `src/renderer/src/components/browser-pane/browser-client-hosted-download-notices.ts`
- `src/renderer/src/components/browser-pane/browser-client-hosted-permission-notices.ts`
...
- `src/renderer/src/components/browser-pane/browser-client-page-metadata-publish-e2e-fault.ts`
- `src/renderer/src/components/browser-pane/browser-client-page-metadata-publisher.test.ts`
- `src/renderer/src/components/browser-pane/browser-client-page-metadata-publisher.ts`
- `src/renderer/src/components/browser-pane/browser-client-page-metadata-reporting.ts`
- `src/renderer/src/components/browser-pane/browser-client-page-metadata-route-census.test.ts`
...
- `src/renderer/src/components/browser-pane/browser-client-page-retained-drag-passthrough.test.ts`
- `src/renderer/src/components/browser-pane/browser-client-page-retained-elements.ts`
- `src/renderer/src/components/browser-pane/browser-client-page-retained-host-fixture.ts`
- `src/renderer/src/components/browser-pane/browser-client-page-retained-key.ts`
- `src/renderer/src/components/browser-pane/browser-client-page-retained-memory-profile.ts`
- `src/renderer/src/components/browser-pane/browser-client-page-retained-registry.test.ts`
- `src/renderer/src/components/browser-pane/browser-client-page-retained-registry.ts`
- `src/renderer/src/components/browser-pane/browser-client-page-retained-rekey.ts`
- `src/renderer/src/components/browser-pane/browser-client-page-retained-state.ts`
- `src/renderer/src/components/browser-pane/browser-client-page-visible-attachment.ts`
- `src/renderer/src/components/browser-pane/browser-download-destination-toast.test.ts`
- `src/renderer/src/components/browser-pane/browser-download-destination-toast.ts`
- `src/renderer/src/components/browser-pane/browser-reopen-on-server.test.ts`
- `src/renderer/src/components/browser-pane/browser-reopen-on-server.ts`
- `src/renderer/src/components/browser-pane/client-hosted-browser-host-row-pane.tsx`
- `src/renderer/src/components/browser-pane/ClientHostedBrowserPagePane.chrome-parity.test.tsx`
- `src/renderer/src/components/browser-pane/ClientHostedBrowserPagePane.download-notices.test.tsx`
- `src/renderer/src/components/browser-pane/ClientHostedBrowserPagePane.drag-focus.test.tsx`
- `src/renderer/src/components/browser-pane/ClientHostedBrowserPagePane.failure-remount.test.tsx`
...
- `src/renderer/src/components/browser-pane/client-hosted-browser-pane-test-rig.ts`
- `src/renderer/src/components/browser-pane/client-hosted-browser-unavailable-notice.tsx`
- `src/renderer/src/components/browser-pane/describe-page/browser-annotation-geometry.test.ts`
- `src/renderer/src/components/browser-pane/describe-page/browser-annotation-geometry.ts`
- `src/renderer/src/components/browser-pane/describe-page/browser-artifact-upload.test.ts`
- `src/renderer/src/components/browser-pane/describe-page/browser-artifact-upload.ts`
- `src/renderer/src/components/browser-pane/describe-page/browser-overlay-shortcut-target.test.ts`
- `src/renderer/src/components/browser-pane/describe-page/browser-overlay-shortcut-target.ts`
- `src/renderer/src/components/browser-pane/describe-page/browser-page-load-error.ts`
- `src/renderer/src/components/browser-pane/describe-page/browser-page-types.ts`
...
- `src/renderer/src/components/browser-pane/describe-page/live-browser-url-registry.test.ts`
- `src/renderer/src/components/browser-pane/describe-page/live-browser-url-registry.ts`
...
- `src/renderer/src/components/browser-pane/host-guest/browser-automation-visibility.test.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-automation-visibility.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-focus.test.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-focus.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-guest-eviction-veto.test.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-guest-paint-retention.test.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-guest-paint-retention.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-guest-retention-site-census.test.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-guest-worktree-retention.test.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-guest-worktree-retention.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-keyboard.test.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-keyboard.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-page-guest-recovery.test.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-page-guest-recovery.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-page-paintability.test.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-page-paintability.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-page-viewport.test.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-page-viewport.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-page-webview.test.ts`
...
- `src/renderer/src/components/browser-pane/host-guest/browser-page-webview-loading-handlers.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-page-webview-navigation-handlers.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-page-zoom.test.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-page-zoom.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-system-resume.test.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-system-resume.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-worktree-surface-paintability.test.ts`
- `src/renderer/src/components/browser-pane/host-guest/browser-worktree-surface-paintability.ts`
- `src/renderer/src/components/browser-pane/host-guest/use-browser-page-keyboard-shortcuts.ts`
- `src/renderer/src/components/browser-pane/host-guest/use-browser-page-slot-viewport.test.ts`
- `src/renderer/src/components/browser-pane/host-guest/use-browser-page-slot-viewport.ts`
- `src/renderer/src/components/browser-pane/host-guest/use-browser-page-viewport-scroll-reporting.test.tsx`
- `src/renderer/src/components/browser-pane/host-guest/use-browser-page-viewport-scroll-reporting.ts`
- `src/renderer/src/components/browser-pane/host-guest/use-browser-page-webview-lifecycle.ts`
- `src/renderer/src/components/browser-pane/host-guest/use-browser-page-webview-partition.ts`
- `src/renderer/src/components/browser-pane/host-guest/use-browser-page-webview-shortcuts.ts`
- `src/renderer/src/components/browser-pane/host-guest/use-browser-page-zoom-feedback.ts`
- `src/renderer/src/components/browser-pane/host-guest/use-client-hosted-guest-activation-focus.ts`
- `src/renderer/src/components/browser-pane/host-guest/use-guest-drag-passthrough.ts`
- `src/renderer/src/components/browser-pane/host-guest/use-webview-drag-passthrough-active.test.tsx`
- `src/renderer/src/components/browser-pane/host-guest/use-webview-drag-passthrough-active.ts`
- `src/renderer/src/components/browser-pane/host-guest/webview-drag-passthrough.ts`
...
- `src/renderer/src/components/browser-pane/navigate/browser-address-bar-navigation.test.ts`
- `src/renderer/src/components/browser-pane/navigate/browser-address-bar-navigation.ts`
- `src/renderer/src/components/browser-pane/navigate/browser-download-progress.test.ts`
- `src/renderer/src/components/browser-pane/navigate/browser-download-progress.ts`
- `src/renderer/src/components/browser-pane/navigate/browser-load-failure-for-url.ts`
- `src/renderer/src/components/browser-pane/navigate/browser-load-failure-overlay.test.tsx`
...
- `src/renderer/src/components/browser-pane/navigate/browser-page-deferred-navigation.ts`
- `src/renderer/src/components/browser-pane/navigate/browser-page-download-activity.test.ts`
- `src/renderer/src/components/browser-pane/navigate/browser-page-download-activity.ts`
- `src/renderer/src/components/browser-pane/navigate/browser-page-download-list.tsx`
...
- `src/renderer/src/components/browser-pane/navigate/chromium-error-page-polling.test.ts`
- `src/renderer/src/components/browser-pane/navigate/chromium-error-page-polling.ts`
- `src/renderer/src/components/browser-pane/navigate/navigate-browser-page-url.ts`
- `src/renderer/src/components/browser-pane/navigate/use-browser-page-download-events.ts`
- `src/renderer/src/components/browser-pane/navigate/use-browser-page-navigation-downloads.ts`
- `src/renderer/src/components/browser-pane/navigate/use-browser-page-reload-actions.test.tsx`
- `src/renderer/src/components/browser-pane/navigate/use-browser-page-reload-actions.ts`
- `src/renderer/src/components/browser-pane/navigate/use-browser-page-resource-notices.ts`
- `src/renderer/src/components/browser-pane/navigate/use-browser-page-webview-url-sync.ts`
- `src/renderer/src/components/browser-pane/navigate/use-client-hosted-page-url-submission.ts`
- `src/renderer/src/components/browser-pane/navigate/workspace-doc-address-submission.ts`
- `src/renderer/src/components/browser-pane/ReopenBrowserPageOnServerButton.test.tsx`
- `src/renderer/src/components/browser-pane/ReopenBrowserPageOnServerButton.tsx`
- `src/renderer/src/components/browser-pane/restored-client-hosted-recovery-window.test.tsx`
- `src/renderer/src/components/browser-pane/restored-client-hosted-recovery-window.ts`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-frame-style.test.ts`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-frame-style.ts`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-keyboard.test.ts`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-keyboard.ts`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-page-context-menu.tsx`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-page-input-model.test.ts`
...
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-page-pane.chrome-chords.test.tsx`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-page-pane.tsx`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-page-session.ts`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-page-toolbar.tsx`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-page-viewport.tsx`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-screencast-subscription.ts`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-stream-errors.test.ts`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-stream-errors.ts`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-stream-lifecycle.test.ts`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-stream-lifecycle.ts`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-stream-lifecycle-deps.ts`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-stream-lifecycle-test-harness.ts`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-stream-liveness.ts`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-stream-restart-attempt.ts`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-stream-restart-scheduler.test.ts`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-stream-restart-scheduler.ts`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-stream-status.test.ts`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-stream-status.ts`
- `src/renderer/src/components/browser-pane/stream-remote/remote-browser-stream-tokens.ts`
- `src/renderer/src/components/browser-pane/stream-remote/use-remote-browser-page-chrome-chords.ts`
- `src/renderer/src/components/browser-pane/stream-remote/use-remote-browser-page-input.ts`
- `src/renderer/src/components/browser-pane/stream-remote/use-remote-browser-page-lifecycle.ts`
- `src/renderer/src/components/browser-pane/stream-remote/use-remote-browser-page-navigation.test.ts`
- `src/renderer/src/components/browser-pane/stream-remote/use-remote-browser-page-navigation.ts`
- `src/renderer/src/components/browser-pane/stream-remote/use-remote-browser-page-stream.ts`
- `src/renderer/src/components/browser-pane/stream-remote/use-remote-browser-page-wheel.ts`
- `src/renderer/src/components/browser-pane/stream-remote/use-remote-browser-stream-activation.test.ts`
- `src/renderer/src/components/browser-pane/stream-remote/use-remote-browser-stream-activation.ts`
- `src/renderer/src/components/browser-pane/use-client-hosted-browser-intro-tour.ts`
- `src/renderer/src/components/browser-pane/use-ssh-workspace-browser-route.ts`
- `src/renderer/src/components/browser-pane/workspace-doc/doc-preview-address-edit.tsx`
- `src/renderer/src/components/browser-pane/workspace-doc/doc-preview-directory-access.tsx`
- `src/renderer/src/components/browser-pane/workspace-doc/doc-preview-document-actions.test.ts`
- `src/renderer/src/components/browser-pane/workspace-doc/doc-preview-document-actions.ts`
- `src/renderer/src/components/browser-pane/workspace-doc/doc-preview-document-chip.tsx`
- `src/renderer/src/components/browser-pane/workspace-doc/doc-preview-document-identity.test.ts`
- `src/renderer/src/components/browser-pane/workspace-doc/doc-preview-document-identity.ts`
- `src/renderer/src/components/browser-pane/workspace-doc/doc-preview-external-link-confirmation.test.ts`
- `src/renderer/src/components/browser-pane/workspace-doc/doc-preview-external-link-confirmation.tsx`
- `src/renderer/src/components/browser-pane/workspace-doc/doc-preview-failure-messages.ts`
- `src/renderer/src/components/browser-pane/workspace-doc/doc-preview-overflow-menu.tsx`
- `src/renderer/src/components/browser-pane/workspace-doc/doc-preview-toolbar.tsx`
- `src/renderer/src/components/browser-pane/workspace-doc/doc-preview-webview-attach.ts`
- `src/renderer/src/components/browser-pane/workspace-doc/doc-preview-webview-history.ts`
...
- `src/renderer/src/components/browser-pane/workspace-doc/use-doc-preview-guest-tools.test.ts`
- `src/renderer/src/components/browser-pane/workspace-doc/use-doc-preview-guest-tools.ts`
- `src/renderer/src/components/browser-pane/workspace-doc/workspace-doc-page-pane.test.tsx`
- `src/renderer/src/components/browser-pane/workspace-doc/workspace-doc-page-pane.tsx`
- `src/renderer/src/components/browser-webauthn-account-dialog.test.tsx`
- `src/renderer/src/components/browser-webauthn-account-dialog.tsx`
- `src/renderer/src/components/cmd-j/PaletteCreateWorktreeRow.tsx`
- `src/renderer/src/components/cmd-j/palette-duplicate-key-ghost-rows.test.tsx`
- `src/renderer/src/components/cmd-j/palette-list-entry-render-keys.test.ts`
- `src/renderer/src/components/cmd-j/palette-list-entry-render-keys.ts`
- `src/renderer/src/components/cmd-j/palette-session-age.test.ts`
- `src/renderer/src/components/cmd-j/palette-session-age.ts`
- `src/renderer/src/components/contextual-tours/ContextualTourOverlay.remeasure.test.tsx`
...
- `src/renderer/src/components/dashboard/build-dashboard-bucket-counts.ts`
- `src/renderer/src/components/dashboard/dashboard-orchestration-selection.ts`
- `src/renderer/src/components/dashboard/dashboard-row-bucket.ts`
- `src/renderer/src/components/dashboard/dashboard-subagent-cards.ts`
- `src/renderer/src/components/dashboard-popout/agent-dashboard-filter-options.ts`
- `src/renderer/src/components/dashboard-popout/AgentMapFilterCheckbox.tsx`
- `src/renderer/src/components/dashboard-popout/AgentMapFilterChips.tsx`
- `src/renderer/src/components/dashboard-popout/agent-map-filter-labels.ts`
- `src/renderer/src/components/dashboard-popout/AgentMapFilterPanel.test.tsx`
- `src/renderer/src/components/dashboard-popout/AgentMapFilterPanel.tsx`
- `src/renderer/src/components/dashboard-popout/AgentMapFilterSection.tsx`
- `src/renderer/src/components/dashboard-popout/agent-map-filter-summaries.ts`
- `src/renderer/src/components/dashboard-popout/agent-map-node-metadata.test.ts`
- `src/renderer/src/components/dashboard-popout/agent-map-node-presentation.test.ts`
- `src/renderer/src/components/dashboard-popout/agent-map-node-presentation.ts`
- `src/renderer/src/components/dashboard-popout/AgentMapQuestionMarker.tsx`
- `src/renderer/src/components/dashboard-popout/agent-map-quick-views.test.ts`
- `src/renderer/src/components/dashboard-popout/agent-map-quick-views.ts`
- `src/renderer/src/components/dashboard-popout/agent-map-time-filter.test.ts`
- `src/renderer/src/components/dashboard-popout/agent-map-time-filter.ts`
- `src/renderer/src/components/dashboard-popout/AgentMapTimeRangeField.test.tsx`
- `src/renderer/src/components/dashboard-popout/AgentMapTimeRangeField.tsx`
- `src/renderer/src/components/dashboard-popout/agent-map-worktree-host.ts`
...
- `src/renderer/src/components/dashboard-popout/DashboardHostBadge.test.tsx`
- `src/renderer/src/components/dashboard-popout/DashboardHostBadge.tsx`
- `src/renderer/src/components/dashboard-popout/DashboardPopoutRoot.test.tsx`
- `src/renderer/src/components/dashboard-popout/preview-terminal-box-fit.ts`
- `src/renderer/src/components/dashboard-popout/preview-terminal-ime-bridge-kitty-bytes.test.ts`
- `src/renderer/src/components/dashboard-popout/preview-terminal-right-click-paste.test.ts`
- `src/renderer/src/components/dashboard-popout/preview-terminal-right-click-paste.ts`
- `src/renderer/src/components/dashboard-popout/preview-terminal-snapshot-replay.test.ts`
- `src/renderer/src/components/dashboard-popout/preview-terminal-snapshot-replay.ts`
- `src/renderer/src/components/dashboard-popout/useAgentMapFilters.test.tsx`
- `src/renderer/src/components/dashboard-popout/useAgentMapFilters.ts`
- `src/renderer/src/components/dictation/dictation-audio-meter.test.ts`
- `src/renderer/src/components/dictation/dictation-audio-meter.ts`
- `src/renderer/src/components/dictation/DictationGrapes.tsx`
- `src/renderer/src/components/dictation/DictationIndicator.localization.test.ts`
- `src/renderer/src/components/dictation/dictation-meter-store.test.tsx`
- `src/renderer/src/components/dictation/dictation-meter-store.ts`
- `src/renderer/src/components/diff-comments/decorated-diff-comment.ts`
- `src/renderer/src/components/diff-comments/diff-comment-add-button-overlay.ts`
- `src/renderer/src/components/diff-comments/diff-comment-view-zone-entry.ts`
- `src/renderer/src/components/diff-comments/diff-comment-zone-card.tsx`
- `src/renderer/src/components/editor/check-annotation-open.test.ts`
- `src/renderer/src/components/editor/check-run-clipboard-text.test.ts`
- `src/renderer/src/components/editor/check-run-clipboard-text.ts`
- `src/renderer/src/components/editor/CheckRunCopyButton.test.tsx`
- `src/renderer/src/components/editor/CheckRunCopyButton.tsx`
- `src/renderer/src/components/editor/CheckRunDetailsPanel.copy.test.tsx`
- `src/renderer/src/components/editor/combined-diff/browse-files/combined-diff-file-tree.test.ts`
- `src/renderer/src/components/editor/combined-diff/browse-files/combined-diff-file-tree.tsx`
- `src/renderer/src/components/editor/combined-diff/browse-files/combined-diff-file-tree-filter.ts`
- `src/renderer/src/components/editor/combined-diff/browse-files/combined-diff-file-tree-model.ts`
- `src/renderer/src/components/editor/combined-diff/browse-files/combined-diff-file-tree-navigation.ts`
- `src/renderer/src/components/editor/combined-diff/browse-files/combined-diff-file-tree-row.tsx`
- `src/renderer/src/components/editor/combined-diff/browse-files/use-combined-diff-file-tree-resize.test.tsx`
- `src/renderer/src/components/editor/combined-diff/browse-files/use-combined-diff-file-tree-resize.ts`
- `src/renderer/src/components/editor/combined-diff/browse-files/use-combined-diff-tree-navigation.test.ts`
- `src/renderer/src/components/editor/combined-diff/browse-files/use-combined-diff-tree-navigation.ts`
- `src/renderer/src/components/editor/combined-diff/CombinedDiffViewer.tsx`
- `src/renderer/src/components/editor/combined-diff/load-sections/combined-diff-initial-section-load.test.ts`
- `src/renderer/src/components/editor/combined-diff/load-sections/combined-diff-initial-section-load.ts`
- `src/renderer/src/components/editor/combined-diff/load-sections/combined-diff-load-scheduler.test.ts`
- `src/renderer/src/components/editor/combined-diff/load-sections/combined-diff-load-scheduler.ts`
- `src/renderer/src/components/editor/combined-diff/load-sections/combined-diff-section-connection.test.ts`
- `src/renderer/src/components/editor/combined-diff/load-sections/combined-diff-section-connection.ts`
- `src/renderer/src/components/editor/combined-diff/load-sections/combined-diff-section-load-registry.ts`
- `src/renderer/src/components/editor/combined-diff/load-sections/combined-diff-section-load-state.test.ts`
- `src/renderer/src/components/editor/combined-diff/load-sections/combined-diff-section-load-state.ts`
- `src/renderer/src/components/editor/combined-diff/load-sections/combined-diff-section-load-timeout.ts`
- `src/renderer/src/components/editor/combined-diff/load-sections/fetch-combined-diff-section.ts`
- `src/renderer/src/components/editor/combined-diff/load-sections/use-combined-diff-section-loader.ts`
- `src/renderer/src/components/editor/combined-diff/load-sections/use-combined-diff-section-retry.ts`
- `src/renderer/src/components/editor/combined-diff/load-sections/use-combined-diff-section-revalidation.ts`
- `src/renderer/src/components/editor/combined-diff/remember-view/combined-diff-view-memory.ts`
- `src/renderer/src/components/editor/combined-diff/remember-view/use-combined-diff-view-persist.ts`
- `src/renderer/src/components/editor/combined-diff/remember-view/use-combined-diff-view-restore.test.tsx`
- `src/renderer/src/components/editor/combined-diff/remember-view/use-combined-diff-view-restore.ts`
- `src/renderer/src/components/editor/combined-diff/resolve-changes/combined-diff-entries.test.ts`
- `src/renderer/src/components/editor/combined-diff/resolve-changes/combined-diff-entries.ts`
- `src/renderer/src/components/editor/combined-diff/resolve-changes/combined-diff-git-status-signature.ts`
- `src/renderer/src/components/editor/combined-diff/resolve-changes/combined-diff-section-cache-match.test.ts`
- `src/renderer/src/components/editor/combined-diff/resolve-changes/combined-diff-section-cache-match.ts`
- `src/renderer/src/components/editor/combined-diff/resolve-changes/combined-diff-section-identity.ts`
- `src/renderer/src/components/editor/combined-diff/resolve-changes/use-combined-diff-entry-set.ts`
- `src/renderer/src/components/editor/combined-diff/review-controls/combined-diff-commit-header.tsx`
- `src/renderer/src/components/editor/combined-diff/review-controls/combined-diff-commit-message.test.ts`
- `src/renderer/src/components/editor/combined-diff/review-controls/combined-diff-commit-message.ts`
- `src/renderer/src/components/editor/combined-diff/review-controls/combined-diff-notes-popover.tsx`
- `src/renderer/src/components/editor/combined-diff/review-controls/combined-diff-skipped-conflicts.tsx`
- `src/renderer/src/components/editor/combined-diff/review-controls/combined-diff-toolbar.tsx`
- `src/renderer/src/components/editor/combined-diff/review-controls/use-combined-diff-notes-actions.ts`
...
- `src/renderer/src/components/editor/combined-diff/scroll-viewport/combined-diff-scrollbar-drag.test.ts`
- `src/renderer/src/components/editor/combined-diff/scroll-viewport/combined-diff-scrollbar-drag.ts`
- `src/renderer/src/components/editor/combined-diff/scroll-viewport/combined-diff-section-list.tsx`
- `src/renderer/src/components/editor/combined-diff/scroll-viewport/use-combined-diff-direct-scroll-input.ts`
- `src/renderer/src/components/editor/combined-diff/scroll-viewport/use-combined-diff-scroll-anchors.ts`
- `src/renderer/src/components/editor/combined-diff/scroll-viewport/use-combined-diff-scrollbar.ts`
- `src/renderer/src/components/editor/combined-diff/scroll-viewport/use-combined-diff-scroll-persistence.ts`
- `src/renderer/src/components/editor/combined-diff/scroll-viewport/use-combined-diff-virtualizer.ts`
- `src/renderer/src/components/editor/combined-diff-on-demand-load.test.ts`
- `src/renderer/src/components/editor/combined-diff-on-demand-load.ts`
...
- `src/renderer/src/components/editor/EditorConflictReviewSurface.tsx`
- `src/renderer/src/components/editor/EditorContent.markdown-classification.test.tsx`
- `src/renderer/src/components/editor/EditorDiffFileSurface.tsx`
- `src/renderer/src/components/editor/EditorEditFileSurface.tsx`
- `src/renderer/src/components/editor/editor-external-change-tab-reset.ts`
- `src/renderer/src/components/editor/editor-external-watch-path-index.test.ts`
- `src/renderer/src/components/editor/editor-external-watch-path-index.ts`
- `src/renderer/src/components/editor/EditorFileLoadErrorView.tsx`
- `src/renderer/src/components/editor/editor-lazy-views.ts`
- `src/renderer/src/components/editor/EditorMarkdownFileSurface.tsx`
- `src/renderer/src/components/editor/EditorPanelShell.header.test.tsx`
- `src/renderer/src/components/editor/editor-restart-save-handlers.ts`
- `src/renderer/src/components/editor/editor-save-queue.ts`
- `src/renderer/src/components/editor/IpynbCellEditor.tsx`
- `src/renderer/src/components/editor/ipynb-cell-mutations.ts`
- `src/renderer/src/components/editor/IpynbCellOutputs.tsx`
- `src/renderer/src/components/editor/IpynbCellToolbar.tsx`
- `src/renderer/src/components/editor/LargeDiffLoadPrompt.test.tsx`
- `src/renderer/src/components/editor/LargeDiffLoadPrompt.tsx`
- `src/renderer/src/components/editor/local-image-cache-pinning.ts`
- `src/renderer/src/components/editor/markdown-preview-anchor-navigation.ts`
- `src/renderer/src/components/editor/MarkdownPreviewAnnotationComposer.tsx`
- `src/renderer/src/components/editor/markdown-preview-block-model.ts`
- `src/renderer/src/components/editor/MarkdownPreviewBody.tsx`
- `src/renderer/src/components/editor/markdown-preview-editor-reveal.ts`
- `src/renderer/src/components/editor/markdown-preview-link-actions.ts`
- `src/renderer/src/components/editor/MarkdownPreviewReviewToolbar.tsx`
- `src/renderer/src/components/editor/MarkdownPreviewSearchBar.tsx`
- `src/renderer/src/components/editor/markdown-preview-source-routing.ts`
- `src/renderer/src/components/editor/MarkdownPreviewSurface.tsx`
- `src/renderer/src/components/editor/markdown-preview-system-link-action.ts`
- `src/renderer/src/components/editor/markdown-preview-types.ts`
- `src/renderer/src/components/editor/monaco-editor-input-bindings.ts`
- `src/renderer/src/components/editor/monaco-editor-mount-params.ts`
- `src/renderer/src/components/editor/monaco-find-widget.test.ts`
- `src/renderer/src/components/editor/monaco-find-widget.ts`
- `src/renderer/src/components/editor/MonacoMarkdownAnnotationOverlay.tsx`
- `src/renderer/src/components/editor/monaco-view-state-persistence.test.ts`
- `src/renderer/src/components/editor/monaco-view-state-persistence.ts`
- `src/renderer/src/components/editor/position-stable-node-view-update.test.ts`
- `src/renderer/src/components/editor/position-stable-node-view-update.ts`
- `src/renderer/src/components/editor/rich-markdown-code-block-indent.ts`
- `src/renderer/src/components/editor/rich-markdown-code-block-languages.test.ts`
- `src/renderer/src/components/editor/rich-markdown-code-block-languages.ts`
- `src/renderer/src/components/editor/rich-markdown-list-indent.ts`
- `src/renderer/src/components/editor/rich-markdown-list-tokenizers.test.ts`
- `src/renderer/src/components/editor/rich-markdown-lowlight.test.ts`
- `src/renderer/src/components/editor/rich-markdown-lowlight.ts`
- `src/renderer/src/components/editor/rich-markdown-lowlight-cache.test.ts`
- `src/renderer/src/components/editor/rich-markdown-lowlight-cache.ts`
- `src/renderer/src/components/editor/rich-markdown-ordered-list.ts`
- `src/renderer/src/components/editor/RichMarkdownSearchBar.ime-enter.test.tsx`
- `src/renderer/src/components/editor/useEditorConflictNavigation.ts`
- `src/renderer/src/components/editor/useEditorPanelActiveTabContentLoad.ts`
- `src/renderer/src/components/editor/useEditorPanelContentReloadTriggers.ts`
- `src/renderer/src/components/editor/useEditorPanelDiffContentLoader.ts`
- `src/renderer/src/components/editor/useEditorPanelFileContentLoader.ts`
- `src/renderer/src/components/editor/useIpynbCellExecution.test.tsx`
- `src/renderer/src/components/editor/useIpynbCellExecution.ts`
- `src/renderer/src/components/editor/useIpynbDocumentEditing.test.tsx`
- `src/renderer/src/components/editor/useIpynbDocumentEditing.ts`
- `src/renderer/src/components/editor/useIpynbScrollRestoration.ts`
- `src/renderer/src/components/editor/use-markdown-preview-annotation-renderers.tsx`
- `src/renderer/src/components/editor/use-markdown-preview-components.tsx`
- `src/renderer/src/components/editor/use-markdown-preview-foundation.ts`
- `src/renderer/src/components/editor/use-markdown-preview-review-actions.ts`
- `src/renderer/src/components/editor/use-markdown-preview-scroll-viewport.ts`
- `src/renderer/src/components/editor/use-markdown-preview-source-foundation.ts`
- `src/renderer/src/components/editor/use-markdown-preview-viewport.ts`
- `src/renderer/src/components/editor/use-monaco-content-sync-bridge.ts`
- `src/renderer/src/components/editor/use-monaco-editor-decorations.ts`
- `src/renderer/src/components/editor/use-monaco-editor-mount.ts`
- `src/renderer/src/components/editor/use-monaco-markdown-annotations.ts`
- `src/renderer/src/components/editor/use-monaco-reveal-scheduler.ts`
- `src/renderer/src/components/editor/useRichMarkdownEditorInstance.integration.test.tsx`
- `src/renderer/src/components/editor/useRichMarkdownEditorInstance.test.tsx`
- `src/renderer/src/components/editor/useRichMarkdownSearch.test.tsx`
- `src/renderer/src/components/error-boundaries/react-185-bystander-attribution.test.tsx`
- `src/renderer/src/components/feature-tips/CliSkillSetupTerminal.test.tsx`
- `src/renderer/src/components/feature-wall/BrowserAgentVerificationPane.tsx`
- `src/renderer/src/components/feature-wall/browser-animated-visual-phase.ts`
- `src/renderer/src/components/feature-wall/browser-animated-visual-sequence.test.ts`
- `src/renderer/src/components/feature-wall/browser-animated-visual-sequence.ts`
- `src/renderer/src/components/feature-wall/BrowserPricingStoryboard.tsx`
- `src/renderer/src/components/feature-wall/BrowserSignupStoryboard.tsx`
- `src/renderer/src/components/feature-wall/BrowserStoryboardWindow.tsx`
- `src/renderer/src/components/feature-wall/editor-animated-toolbar-icons.tsx`
- `src/renderer/src/components/feature-wall/editor-animated-visual-markup.ts`
- `src/renderer/src/components/feature-wall/feature-wall-setup-checklist-localized-copy.test.ts`
- `src/renderer/src/components/feature-wall/feature-wall-setup-checklist-localized-copy.ts`
- `src/renderer/src/components/feature-wall/use-browser-animated-visual-storyboard.ts`
- `src/renderer/src/components/feature-wall/use-editor-animated-visual-animation.ts`
- `src/renderer/src/components/feature-wall/use-workbench-terminal-cursor.ts`
- `src/renderer/src/components/feature-wall/use-workbench-terminal-storyboard.ts`
- `src/renderer/src/components/feature-wall/WorkbenchTerminalPanes.tsx`
- `src/renderer/src/components/feature-wall/WorkbenchTerminalSplitMenu.tsx`
- `src/renderer/src/components/feature-wall/workbench-terminal-storyboard-sequence.test.ts`
- `src/renderer/src/components/feature-wall/workbench-terminal-storyboard-sequence.ts`
- `src/renderer/src/components/feature-wall/workbench-terminal-storyboard-state.ts`
- `src/renderer/src/components/floating-terminal/FloatingTerminalEmptyState.tsx`
- `src/renderer/src/components/floating-terminal/floating-terminal-focus-reporting.ts`
- `src/renderer/src/components/floating-terminal/FloatingTerminalOrchestrationCard.tsx`
- `src/renderer/src/components/floating-terminal/FloatingTerminalPanel.bounds.test.tsx`
- `src/renderer/src/components/floating-terminal/FloatingTerminalPanel.empty-state.test.tsx`
- `src/renderer/src/components/floating-terminal/FloatingTerminalPanel.focus.test.tsx`
- `src/renderer/src/components/floating-terminal/FloatingTerminalPanel.markdown-editor.test.tsx`
- `src/renderer/src/components/floating-terminal/FloatingTerminalPanel.shortcuts.test.tsx`
- `src/renderer/src/components/floating-terminal/FloatingTerminalPanel.tab-lifecycle.test.tsx`
- `src/renderer/src/components/floating-terminal/floating-terminal-panel-component-stubs.ts`
- `src/renderer/src/components/floating-terminal/floating-terminal-panel-drag-actions.ts`
- `src/renderer/src/components/floating-terminal/floating-terminal-panel-drag-target.ts`
- `src/renderer/src/components/floating-terminal/floating-terminal-panel-initial-bounds.ts`
- `src/renderer/src/components/floating-terminal/floating-terminal-panel-render-probe.ts`
- `src/renderer/src/components/floating-terminal/FloatingTerminalPanelSurface.tsx`
- `src/renderer/src/components/floating-terminal/floating-terminal-panel-test-fixtures.ts`
- `src/renderer/src/components/floating-terminal/floating-terminal-panel-test-harness.ts`
- `src/renderer/src/components/floating-terminal/floating-terminal-panel-test-module-mocks.ts`
- `src/renderer/src/components/floating-terminal/floating-terminal-panel-types.ts`
- `src/renderer/src/components/floating-terminal/FloatingTerminalSaveDialog.tsx`
- `src/renderer/src/components/floating-terminal/floating-terminal-titlebar-drag-target.ts`
- `src/renderer/src/components/floating-terminal/FloatingWorkspaceTabDragContext.tsx`
- `src/renderer/src/components/floating-terminal/floating-workspace-tab-reorder.test.ts`
...
- `src/renderer/src/components/floating-terminal/use-floating-terminal-editor-close-queue.ts`
- `src/renderer/src/components/floating-terminal/use-floating-terminal-focus-lifecycle.ts`
- `src/renderer/src/components/floating-terminal/use-floating-terminal-global-shortcut-listeners.ts`
- `src/renderer/src/components/floating-terminal/use-floating-terminal-guest-bridge.ts`
- `src/renderer/src/components/floating-terminal/use-floating-terminal-initial-focus-effects.ts`
- `src/renderer/src/components/floating-terminal/use-floating-terminal-orchestration-dismissal.ts`
...
- `src/renderer/src/components/floating-terminal/use-floating-terminal-panel-focus-reclaim.ts`
- `src/renderer/src/components/floating-terminal/use-floating-terminal-panel-geometry.ts`
- `src/renderer/src/components/floating-terminal/use-floating-terminal-panel-items.ts`
- `src/renderer/src/components/floating-terminal/use-floating-terminal-panel-local-state.ts`
- `src/renderer/src/components/floating-terminal/use-floating-terminal-panel-maximize.ts`
...
- `src/renderer/src/components/floating-terminal/use-floating-terminal-shortcut-details.ts`
- `src/renderer/src/components/github/review-state-presentation.ts`
- `src/renderer/src/components/github/work-item-state-badge.tsx`
- `src/renderer/src/components/github-item-dialog/discuss-item/comment-reply-form.tsx`
- `src/renderer/src/components/github-item-dialog/discuss-item/conversation-tab.tsx`
- `src/renderer/src/components/github-item-dialog/discuss-item/conversation-tab-activity.tsx`
- `src/renderer/src/components/github-item-dialog/discuss-item/conversation-tab-comment-card.tsx`
- `src/renderer/src/components/github-item-dialog/discuss-item/conversation-tab-comment-group.tsx`
- `src/renderer/src/components/github-item-dialog/discuss-item/conversation-tab-description.tsx`
- `src/renderer/src/components/github-item-dialog/discuss-item/conversation-tab-pr-sidebar.tsx`
- `src/renderer/src/components/github-item-dialog/discuss-item/conversation-tab-timeline.tsx`
- `src/renderer/src/components/github-item-dialog/discuss-item/gh-comment-composer.tsx`
- `src/renderer/src/components/github-item-dialog/discuss-item/issue-conversation-entries.ts`
- `src/renderer/src/components/github-item-dialog/edit-item-fields/gh-edit-section.tsx`
- `src/renderer/src/components/github-item-dialog/edit-item-fields/gh-edit-section-assignees.tsx`
- `src/renderer/src/components/github-item-dialog/edit-item-fields/gh-edit-section-horizontal.tsx`
- `src/renderer/src/components/github-item-dialog/edit-item-fields/gh-edit-section-labels.tsx`
- `src/renderer/src/components/github-item-dialog/edit-item-fields/gh-edit-section-mutations.ts`
- `src/renderer/src/components/github-item-dialog/edit-item-fields/gh-edit-section-status-popover.tsx`
- `src/renderer/src/components/github-item-dialog/edit-item-fields/gh-edit-section-top-columns.tsx`
- `src/renderer/src/components/github-item-dialog/edit-item-fields/github-labels-settings-link.tsx`
- `src/renderer/src/components/github-item-dialog/edit-item-fields/repository-labels-url.ts`
- `src/renderer/src/components/github-item-dialog/inspect-pull-request/checks-tab.tsx`
- `src/renderer/src/components/github-item-dialog/inspect-pull-request/checks-tab-actions.ts`
- `src/renderer/src/components/github-item-dialog/inspect-pull-request/checks-tab-check-details.tsx`
- `src/renderer/src/components/github-item-dialog/inspect-pull-request/checks-tab-check-row.tsx`
- `src/renderer/src/components/github-item-dialog/inspect-pull-request/checks-tab-header.tsx`
- `src/renderer/src/components/github-item-dialog/inspect-pull-request/checks-tab-request-details.ts`
- `src/renderer/src/components/github-item-dialog/inspect-pull-request/checks-tab-summary.ts`
- `src/renderer/src/components/github-item-dialog/inspect-pull-request/pr-files-combined-diff-body.tsx`
- `src/renderer/src/components/github-item-dialog/inspect-pull-request/pr-files-combined-diff-load.ts`
- `src/renderer/src/components/github-item-dialog/inspect-pull-request/pr-files-combined-diff-signature.ts`
- `src/renderer/src/components/github-item-dialog/inspect-pull-request/pr-files-combined-diff-toolbar.tsx`
- `src/renderer/src/components/github-item-dialog/inspect-pull-request/pr-files-combined-diff-viewer.tsx`
- `src/renderer/src/components/github-item-dialog/land-pull-request/pr-actions-merge-menu.tsx`
- `src/renderer/src/components/github-item-dialog/land-pull-request/pr-actions-panel.tsx`
- `src/renderer/src/components/github-item-dialog/land-pull-request/pr-reviewers-panel.tsx`
- `src/renderer/src/components/github-item-dialog/land-pull-request/pr-reviewers-picker-row.tsx`
- `src/renderer/src/components/github-item-dialog/land-pull-request/pr-reviewers-request-actions.ts`
- `src/renderer/src/components/github-item-dialog/land-pull-request/pr-reviewers-requested-list.tsx`
- `src/renderer/src/components/github-item-dialog/load-item-details/github-item-dialog-types.ts`
- `src/renderer/src/components/github-item-dialog/load-item-details/pr-file-content-cache.ts`
- `src/renderer/src/components/github-item-dialog/load-item-details/pr-file-viewed-change.ts`
- `src/renderer/src/components/github-item-dialog/load-item-details/use-github-item-dialog-details.ts`
- `src/renderer/src/components/github-item-dialog/load-item-details/work-item-details-cache.ts`
- `src/renderer/src/components/github-item-dialog/load-item-details/work-item-details-fetch-settle.ts`
- `src/renderer/src/components/github-item-dialog/load-item-details/work-item-state-badge.tsx`
- `src/renderer/src/components/github-item-dialog/open-dialog/github-item-dialog.tsx`
- `src/renderer/src/components/github-item-dialog/open-dialog/github-item-dialog-issue-body.tsx`
- `src/renderer/src/components/github-item-dialog/open-dialog/github-item-dialog-issue-header.tsx`
- `src/renderer/src/components/github-item-dialog/open-dialog/github-item-dialog-pr-header.tsx`
- `src/renderer/src/components/github-item-dialog/open-dialog/github-item-dialog-pr-tabs.tsx`
- `src/renderer/src/components/github-item-dialog/open-dialog/use-github-item-dialog-link-copy.ts`
- `src/renderer/src/components/github-item-dialog/open-dialog/work-item-issue-source-indicator.tsx`
- `src/renderer/src/components/github-project/project-cell-chip-colors.ts`
- `src/renderer/src/components/github-project/ProjectCellIdentity.tsx`
- `src/renderer/src/components/github-project/ProjectCellIssueType.tsx`
- `src/renderer/src/components/github-project/ProjectCellRepositoryEditors.tsx`
- `src/renderer/src/components/github-project/ProjectCellSelectionEditors.tsx`
- `src/renderer/src/components/github-project/ProjectCellValueEditors.tsx`
- `src/renderer/src/components/github-project/ProjectMissingRepoDialog.tsx`
- `src/renderer/src/components/github-project/ProjectPickerBrowse.tsx`
- `src/renderer/src/components/github-project/project-picker-input.ts`
- `src/renderer/src/components/github-project/ProjectPickerPanels.tsx`
- `src/renderer/src/components/github-project/project-picker-runtime.ts`
- `src/renderer/src/components/github-project/project-picker-selection.ts`
- `src/renderer/src/components/github-project/ProjectViewStates.tsx`
- `src/renderer/src/components/github-project/ProjectViewToolbar.tsx`
- `src/renderer/src/components/github-project/project-work-item.ts`
- `src/renderer/src/components/github-project/useProjectPickerBrowse.ts`
- `src/renderer/src/components/github-project/useProjectRowActions.ts`
- `src/renderer/src/components/github-project/useProjectRowMutations.ts`
- `src/renderer/src/components/github-project/useProjectViewTable.ts`
- `src/renderer/src/components/gitlab-item-dialog/gitlab-conversation-tab.tsx`
- `src/renderer/src/components/gitlab-item-dialog/gitlab-description-tab.tsx`
- `src/renderer/src/components/gitlab-item-dialog/gitlab-files-tab.tsx`
- `src/renderer/src/components/gitlab-item-dialog/gitlab-item-dialog-types.ts`
- `src/renderer/src/components/gitlab-item-dialog/gitlab-item-dialog-view.tsx`
- `src/renderer/src/components/gitlab-item-dialog/gitlab-pipeline-tab.tsx`
- `src/renderer/src/components/gitlab-item-dialog/use-gitlab-details-editing.ts`
- `src/renderer/src/components/gitlab-item-dialog/use-gitlab-item-dialog-effects.ts`
- `src/renderer/src/components/gitlab-item-dialog/use-gitlab-item-dialog-state.ts`
- `src/renderer/src/components/gitlab-item-dialog/use-gitlab-pipeline-actions.ts`
- `src/renderer/src/components/gitlab-item-dialog/use-gitlab-primary-actions.ts`
- `src/renderer/src/components/gitlab-item-dialog/use-gitlab-review-actions.ts`
- `src/renderer/src/components/gitlab-item-dialog-parts.tsx`
- `src/renderer/src/components/HostedReviewUnlinkMenuItem.tsx`
- `src/renderer/src/components/host-row-icon.tsx`
- `src/renderer/src/components/jira-issue-workspace-actions.ts`
- `src/renderer/src/components/jira-issue-workspace-chrome.tsx`
- `src/renderer/src/components/jira-issue-workspace-content.tsx`
- `src/renderer/src/components/jira-user-picker.tsx`
- `src/renderer/src/components/linear-custom-view-table-content.tsx`
- `src/renderer/src/components/linear-issue-activity.tsx`
- `src/renderer/src/components/linear-issue-attribute-filter-coverage-agreement.test.ts`
- `src/renderer/src/components/linear-issue-attribute-filter-coverage-notice.tsx`
- `src/renderer/src/components/linear-issue-attribute-filter-pills.ts`
- `src/renderer/src/components/linear-issue-clipboard.ts`
- `src/renderer/src/components/linear-issue-project-selector.test.tsx`
- `src/renderer/src/components/linear-issue-project-selector.tsx`
- `src/renderer/src/components/linear-issue-sub-issues.tsx`
- `src/renderer/src/components/linear-issue-workspace-api-parity.test.ts`
- `src/renderer/src/components/linear-issue-workspace-detail-state.test.tsx`
- `src/renderer/src/components/linear-issue-workspace-detail-state.ts`
- `src/renderer/src/components/linear-issue-workspace-header.test.ts`
- `src/renderer/src/components/linear-issue-workspace-header.tsx`
- `src/renderer/src/components/linear-issue-workspace-sidebar.tsx`
- `src/renderer/src/components/linear-item-drawer-comment-footer.tsx`
- `src/renderer/src/components/linear-item-drawer-edit-chips-layout.tsx`
- `src/renderer/src/components/linear-item-drawer-edit-controller.tsx`
- `src/renderer/src/components/linear-item-drawer-edit-controls.tsx`
- `src/renderer/src/components/linear-item-drawer-edit-properties-layout.tsx`
- `src/renderer/src/components/linear-item-drawer-edit-section.tsx`
- `src/renderer/src/components/linear-item-drawer-sheet.tsx`
- `src/renderer/src/components/linear-item-drawer-types.ts`
- `src/renderer/src/components/linear-project-overview-content.tsx`
- `src/renderer/src/components/linear-project-overview-metadata.tsx`
- `src/renderer/src/components/linear-project-presentation.test.ts`
- `src/renderer/src/components/linear-project-presentation.ts`
- `src/renderer/src/components/linear-project-table-content.tsx`
- `src/renderer/src/components/linear-project-view-surfaces.test.tsx`
- `src/renderer/src/components/maintenance/update-card/UpdateAvailableCardContent.tsx`
- `src/renderer/src/components/maintenance/update-card/update-card-error-model.test.ts`
- `src/renderer/src/components/maintenance/update-card/update-card-error-model.ts`
...
- `src/renderer/src/components/maintenance/update-card/UpdateCheckFeedback.tsx`
- `src/renderer/src/components/maintenance/update-card/UpdateDownloadCardContent.tsx`
- `src/renderer/src/components/mobile/MobileAndroidInstallHelp.tsx`
- `src/renderer/src/components/native-chat/native-chat-command-marker.ts`
- `src/renderer/src/components/native-chat/native-chat-composer-composition.test.tsx`
- `src/renderer/src/components/native-chat/NativeChatImageAttachmentPreview.tsx`
- `src/renderer/src/components/native-chat/NativeChatMessageList.provider-frame.test.tsx`
- `src/renderer/src/components/native-chat/NativeChatMessageList.test.tsx`
- `src/renderer/src/components/native-chat/NativeChatOrchestrationPausedNotice.test.tsx`
- `src/renderer/src/components/native-chat/NativeChatOrchestrationPausedNotice.tsx`
- `src/renderer/src/components/native-chat/native-chat-prose.ts`
...
- `src/renderer/src/components/native-chat/native-chat-structured-composer-dispatch.ts`
...
- `src/renderer/src/components/native-chat/native-chat-typing-indicator.test.ts`
- `src/renderer/src/components/native-chat/native-chat-typing-indicator.ts`
- `src/renderer/src/components/native-chat/NativeChatWorkingStatus.tsx`
- `src/renderer/src/components/native-chat/structured-agent-session-message-projection.test.ts`
- `src/renderer/src/components/native-chat/structured-agent-session-message-projection.ts`
- `src/renderer/src/components/native-chat/structured-agent-session-outbox-storage.ts`
...
- `src/renderer/src/components/native-chat/use-native-chat-file-link-context.ts`
- `src/renderer/src/components/native-chat/use-native-chat-hook-status.test.ts`
- `src/renderer/src/components/native-chat/use-native-chat-live-session-pending.test.ts`
- `src/renderer/src/components/native-chat/use-native-chat-pty-composer-send.ts`
- `src/renderer/src/components/native-chat/use-native-chat-status-entry.ts`
...
- `src/renderer/src/components/native-chat/use-structured-agent-session-hold.test.tsx`
...
- `src/renderer/src/components/new-workspace/ComposerParentWorktreePicker.test.tsx`
...
- `src/renderer/src/components/new-workspace/new-workspace-composer-card-props.ts`
...
- `src/renderer/src/components/new-workspace/new-workspace-composer-ssh-status.ts`
- `src/renderer/src/components/new-workspace/pick-local-project-folder.ts`
- `src/renderer/src/components/new-workspace/SetProjectLocationDialog.test.tsx`
- `src/renderer/src/components/new-workspace/SetProjectLocationDialog.tsx`
- `src/renderer/src/components/new-workspace/SetProjectLocationForms.tsx`
- `src/renderer/src/components/new-workspace/smart-workspace-cross-repo-dialog.tsx`
- `src/renderer/src/components/new-workspace/smart-workspace-github-direct-link.ts`
- `src/renderer/src/components/new-workspace/smart-workspace-name-field-copy.ts`
- `src/renderer/src/components/new-workspace/smart-workspace-name-field-model.ts`
- `src/renderer/src/components/new-workspace/smart-workspace-name-field-surface.tsx`
- `src/renderer/src/components/new-workspace/smart-workspace-name-input-surface.tsx`
- `src/renderer/src/components/new-workspace/smart-workspace-provider-availability.ts`
- `src/renderer/src/components/new-workspace/smart-workspace-repo-slug.ts`
- `src/renderer/src/components/new-workspace/smart-workspace-source-results-surface.tsx`
- `src/renderer/src/components/new-workspace/smart-workspace-source-row-content.tsx`
- `src/renderer/src/components/new-workspace/use-composer-file-drag-over.ts`
- `src/renderer/src/components/new-workspace/use-smart-workspace-field-availability.ts`
- `src/renderer/src/components/new-workspace/use-smart-workspace-field-focus-controls.ts`
- `src/renderer/src/components/new-workspace/use-smart-workspace-github-search.ts`
- `src/renderer/src/components/new-workspace/use-smart-workspace-gitlab-search.ts`
- `src/renderer/src/components/new-workspace/use-smart-workspace-name-field-actions.ts`
- `src/renderer/src/components/new-workspace/use-smart-workspace-name-field-controller.ts`
- `src/renderer/src/components/new-workspace/use-smart-workspace-name-field-foundation.ts`
- `src/renderer/src/components/new-workspace/use-smart-workspace-name-field-presentation.ts`
- `src/renderer/src/components/new-workspace/use-smart-workspace-name-field-state.ts`
- `src/renderer/src/components/new-workspace/use-smart-workspace-secondary-searches.ts`
- `src/renderer/src/components/NewWorkspaceComposerCard.set-location.test.tsx`
- `src/renderer/src/components/onboarding/onboarding-flow-state.ts`
- `src/renderer/src/components/onboarding/use-onboarding-flow-actions.ts`
- `src/renderer/src/components/onboarding/use-onboarding-flow-telemetry.ts`
- `src/renderer/src/components/pull-request-page/actions/merge-actions.ts`
- `src/renderer/src/components/pull-request-page/actions/panel.tsx`
- `src/renderer/src/components/pull-request-page/cache/file-content.test.ts`
- `src/renderer/src/components/pull-request-page/cache/file-content.ts`
- `src/renderer/src/components/pull-request-page/cache/files-diff-view.ts`
- `src/renderer/src/components/pull-request-page/cache/work-item-details.ts`
- `src/renderer/src/components/pull-request-page/checks/details.tsx`
- `src/renderer/src/components/pull-request-page/checks/details-list-keys.ts`
- `src/renderer/src/components/pull-request-page/checks/details-request.ts`
- `src/renderer/src/components/pull-request-page/checks/fix-dialog.tsx`
- `src/renderer/src/components/pull-request-page/checks/fix-launch.ts`
- `src/renderer/src/components/pull-request-page/checks/layouts.tsx`
- `src/renderer/src/components/pull-request-page/checks/refresh.ts`
- `src/renderer/src/components/pull-request-page/checks/rerun.ts`
- `src/renderer/src/components/pull-request-page/checks/row.tsx`
- `src/renderer/src/components/pull-request-page/checks/tab.tsx`
- `src/renderer/src/components/pull-request-page/checks/toolbar.tsx`
- `src/renderer/src/components/pull-request-page/comments/composer.tsx`
- `src/renderer/src/components/pull-request-page/comments/reply-form.tsx`
- `src/renderer/src/components/pull-request-page/conversation/comment-card.tsx`
- `src/renderer/src/components/pull-request-page/conversation/comment-group.tsx`
- `src/renderer/src/components/pull-request-page/conversation/comments-list.tsx`
- `src/renderer/src/components/pull-request-page/conversation/description.tsx`
- `src/renderer/src/components/pull-request-page/conversation/reply.ts`
- `src/renderer/src/components/pull-request-page/conversation/tab.tsx`
- `src/renderer/src/components/pull-request-page/edit/issue-updates.ts`
- `src/renderer/src/components/pull-request-page/edit/section.tsx`
- `src/renderer/src/components/pull-request-page/files/active-section.ts`
- `src/renderer/src/components/pull-request-page/files/combined-diff-viewer.tsx`
- `src/renderer/src/components/pull-request-page/files/inline-comments.ts`
- `src/renderer/src/components/pull-request-page/files/line-comment.ts`
- `src/renderer/src/components/pull-request-page/files/section-heights.ts`
- `src/renderer/src/components/pull-request-page/files/section-loader.ts`
- `src/renderer/src/components/pull-request-page/files/toolbar.tsx`
- `src/renderer/src/components/pull-request-page/files/view-restore.ts`
- `src/renderer/src/components/pull-request-page/mentions/options.test.ts`
- `src/renderer/src/components/pull-request-page/mentions/options.ts`
- `src/renderer/src/components/pull-request-page/mentions/query.test.ts`
- `src/renderer/src/components/pull-request-page/mentions/query.ts`
- `src/renderer/src/components/pull-request-page/mentions/textarea.tsx`
- `src/renderer/src/components/pull-request-page/page/header.tsx`
- `src/renderer/src/components/pull-request-page/page/surface.tsx`
- `src/renderer/src/components/pull-request-page/page/tabs-shell.tsx`
- `src/renderer/src/components/pull-request-page/page/use-details.ts`
- `src/renderer/src/components/pull-request-page/page/viewed-sync.ts`
- `src/renderer/src/components/pull-request-page/page-types.ts`
- `src/renderer/src/components/pull-request-page/presentation/state-badge.test.ts`
- `src/renderer/src/components/pull-request-page/presentation/state-badge.tsx`
- `src/renderer/src/components/pull-request-page/reviewers/panel.tsx`
- `src/renderer/src/components/pull-request-page/reviewers/picker.tsx`
- `src/renderer/src/components/pull-request-page/reviewers/picker-row.tsx`
- `src/renderer/src/components/pull-request-page/reviewers/request-actions.ts`
- `src/renderer/src/components/pull-request-page/reviewers/requested-list.tsx`
- `src/renderer/src/components/refactor-hook-contract.test-support.ts`
- `src/renderer/src/components/right-sidebar/activity-bar-position-menu.tsx`
- `src/renderer/src/components/right-sidebar/ai-vault-session-identity.test.ts`
- `src/renderer/src/components/right-sidebar/ai-vault-session-identity.ts`
- `src/renderer/src/components/right-sidebar/checks-panel/active-content.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/active-content-props.ts`
- `src/renderer/src/components/right-sidebar/checks-panel/check-and-review-action-dependencies.ts`
- `src/renderer/src/components/right-sidebar/checks-panel/check-details-model.ts`
- `src/renderer/src/components/right-sidebar/checks-panel/check-presentation.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/check-run-details.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/checks-list.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/comment-controls.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/comment-group.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/comment-row.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/comments-list.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/conflict-summary.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/empty-content.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/empty-content-props.ts`
- `src/renderer/src/components/right-sidebar/checks-panel/gitlab-review-client.test.ts`
- `src/renderer/src/components/right-sidebar/checks-panel/gitlab-review-client.ts`
- `src/renderer/src/components/right-sidebar/checks-panel/manual-refresh-dependencies.ts`
- `src/renderer/src/components/right-sidebar/checks-panel/panel-content-rendering.test.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/panel-state-types.ts`
- `src/renderer/src/components/right-sidebar/checks-panel/review-state-dependencies.ts`
- `src/renderer/src/components/right-sidebar/checks-panel/triage-strip.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-list-state.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-ai-acknowledgement.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-ai-queue.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-branch-actions.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-check-and-review-actions.test.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-check-and-review-actions.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-comment-mutations.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-comment-resolution.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-composer-state.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-conflict-refresh.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-context-state.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-controller-state.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-create-review.test.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-create-review.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-entry-refresh-and-title-actions.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-foreground-effects.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-generation.test.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-generation.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-git-status-effects.test.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-git-status-effects.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-manual-refresh.test.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-manual-refresh.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-polling.test.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-polling.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-review-data.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-review-link-actions.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-checks-panel-review-state.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-comments-list-state.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel/use-unlink-github-pull-request.ts`
- `src/renderer/src/components/right-sidebar/CreateHostedReviewBasePicker.tsx`
- `src/renderer/src/components/right-sidebar/create-hosted-review-button-label.ts`
- `src/renderer/src/components/right-sidebar/create-hosted-review-composer-field-class.ts`
- `src/renderer/src/components/right-sidebar/CreateHostedReviewComposerMessage.tsx`
- `src/renderer/src/components/right-sidebar/create-pull-request-base-ref-normalization.ts`
- `src/renderer/src/components/right-sidebar/create-pull-request-dialog-field-model.ts`
- `src/renderer/src/components/right-sidebar/file-explorer-drag-edge-scroll.ts`
- `src/renderer/src/components/right-sidebar/file-explorer-element-tree-test-harness.ts`
...
- `src/renderer/src/components/right-sidebar/FileExplorerNameFilter.test.tsx`
- `src/renderer/src/components/right-sidebar/file-explorer-name-filter-projection.test.ts`
- `src/renderer/src/components/right-sidebar/FileExplorerRow.actions.test.tsx`
...
- `src/renderer/src/components/right-sidebar/FileExplorerToolbar.test.tsx`
- `src/renderer/src/components/right-sidebar/file-explorer-tree-node-test-fixtures.ts`
- `src/renderer/src/components/right-sidebar/FileExplorerViewSwitch.test.tsx`
- `src/renderer/src/components/right-sidebar/FileExplorerVirtualRows.row-handlers.test.tsx`
- `src/renderer/src/components/right-sidebar/github-pr-link-modal.test.ts`
- `src/renderer/src/components/right-sidebar/github-pr-link-modal.ts`
- `src/renderer/src/components/right-sidebar/HostedReviewActions.draft.test.tsx`
- `src/renderer/src/components/right-sidebar/hosted-review-gitlab-actions.ts`
- `src/renderer/src/components/right-sidebar/local-port-details-dialog.tsx`
- `src/renderer/src/components/right-sidebar/local-port-row.tsx`
...
- `src/renderer/src/components/right-sidebar/pr-comment-snapshotted-thread-resolver.test.ts`
- `src/renderer/src/components/right-sidebar/pr-comment-snapshotted-thread-resolver.ts`
- `src/renderer/src/components/right-sidebar/right-panel-comment-composer.ime-enter.test.tsx`
- `src/renderer/src/components/right-sidebar/right-sidebar-top-activity-bar.tsx`
- `src/renderer/src/components/right-sidebar/source-control/ai/controller-types.ts`
- `src/renderer/src/components/right-sidebar/source-control/ai/prompts.ts`
- `src/renderer/src/components/right-sidebar/source-control/ai/recipe-persistence.ts`
- `src/renderer/src/components/right-sidebar/source-control/ai/recovery-launch.ts`
- `src/renderer/src/components/right-sidebar/source-control/ai/text-generation-defaults.ts`
- `src/renderer/src/components/right-sidebar/source-control/ai/text-generation-dialog.tsx`
- `src/renderer/src/components/right-sidebar/source-control/ai/text-generation-dialog-form.tsx`
- `src/renderer/src/components/right-sidebar/source-control/ai/text-generation-params.ts`
- `src/renderer/src/components/right-sidebar/source-control/ai/use-ai.ts`
- `src/renderer/src/components/right-sidebar/source-control/ai/use-recovery-ai.ts`
- `src/renderer/src/components/right-sidebar/source-control/commit/bulk-action-bar.tsx`
...
- `src/renderer/src/components/right-sidebar/source-control/commit/commit-area-types.ts`
- `src/renderer/src/components/right-sidebar/source-control/commit/commit-drafts.ts`
- `src/renderer/src/components/right-sidebar/source-control/commit/commit-failure-summary.ts`
...
- `src/renderer/src/components/right-sidebar/source-control/commit/component-gates.ts`
...
- `src/renderer/src/components/right-sidebar/source-control/commit/pull-policy-error-notice.tsx`
- `src/renderer/src/components/right-sidebar/source-control/commit/recovery-notice.tsx`
- `src/renderer/src/components/right-sidebar/source-control/commit/use-bulk-actions.ts`
- `src/renderer/src/components/right-sidebar/source-control/commit/use-commit-action.ts`
- `src/renderer/src/components/right-sidebar/source-control/commit/use-commit-flows.ts`
- `src/renderer/src/components/right-sidebar/source-control/commit/use-commit-message-generation.ts`
- `src/renderer/src/components/right-sidebar/source-control/commit/use-discard-confirmation.ts`
- `src/renderer/src/components/right-sidebar/source-control/commit/use-entry-mutations.ts`
- `src/renderer/src/components/right-sidebar/source-control/listing/action-button.tsx`
- `src/renderer/src/components/right-sidebar/source-control/listing/active-open-file-keys.ts`
- `src/renderer/src/components/right-sidebar/source-control/listing/branch-entry-row.tsx`
- `src/renderer/src/components/right-sidebar/source-control/listing/branch-section.tsx`
- `src/renderer/src/components/right-sidebar/source-control/listing/conflict-badge.tsx`
- `src/renderer/src/components/right-sidebar/source-control/listing/conflict-label.ts`
- `src/renderer/src/components/right-sidebar/source-control/listing/conflict-status-cards.tsx`
- `src/renderer/src/components/right-sidebar/source-control/listing/content-status.tsx`
...
- `src/renderer/src/components/right-sidebar/source-control/listing/operation-target.ts`
...
- `src/renderer/src/components/right-sidebar/source-control/listing/split-open.ts`
- `src/renderer/src/components/right-sidebar/source-control/listing/submodule-expansion.ts`
- `src/renderer/src/components/right-sidebar/source-control/listing/submodule-placeholder-row.tsx`
...
- `src/renderer/src/components/right-sidebar/source-control/listing/use-file-listing.ts`
- `src/renderer/src/components/right-sidebar/source-control/listing/use-file-projection.ts`
- `src/renderer/src/components/right-sidebar/source-control/listing/use-row-opening.ts`
- `src/renderer/src/components/right-sidebar/source-control/listing/use-selection.ts`
- `src/renderer/src/components/right-sidebar/source-control/listing/use-store-actions.ts`
- `src/renderer/src/components/right-sidebar/source-control/listing/use-submodule-status.ts`
- `src/renderer/src/components/right-sidebar/source-control/listing/use-worktree-context.ts`
- `src/renderer/src/components/right-sidebar/source-control/listing/virtual-file-list.tsx`
- `src/renderer/src/components/right-sidebar/source-control/notes/copy-feedback.ts`
- `src/renderer/src/components/right-sidebar/source-control/notes/diff-comments-clear-dialog-state.ts`
- `src/renderer/src/components/right-sidebar/source-control/notes/diff-comments-list.tsx`
- `src/renderer/src/components/right-sidebar/source-control/notes/editor-reveal-frames.ts`
- `src/renderer/src/components/right-sidebar/source-control/notes/notes-shelf.tsx`
- `src/renderer/src/components/right-sidebar/source-control/notes/use-diff-comment-notes.ts`
- `src/renderer/src/components/right-sidebar/source-control/notes/use-note-opening.ts`
- `src/renderer/src/components/right-sidebar/source-control/panel/branch-context-row.tsx`
- `src/renderer/src/components/right-sidebar/source-control/panel/branch-context-stats.ts`
...
- `src/renderer/src/components/right-sidebar/source-control/panel/dialog-layer.tsx`
- `src/renderer/src/components/right-sidebar/source-control/panel/fork-push-notice.tsx`
- `src/renderer/src/components/right-sidebar/source-control/panel/fork-push-target-label.ts`
- `src/renderer/src/components/right-sidebar/source-control/panel/header-icon-button.tsx`
...
- `src/renderer/src/components/right-sidebar/source-control/panel/panel-dialogs.tsx`
- `src/renderer/src/components/right-sidebar/source-control/panel/panel-props.ts`
- `src/renderer/src/components/right-sidebar/source-control/panel/panel-ready.tsx`
- `src/renderer/src/components/right-sidebar/source-control/panel/use-panel-foundation.ts`
- `src/renderer/src/components/right-sidebar/source-control/panel/use-panel-model.ts`
- `src/renderer/src/components/right-sidebar/source-control/panel/use-panel-state.ts`
- `src/renderer/src/components/right-sidebar/source-control/panel/use-panel-view-state.ts`
- `src/renderer/src/components/right-sidebar/source-control/panel/use-worktree-operation-state.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/create-pr-intent-branch-prep.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/create-pr-intent-flow.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/create-pr-intent-review-step.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/create-pr-intent-run-snapshot.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/create-pr-intent-state.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/hosted-review-creation-eligibility-snapshot.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/hosted-review-creation-state.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/hosted-review-header-chrome.tsx`
- `src/renderer/src/components/right-sidebar/source-control/review/hosted-review-push-target.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/manual-review-url.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/primary-create-pr-intent-action.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/remote-repo.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/suppressed-github-pr.test.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/suppressed-github-pr.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/use-action-dispatch.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/use-action-model.test.tsx`
- `src/renderer/src/components/right-sidebar/source-control/review/use-action-model.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/use-create-pr-intent-commit-message.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/use-create-pr-intent-flows.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/use-create-pr-intent-probes.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/use-create-pr-intent-review.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/use-create-pr-intent-run.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/use-create-pr-intent-target.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/use-create-review-composer.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/use-hosted-review-created.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/use-hosted-review-creation.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/use-hosted-review-eligibility.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/use-hosted-review-polling.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/use-hosted-review-provider-hint.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/use-hosted-review-state.test.tsx`
- `src/renderer/src/components/right-sidebar/source-control/review/use-hosted-review-state.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/use-linked-reviews.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/use-pull-request-generation.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/use-review-context.ts`
- `src/renderer/src/components/right-sidebar/source-control/review/use-review-flows.ts`
- `src/renderer/src/components/right-sidebar/source-control/sync/action-error.ts`
- `src/renderer/src/components/right-sidebar/source-control/sync/base-ref-resolution.ts`
- `src/renderer/src/components/right-sidebar/source-control/sync/compare-summary.tsx`
- `src/renderer/src/components/right-sidebar/source-control/sync/git-history-commit-context-menu.tsx`
- `src/renderer/src/components/right-sidebar/source-control/sync/git-history-commit-files.tsx`
- `src/renderer/src/components/right-sidebar/source-control/sync/git-history-format.ts`
- `src/renderer/src/components/right-sidebar/source-control/sync/git-history-graph-svg.tsx`
- `src/renderer/src/components/right-sidebar/source-control/sync/git-history-panel.tsx`
- `src/renderer/src/components/right-sidebar/source-control/sync/git-history-row.tsx`
- `src/renderer/src/components/right-sidebar/source-control/sync/push-recovery.ts`
- `src/renderer/src/components/right-sidebar/source-control/sync/remote-refresh.ts`
- `src/renderer/src/components/right-sidebar/source-control/sync/use-base-ref-default.ts`
- `src/renderer/src/components/right-sidebar/source-control/sync/use-base-refs.ts`
- `src/renderer/src/components/right-sidebar/source-control/sync/use-branch-compare.ts`
- `src/renderer/src/components/right-sidebar/source-control/sync/use-branch-line-total-gate.ts`
- `src/renderer/src/components/right-sidebar/source-control/sync/use-conflict-abort.ts`
- `src/renderer/src/components/right-sidebar/source-control/sync/use-git-history.ts`
- `src/renderer/src/components/right-sidebar/source-control/sync/use-git-history-commit-actions.ts`
- `src/renderer/src/components/right-sidebar/source-control/sync/use-remote-action-runner.ts`
- `src/renderer/src/components/right-sidebar/source-control/sync/use-status-refresh.ts`
- `src/renderer/src/components/right-sidebar/source-control/sync/use-upstream-status-fetch.ts`
- `src/renderer/src/components/right-sidebar/source-control-branch-section-heading.test.tsx`
- `src/renderer/src/components/right-sidebar/source-control-created-review-link.test.ts`
- `src/renderer/src/components/right-sidebar/source-control-created-review-link.ts`
- `src/renderer/src/components/right-sidebar/source-control-dropdown-action-context.ts`
- `src/renderer/src/components/right-sidebar/source-control-dropdown-commit-items.ts`
- `src/renderer/src/components/right-sidebar/source-control-dropdown-item-types.ts`
...
- `src/renderer/src/components/right-sidebar/source-control-dropdown-review-items.ts`
- `src/renderer/src/components/right-sidebar/source-control-hook-test-harness.tsx`
- `src/renderer/src/components/right-sidebar/ssh-detected-port-row.tsx`
- `src/renderer/src/components/right-sidebar/ssh-forwarded-port-row.tsx`
- `src/renderer/src/components/right-sidebar/ssh-port-forward-dialog.tsx`
- `src/renderer/src/components/right-sidebar/ssh-ports-panel.tsx`
- `src/renderer/src/components/right-sidebar/use-create-pull-request-base-ref-discovery.ts`
- `src/renderer/src/components/right-sidebar/useCreatePullRequestDialogFields.repo-default.test.ts`
- `src/renderer/src/components/right-sidebar/use-create-pull-request-field-generation.ts`
- `src/renderer/src/components/right-sidebar/use-create-pull-request-field-seeding.ts`
- `src/renderer/src/components/right-sidebar/use-file-explorer-background-menu.ts`
- `src/renderer/src/components/right-sidebar/useFileExplorerDragEdgeScroll.ts`
- `src/renderer/src/components/right-sidebar/useFileExplorerDragExpand.ts`
- `src/renderer/src/components/right-sidebar/useFileExplorerMoveDrop.ts`
- `src/renderer/src/components/right-sidebar/use-file-explorer-name-filter.ts`
- `src/renderer/src/components/right-sidebar/use-file-explorer-node-commands.ts`
- `src/renderer/src/components/right-sidebar/use-file-explorer-row-scrolling.ts`
...
- `src/renderer/src/components/right-sidebar/useHostedReviewStackParent.test.tsx`
- `src/renderer/src/components/right-sidebar/useHostedReviewStackParent.ts`
- `src/renderer/src/components/right-sidebar/use-ready-hosted-review-action.ts`
- `src/renderer/src/components/right-sidebar/use-right-sidebar-activity-items.ts`
- `src/renderer/src/components/right-sidebar/use-right-sidebar-tab-routing.ts`
- `src/renderer/src/components/right-sidebar/use-source-control-branch-compare.test.tsx`
- `src/renderer/src/components/right-sidebar/use-source-control-git-history.test.tsx`
- `src/renderer/src/components/right-sidebar/use-window-width.ts`
- `src/renderer/src/components/settings/accounts-pane-account-actions.ts`
- `src/renderer/src/components/settings/accounts-pane-action-errors.ts`
- `src/renderer/src/components/settings/accounts-pane-claude-section.tsx`
- `src/renderer/src/components/settings/accounts-pane-codex-account-row.tsx`
- `src/renderer/src/components/settings/accounts-pane-codex-section.tsx`
- `src/renderer/src/components/settings/accounts-pane-config-sync.ts`
- `src/renderer/src/components/settings/accounts-pane-location-section.tsx`
...
- `src/renderer/src/components/settings/accounts-pane-removal-dialogs.tsx`
- `src/renderer/src/components/settings/accounts-pane-runtime.ts`
- `src/renderer/src/components/settings/accounts-pane-types.ts`
- `src/renderer/src/components/settings/agent-availability-settings.test.ts`
- `src/renderer/src/components/settings/agent-availability-settings.ts`
- `src/renderer/src/components/settings/AgentCatalogRow.tsx`
- `src/renderer/src/components/settings/AgentDefaultSetting.tsx`
- `src/renderer/src/components/settings/AgentDetectionCatalog.tsx`
- `src/renderer/src/components/settings/AgentLaunchDefaultsEditor.tsx`
- `src/renderer/src/components/settings/agent-skill-terminal-snapshot.ts`
- `src/renderer/src/components/settings/bitbucket-credentials-dialog.tsx`
- `src/renderer/src/components/settings/bitbucket-integration-card.tsx`
- `src/renderer/src/components/settings/browser-client-hosted-remote-copy.ts`
- `src/renderer/src/components/settings/BrowserClientHostedRemoteSetting.test.tsx`
- `src/renderer/src/components/settings/BrowserClientHostedRemoteSetting.tsx`
- `src/renderer/src/components/settings/browser-ssh-workspace-routing-copy.ts`
- `src/renderer/src/components/settings/BrowserSshWorkspaceRoutingSetting.test.tsx`
- `src/renderer/src/components/settings/BrowserSshWorkspaceRoutingSetting.tsx`
- `src/renderer/src/components/settings/cli-install-failure.test.ts`
- `src/renderer/src/components/settings/cli-install-failure.ts`
- `src/renderer/src/components/settings/CliSection.install-failure.test.tsx`
- `src/renderer/src/components/settings/DiffShowWhitespaceSetting.test.tsx`
- `src/renderer/src/components/settings/DiffShowWhitespaceSetting.tsx`
- `src/renderer/src/components/settings/EphemeralVmCleanupStopDialog.tsx`
- `src/renderer/src/components/settings/EphemeralVmRuntimeRow.tsx`
...
- `src/renderer/src/components/settings/GlobalWorktreeVisibilitySourcesSetting.tsx`
- `src/renderer/src/components/settings/HiddenExperimentalGroup.test.tsx`
- `src/renderer/src/components/settings/native-chat-experimental-search-entry.test.ts`
- `src/renderer/src/components/settings/NativeChatSupportedAgents.test.tsx`
- `src/renderer/src/components/settings/NativeChatSupportedAgents.tsx`
- `src/renderer/src/components/settings/nested-worker-depth-copy.ts`
- `src/renderer/src/components/settings/QuickCommandsList.test.tsx`
- `src/renderer/src/components/settings/QuickCommandsToolbar.tsx`
- `src/renderer/src/components/settings/RepositoryForkSyncSection.test.tsx`
- `src/renderer/src/components/settings/RepositoryHookPolicySettings.tsx`
- `src/renderer/src/components/settings/RepositoryHookScriptSetting.tsx`
- `src/renderer/src/components/settings/repository-hook-settings-draft.test.ts`
- `src/renderer/src/components/settings/repository-hook-settings-draft.ts`
- `src/renderer/src/components/settings/RepositoryHooksYamlStatus.tsx`
- `src/renderer/src/components/settings/RepositoryIssueCommandSetting.tsx`
- `src/renderer/src/components/settings/runtime-active-server-section.tsx`
- `src/renderer/src/components/settings/runtime-environment-dialogs.tsx`
- `src/renderer/src/components/settings/runtime-environment-host-details.ts`
- `src/renderer/src/components/settings/runtime-environment-selection.ts`
- `src/renderer/src/components/settings/runtime-server-row.tsx`
- `src/renderer/src/components/settings/runtime-servers-connect-section.tsx`
- `src/renderer/src/components/settings/runtime-server-workflow-sections.tsx`
- `src/renderer/src/components/settings/settings-advanced-section-renderers.tsx`
- `src/renderer/src/components/settings/settings-capability-section-renderers.tsx`
- `src/renderer/src/components/settings/settings-deep-link-target-watcher.test.ts`
- `src/renderer/src/components/settings/settings-deep-link-target-watcher.ts`
...
- `src/renderer/src/components/settings/settings-project-section-renderer.tsx`
- `src/renderer/src/components/settings/settings-remote-security-section-renderers.tsx`
- `src/renderer/src/components/settings/settings-render-context.ts`
- `src/renderer/src/components/settings/settings-setup-workflow-section-renderers.tsx`
- `src/renderer/src/components/settings/settings-view-model.ts`
- `src/renderer/src/components/settings/ShareSkillsSettingsPane.test.tsx`
- `src/renderer/src/components/settings/ShareSkillsSettingsPane.tsx`
- `src/renderer/src/components/settings/share-skills-settings-search.ts`
- `src/renderer/src/components/settings/ShortcutCommandBlock.test.tsx`
- `src/renderer/src/components/settings/shortcut-definition-catalog.test.ts`
- `src/renderer/src/components/settings/shortcut-row-visibility.test.ts`
- `src/renderer/src/components/settings/shortcut-row-visibility.ts`
- `src/renderer/src/components/settings/SshTargetCard.test.tsx`
- `src/renderer/src/components/settings/use-cli-registration-actions.ts`
- `src/renderer/src/components/settings/use-mac-captured-digit-chords.test.ts`
- `src/renderer/src/components/settings/use-mac-captured-digit-chords.ts`
- `src/renderer/src/components/settings/use-repository-hook-settings-draft.test.tsx`
- `src/renderer/src/components/settings/use-repository-hook-settings-draft.ts`
- `src/renderer/src/components/settings/use-repository-issue-command.ts`
...
- `src/renderer/src/components/settings/use-settings-interaction-controller.ts`
- `src/renderer/src/components/settings/use-settings-navigation-model.ts`
- `src/renderer/src/components/settings/use-settings-page-effects.ts`
- `src/renderer/src/components/settings/use-settings-repo-scroll-effects.ts`
- `src/renderer/src/components/settings/use-settings-store-model.ts`
- `src/renderer/src/components/settings/use-settings-terminal-model.ts`
- `src/renderer/src/components/sidebar/add-repo-browse-authority.test.ts`
- `src/renderer/src/components/sidebar/add-repo-browse-authority.ts`
- `src/renderer/src/components/sidebar/default-branch-workspace.ts`
- `src/renderer/src/components/sidebar/delete-worktree-dialog-force-delete.ts`
- `src/renderer/src/components/sidebar/delete-worktree-dirty-change-counts.test.ts`
- `src/renderer/src/components/sidebar/delete-worktree-lineage-delete-all.ts`
- `src/renderer/src/components/sidebar/DeleteWorktreeTargetPreview.test.tsx`
- `src/renderer/src/components/sidebar/folder-workspace-host-id.ts`
- `src/renderer/src/components/sidebar/HiddenWorktreeRecoveryList.tsx`
- `src/renderer/src/components/sidebar/host-section-folder-workspace-counts.test.ts`
- `src/renderer/src/components/sidebar/hovered-workspace-delete.test.ts`
...
- `src/renderer/src/components/sidebar/pinned-section-worktrees.test.ts`
- `src/renderer/src/components/sidebar/pinned-section-worktrees.ts`
- `src/renderer/src/components/sidebar/RemoteFileBrowserBreadcrumbs.tsx`
- `src/renderer/src/components/sidebar/RemoteFileBrowserEntryList.tsx`
- `src/renderer/src/components/sidebar/remote-file-browser-path-preview-resolver.ts`
...
- `src/renderer/src/components/sidebar/sidebar-empty-state-gate.test.ts`
- `src/renderer/src/components/sidebar/sidebar-empty-state-gate.ts`
- `src/renderer/src/components/sidebar/sidebar-filter-actions.ts`
- `src/renderer/src/components/sidebar/SidebarHeader.test.tsx`
- `src/renderer/src/components/sidebar/stale-agent-row-unverifiable.test.ts`
- `src/renderer/src/components/sidebar/use-remote-file-browser-filter-key-commands.ts`
- `src/renderer/src/components/sidebar/use-remote-file-browser-listing.ts`
- `src/renderer/src/components/sidebar/use-remote-file-browser-path-preview.ts`
- `src/renderer/src/components/sidebar/use-repo-owner-visibility-defaults.ts`
- `src/renderer/src/components/sidebar/use-sidebar-feedback-environment-prefill.ts`
- `src/renderer/src/components/sidebar/use-sidebar-feedback-images.ts`
- `src/renderer/src/components/sidebar/use-visible-workspace-kanban-worktree-ids.test.tsx`
- `src/renderer/src/components/sidebar/use-workspace-board-task-status-sync.ts`
- `src/renderer/src/components/sidebar/use-workspace-kanban-board-projection.ts`
- `src/renderer/src/components/sidebar/use-workspace-kanban-drawer-lingering.test.tsx`
- `src/renderer/src/components/sidebar/use-workspace-kanban-drawer-lingering.ts`
- `src/renderer/src/components/sidebar/use-workspace-kanban-native-drag.ts`
- `src/renderer/src/components/sidebar/use-workspace-kanban-render-lifecycle.ts`
- `src/renderer/src/components/sidebar/use-workspace-kanban-status-actions.ts`
- `src/renderer/src/components/sidebar/use-workspace-kanban-worktree-actions.ts`
- `src/renderer/src/components/sidebar/use-worktree-card-secondary-details.store-subscriptions.test.tsx`
- `src/renderer/src/components/sidebar/use-worktree-context-menu-commands.ts`
- `src/renderer/src/components/sidebar/use-worktree-context-menu-model.tsx`
- `src/renderer/src/components/sidebar/use-worktree-context-menu-secondary-actions.ts`
- `src/renderer/src/components/sidebar/use-worktree-parent-picker-transition.ts`
- `src/renderer/src/components/sidebar/visible-worktree-host-scope.ts`
- `src/renderer/src/components/sidebar/visible-worktree-kinds.ts`
- `src/renderer/src/components/sidebar/workspace-kanban-area-selection-state.ts`
- `src/renderer/src/components/sidebar/WorkspaceKanbanCard.host-identity.test.tsx`
- `src/renderer/src/components/sidebar/WorkspaceKanbanDrawerView.tsx`
- `src/renderer/src/components/sidebar/workspace-kanban-pointer-drag-selection.ts`
- `src/renderer/src/components/sidebar/WorkspaceKanbanSheet.tsx`
- `src/renderer/src/components/sidebar/worktree-agent-row-orchestration.ts`
- `src/renderer/src/components/sidebar/worktree-agent-row-type.ts`
- `src/renderer/src/components/sidebar/worktree-card-agent-ack-inputs.test.tsx`
- `src/renderer/src/components/sidebar/worktree-card-agent-ack-inputs.ts`
- `src/renderer/src/components/sidebar/worktree-card-agent-summary.test.ts`
- `src/renderer/src/components/sidebar/WorktreeCardAutomationDetailSection.test.tsx`
- `src/renderer/src/components/sidebar/WorktreeContextMenu.delete-shortcut.test.tsx`
- `src/renderer/src/components/sidebar/WorktreeContextMenu.react185-bystander.test.tsx`
- `src/renderer/src/components/sidebar/WorktreeContextMenuOverlays.tsx`
...
- `src/renderer/src/components/sidebar/worktree-delete-request.test.ts`
- `src/renderer/src/components/sidebar/worktree-delete-state-host-match.ts`
- `src/renderer/src/components/sidebar/WorktreeList.empty-project-rows.test.ts`
- `src/renderer/src/components/sidebar/WorktreeList.folder-workspace-rows.test.ts`
- `src/renderer/src/components/sidebar/WorktreeList.group-headers.test.ts`
- `src/renderer/src/components/sidebar/worktree-list/drag/drop-commit-context.ts`
- `src/renderer/src/components/sidebar/worktree-list/drag/groups.ts`
- `src/renderer/src/components/sidebar/worktree-list/drag/pointer-commit.ts`
- `src/renderer/src/components/sidebar/worktree-list/drag/pointer-flush.ts`
...
- `src/renderer/src/components/sidebar/worktree-list/drag/use-document-drop.ts`
- `src/renderer/src/components/sidebar/worktree-list/drag/use-drop-commit-context.ts`
- `src/renderer/src/components/sidebar/worktree-list/drag/use-header-drag.ts`
- `src/renderer/src/components/sidebar/worktree-list/drag/use-lineage-drop-commit.ts`
- `src/renderer/src/components/sidebar/worktree-list/drag/use-native-autoscroll.ts`
- `src/renderer/src/components/sidebar/worktree-list/drag/use-native-drag.ts`
- `src/renderer/src/components/sidebar/worktree-list/drag/use-pointer-autoscroll.ts`
- `src/renderer/src/components/sidebar/worktree-list/drag/use-pointer-drag.ts`
- `src/renderer/src/components/sidebar/worktree-list/drag/use-pointer-window-events.ts`
- `src/renderer/src/components/sidebar/worktree-list/drag/use-runtime.ts`
- `src/renderer/src/components/sidebar/worktree-list/drag/use-session.ts`
...
- `src/renderer/src/components/sidebar/worktree-list/grouping/build-rows.folder-workspace-lanes.test.ts`
...
- `src/renderer/src/components/sidebar/worktree-list/grouping/folder-workspace-lanes.ts`
- `src/renderer/src/components/sidebar/worktree-list/grouping/group-keys.ts`
- `src/renderer/src/components/sidebar/worktree-list/grouping/group-sections.ts`
- `src/renderer/src/components/sidebar/worktree-list/grouping/host-labels.ts`
- `src/renderer/src/components/sidebar/worktree-list/grouping/imported-rows.test.ts`
- `src/renderer/src/components/sidebar/worktree-list/grouping/pinned-group-rows.ts`
- `src/renderer/src/components/sidebar/worktree-list/grouping/project-grouping.ts`
- `src/renderer/src/components/sidebar/worktree-list/grouping/project-group-sections.ts`
- `src/renderer/src/components/sidebar/worktree-list/grouping/row-builders.ts`
- `src/renderer/src/components/sidebar/worktree-list/grouping/row-types.ts`
- `src/renderer/src/components/sidebar/worktree-list/grouping/section-order.ts`
- `src/renderer/src/components/sidebar/worktree-list/grouping/worktree-grouping.ts`
- `src/renderer/src/components/sidebar/worktree-list/grouping/worktree-group-keys.ts`
- `src/renderer/src/components/sidebar/worktree-list/listing/EmptyState.tsx`
- `src/renderer/src/components/sidebar/worktree-list/listing/host-filtering.test.ts`
- `src/renderer/src/components/sidebar/worktree-list/listing/host-filtering.ts`
- `src/renderer/src/components/sidebar/worktree-list/listing/renderable-rows.ts`
- `src/renderer/src/components/sidebar/worktree-list/listing/render-row.ts`
- `src/renderer/src/components/sidebar/worktree-list/listing/review-cache-inputs.test.ts`
- `src/renderer/src/components/sidebar/worktree-list/listing/review-cache-inputs.ts`
- `src/renderer/src/components/sidebar/worktree-list/listing/use-agent-send-target.ts`
- `src/renderer/src/components/sidebar/worktree-list/listing/use-collapsed-groups.ts`
- `src/renderer/src/components/sidebar/worktree-list/listing/use-external-worktree-cards.ts`
- `src/renderer/src/components/sidebar/worktree-list/listing/use-filters.ts`
- `src/renderer/src/components/sidebar/worktree-list/listing/use-folder-path-statuses.ts`
- `src/renderer/src/components/sidebar/worktree-list/listing/use-host-visible-scope.ts`
- `src/renderer/src/components/sidebar/worktree-list/listing/use-reused-array-identity.ts`
- `src/renderer/src/components/sidebar/worktree-list/listing/use-section-rows.ts`
- `src/renderer/src/components/sidebar/worktree-list/listing/use-sort-order.ts`
- `src/renderer/src/components/sidebar/worktree-list/listing/use-visible-worktrees.test.tsx`
- `src/renderer/src/components/sidebar/worktree-list/listing/use-visible-worktrees.ts`
- `src/renderer/src/components/sidebar/worktree-list/navigation/active-descendant-option.test.ts`
- `src/renderer/src/components/sidebar/worktree-list/navigation/active-descendant-option.ts`
- `src/renderer/src/components/sidebar/worktree-list/navigation/folder-reveal.test.ts`
- `src/renderer/src/components/sidebar/worktree-list/navigation/folder-reveal.ts`
- `src/renderer/src/components/sidebar/worktree-list/navigation/mounted-row-reveal.ts`
- `src/renderer/src/components/sidebar/worktree-list/navigation/pending-reveal-inputs.ts`
- `src/renderer/src/components/sidebar/worktree-list/navigation/render-row-lookup.folder-workspace.test.ts`
- `src/renderer/src/components/sidebar/worktree-list/navigation/render-row-lookup.ts`
- `src/renderer/src/components/sidebar/worktree-list/navigation/reveal-ancestors.ts`
- `src/renderer/src/components/sidebar/worktree-list/navigation/use-active-row.ts`
...
- `src/renderer/src/components/sidebar/worktree-list/navigation/use-reveal-highlight.ts`
- `src/renderer/src/components/sidebar/worktree-list/navigation/use-reveal-requests.ts`
- `src/renderer/src/components/sidebar/worktree-list/navigation/use-selection.ts`
- `src/renderer/src/components/sidebar/worktree-list/navigation/use-selection-host-collision.test.tsx`
- `src/renderer/src/components/sidebar/worktree-list/rows/FolderPathStatusIndicator.test.tsx`
- `src/renderer/src/components/sidebar/worktree-list/rows/FolderPathStatusIndicator.tsx`
- `src/renderer/src/components/sidebar/worktree-list/rows/folder-row.tsx`
- `src/renderer/src/components/sidebar/worktree-list/rows/header-event-guards.ts`
...
- `src/renderer/src/components/sidebar/worktree-list/rows/indentation.ts`
- `src/renderer/src/components/sidebar/worktree-list/rows/item-row.tsx`
- `src/renderer/src/components/sidebar/worktree-list/rows/notice-rows.tsx`
- `src/renderer/src/components/sidebar/worktree-list/rows/option-dom.ts`
- `src/renderer/src/components/sidebar/worktree-list/rows/option-dom-host-collision.test.ts`
- `src/renderer/src/components/sidebar/worktree-list/rows/ProjectGroupDialogs.tsx`
- `src/renderer/src/components/sidebar/worktree-list/rows/project-group-header-actions.tsx`
...
- `src/renderer/src/components/sidebar/worktree-list/rows/use-project-group-dialogs.ts`
- `src/renderer/src/components/sidebar/worktree-list/rows/use-project-group-dialogs-owner-host.test.tsx`
- `src/renderer/src/components/sidebar/worktree-list/rows/virtual-row-dispatch.tsx`
- `src/renderer/src/components/sidebar/worktree-list/viewport/drop-indicators.tsx`
- `src/renderer/src/components/sidebar/worktree-list/viewport/hard-scroll-up.test.ts`
- `src/renderer/src/components/sidebar/worktree-list/viewport/hard-scroll-up.ts`
- `src/renderer/src/components/sidebar/worktree-list/viewport/scroll-adjustment.test.ts`
- `src/renderer/src/components/sidebar/worktree-list/viewport/sticky-headers.test.ts`
- `src/renderer/src/components/sidebar/worktree-list/viewport/use-group-toggle.ts`
- `src/renderer/src/components/sidebar/worktree-list/viewport/use-row-measurement.ts`
- `src/renderer/src/components/sidebar/worktree-list/viewport/use-row-removal-animation.test.ts`
- `src/renderer/src/components/sidebar/worktree-list/viewport/use-row-removal-animation.ts`
- `src/renderer/src/components/sidebar/worktree-list/viewport/use-scroll-suppression.ts`
- `src/renderer/src/components/sidebar/worktree-list/viewport/use-scroll-to-top.test.ts`
- `src/renderer/src/components/sidebar/worktree-list/viewport/use-scroll-to-top.test.tsx`
- `src/renderer/src/components/sidebar/worktree-list/viewport/use-scroll-to-top.ts`
- `src/renderer/src/components/sidebar/worktree-list/viewport/use-virtualizer.ts`
- `src/renderer/src/components/sidebar/worktree-list/viewport/use-visible-review-refresh.ts`
- `src/renderer/src/components/sidebar/worktree-list/viewport/viewport-props.ts`
...
- `src/renderer/src/components/sidebar/worktree-list/viewport/virtual-rows.test.ts`
- `src/renderer/src/components/sidebar/worktree-list/viewport/virtual-rows.ts`
- `src/renderer/src/components/sidebar/worktree-list/viewport/visible-refresh.test.ts`
- `src/renderer/src/components/sidebar/worktree-list-card-markup-queries.ts`
- `src/renderer/src/components/sidebar/worktree-list-groups-host-collision.test.ts`
- `src/renderer/src/components/sidebar/worktree-list-groups-host-labels.test.ts`
- `src/renderer/src/components/sidebar/worktree-list-groups-imported-worktrees.test.ts`
- `src/renderer/src/components/sidebar/worktree-list-groups-lineage-nesting.test.ts`
- `src/renderer/src/components/sidebar/worktree-list-groups-nested-project-groups.test.ts`
- `src/renderer/src/components/sidebar/worktree-list-groups-notice-host-labels.test.ts`
- `src/renderer/src/components/sidebar/worktree-list-groups-pending-creations.test.ts`
- `src/renderer/src/components/sidebar/worktree-list-groups-project-groups.test.ts`
- `src/renderer/src/components/sidebar/worktree-list-groups-project-host-setups.test.ts`
- `src/renderer/src/components/sidebar/worktree-list-groups-project-order.test.ts`
- `src/renderer/src/components/sidebar/worktree-list-groups-section-label-disambiguation.test.ts`
- `src/renderer/src/components/sidebar/worktree-list-groups-test-fixtures.ts`
- `src/renderer/src/components/sidebar/worktree-list-lineage-card-test-fixtures.ts`
- `src/renderer/src/components/sidebar/worktree-list-lineage-card-test-harness.ts`
- `src/renderer/src/components/sidebar/worktree-list-lineage-store-state.ts`
- `src/renderer/src/components/sidebar/worktree-list-pinned-store-state.ts`
- `src/renderer/src/components/sidebar/WorktreeListScrollToTopButton.tsx`
- `src/renderer/src/components/sidebar/worktree-manual-order-catalog.test.ts`
- `src/renderer/src/components/sidebar/worktree-manual-order-catalog.ts`
- `src/renderer/src/components/sidebar/worktree-manual-order-store-write.test.ts`
- `src/renderer/src/components/sidebar/WorktreeReviewLinkField.tsx`
- `src/renderer/src/components/sidebar/worktree-sidebar-reveal.test.ts`
- `src/renderer/src/components/sidebar/worktree-sidebar-reveal-scroll-settle.test.ts`
- `src/renderer/src/components/sidebar/worktree-sidebar-reveal-scroll-settle.ts`
- `src/renderer/src/components/sidebar/worktree-snapshot-prune-batch.ts`
- `src/renderer/src/components/sidebar/WorktreeStatusMenuItems.tsx`
- `src/renderer/src/components/sidebar/worktree-unambiguous-id-index.test.ts`
- `src/renderer/src/components/sidebar/worktree-unambiguous-id-index.ts`
- `src/renderer/src/components/sidebar/worktree-unnest.test.ts`
- `src/renderer/src/components/sidebar/worktree-unnest.ts`
- `src/renderer/src/components/sidebar/WorktreeVisibilityDialog.test.tsx`
- `src/renderer/src/components/sidebar/WorktreeVisibilityGlobalSettingsLink.tsx`
- `src/renderer/src/components/sidebar/WorktreeVisibilityHelpPopover.test.tsx`
- `src/renderer/src/components/sidebar/WorktreeVisibilityHelpPopover.tsx`
- `src/renderer/src/components/sidebar/worktree-visibility-host-target.ts`
- `src/renderer/src/components/sidebar/worktree-visibility-mutation-fence.ts`
- `src/renderer/src/components/sidebar/worktree-visibility-repo-sources.ts`
- `src/renderer/src/components/sidebar/WorktreeVisibilityScanStatus.tsx`
- `src/renderer/src/components/sidebar/WorktreeVisibilitySourceAddForm.tsx`
- `src/renderer/src/components/sidebar/WorktreeVisibilitySourceList.test.tsx`
- `src/renderer/src/components/sidebar/WorktreeVisibilitySourceList.tsx`
- `src/renderer/src/components/sidebar/worktree-visibility-source-mutation.ts`
- `src/renderer/src/components/sidebar/worktree-visibility-source-provenance.test.ts`
- `src/renderer/src/components/sidebar/worktree-visibility-source-provenance.ts`
- `src/renderer/src/components/sidebar/worktree-visibility-update-error.ts`
- `src/renderer/src/components/sidebar/worktree-visibility-use-global.ts`
- `src/renderer/src/components/skills/skill-agent-filter.ts`
- `src/renderer/src/components/skills/SkillBundleInstallFlow.tsx`
- `src/renderer/src/components/skills/SkillBundleInstallOutcome.tsx`
- `src/renderer/src/components/skills/SkillBundleInstallReview.tsx`
- `src/renderer/src/components/skills/skill-bundle-name.test.ts`
- `src/renderer/src/components/skills/skill-bundle-name.ts`
- `src/renderer/src/components/skills/skill-bundle-retry-selection.test.ts`
- `src/renderer/src/components/skills/skill-bundle-retry-selection.ts`
- `src/renderer/src/components/skills/skill-delete-copy.test.ts`
- `src/renderer/src/components/skills/skill-delete-copy.ts`
- `src/renderer/src/components/skills/SkillDeleteResultBand.tsx`
- `src/renderer/src/components/skills/skill-delete-selection.test.ts`
- `src/renderer/src/components/skills/skill-delete-selection.ts`
- `src/renderer/src/components/skills/SkillDescriptionDisclosure.tsx`
- `src/renderer/src/components/skills/skill-description-length.test.ts`
- `src/renderer/src/components/skills/skill-description-length.ts`
- `src/renderer/src/components/skills/SkillDetailDialog.tsx`
- `src/renderer/src/components/skills/SkillDisclosureTrigger.tsx`
- `src/renderer/src/components/skills/SkillInstallAgentPicker.test.tsx`
- `src/renderer/src/components/skills/SkillInstallAgentPicker.tsx`
- `src/renderer/src/components/skills/SkillInstallDialog.test.tsx`
- `src/renderer/src/components/skills/SkillInstallDialog.tsx`
- `src/renderer/src/components/skills/SkillInstallDialogFooter.tsx`
- `src/renderer/src/components/skills/SkillInstallMachineSelect.tsx`
- `src/renderer/src/components/skills/skill-install-management-copy.ts`
- `src/renderer/src/components/skills/SkillInstallManagementDialog.test.tsx`
- `src/renderer/src/components/skills/SkillInstallManagementDialog.tsx`
- `src/renderer/src/components/skills/SkillInstallManagementDialogContent.tsx`
- `src/renderer/src/components/skills/SkillInstallManagementStatus.tsx`
- `src/renderer/src/components/skills/skill-install-progress-state.test.tsx`
- `src/renderer/src/components/skills/skill-install-progress-state.ts`
- `src/renderer/src/components/skills/skill-install-provider-groups.test.ts`
- `src/renderer/src/components/skills/skill-install-provider-groups.ts`
- `src/renderer/src/components/skills/skill-install-result-label.ts`
- `src/renderer/src/components/skills/SkillInstallReviewContent.tsx`
- `src/renderer/src/components/skills/SkillInstallRiskNotice.tsx`
- `src/renderer/src/components/skills/SkillInstallTargetFields.test.tsx`
- `src/renderer/src/components/skills/SkillInstallTargetFields.tsx`
- `src/renderer/src/components/skills/skill-install-workspace-choices.test.ts`
- `src/renderer/src/components/skills/skill-install-workspace-choices.ts`
- `src/renderer/src/components/skills/SkillInstallWorkspaceCombobox.test.tsx`
- `src/renderer/src/components/skills/SkillInstallWorkspaceCombobox.tsx`
- `src/renderer/src/components/skills/skill-managed-install-groups.ts`
- `src/renderer/src/components/skills/skill-managed-install-labels.ts`
- `src/renderer/src/components/skills/SkillManagedInstallRow.tsx`
- `src/renderer/src/components/skills/skill-managed-removal-summary.ts`
- `src/renderer/src/components/skills/skill-managed-version-selection.ts`
- `src/renderer/src/components/skills/SkillPackageChecklist.tsx`
- `src/renderer/src/components/skills/skill-package-checklist-items.test.ts`
- `src/renderer/src/components/skills/skill-package-checklist-items.ts`
- `src/renderer/src/components/skills/skill-package-digest.test.ts`
- `src/renderer/src/components/skills/skill-package-digest.ts`
- `src/renderer/src/components/skills/skill-package-install-risk.test.ts`
- `src/renderer/src/components/skills/skill-package-install-risk.ts`
- `src/renderer/src/components/skills/SkillRow.tsx`
- `src/renderer/src/components/skills/SkillRowActions.tsx`
- `src/renderer/src/components/skills/skill-selection.ts`
- `src/renderer/src/components/skills/SkillsFilterToolbar.tsx`
- `src/renderer/src/components/skills/SkillShareDialog.test.tsx`
- `src/renderer/src/components/skills/SkillShareDialog.tsx`
- `src/renderer/src/components/skills/SkillSharedLinkRow.test.tsx`
- `src/renderer/src/components/skills/SkillSharedLinkRow.tsx`
- `src/renderer/src/components/skills/SkillSharedLinksView.tsx`
- `src/renderer/src/components/skills/skill-share-link.test.ts`
- `src/renderer/src/components/skills/skill-share-link.ts`
- `src/renderer/src/components/skills/skill-share-package-selection.test.ts`
- `src/renderer/src/components/skills/skill-share-package-selection.ts`
- `src/renderer/src/components/skills/SkillSharePackageSummary.tsx`
- `src/renderer/src/components/skills/skill-share-preview-summary.test.ts`
- `src/renderer/src/components/skills/skill-share-preview-summary.ts`
- `src/renderer/src/components/skills/SkillShareReleaseNotesField.tsx`
- `src/renderer/src/components/skills/SkillShareReviewContent.tsx`
- `src/renderer/src/components/skills/skill-share-selection.test.ts`
- `src/renderer/src/components/skills/skill-share-selection.ts`
- `src/renderer/src/components/skills/skill-share-version-summary.ts`
- `src/renderer/src/components/skills/SkillsList.tsx`
- `src/renderer/src/components/skills/skill-source-inventory.test.ts`
- `src/renderer/src/components/skills/skill-source-inventory.ts`
- `src/renderer/src/components/skills/skills-page-column.ts`
- `src/renderer/src/components/skills/SkillsPageHeader.tsx`
- `src/renderer/src/components/skills/skills-page-states.tsx`
- `src/renderer/src/components/skills/skills-page-view.ts`
- `src/renderer/src/components/skills/SkillsSelectionHeader.tsx`
- `src/renderer/src/components/skills/SkillsSourcesPopover.tsx`
- `src/renderer/src/components/skills/skills-subtitle-action.ts`
- `src/renderer/src/components/skills/skill-warning-preview-gate.ts`
- `src/renderer/src/components/skills/SkillWarningPreviewLauncher.tsx`
- `src/renderer/src/components/skills/skill-warning-preview-version.ts`
- `src/renderer/src/components/skills/use-owned-skill-shares.ts`
- `src/renderer/src/components/skills/use-skill-delete-flow.ts`
- `src/renderer/src/components/skills/use-skill-discovery-host-label.ts`
- `src/renderer/src/components/skills/use-skill-install-detected-agents.ts`
- `src/renderer/src/components/skills/use-skill-install-risk.ts`
- `src/renderer/src/components/skills/use-skills-page-keyboard-navigation.ts`
- `src/renderer/src/components/StateIndicatorTooltip.test.tsx`
- `src/renderer/src/components/StateIndicatorTooltip.tsx`
- `src/renderer/src/components/stats/UsageBreakdownSection.test.tsx`
- `src/renderer/src/components/stats/usage-overview-daily-series.ts`
- `src/renderer/src/components/stats/usage-overview-types.ts`
- `src/renderer/src/components/stats/usage-provider-normalization.ts`
...
- `src/renderer/src/components/status-bar/codex-sign-in-action.ts`
- `src/renderer/src/components/status-bar/codex-status-sign-in.test.tsx`
...
- `src/renderer/src/components/status-bar/InlineProviderUsage.tsx`
- `src/renderer/src/components/status-bar/PetStatusSegment.layout.test.ts`
- `src/renderer/src/components/status-bar/ProviderDetailsMenu.tsx`
- `src/renderer/src/components/status-bar/remote-host-connection-status.test.ts`
- `src/renderer/src/components/status-bar/resource-manager-worktree-target.test.ts`
- `src/renderer/src/components/status-bar/resource-manager-worktree-target.ts`
- `src/renderer/src/components/status-bar/resource-usage-kill-dialog.tsx`
- `src/renderer/src/components/status-bar/resource-usage-metrics.tsx`
- `src/renderer/src/components/status-bar/resource-usage-popover-body.tsx`
- `src/renderer/src/components/status-bar/resource-usage-popover-summary.tsx`
- `src/renderer/src/components/status-bar/resource-usage-resource-tree.tsx`
- `src/renderer/src/components/status-bar/resource-usage-session-rows.tsx`
- `src/renderer/src/components/status-bar/resource-usage-status-trigger.tsx`
- `src/renderer/src/components/status-bar/StatusBarAccountControls.tsx`
- `src/renderer/src/components/status-bar/status-bar-claude-accounts.ts`
...
- `src/renderer/src/components/status-bar/status-bar-runtime-targets.ts`
...
- `src/renderer/src/components/status-bar/use-codex-switcher-controller.ts`
...
- `src/renderer/src/components/status-bar/use-workspace-space-decision-projection.ts`
- `src/renderer/src/components/status-bar/use-workspace-space-git-refresh-action.ts`
- `src/renderer/src/components/status-bar/use-workspace-space-manager-bindings.ts`
- `src/renderer/src/components/status-bar/use-workspace-space-manager-panel.ts`
- `src/renderer/src/components/status-bar/use-workspace-space-manager-projection.ts`
- `src/renderer/src/components/status-bar/workspace-space-breakdown-list.test.tsx`
- `src/renderer/src/components/status-bar/workspace-space-breakdown-list.tsx`
- `src/renderer/src/components/status-bar/workspace-space-decision-details.ts`
- `src/renderer/src/components/status-bar/workspace-space-decision-hover-card.tsx`
- `src/renderer/src/components/status-bar/workspace-space-delete-host-routing.test.ts`
- `src/renderer/src/components/status-bar/workspace-space-delete-selection.ts`
- `src/renderer/src/components/status-bar/workspace-space-git-status-order.ts`
- `src/renderer/src/components/status-bar/workspace-space-manager-overview.tsx`
- `src/renderer/src/components/status-bar/workspace-space-manager-source-boundary.test.ts`
- `src/renderer/src/components/status-bar/workspace-space-manager-state-types.ts`
- `src/renderer/src/components/status-bar/workspace-space-manager-table.tsx`
- `src/renderer/src/components/status-bar/workspace-space-manager-toolbar.tsx`
- `src/renderer/src/components/status-bar/workspace-space-manager-view.tsx`
- `src/renderer/src/components/status-bar/workspace-space-metrics.tsx`
- `src/renderer/src/components/status-bar/workspace-space-selection-controls.tsx`
- `src/renderer/src/components/status-bar/workspace-space-state-resolution.ts`
- `src/renderer/src/components/status-bar/workspace-space-status-badge.tsx`
- `src/renderer/src/components/status-bar/workspace-space-treemap.tsx`
- `src/renderer/src/components/status-bar/workspace-space-worktree-row.tsx`
- `src/renderer/src/components/tab-bar/client-hosted-browser-row-label.ts`
- `src/renderer/src/components/tab-bar/client-hosted-browser-row-strip-placement.test.ts`
- `src/renderer/src/components/tab-bar/client-hosted-browser-row-strip-placement.ts`
- `src/renderer/src/components/tab-bar/ClientHostedBrowserTab.tsx`
- `src/renderer/src/components/tab-bar/ClientHostedBrowserTabRows.test.tsx`
- `src/renderer/src/components/tab-bar/ClientHostedBrowserTabRows.tsx`
- `src/renderer/src/components/tab-bar/open-tab-search-retention.test.ts`
- `src/renderer/src/components/tab-bar/open-tab-search-retention.ts`
- `src/renderer/src/components/tab-bar/SortableTab.update-depth-probe.test.tsx`
- `src/renderer/src/components/tab-bar/tab-agent-session-id.test.ts`
- `src/renderer/src/components/tab-bar/tab-agent-session-id.ts`
- `src/renderer/src/components/tab-bar/TabAgentSessionIdMenuItem.test.tsx`
- `src/renderer/src/components/tab-bar/TabAgentSessionIdMenuItem.tsx`
- `src/renderer/src/components/tab-bar/TabBar.client-hosted-row-active-state.test.ts`
- `src/renderer/src/components/tab-bar/TabBar.windows-shell-remote-runtime.test.ts`
- `src/renderer/src/components/tab-bar/TabBar.windows-shell-ssh-host.test.ts`
- `src/renderer/src/components/tab-bar/TabBarCreateEntry.history.test.tsx`
- `src/renderer/src/components/tab-bar/TabBarCreateEntry.search.test.tsx`
- `src/renderer/src/components/tab-bar/tab-bar-dropdown-menu-item-probe.ts`
- `src/renderer/src/components/tab-bar/tab-bar-item-surface.client-hosted-active-state.test.tsx`
- `src/renderer/src/components/tab-bar/tab-bar-windows-shell-launch-render-stubs.ts`
- `src/renderer/src/components/tab-bar/tab-bar-windows-shell-launch-test-harness.ts`
- `src/renderer/src/components/tab-bar/tab-create-entry-copy.ts`
- `src/renderer/src/components/tab-bar/tab-create-entry-empty-options.ts`
- `src/renderer/src/components/tab-bar/tab-create-entry-forced-search.test.ts`
- `src/renderer/src/components/tab-bar/tab-create-entry-forced-search.ts`
- `src/renderer/src/components/tab-bar/tab-create-entry-history-placement.test.ts`
- `src/renderer/src/components/tab-bar/tab-create-entry-history-placement.ts`
- `src/renderer/src/components/tab-bar/tab-create-entry-keyboard-focus.ts`
- `src/renderer/src/components/tab-bar/tab-create-entry-network-selection.ts`
- `src/renderer/src/components/tab-bar/tab-create-entry-props.ts`
- `src/renderer/src/components/tab-bar/use-omnibox-browser-history.ts`
- `src/renderer/src/components/tab-bar/use-tab-create-entry-search-results.ts`
- `src/renderer/src/components/tab-bar/use-tab-entry-menu-return-focus.ts`
- `src/renderer/src/components/tab-group/tab-drag-drop-commit.ts`
- `src/renderer/src/components/tab-group/tab-drag-gesture-lifecycle.ts`
- `src/renderer/src/components/tab-group/tab-drag-hover-preview.ts`
- `src/renderer/src/components/tab-group/tab-drag-missed-end-listeners.ts`
- `src/renderer/src/components/tab-group/tab-drag-retained-guest-passthrough.test.tsx`
- `src/renderer/src/components/tab-group/useTabGroupActivationCommands.ts`
- `src/renderer/src/components/tab-group/useTabGroupCloseScopeCommands.ts`
- `src/renderer/src/components/tab-group/useTabGroupCreationCommands.local-shell.test.ts`
- `src/renderer/src/components/tab-group/useTabGroupCreationCommands.ts`
- `src/renderer/src/components/tab-group/useTabGroupItemProjections.ts`
...
- `src/renderer/src/components/task-page/Content.tsx`
...
- `src/renderer/src/components/task-page/github/ChecksCell.tsx`
- `src/renderer/src/components/task-page/github/DuplicatePicker.tsx`
- `src/renderer/src/components/task-page/github/Filters.tsx`
- `src/renderer/src/components/task-page/github/IssueDialog.tsx`
- `src/renderer/src/components/task-page/github/IssueSelectors.tsx`
- `src/renderer/src/components/task-page/github/List.tsx`
- `src/renderer/src/components/task-page/github/MergeCell.tsx`
- `src/renderer/src/components/task-page/github/ModeControls.tsx`
- `src/renderer/src/components/task-page/github/ReviewCell.tsx`
...
- `src/renderer/src/components/task-page/gitlab/Dialog.tsx`
- `src/renderer/src/components/task-page/gitlab/Filters.tsx`
- `src/renderer/src/components/task-page/gitlab/ItemList.tsx`
- `src/renderer/src/components/task-page/gitlab/TodoList.tsx`
- `src/renderer/src/components/task-page/jira/ConnectDialog.tsx`
- `src/renderer/src/components/task-page/jira/Content.tsx`
- `src/renderer/src/components/task-page/jira/Filters.tsx`
- `src/renderer/src/components/task-page/jira/IssueDialog.tsx`
- `src/renderer/src/components/task-page/linear/ConnectDialog.tsx`
- `src/renderer/src/components/task-page/linear/Content.tsx`
- `src/renderer/src/components/task-page/linear/CustomViewList.tsx`
- `src/renderer/src/components/task-page/linear/CustomViewProjects.tsx`
- `src/renderer/src/components/task-page/linear/Filters.tsx`
- `src/renderer/src/components/task-page/linear/IssueAttributes.tsx`
- `src/renderer/src/components/task-page/linear/IssueBoard.tsx`
- `src/renderer/src/components/task-page/linear/IssueBoardColumns.tsx`
- `src/renderer/src/components/task-page/linear/IssueDialog.tsx`
- `src/renderer/src/components/task-page/linear/IssueList.tsx`
- `src/renderer/src/components/task-page/linear/IssueRows.tsx`
- `src/renderer/src/components/task-page/linear/IssueTable.tsx`
- `src/renderer/src/components/task-page/linear/IssueToolbar.tsx`
- `src/renderer/src/components/task-page/linear/ProjectDialog.tsx`
- `src/renderer/src/components/task-page/linear/ProjectFields.tsx`
- `src/renderer/src/components/task-page/linear/ProjectList.tsx`
- `src/renderer/src/components/task-page/linear/ProjectOverview.tsx`
- `src/renderer/src/components/task-page/ListChrome.tsx`
- `src/renderer/src/components/task-page/PaginationBar.tsx`
- `src/renderer/src/components/task-page/ProviderFilters.tsx`
- `src/renderer/src/components/task-page/SourceBar.tsx`
- `src/renderer/src/components/task-page/Surface.tsx`
- `src/renderer/src/components/task-page/TaskPage.tsx`
- `src/renderer/src/components/task-page-draft-storage.tsx`
- `src/renderer/src/components/task-page-github-landing-refresh-run.tsx`
- `src/renderer/src/components/task-page-github-list-scroll-restore.test.ts`
- `src/renderer/src/components/task-page-github-list-scroll-restore.ts`
- `src/renderer/src/components/task-page-github-quiet-refresh-run.tsx`
- `src/renderer/src/components/task-page-github-reviewer-actions.ts`
- `src/renderer/src/components/task-page-github-reviewer-suggestions.test.ts`
- `src/renderer/src/components/task-page-github-review-model.tsx`
- `src/renderer/src/components/task-page-gitlab-task-filters.test.ts`
- `src/renderer/src/components/task-page-linear-issue-dialog-popover-scroll.test.ts`
- `src/renderer/src/components/task-page-linear-issue-grouping.test.ts`
- `src/renderer/src/components/task-page-linear-issue-model.tsx`
- `src/renderer/src/components/task-page-linear-jira-list-model.tsx`
- `src/renderer/src/components/task-page-repo-source-context.test.ts`
- `src/renderer/src/components/task-page-repo-source-divergence.test.ts`
- `src/renderer/src/components/task-page-source-context.tsx`
- `src/renderer/src/components/task-page-source-family.test-support.ts`
- `src/renderer/src/components/task-page-task-source-host-availability.test.ts`
- `src/renderer/src/components/terminal/initial-terminal-wiring.test.ts`
- `src/renderer/src/components/terminal/structured-terminal-session-disposal.ts`
- `src/renderer/src/components/terminal/terminal-provider-snapshot-capability-resettlement.test.ts`
- `src/renderer/src/components/terminal/terminal-tab-actions-structured-session.test.ts`
- `src/renderer/src/components/terminal/terminal-tab-actions-unified-close.test.ts`
- `src/renderer/src/components/terminal/terminal-tab-bulk-actions.test.ts`
- `src/renderer/src/components/terminal/use-worktree-files.test.tsx`
- `src/renderer/src/components/terminal/use-worktree-files.ts`
- `src/renderer/src/components/terminal-agent-tab-shortcut.ts`
- `src/renderer/src/components/terminal-cold-activation.ts`
- `src/renderer/src/components/TerminalLegacyBrowserPanes.tsx`
- `src/renderer/src/components/TerminalLegacyEditorSurface.tsx`
- `src/renderer/src/components/TerminalLegacyTerminalPanes.tsx`
- `src/renderer/src/components/TerminalLegacyWorkspaceSurface.tsx`
- `src/renderer/src/components/terminal-pane/__fixtures__/ipados-hardware-2set-hangul-batchim-migration-trace.json`
...
- `src/renderer/src/components/terminal-pane/agent-completion-coordinator-test-harness.ts`
- `src/renderer/src/components/terminal-pane/agent-completion-hook-observer.ts`
- `src/renderer/src/components/terminal-pane/agent-completion-identity-store.ts`
- `src/renderer/src/components/terminal-pane/agent-completion-lifecycle.ts`
- `src/renderer/src/components/terminal-pane/agent-completion-notification-controller.ts`
- `src/renderer/src/components/terminal-pane/agent-completion-pending-title.ts`
- `src/renderer/src/components/terminal-pane/agent-completion-poll-cadence.ts`
- `src/renderer/src/components/terminal-pane/agent-completion-process-monitor.ts`
- `src/renderer/src/components/terminal-pane/agent-completion-process-types.ts`
- `src/renderer/src/components/terminal-pane/agent-completion-title-observer.ts`
- `src/renderer/src/components/terminal-pane/agent-process-inspection-queue-rejection-containment.test.ts`
- `src/renderer/src/components/terminal-pane/deferred-split-pane-handoff.test.ts`
- `src/renderer/src/components/terminal-pane/deferred-split-pane-handoff.ts`
...
- `src/renderer/src/components/terminal-pane/hangul-jamo-key.ts`
- `src/renderer/src/components/terminal-pane/ipc-pty-attach.ts`
...
- `src/renderer/src/components/terminal-pane/ipc-pty-session-handlers.ts`
...
- `src/renderer/src/components/terminal-pane/paired-runtime-parking-capabilities.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/agent-done-started-at.ts`
...
- `src/renderer/src/components/terminal-pane/pty-connection/agent-task-complete-settings.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/apply-reattach-payload.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/codex-pane-stale.ts`
...
- `src/renderer/src/components/terminal-pane/pty-connection/connect-pane-pty-session.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/cursor-agent-reattach-screen.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/deferred-cold-restore-and-snapshot.ts`
...
- `src/renderer/src/components/terminal-pane/pty-connection/direct-ssh-retry-lease.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/direct-ssh-retry-status.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/e2e-terminal-pty-harness.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/foreground-output-budgets.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/foreground-output-budgets.ts`
...
- `src/renderer/src/components/terminal-pane/pty-connection/fresh-spawn-follow-reset.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/fresh-spawn-start.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/fresh-spawn-types.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/hidden-output-restore-abandon.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/hidden-output-restore-chunk.ts`
...
- `src/renderer/src/components/terminal-pane/pty-connection/hidden-startup-renderer-query.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/hidden-startup-renderer-query-write.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/interrupt-input-intent.ts`
...
- `src/renderer/src/components/terminal-pane/pty-connection/pane-pty-layout-binding.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/pane-pty-layout-binding.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/pane-pty-visibility-bind.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/pane-serializer-register.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/pane-serializer-settle.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/pending-hidden-output-restore-chunk.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/process-exit-startup.ts`
...
- `src/renderer/src/components/terminal-pane/pty-connection/pty-resize-geometry.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/reattach-live-data-deferral.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/reattach-payload-context.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/reattach-payload-context.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/reattach-payload-session.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/reattach-payload-ssh-reconnect-model-paint.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/reattach-result-handler.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/replay-data-drain.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/resolve-ssh-reconnect-model-paint.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/retained-legacy-pty-attach.ts`
...
- `src/renderer/src/components/terminal-pane/pty-connection/setup-split-geometry.ts`
...
- `src/renderer/src/components/terminal-pane/pty-connection/ssh-session-connect.ts`
- `src/renderer/src/components/terminal-pane/pty-connection/ssh-snapshot-prepaint.ts`
...
- `src/renderer/src/components/terminal-pane/pty-connection/terminal-tab-id.test.ts`
...
- `src/renderer/src/components/terminal-pane/pty-connection/transport-output-callbacks.ts`
...
- `src/renderer/src/components/terminal-pane/pty-connection-cold-restore-agent-resume.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-cold-restore-repaint.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-cold-restore-resume-command.test.ts`
...
- `src/renderer/src/components/terminal-pane/pty-connection-deferred-ssh-passphrase.test.ts`
...
- `src/renderer/src/components/terminal-pane/pty-connection-foreground-routing-confirmation.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-foreground-write-path.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-fresh-spawn-guards.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-hibernation-wake.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-hidden-atlas-recovery.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-hidden-backlog-reconciliation.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-hidden-backlog-snapshot.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-hidden-codex-queries.test.ts`
...
- `src/renderer/src/components/terminal-pane/pty-connection-hidden-query-snapshot-restore.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-hidden-snapshot-live-overlap.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-hidden-snapshot-resize-signals.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-hidden-tui-snapshot-replay.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-hook-completion-bell-arbitration.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-hook-completion-side-effects.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-hook-idle-arbitration.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-interrupt-inference.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-main-side-effect-authority.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-mode-2031-subscriptions.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-notification-settings-gating.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-parked-ssh-snapshot.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-post-dispose-restore-termination.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-pty-exit-teardown.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-queued-startup-consume.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-reattach-binding.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-reattach-mode-reset.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-remote-runtime-attach.test.ts`
...
- `src/renderer/src/components/terminal-pane/pty-connection-restored-baseline-shortfall.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-runtime-owner-spawn-routing.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-session-liveness.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-setup-split-spawn.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-sleeping-resume-banner.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-split-cwd-resolution.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-ssh-startup-draft-delivery.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-stalled-hidden-restore.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-startup-command-delivery.test.ts`
...
- `src/renderer/src/components/terminal-pane/pty-connection-test-async.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-test-constants.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-test-deps.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-test-dom.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-test-environment.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-test-pane-fixtures.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-test-store-fixtures.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-test-store-state.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-typed-agent-identity.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-visibility-resume-size.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-visible-pane-output-pause-latch.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-windows-cjk-repaint.test.ts`
- `src/renderer/src/components/terminal-pane/pty-connection-windows-keyboard-reset.test.ts`
- `src/renderer/src/components/terminal-pane/pty-input-write-head-queue.ts`
- `src/renderer/src/components/terminal-pane/pty-input-write-queue-contract.ts`
- `src/renderer/src/components/terminal-pane/pty-output-processor.ts`
- `src/renderer/src/components/terminal-pane/pty-output-side-effect-queue.ts`
- `src/renderer/src/components/terminal-pane/pty-output-title-observer.ts`
- `src/renderer/src/components/terminal-pane/pty-preconnect-input-buffer.test.ts`
- `src/renderer/src/components/terminal-pane/pty-preconnect-input-buffer.ts`
...
- `src/renderer/src/components/terminal-pane/pty-transport-handler-suspension.test.ts`
...
- `src/renderer/src/components/terminal-pane/pty-transport-recycled-pty-incarnation.test.ts`
- `src/renderer/src/components/terminal-pane/pty-transport-spawn-errors.test.ts`
- `src/renderer/src/components/terminal-pane/pty-transport-test-harness.ts`
- `src/renderer/src/components/terminal-pane/remote-execution-host-pty.test.ts`
- `src/renderer/src/components/terminal-pane/remote-execution-host-pty.ts`
...
- `src/renderer/src/components/terminal-pane/remote-runtime-pty-transport-end-verdict.test.ts`
...
- `src/renderer/src/components/terminal-pane/remote-runtime-pty-transport-pending-host-surface-attach.test.ts`
- `src/renderer/src/components/terminal-pane/remote-runtime-pty-transport-snapshot-replay.test.ts`
- `src/renderer/src/components/terminal-pane/remote-runtime-pty-transport-split-leaf-activation.test.ts`
- `src/renderer/src/components/terminal-pane/remote-runtime-pty-transport-stale-handle-recovery.test.ts`
- `src/renderer/src/components/terminal-pane/remote-runtime-pty-transport-sticky-replacement-policy.test.ts`
- `src/renderer/src/components/terminal-pane/remote-runtime-pty-transport-stream-fixtures.ts`
...
- `src/renderer/src/components/terminal-pane/remote-runtime-pty-transport-web-mirror-recovery.test.ts`
- `src/renderer/src/components/terminal-pane/restored-snapshot-coverage.test.ts`
- `src/renderer/src/components/terminal-pane/restored-snapshot-coverage.ts`
- `src/renderer/src/components/terminal-pane/sleeping-record-park-exemption.test.ts`
- `src/renderer/src/components/terminal-pane/ssh-reconnect-model-paint-gate.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-agent-paste-bracketing.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-agent-paste-bracketing.ts`
- `src/renderer/src/components/terminal-pane/terminal-cjk-cursor-cell-placement.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-cold-park-exempt-flip.react185.test.tsx`
- `src/renderer/src/components/terminal-pane/terminal-cold-park-subscription-narrowing.react185.test.tsx`
- `src/renderer/src/components/terminal-pane/terminal-cold-park-tab-model-identity.react185.test.tsx`
- `src/renderer/src/components/terminal-pane/terminal-cursor-appearance-precedence.test.ts`
...
- `src/renderer/src/components/terminal-pane/terminal-ime-composer-placeholder-mask.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-ime-composer-placeholder-mask.ts`
...
- `src/renderer/src/components/terminal-pane/terminal-ime-forwarder-space-claim.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-ime-hangul-terminating-digit.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-ime-xterm-cancelled-preedit-visibility.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-ime-xterm-consumed-key-commit.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-ime-xterm-midline-preedit-tail.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-ime-xterm-trailing-preedit-occlusion.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-ios-hangul-preedit.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-ios-hangul-preedit.ts`
- `src/renderer/src/components/terminal-pane/terminal-ios-hangul-preedit-coexistence.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-ios-hangul-preedit-device-trace.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-ios-hangul-preedit-fixture.ts`
- `src/renderer/src/components/terminal-pane/terminal-ios-hangul-preedit-overlay.ts`
- `src/renderer/src/components/terminal-pane/terminal-keyboard-action-dispatch.ts`
- `src/renderer/src/components/terminal-pane/terminal-keyboard-dependencies.ts`
...
- `src/renderer/src/components/terminal-pane/terminal-keyboard-hook.ts`
- `src/renderer/src/components/terminal-pane/terminal-keyboard-pane-resolution.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-keyboard-pane-resolution.ts`
- `src/renderer/src/components/terminal-pane/terminal-keyboard-release-handlers.ts`
- `src/renderer/src/components/terminal-pane/terminal-keyboard-runtime.ts`
- `src/renderer/src/components/terminal-pane/terminal-keyboard-shortcut-matching.ts`
- `src/renderer/src/components/terminal-pane/terminal-kitty-csi-u-encoding.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-kitty-csi-u-encoding.ts`
- `src/renderer/src/components/terminal-pane/terminal-link-click-fallback.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-link-file-open-routing.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-link-handlers-test-fixtures.ts`
- `src/renderer/src/components/terminal-pane/terminal-link-handlers-test-harness.ts`
- `src/renderer/src/components/terminal-pane/terminal-link-osc-file-targets.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-link-osc-url-routing.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-link-provider-buffer-fixtures.ts`
- `src/renderer/src/components/terminal-pane/terminal-link-provider-link-detection.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-link-pty-mouse-suppression.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-link-remote-runtime-ssh-open.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-link-worktree-root-activation.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-link-wsl-path-mapping.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-non-latin-control-chord.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-non-latin-control-chord.ts`
- `src/renderer/src/components/terminal-pane/terminal-option-kitty-release.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-option-kitty-release.ts`
...
- `src/renderer/src/components/terminal-pane/terminal-pane-layout-restore.ts`
- `src/renderer/src/components/terminal-pane/terminal-pane-layout-tree.ts`
- `src/renderer/src/components/terminal-pane/terminal-pane-lifecycle-close.ts`
- `src/renderer/src/components/terminal-pane/terminal-pane-lifecycle-primitives.ts`
- `src/renderer/src/components/terminal-pane/terminal-pane-lifecycle-types.ts`
- `src/renderer/src/components/terminal-pane/terminal-pane-listener-order-parity.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-pane-manager-options.ts`
- `src/renderer/src/components/terminal-pane/terminal-pane-menu-agent-session-actions.ts`
- `src/renderer/src/components/terminal-pane/terminal-pane-menu-copy-actions.ts`
- `src/renderer/src/components/terminal-pane/terminal-pane-menu-paste.ts`
- `src/renderer/src/components/terminal-pane/terminal-pane-mount-bootstrap.ts`
- `src/renderer/src/components/terminal-pane/terminal-pane-mount-cleanup.ts`
- `src/renderer/src/components/terminal-pane/terminal-pane-mount-context.ts`
- `src/renderer/src/components/terminal-pane/terminal-pane-mount-events.ts`
...
- `src/renderer/src/components/terminal-pane/terminal-pane-pane-closed.ts`
- `src/renderer/src/components/terminal-pane/terminal-pane-pane-created.ts`
- `src/renderer/src/components/terminal-pane/terminal-pane-pane-input.ts`
- `src/renderer/src/components/terminal-pane/terminal-pane-pane-links.ts`
- `src/renderer/src/components/terminal-pane/terminal-pane-paste-execution.ts`
- `src/renderer/src/components/terminal-pane/terminal-pane-paste-listeners.ts`
- `src/renderer/src/components/terminal-pane/terminal-pane-pty-deps.ts`
- `src/renderer/src/components/terminal-pane/TerminalPaneRuntimePortals.tsx`
...
- `src/renderer/src/components/terminal-pane/terminal-pane-types.ts`
- `src/renderer/src/components/terminal-pane/terminal-parked-tab-eviction-exemption.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-parked-watcher-sleep-preserved-exit.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-parked-watcher-sole-newborn-exit.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-park-verdict-worktree-driver-loop.test.tsx`
- `src/renderer/src/components/terminal-pane/terminal-pending-startup-park-presence.ts`
- `src/renderer/src/components/terminal-pane/TerminalProcessExitOverlay.test.tsx`
...
- `src/renderer/src/components/terminal-pane/terminal-pty-pre-spawn-e2e-barrier.ts`
- `src/renderer/src/components/terminal-pane/TerminalQuickCommandEditorDialog.tsx`
- `src/renderer/src/components/terminal-pane/terminal-remote-file-download-open.ts`
- `src/renderer/src/components/terminal-pane/terminal-render-desync-evidence-persistence.ts`
- `src/renderer/src/components/terminal-pane/terminal-render-desync-trigger.ts`
- `src/renderer/src/components/terminal-pane/terminal-render-desync-weight-probe.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-render-desync-weight-probe.ts`
- `src/renderer/src/components/terminal-pane/terminal-replay-application-continuity.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-restore-sgr-latch.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-retention-exempt-growth.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-shortcut-option-compose.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-tab-activation-order.ts`
- `src/renderer/src/components/terminal-pane/terminal-tab-park-candidates.ts`
- `src/renderer/src/components/terminal-pane/terminal-tab-strip-drop-target.ts`
- `src/renderer/src/components/terminal-pane/use-terminal-context-menu-trigger.ts`
...
- `src/renderer/src/components/terminal-pane/use-terminal-pane-context-actions.ts`
- `src/renderer/src/components/terminal-pane/use-terminal-pane-controller.ts`
- `src/renderer/src/components/terminal-pane/use-terminal-pane-foundation.ts`
...
- `src/renderer/src/components/terminal-pane/use-terminal-pane-global-effects-test-harness.ts`
- `src/renderer/src/components/terminal-pane/use-terminal-pane-global-effects-visibility-resume.test.ts`
...
- `src/renderer/src/components/terminal-pane/use-terminal-pane-layout-bindings.ts`
- `src/renderer/src/components/terminal-pane/use-terminal-pane-layout-persistence.ts`
- `src/renderer/src/components/terminal-pane/use-terminal-pane-lifecycle-refs.ts`
- `src/renderer/src/components/terminal-pane/use-terminal-pane-lifecycle-stage.ts`
- `src/renderer/src/components/terminal-pane/use-terminal-pane-mobile-actions.ts`
- `src/renderer/src/components/terminal-pane/use-terminal-pane-mount-lifecycle.ts`
- `src/renderer/src/components/terminal-pane/use-terminal-pane-paste-listeners.ts`
- `src/renderer/src/components/terminal-pane/use-terminal-pane-process-exit-actions.ts`
...
- `src/renderer/src/components/terminal-pane/use-terminal-pane-split-actions.ts`
- `src/renderer/src/components/terminal-pane/use-terminal-pane-startup-actions.ts`
- `src/renderer/src/components/terminal-pane/use-terminal-pane-store-bindings.ts`
- `src/renderer/src/components/terminal-pane/use-terminal-pane-title-effects.ts`
- `src/renderer/src/components/terminal-pane/use-terminal-pane-title-state.ts`
- `src/renderer/src/components/terminal-pane/use-terminal-park-mount-intent.react185.test.tsx`
- `src/renderer/src/components/terminal-pane/use-terminal-park-mount-intent.ts`
- `src/renderer/src/components/terminal-pane/use-terminal-park-verdict-pin.ts`
- `src/renderer/src/components/terminal-pane/xterm-bypass-policy-ios.test.ts`
- `src/renderer/src/components/terminal-parking-pass-candidates.ts`
- `src/renderer/src/components/terminal-quick-commands/TerminalQuickCommandCollapsibleRow.tsx`
- `src/renderer/src/components/TerminalSplitWorkspaceSurfaces.tsx`
- `src/renderer/src/components/TerminalSurface.tsx`
- `src/renderer/src/components/TerminalTitlebarTabs.test.tsx`
- `src/renderer/src/components/TerminalTitlebarTabs.tsx`
- `src/renderer/src/components/TerminalWorkbenchContainer.test.tsx`
- `src/renderer/src/components/TerminalWorkbenchContainer.tsx`
- `src/renderer/src/components/TerminalWorkspaceDialogs.tsx`
- `src/renderer/src/components/terminal-workspace-editor-shortcuts.ts`
- `src/renderer/src/components/terminal-workspace-keydown.test.ts`
- `src/renderer/src/components/terminal-workspace-keydown.ts`
- `src/renderer/src/components/terminal-workspace-model.ts`
- `src/renderer/src/components/TerminalWorktreeSplitSurface.tsx`
- `src/renderer/src/components/ui/popover-wheel-scroll.test.tsx`
- `src/renderer/src/components/ui/slider.test.tsx`
- `src/renderer/src/components/ui/textarea.tsx`
- `src/renderer/src/components/use-task-page-composer-actions.ts`
- `src/renderer/src/components/use-task-page-detail-routing.ts`
- `src/renderer/src/components/use-task-page-github-cache-reconciliation.ts`
- `src/renderer/src/components/use-task-page-github-detail.ts`
- `src/renderer/src/components/use-task-page-github-issue-creation.ts`
- `src/renderer/src/components/use-task-page-github-issue-draft.ts`
- `src/renderer/src/components/use-task-page-github-landing-refresh.ts`
- `src/renderer/src/components/use-task-page-github-list-projection.ts`
- `src/renderer/src/components/use-task-page-github-list-state.ts`
- `src/renderer/src/components/use-task-page-github-mutation-state.ts`
- `src/renderer/src/components/use-task-page-github-quiet-refresh.ts`
- `src/renderer/src/components/use-task-page-github-quiet-refresh-effect.ts`
- `src/renderer/src/components/use-task-page-github-search-pagination.ts`
- `src/renderer/src/components/use-task-page-gitlab-loading.ts`
- `src/renderer/src/components/use-task-page-global-effects.ts`
- `src/renderer/src/components/use-task-page-jira-creation-metadata.ts`
- `src/renderer/src/components/use-task-page-jira-creation-projects.ts`
- `src/renderer/src/components/use-task-page-jira-creation-state.ts`
- `src/renderer/src/components/use-task-page-jira-issue-creation.ts`
- `src/renderer/src/components/use-task-page-jira-list-effects.ts`
- `src/renderer/src/components/use-task-page-jira-list-projection.ts`
- `src/renderer/src/components/use-task-page-jira-list-state.ts`
- `src/renderer/src/components/use-task-page-linear-board.ts`
- `src/renderer/src/components/use-task-page-linear-collection-effects.ts`
- `src/renderer/src/components/use-task-page-linear-context-actions.ts`
- `src/renderer/src/components/use-task-page-linear-context-state.ts`
- `src/renderer/src/components/use-task-page-linear-creation-state.ts`
- `src/renderer/src/components/use-task-page-linear-custom-view-effects.ts`
- `src/renderer/src/components/use-task-page-linear-filter-selection.ts`
- `src/renderer/src/components/use-task-page-linear-in-orca-effects.ts`
- `src/renderer/src/components/use-task-page-linear-issue-creation.ts`
- `src/renderer/src/components/use-task-page-linear-list-effects.ts`
- `src/renderer/src/components/use-task-page-linear-list-presentation.ts`
- `src/renderer/src/components/use-task-page-linear-list-projection.ts`
- `src/renderer/src/components/use-task-page-linear-list-selection.ts`
- `src/renderer/src/components/use-task-page-linear-project-creation.ts`
- `src/renderer/src/components/use-task-page-linear-view-state.ts`
- `src/renderer/src/components/use-task-page-provider-metadata.ts`
- `src/renderer/src/components/use-task-page-provider-state.ts`
- `src/renderer/src/components/use-task-page-repo-selection.ts`
- `src/renderer/src/components/use-task-page-resume-restoration.ts`
- `src/renderer/src/components/use-task-page-runtime-hosts.ts`
- `src/renderer/src/components/use-task-page-search-actions.ts`
- `src/renderer/src/components/use-task-page-source-availability.ts`
- `src/renderer/src/components/use-task-page-source-summary.ts`
- `src/renderer/src/components/use-task-page-store-bindings.ts`
- `src/renderer/src/components/use-task-page-workspace-actions.ts`
- `src/renderer/src/components/use-terminal-activation-actions.ts`
- `src/renderer/src/components/use-terminal-browser-retention.ts`
- `src/renderer/src/components/use-terminal-bulk-close-actions.ts`
- `src/renderer/src/components/use-terminal-close-actions.ts`
- `src/renderer/src/components/use-terminal-controller.ts`
- `src/renderer/src/components/use-terminal-create-actions.test.tsx`
- `src/renderer/src/components/use-terminal-create-actions.ts`
- `src/renderer/src/components/use-terminal-editor-close-dialog-actions.ts`
- `src/renderer/src/components/use-terminal-editor-close-foundation.ts`
- `src/renderer/src/components/use-terminal-editor-close-queue.ts`
...
- `src/renderer/src/components/use-terminal-parking-pass.ts`
- `src/renderer/src/components/use-terminal-watcher-effects.ts`
- `src/renderer/src/components/use-terminal-window-lifecycle.ts`
...
- `src/renderer/src/components/use-terminal-workspace-store-bindings.ts`
- `src/renderer/src/components/use-worktree-jump-palette-controller.ts`
- `src/renderer/src/components/use-worktree-jump-palette-create-action.ts`
- `src/renderer/src/components/use-worktree-jump-palette-filter.ts`
- `src/renderer/src/components/use-worktree-jump-palette-list-entries.ts`
...
- `src/renderer/src/components/use-worktree-jump-palette-project-targets.ts`
...
- `src/renderer/src/components/use-worktree-jump-palette-task-url.ts`
- `src/renderer/src/components/use-worktree-jump-palette-worktrees.ts`
- `src/renderer/src/components/workspace-cleanup/use-workspace-cleanup-browse-state.test.tsx`
- `src/renderer/src/components/workspace-cleanup/use-workspace-cleanup-browse-state.ts`
- `src/renderer/src/components/workspace-cleanup/use-workspace-cleanup-dialog-lifecycle.ts`
- `src/renderer/src/components/workspace-cleanup/use-workspace-cleanup-facet-rows.test.tsx`
- `src/renderer/src/components/workspace-cleanup/use-workspace-cleanup-facet-rows.ts`
- `src/renderer/src/components/workspace-cleanup/use-workspace-cleanup-git-evidence.test.tsx`
- `src/renderer/src/components/workspace-cleanup/use-workspace-cleanup-git-evidence.ts`
- `src/renderer/src/components/workspace-cleanup/use-workspace-cleanup-removal.ts`
- `src/renderer/src/components/workspace-cleanup/use-workspace-cleanup-row-order.test.ts`
- `src/renderer/src/components/workspace-cleanup/use-workspace-cleanup-row-order.ts`
- `src/renderer/src/components/workspace-cleanup/use-workspace-cleanup-scan-lifecycle.ts`
- `src/renderer/src/components/workspace-cleanup/use-workspace-cleanup-unverified-removal.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-active-facets.test.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-active-facets.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-applied-filter-chips.tsx`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-background-removal-snapshot-batch.test.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-browse-toolbar.tsx`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-confirm-remove.test.tsx`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-confirm-remove.tsx`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-deletion-phases.test.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-deletion-phases.ts`
- `src/renderer/src/components/workspace-cleanup/WorkspaceCleanupDialog.stale-while-revalidate.test.tsx`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-dialog-header.tsx`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-dialog-notices.test.tsx`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-dialog-notices.tsx`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-facet.test.fixture.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-facet-controls.test.tsx`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-facet-controls.tsx`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-facet-filter.test.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-facet-labels.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-facet-matchers.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-facet-panel-model.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-facet-row-caches.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-facets.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-facet-sort.test.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-facet-sort.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-filter-bar.test.tsx`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-filter-bar.tsx`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-flat-list.test.tsx`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-forget-locally-button.tsx`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-freshness.tsx`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-git-evidence.test.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-git-evidence.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-git-review-facets.tsx`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-host-identity.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-host-label.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-lifecycle-facets.tsx`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-metadata-chip.tsx`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-query.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-relative-time.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-removal-timeout-recovery.test.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-row-labels.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-row-list.tsx`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-scanned-host-confirmation-removal.test.tsx`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-scan-notice.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-selection-model.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-snapshot-prune-batch.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-sort-header.test.tsx`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-sort-header.tsx`
- `src/renderer/src/components/workspace-emoji/WorkspaceEmojiSuggestionPopover.test.tsx`
...
- `src/renderer/src/components/WorktreeJumpPalette.linear-url.test.tsx`
...
- `src/renderer/src/components/worktree-jump-palette-create-worktree.ts`
- `src/renderer/src/components/worktree-jump-palette-document-index.ts`
- `src/renderer/src/components/worktree-jump-palette-empty-state.ts`
- `src/renderer/src/components/worktree-jump-palette-entry.tsx`
- `src/renderer/src/components/worktree-jump-palette-model.ts`
- `src/renderer/src/components/worktree-jump-palette-primitives.tsx`
- `src/renderer/src/components/worktree-jump-palette-project-action-rows.tsx`
- `src/renderer/src/components/worktree-jump-palette-quick-action-availability.test.tsx`
- `src/renderer/src/components/worktree-jump-palette-recent-inclusion.ts`
- `src/renderer/src/components/worktree-jump-palette-source.test-support.ts`
...
- `src/renderer/src/hooks/agent-hook-completion-fresh-working.test.ts`
- `src/renderer/src/hooks/agent-hook-completion-notifications-import.test.ts`
- `src/renderer/src/hooks/automation-agent-status-entry-change.test.ts`
- `src/renderer/src/hooks/automation-agent-status-entry-change.ts`
- `src/renderer/src/hooks/automation-dispatch-completion.ts`
- `src/renderer/src/hooks/automation-dispatch-handler.ts`
- `src/renderer/src/hooks/automation-dispatch-observer-test-probe.ts`
- `src/renderer/src/hooks/automation-dispatch-unverifiable-loss.test.ts`
- `src/renderer/src/hooks/automation-dispatch-workspace.ts`
- `src/renderer/src/hooks/automations-changed-event-attribution.test.ts`
- `src/renderer/src/hooks/composer-state/assemble-composer-model.ts`
- `src/renderer/src/hooks/composer-state/async-composer-state.ts`
- `src/renderer/src/hooks/composer-state/async-model.ts`
- `src/renderer/src/hooks/composer-state/attachment-drop-state.ts`
- `src/renderer/src/hooks/composer-state/branch-start-point-actions.ts`
- `src/renderer/src/hooks/composer-state/composer-card-contract.ts`
- `src/renderer/src/hooks/composer-state/composer-card-props.ts`
- `src/renderer/src/hooks/composer-state/composer-decisions.ts`
- `src/renderer/src/hooks/composer-state/composer-drop-listener.test.ts`
- `src/renderer/src/hooks/composer-state/composer-drop-listener.ts`
- `src/renderer/src/hooks/composer-state/composer-external-sync.ts`
- `src/renderer/src/hooks/composer-state/composer-external-sync-contract.ts`
- `src/renderer/src/hooks/composer-state/composer-model.ts`
- `src/renderer/src/hooks/composer-state/composer-navigation-actions.ts`
- `src/renderer/src/hooks/composer-state/composer-source-model.ts`
- `src/renderer/src/hooks/composer-state/composer-source-state.ts`
- `src/renderer/src/hooks/composer-state/composer-source-state-contract.ts`
- `src/renderer/src/hooks/composer-state/composer-store-actions.ts`
- `src/renderer/src/hooks/composer-state/composer-submit-model.ts`
- `src/renderer/src/hooks/composer-state/composer-submit-orchestration.ts`
- `src/renderer/src/hooks/composer-state/composer-submit-state-contract.ts`
- `src/renderer/src/hooks/composer-state/composer-target-input-contracts.ts`
- `src/renderer/src/hooks/composer-state/composer-target-state.ts`
- `src/renderer/src/hooks/composer-state/composer-target-state-contract.ts`
- `src/renderer/src/hooks/composer-state/composer-target-store.ts`
- `src/renderer/src/hooks/composer-state/derived-composer-state.ts`
- `src/renderer/src/hooks/composer-state/derived-model.ts`
- `src/renderer/src/hooks/composer-state/draft-target-sync.test.ts`
- `src/renderer/src/hooks/composer-state/draft-target-sync.ts`
...
- `src/renderer/src/hooks/composer-state/full-submit-orchestration.test.ts`
- `src/renderer/src/hooks/composer-state/full-submit-orchestration.ts`
- `src/renderer/src/hooks/composer-state/full-submit-preparation.ts`
- `src/renderer/src/hooks/composer-state/full-submit-source-preparation.ts`
- `src/renderer/src/hooks/composer-state/github-provider-selection.ts`
- `src/renderer/src/hooks/composer-state/github-source-application.ts`
- `src/renderer/src/hooks/composer-state/github-submit-resolution.ts`
- `src/renderer/src/hooks/composer-state/gitlab-provider-selection.ts`
- `src/renderer/src/hooks/composer-state/host-runtime-effects.ts`
- `src/renderer/src/hooks/composer-state/identity-model.ts`
- `src/renderer/src/hooks/composer-state/initial-target-model.ts`
- `src/renderer/src/hooks/composer-state/initial-target-state.ts`
- `src/renderer/src/hooks/composer-state/issue-source-actions.ts`
...
- `src/renderer/src/hooks/composer-state/project-target-actions.ts`
- `src/renderer/src/hooks/composer-state/provider-runtime-sync.test.ts`
- `src/renderer/src/hooks/composer-state/provider-runtime-sync.ts`
- `src/renderer/src/hooks/composer-state/provider-sync-model.ts`
...
- `src/renderer/src/hooks/composer-state/quick-startup-plan.ts`
- `src/renderer/src/hooks/composer-state/quick-submit-action.ts`
- `src/renderer/src/hooks/composer-state/quick-submit-input-contract.ts`
- `src/renderer/src/hooks/composer-state/quick-submit-preparation.ts`
- `src/renderer/src/hooks/composer-state/quick-submit-source-preparation.ts`
- `src/renderer/src/hooks/composer-state/runtime-target-model.ts`
- `src/renderer/src/hooks/composer-state/runtime-target-selection.ts`
- `src/renderer/src/hooks/composer-state/setup-policy-decisions.ts`
- `src/renderer/src/hooks/composer-state/source-context-model.ts`
- `src/renderer/src/hooks/composer-state/source-context-state.ts`
- `src/renderer/src/hooks/composer-state/source-identity-actions.ts`
- `src/renderer/src/hooks/composer-state/source-selection-decisions.ts`
- `src/renderer/src/hooks/composer-state/target-change-actions.ts`
- `src/renderer/src/hooks/composer-state/target-store-model.ts`
- `src/renderer/src/hooks/composer-state/work-item-source-actions.ts`
- `src/renderer/src/hooks/composer-state/workspace-identity-state.ts`
- `src/renderer/src/hooks/editor-external-watch-disk-verification.ts`
- `src/renderer/src/hooks/editor-external-watch-event-reconciliation.ts`
- `src/renderer/src/hooks/editor-external-watch-targets.ts`
- `src/renderer/src/hooks/ipc-events/agent-dashboard-command.ts`
- `src/renderer/src/hooks/ipc-events/agent-status-bridge-types.ts`
- `src/renderer/src/hooks/ipc-events/agent-status-event-applicator.ts`
- `src/renderer/src/hooks/ipc-events/agent-status-ipc-bridge.ts`
- `src/renderer/src/hooks/ipc-events/agent-status-listeners.ts`
- `src/renderer/src/hooks/ipc-events/agent-status-pane-routing-index.ts`
- `src/renderer/src/hooks/ipc-events/agent-status-pending-retry-gate.test.ts`
- `src/renderer/src/hooks/ipc-events/agent-status-pending-retry-gate.ts`
- `src/renderer/src/hooks/ipc-events/agent-status-routing.ts`
- `src/renderer/src/hooks/ipc-events/app-lifetime-ipc-bridge.ts`
- `src/renderer/src/hooks/ipc-events/browser-automation-bootstrap-lease.test.ts`
- `src/renderer/src/hooks/ipc-events/browser-automation-bootstrap-lease.ts`
- `src/renderer/src/hooks/ipc-events/browser-request-ipc-bridge.ts`
- `src/renderer/src/hooks/ipc-events/browser-session-tab-target.ts`
...
- `src/renderer/src/hooks/ipc-events/content-creation-ipc-bridge.ts`
- `src/renderer/src/hooks/ipc-events/direct-ssh-bridge-runtime.ts`
- `src/renderer/src/hooks/ipc-events/direct-ssh-hydration-fanout.test.ts`
- `src/renderer/src/hooks/ipc-events/direct-ssh-hydration-target-metadata.test.ts`
- `src/renderer/src/hooks/ipc-events/direct-ssh-initial-state-hydration.ts`
- `src/renderer/src/hooks/ipc-events/direct-ssh-state-ipc-bridge.ts`
- `src/renderer/src/hooks/ipc-events/mobile-driver-ipc-bridge.ts`
- `src/renderer/src/hooks/ipc-events/mobile-terminal-close-ipc-bridge.ts`
- `src/renderer/src/hooks/ipc-events/new-workspace-command.ts`
- `src/renderer/src/hooks/ipc-events/normalize-agent-status-event.test.ts`
- `src/renderer/src/hooks/ipc-events/normalize-agent-status-event.ts`
- `src/renderer/src/hooks/ipc-events/os-markdown-file-open-bridge.test.ts`
- `src/renderer/src/hooks/ipc-events/os-markdown-file-open-bridge.ts`
- `src/renderer/src/hooks/ipc-events/project-catalog-ipc-bridge.ts`
- `src/renderer/src/hooks/ipc-events/rate-limit-ipc-bridge.ts`
- `src/renderer/src/hooks/ipc-events/remote-workspace-ipc-bridge.ts`
- `src/renderer/src/hooks/ipc-events/runtime-client-ipc-bridge.ts`
- `src/renderer/src/hooks/ipc-events/runtime-environment-subscription-selection.ts`
...
- `src/renderer/src/hooks/ipc-events/settings-sidebar-ipc-bridge.ts`
- `src/renderer/src/hooks/ipc-events/tab-lifecycle-ipc-bridge.ts`
- `src/renderer/src/hooks/ipc-events/terminal-command-state.ts`
- `src/renderer/src/hooks/ipc-events/terminal-presentation-ipc-bridge.ts`
...
- `src/renderer/src/hooks/ipc-events/updater-status-ipc-bridge.test.ts`
- `src/renderer/src/hooks/ipc-events/updater-status-ipc-bridge.ts`
- `src/renderer/src/hooks/ipc-events/workspace-shortcut-ipc-bridge.ts`
- `src/renderer/src/hooks/ipc-events/worktree-event-runtime.ts`
- `src/renderer/src/hooks/ipc-events/zoom-ipc-bridge.ts`
- `src/renderer/src/hooks/ipc-events-agent-status-store-test-fixtures.ts`
...
- `src/renderer/src/hooks/ipc-events-harness-store-state.ts`
- `src/renderer/src/hooks/ipc-events-ssh-authority-test-fixtures.ts`
- `src/renderer/src/hooks/ipc-events-terminal-create-scenario-types.ts`
- `src/renderer/src/hooks/ipc-events-terminal-create-test-harness.ts`
...
- `src/renderer/src/hooks/remote-workspace-push-status.ts`
- `src/renderer/src/hooks/remote-workspace-session-merge-closed-terminal-tombstone.test.ts`
...
- `src/renderer/src/hooks/remote-workspace-session-readiness.ts`
- `src/renderer/src/hooks/remote-workspace-snapshot-apply-deferred-session-write.test.ts`
- `src/renderer/src/hooks/remote-workspace-snapshot-arrival-coordinator.test.ts`
- `src/renderer/src/hooks/remote-workspace-snapshot-arrival-coordinator.ts`
- `src/renderer/src/hooks/remote-workspace-snapshot-fresh-client-tab-seeding.test.ts`
- `src/renderer/src/hooks/remote-workspace-snapshot-local-tab-survival.test.ts`
- `src/renderer/src/hooks/remote-workspace-snapshot-placement.ts`
- `src/renderer/src/hooks/remote-workspace-snapshot-unplaced-tab-adoption.test.ts`
- `src/renderer/src/hooks/settings-navigation-build-options.ts`
- `src/renderer/src/hooks/settings-navigation-capability-sections.ts`
- `src/renderer/src/hooks/settings-navigation-interface-sections.ts`
- `src/renderer/src/hooks/settings-navigation-remote-sections.ts`
- `src/renderer/src/hooks/settings-navigation-workflow-sections.ts`
- `src/renderer/src/hooks/structured-session-completion-focus.test.ts`
...
- `src/renderer/src/hooks/useComposerState-decisions.test.ts`
- `src/renderer/src/hooks/useEditorExternalWatch-complexity.test.ts`
- `src/renderer/src/hooks/useEditorExternalWatch-subscriptions.test.tsx`
- `src/renderer/src/hooks/useEditorExternalWatch-wsl-repro.test.ts`
- `src/renderer/src/hooks/useIpcEvents-agent-dashboard-shortcut.test.ts`
- `src/renderer/src/hooks/useIpcEvents-agent-status-batch-projection.test.ts`
- `src/renderer/src/hooks/useIpcEvents-agent-status-connection-attribution.test.ts`
- `src/renderer/src/hooks/useIpcEvents-agent-status-hook-titles.test.ts`
- `src/renderer/src/hooks/useIpcEvents-agent-status-pane-teardown.test.ts`
- `src/renderer/src/hooks/useIpcEvents-agent-status-queue-ordering.test.ts`
- `src/renderer/src/hooks/useIpcEvents-agent-status-snapshot-hydration.test.ts`
- `src/renderer/src/hooks/useIpcEvents-agent-status-snapshot-replay.test.ts`
- `src/renderer/src/hooks/useIpcEvents-agent-status-ssh-authority.test.ts`
- `src/renderer/src/hooks/useIpcEvents-agent-status-turn-completion.test.ts`
- `src/renderer/src/hooks/useIpcEvents-browser-certificate-failure.test.ts`
- `src/renderer/src/hooks/useIpcEvents-browser-navigation.test.ts`
- `src/renderer/src/hooks/useIpcEvents-browser-tab-create.test.ts`
- `src/renderer/src/hooks/useIpcEvents-client-hosted-browser-rows.test.ts`
...
- `src/renderer/src/hooks/useIpcEvents-close-routing-floating-guest.test.ts`
- `src/renderer/src/hooks/useIpcEvents-close-routing-session-tabs.test.ts`
- `src/renderer/src/hooks/useIpcEvents-cmd-j-digit-chord.test.ts`
- `src/renderer/src/hooks/useIpcEvents-lifecycle.test.ts`
- `src/renderer/src/hooks/useIpcEvents-new-workspace-shortcut.test.ts`
- `src/renderer/src/hooks/useIpcEvents-rate-limit-hydration.test.ts`
- `src/renderer/src/hooks/useIpcEvents-repos-changed-catalogs.test.ts`
- `src/renderer/src/hooks/useIpcEvents-runtime-environment-selectors.test.ts`
- `src/renderer/src/hooks/useIpcEvents-session-tab-close-request.test.ts`
- `src/renderer/src/hooks/useIpcEvents-silent-terminal-adoption.test.ts`
...
- `src/renderer/src/hooks/useIpcEvents-zoom-routing.test.ts`
- `src/renderer/src/hooks/useMacTccAttributionSeveredNotice.test.tsx`
- `src/renderer/src/hooks/useMacTccAttributionSeveredNotice.ts`
- `src/renderer/src/hooks/use-now.test.ts`
- `src/renderer/src/hooks/use-now.ts`
- `src/renderer/src/hooks/useRetiredWorktreeNames.test.ts`
- `src/renderer/src/hooks/useRetiredWorktreeNames.ts`
- `src/renderer/src/i18n/weekday-names.test.ts`
- `src/renderer/src/i18n/weekday-names.ts`
- `src/renderer/src/i18n/worktree-visibility-locales.test.ts`
...
- `src/renderer/src/lib/active-agent-note-send-delivery.ts`
- `src/renderer/src/lib/active-agent-note-send-diagnostics.ts`
- `src/renderer/src/lib/active-agent-note-send-explicit-target.test.ts`
- `src/renderer/src/lib/active-agent-note-send-focused-session.test.ts`
- `src/renderer/src/lib/active-agent-note-send-runtime-error-codes.test.ts`
- `src/renderer/src/lib/active-agent-note-send-target-detection.test.ts`
- `src/renderer/src/lib/active-agent-note-send-test-harness.ts`
- `src/renderer/src/lib/agent-background-session-exit.ts`
- `src/renderer/src/lib/agent-catalog-links.test.ts`
- `src/renderer/src/lib/agent-draft-readiness.test.ts`
- `src/renderer/src/lib/agent-hibernation-pane-age.test.ts`
- `src/renderer/src/lib/agent-hibernation-pane-age.ts`
- `src/renderer/src/lib/agent-hibernation-pane-eligibility.ts`
- `src/renderer/src/lib/agent-hibernation-planner-snapshot.ts`
- `src/renderer/src/lib/agent-paste-draft-readiness-budget.test.ts`
- `src/renderer/src/lib/agent-paste-draft-submit-retry.test.ts`
- `src/renderer/src/lib/agent-row-decay-state.ts`
- `src/renderer/src/lib/agent-row-dot-state.ts`
- `src/renderer/src/lib/agent-row-tool-preview.test.ts`
- `src/renderer/src/lib/agent-row-tool-preview.ts`
- `src/renderer/src/lib/agent-send-title-status.test.ts`
- `src/renderer/src/lib/agent-status-epoch-clock.test.ts`
- `src/renderer/src/lib/agent-status-epoch-clock.ts`
- `src/renderer/src/lib/agent-status-evidence-clock.test.ts`
- `src/renderer/src/lib/ai-vault-resume-command.resumable-agent.test.ts`
- `src/renderer/src/lib/ai-vault-resume-shell.test.ts`
- `src/renderer/src/lib/automations-changed-window-event.ts`
- `src/renderer/src/lib/browser-history-match.performance.test.ts`
- `src/renderer/src/lib/browser-history-match.test.ts`
- `src/renderer/src/lib/browser-history-match.ts`
- `src/renderer/src/lib/browser-history-match-budget.ts`
- `src/renderer/src/lib/browser-page-conversion-history.test.ts`
- `src/renderer/src/lib/browser-page-conversion-history.ts`
- `src/renderer/src/lib/browser-workspace-source-resolution.ts`
- `src/renderer/src/lib/browser-workspace-tab-activation.ts`
- `src/renderer/src/lib/client-creation-action-error.ts`
- `src/renderer/src/lib/client-creation-action-policy.test.ts`
- `src/renderer/src/lib/client-creation-action-policy.ts`
- `src/renderer/src/lib/client-environment-info.ts`
- `src/renderer/src/lib/client-login-shell.ts`
- `src/renderer/src/lib/cmd-j-evaluation-fixture.ts`
- `src/renderer/src/lib/cmd-j-github-url-lookup.test.ts`
- `src/renderer/src/lib/cmd-j-github-url-lookup.ts`
- `src/renderer/src/lib/cmd-j-host-qualified-candidate-ownership.test.ts`
- `src/renderer/src/lib/cmd-j-linear-issue-intent.test.ts`
- `src/renderer/src/lib/cmd-j-section-leadership.test.ts`
- `src/renderer/src/lib/cmd-j-section-leadership.ts`
- `src/renderer/src/lib/crash-breadcrumb-data.ts`
- `src/renderer/src/lib/doc-preview-grants.test.ts`
- `src/renderer/src/lib/doc-preview-grants.ts`
- `src/renderer/src/lib/editable-target.test.ts`
- `src/renderer/src/lib/ephemeral-vm-failed-create-cleanup.test.ts`
- `src/renderer/src/lib/ephemeral-vm-failed-create-cleanup.ts`
- `src/renderer/src/lib/ephemeral-vm-worktree-creation.test.ts`
- `src/renderer/src/lib/execution-host-display-label.ts`
- `src/renderer/src/lib/file-preview-action-visibility.test.tsx`
- `src/renderer/src/lib/file-type-icon-extension-table.ts`
- `src/renderer/src/lib/file-type-icon-name-table.ts`
- `src/renderer/src/lib/finished-agent-resume-resurrection.test.ts`
- `src/renderer/src/lib/folder-workspace-path-status.test.ts`
- `src/renderer/src/lib/host-mirrored-pane-liveness.ts`
- `src/renderer/src/lib/host-mirrored-pane-resume-replay.test.ts`
- `src/renderer/src/lib/ios-web-platform.test.ts`
- `src/renderer/src/lib/ios-web-platform.ts`
- `src/renderer/src/lib/keyboard-layout/option-key-location-state.test.ts`
- `src/renderer/src/lib/keyboard-layout/option-key-location-state.ts`
- `src/renderer/src/lib/launch-agent-structured-chat-guard.test.ts`
- `src/renderer/src/lib/launch-structured-codex-session.test.ts`
- `src/renderer/src/lib/launch-structured-codex-session.ts`
- `src/renderer/src/lib/linear-issue-url-lookup.test.ts`
- `src/renderer/src/lib/linear-issue-url-lookup.ts`
- `src/renderer/src/lib/list-row-interaction.test.ts`
- `src/renderer/src/lib/list-row-interaction.ts`
- `src/renderer/src/lib/list-table-layout.ts`
- `src/renderer/src/lib/live-resume-anchor-record.ts`
- `src/renderer/src/lib/open-markdown-in-floating-workspace.test.ts`
- `src/renderer/src/lib/open-markdown-in-floating-workspace.ts`
- `src/renderer/src/lib/open-tab-occupant-agent.test.ts`
- `src/renderer/src/lib/open-tab-occupant-agent.ts`
- `src/renderer/src/lib/orca-yaml-trust-prompt-slot-eviction.test.ts`
- `src/renderer/src/lib/palette-match/evidence-composer.ts`
...
- `src/renderer/src/lib/palette-match/match-quality.ts`
- `src/renderer/src/lib/palette-match/normalized-text.ts`
...
- `src/renderer/src/lib/palette-match/palette-query.ts`
- `src/renderer/src/lib/palette-match/tab-document.ts`
- `src/renderer/src/lib/palette-match/tab-match.ts`
- `src/renderer/src/lib/palette-match/text-segments.ts`
- `src/renderer/src/lib/palette-match/typo-distance.ts`
- `src/renderer/src/lib/palette-repo-resolution.test.ts`
- `src/renderer/src/lib/palette-repo-resolution.ts`
- `src/renderer/src/lib/pane-manager/browser-remote-viewer-state.test.ts`
- `src/renderer/src/lib/pane-manager/browser-remote-viewer-state.ts`
- `src/renderer/src/lib/pane-manager/client-hosted-browser-row-ephemerality.test.ts`
- `src/renderer/src/lib/pane-manager/client-hosted-browser-row-state.test.ts`
- `src/renderer/src/lib/pane-manager/client-hosted-browser-row-state.ts`
- `src/renderer/src/lib/pane-manager/pane-manager-drag-wiring.ts`
- `src/renderer/src/lib/pane-manager/pane-manager-host.ts`
- `src/renderer/src/lib/pane-manager/pane-manager-layout-sweeps.ts`
- `src/renderer/src/lib/pane-manager/pane-manager-pane-creation.ts`
- `src/renderer/src/lib/pane-manager/pane-manager-tree-mutations.ts`
- `src/renderer/src/lib/pane-manager/pane-rendering-diagnostics.ts`
- `src/renderer/src/lib/pane-manager/pane-reparent-frame-tracker.ts`
- `src/renderer/src/lib/pane-manager/pane-terminal-cursor-sequencing.ts`
- `src/renderer/src/lib/pane-manager/pane-terminal-foreground-queue-state.ts`
- `src/renderer/src/lib/pane-manager/pane-terminal-output-drain.ts`
- `src/renderer/src/lib/pane-manager/pane-terminal-output-flusher.ts`
- `src/renderer/src/lib/pane-manager/pane-terminal-output-pipeline.ts`
- `src/renderer/src/lib/pane-manager/pane-terminal-output-queue-backlog.ts`
- `src/renderer/src/lib/pane-manager/pane-terminal-output-queue-chunks.test.ts`
- `src/renderer/src/lib/pane-manager/pane-terminal-output-queue-chunks.ts`
- `src/renderer/src/lib/pane-manager/pane-terminal-output-queue-registry.ts`
- `src/renderer/src/lib/pane-manager/pane-terminal-output-scheduler-ack-credit.test.ts`
- `src/renderer/src/lib/pane-manager/pane-terminal-output-scheduler-backlog-cap.test.ts`
- `src/renderer/src/lib/pane-manager/pane-terminal-output-scheduler-debug.ts`
- `src/renderer/src/lib/pane-manager/pane-terminal-output-scheduler-disposed-writes.test.ts`
- `src/renderer/src/lib/pane-manager/pane-terminal-output-scheduler-foreground-refresh.test.ts`
- `src/renderer/src/lib/pane-manager/pane-terminal-output-scheduler-queue-retention.test.ts`
- `src/renderer/src/lib/pane-manager/pane-terminal-output-scheduler-synchronized-frames.test.ts`
- `src/renderer/src/lib/pane-manager/pane-terminal-output-scheduler-test-harness.ts`
- `src/renderer/src/lib/pane-manager/pane-terminal-output-writer.ts`
- `src/renderer/src/lib/pane-manager/pane-tree-equalization.ts`
- `src/renderer/src/lib/pane-manager/pane-webgl-context-loss-policy.ts`
...
- `src/renderer/src/lib/project-clone-url-prefill.ts`
- `src/renderer/src/lib/provisioned-root-create-options.test.ts`
- `src/renderer/src/lib/provisioned-root-create-options.ts`
- `src/renderer/src/lib/react-commit-cascade-install-order.test.ts`
- `src/renderer/src/lib/react-commit-cascade-observer.react185.test.tsx`
- `src/renderer/src/lib/react-commit-cascade-observer.test.ts`
- `src/renderer/src/lib/react-commit-cascade-observer.ts`
- `src/renderer/src/lib/react-commit-cascade-store-write-samples.test.ts`
- `src/renderer/src/lib/react-commit-cascade-store-write-samples.ts`
- `src/renderer/src/lib/react-commit-cascade-telemetry.test.ts`
- `src/renderer/src/lib/react-commit-cascade-telemetry.ts`
- `src/renderer/src/lib/react-devtools-commit-hook-shim.ts`
- `src/renderer/src/lib/renderer-agent-status-observation-ingress.test.ts`
- `src/renderer/src/lib/renderer-agent-status-observations.ts`
...
- `src/renderer/src/lib/resume-stale-structured-agent-session.test.ts`
- `src/renderer/src/lib/session-write-subscriber-deferred-persist.test.ts`
- `src/renderer/src/lib/shutdown-checkpoint-failure-toast.ts`
...
- `src/renderer/src/lib/structured-agent-session-tab-activation.test.ts`
- `src/renderer/src/lib/structured-agent-session-tab-activation.ts`
- `src/renderer/src/lib/structured-agent-synthetic-sleeping-record.ts`
- `src/renderer/src/lib/structured-native-chat-availability.test.ts`
- `src/renderer/src/lib/structured-native-chat-availability.ts`
- `src/renderer/src/lib/tab-agent-from-signals.ts`
- `src/renderer/src/lib/tab-agent-remote-pty-selector.ts`
- `src/renderer/src/lib/typing-latency/census-probe.ts`
- `src/renderer/src/lib/typing-latency/diagnostic.ts`
- `src/renderer/src/lib/typing-latency/diagnostic-lifecycle.test.ts`
- `src/renderer/src/lib/typing-latency/diagnostic-summary.test.ts`
- `src/renderer/src/lib/typing-latency/diagnostic-summary.ts`
- `src/renderer/src/lib/typing-latency/echo-candidate-timeout.ts`
- `src/renderer/src/lib/typing-latency/echo-instrumentation.test.ts`
- `src/renderer/src/lib/typing-latency/echo-instrumentation.ts`
- `src/renderer/src/lib/typing-latency/echo-observation.ts`
- `src/renderer/src/lib/typing-latency/input-events.test.ts`
- `src/renderer/src/lib/typing-latency/input-events.ts`
- `src/renderer/src/lib/typing-latency/input-source.test.ts`
- `src/renderer/src/lib/typing-latency/input-source.ts`
- `src/renderer/src/lib/typing-latency/pane-target.ts`
- `src/renderer/src/lib/typing-latency/sample-window.test.ts`
- `src/renderer/src/lib/typing-latency/sample-window.ts`
- `src/renderer/src/lib/unified-tab-host-ownership.ts`
- `src/renderer/src/lib/use-tab-agent-observed-signal-dispatch.test.tsx`
- `src/renderer/src/lib/use-tab-agent-remote-pty-selector.test.ts`
- `src/renderer/src/lib/visible-overlay.test.ts`
- `src/renderer/src/lib/visible-overlay.ts`
- `src/renderer/src/lib/wake-sleeping-agents-live-done.test.ts`
- `src/renderer/src/lib/web-runtime-worktree-terminal-after-wake.ts`
- `src/renderer/src/lib/workspace-browser-tab-open.test.ts`
- `src/renderer/src/lib/workspace-browser-tab-open.ts`
- `src/renderer/src/lib/workspace-doc-address-input.test.ts`
- `src/renderer/src/lib/workspace-doc-address-input.ts`
- `src/renderer/src/lib/workspace-file-host-routing.ts`
- `src/renderer/src/lib/workspace-session-browser-tabs.ts`
- `src/renderer/src/lib/workspace-session-closed-tab-tombstones.test.ts`
- `src/renderer/src/lib/workspace-session-closed-tab-tombstones.ts`
- `src/renderer/src/lib/workspace-session-host-contention.test.ts`
- `src/renderer/src/lib/workspace-session-host-contention.ts`
- `src/renderer/src/lib/workspace-session-host-hydration.ts`
- `src/renderer/src/lib/workspace-session-staged-browser-tabs.test.ts`
- `src/renderer/src/lib/workspace-session-staged-browser-tabs.ts`
...
- `src/renderer/src/lib/workspace-terminal-host-authority.test.ts`
- `src/renderer/src/lib/workspace-terminal-host-authority.ts`
...
- `src/renderer/src/lib/worktree-activation-issue-command.test.ts`
- `src/renderer/src/lib/worktree-activation-reveal.test.ts`
...
- `src/renderer/src/lib/worktree-activation-test-harness.ts`
...
- `src/renderer/src/lib/worktree-agent-live-surface-adoption.ts`
- `src/renderer/src/lib/worktree-agent-structured-inventory.ts`
- `src/renderer/src/lib/worktree-attachment-label.test.ts`
- `src/renderer/src/lib/worktree-creation-flow-execute.ts`
- `src/renderer/src/lib/worktree-default-terminal-tabs.ts`
- `src/renderer/src/lib/worktree-execution-host-alias.ts`
...
- `src/renderer/src/lib/worktree-live-terminal-surface-owners.ts`
- `src/renderer/src/lib/worktree-nav-view-history-replay.ts`
- `src/renderer/src/lib/worktree-operation-catalog-route.ts`
- `src/renderer/src/lib/worktree-palette-comment-snippet.test.ts`
- `src/renderer/src/lib/worktree-palette-document.ts`
- `src/renderer/src/lib/worktree-palette-evidence.ts`
- `src/renderer/src/lib/worktree-palette-gitlab-url-match.ts`
- `src/renderer/src/lib/worktree-palette-multi-keyword.test.ts`
- `src/renderer/src/lib/worktree-palette-task-url-match.test.ts`
- `src/renderer/src/lib/worktree-palette-task-url-match.ts`
- `src/renderer/src/lib/worktree-palette-task-url-result.ts`
- `src/renderer/src/lib/worktree-reactivation-runtime-owned-resume-deferral.test.ts`
- `src/renderer/src/lib/worktree-setup-issue-command-queue.ts`
- `src/renderer/src/lib/worktree-startup-payload.ts`
- `src/renderer/src/lib/worktree-status.interrupted.test.ts`
- `src/renderer/src/lib/worktree-tab-bucket-projection.ts`
- `src/renderer/src/lib/worktree-visit-recency.test.ts`
- `src/renderer/src/lib/worktree-visit-recency.ts`
...
- `src/renderer/src/runtime/browser-client-host-identity.test.ts`
- `src/renderer/src/runtime/browser-client-host-identity.ts`
- `src/renderer/src/runtime/browser-workspace-tab-close.test.ts`
- `src/renderer/src/runtime/browser-workspace-tab-close.ts`
- `src/renderer/src/runtime/browser-workspace-tab-close-census.test.ts`
- `src/renderer/src/runtime/browser-workspace-tab-close-plan.test.ts`
- `src/renderer/src/runtime/browser-workspace-tab-close-plan.ts`
- `src/renderer/src/runtime/client-hosted-browser-close-intent-replay.test.ts`
- `src/renderer/src/runtime/client-hosted-browser-close-intent-replay.ts`
- `src/renderer/src/runtime/client-hosted-browser-close-intents.test.ts`
- `src/renderer/src/runtime/client-hosted-browser-close-intents.ts`
- `src/renderer/src/runtime/client-hosted-browser-row-close.test.ts`
- `src/renderer/src/runtime/client-hosted-browser-row-close.ts`
- `src/renderer/src/runtime/gitlab-ipc-timeout.ts`
...
- `src/renderer/src/runtime/host-session-mirror-frame-fixtures.ts`
- `src/renderer/src/runtime/host-session-mirror-frame-ordering-harness.ts`
...
- `src/renderer/src/runtime/host-session-snapshot-authority-client-hosted.test.ts`
- `src/renderer/src/runtime/local-structured-session-empty-worktree-visibility.test.ts`
- `src/renderer/src/runtime/local-structured-session-tabs-host-isolation.test.ts`
...
- `src/renderer/src/runtime/mirrored-agent-status-clock-skew.test.ts`
- `src/renderer/src/runtime/remote-agent-row-last-assistant-message.test.ts`
- `src/renderer/src/runtime/remote-runtime-terminal-binary-controller.ts`
- `src/renderer/src/runtime/remote-runtime-terminal-binary-snapshots.ts`
- `src/renderer/src/runtime/remote-runtime-terminal-e2e-control.ts`
- `src/renderer/src/runtime/remote-runtime-terminal-end-verdict.test.ts`
- `src/renderer/src/runtime/remote-runtime-terminal-flow-controller.ts`
- `src/renderer/src/runtime/remote-runtime-terminal-multiplexer-base.ts`
- `src/renderer/src/runtime/remote-runtime-terminal-multiplexer-implementation.ts`
- `src/renderer/src/runtime/remote-runtime-terminal-multiplexer-types.ts`
- `src/renderer/src/runtime/remote-runtime-terminal-response-controller.ts`
- `src/renderer/src/runtime/remote-runtime-terminal-snapshot-controller.ts`
- `src/renderer/src/runtime/remote-runtime-terminal-snapshot-kitty-flags.test.ts`
- `src/renderer/src/runtime/remote-runtime-terminal-snapshot-state.ts`
- `src/renderer/src/runtime/remote-runtime-terminal-stale-stream-frames.test.ts`
- `src/renderer/src/runtime/restored-client-hosted-browser-host-attach.test.ts`
- `src/renderer/src/runtime/restored-client-hosted-browser-host-attach.ts`
- `src/renderer/src/runtime/restored-client-hosted-browser-host-restart-attach.test.ts`
- `src/renderer/src/runtime/runtime-file-client-download.test.ts`
- `src/renderer/src/runtime/runtime-file-client-external-import.test.ts`
- `src/renderer/src/runtime/runtime-file-client-mutation-ownership.test.ts`
- `src/renderer/src/runtime/runtime-file-client-search-listing.test.ts`
- `src/renderer/src/runtime/runtime-file-client-test-harness.ts`
- `src/renderer/src/runtime/runtime-file-client-types.ts`
- `src/renderer/src/runtime/runtime-file-client-watch.test.ts`
- `src/renderer/src/runtime/runtime-file-import-client.ts`
- `src/renderer/src/runtime/runtime-file-metadata-client.ts`
- `src/renderer/src/runtime/runtime-file-mutation-client.ts`
- `src/renderer/src/runtime/runtime-file-mutation-rpc.ts`
...
- `src/renderer/src/runtime/runtime-file-upload-client.ts`
- `src/renderer/src/runtime/runtime-file-watch-client.ts`
- `src/renderer/src/runtime/runtime-git-client-api-contract.test.ts`
- `src/renderer/src/runtime/runtime-git-client-context.ts`
- `src/renderer/src/runtime/runtime-git-diff-client.ts`
- `src/renderer/src/runtime/runtime-git-generation-client.ts`
- `src/renderer/src/runtime/runtime-git-status-client.ts`
- `src/renderer/src/runtime/runtime-git-sync-client.ts`
- `src/renderer/src/runtime/runtime-git-working-tree-client.ts`
- `src/renderer/src/runtime/runtime-jira-user-fields-client.ts`
- `src/renderer/src/runtime/runtime-legacy-quick-open-inventory.ts`
- `src/renderer/src/runtime/runtime-linear-issue-mutations.ts`
- `src/renderer/src/runtime/runtime-linear-project-client.ts`
- `src/renderer/src/runtime/runtime-skills-delete-client.test.ts`
- `src/renderer/src/runtime/runtime-status-probe-diagnostics.ts`
...
- `src/renderer/src/runtime/structured-agent-session-close.test.ts`
- `src/renderer/src/runtime/structured-agent-session-close.ts`
...
- `src/renderer/src/runtime/sync-runtime-graph/graph-state.ts`
- `src/renderer/src/runtime/sync-runtime-graph/mobile-session-browser-tabs.ts`
- `src/renderer/src/runtime/sync-runtime-graph/mobile-session-capture.ts`
- `src/renderer/src/runtime/sync-runtime-graph/mobile-session-editor-tabs.ts`
- `src/renderer/src/runtime/sync-runtime-graph/mobile-session-group-projection.ts`
- `src/renderer/src/runtime/sync-runtime-graph/mobile-session-inputs.ts`
- `src/renderer/src/runtime/sync-runtime-graph/mobile-session-snapshots.ts`
- `src/renderer/src/runtime/sync-runtime-graph/mobile-session-surfaces.ts`
- `src/renderer/src/runtime/sync-runtime-graph/mobile-session-terminal-tabs.ts`
- `src/renderer/src/runtime/sync-runtime-graph/mobile-terminal-theme.ts`
- `src/renderer/src/runtime/sync-runtime-graph/sync-key.ts`
- `src/renderer/src/runtime/sync-runtime-graph/sync-projections.ts`
- `src/renderer/src/runtime/sync-runtime-graph/types.ts`
...
- `src/renderer/src/runtime/sync-runtime-graph-test-harness.ts`
- `src/renderer/src/runtime/sync-runtime-graph-workspace-publication.test.ts`
- `src/renderer/src/runtime/web-runtime-browser-capability-cleanup.test.ts`
- `src/renderer/src/runtime/web-runtime-browser-creation.ts`
- `src/renderer/src/runtime/web-runtime-browser-creation-context.ts`
- `src/renderer/src/runtime/web-runtime-browser-creation-e2e-fault.ts`
- `src/renderer/src/runtime/web-runtime-browser-creation-failure.ts`
- `src/renderer/src/runtime/web-runtime-browser-materialization.test.ts`
- `src/renderer/src/runtime/web-runtime-browser-materialization.ts`
- `src/renderer/src/runtime/web-runtime-browser-materialization-wait.ts`
- `src/renderer/src/runtime/web-runtime-browser-tab-staging.ts`
- `src/renderer/src/runtime/web-runtime-browser-tab-staging-hosting-intent.test.ts`
...
- `src/renderer/src/runtime/web-runtime-session-browser-create-focus.test.ts`
- `src/renderer/src/runtime/web-runtime-session-browser-create-split-placement.test.ts`
- `src/renderer/src/runtime/web-runtime-session-browser-create-staged-focus.test.ts`
- `src/renderer/src/runtime/web-runtime-session-browser-create-staged-hosting-intent.test.ts`
- `src/renderer/src/runtime/web-runtime-session-browser-create-staging.test.ts`
- `src/renderer/src/runtime/web-runtime-session-browser-placement-staleness.test.ts`
- `src/renderer/src/runtime/web-runtime-session-environment.ts`
- `src/renderer/src/runtime/web-runtime-session-snapshot.ts`
- `src/renderer/src/runtime/web-runtime-session-tab-activate-close.test.ts`
- `src/renderer/src/runtime/web-runtime-session-tab-lifecycle.ts`
- `src/renderer/src/runtime/web-runtime-session-tab-move.test.ts`
- `src/renderer/src/runtime/web-runtime-session-tab-move.ts`
- `src/renderer/src/runtime/web-runtime-session-tab-props.test.ts`
...
- `src/renderer/src/runtime/web-runtime-session-terminal-pane-delegation.test.ts`
- `src/renderer/src/runtime/web-runtime-session-terminal-workspace-routing.test.ts`
- `src/renderer/src/runtime/web-runtime-session-test-harness.ts`
- `src/renderer/src/runtime/web-runtime-session-types.ts`
- `src/renderer/src/runtime/web-runtime-session-workspace-routing.ts`
- `src/renderer/src/runtime/web-runtime-session-workspace-selection.ts`
- `src/renderer/src/runtime/web-runtime-split-focus.ts`
- `src/renderer/src/runtime/web-runtime-terminal-actions.ts`
- `src/renderer/src/runtime/web-runtime-terminal-create-operation.ts`
- `src/renderer/src/runtime/web-runtime-terminal-creation.ts`
- `src/renderer/src/runtime/web-runtime-terminal-identity.ts`
- `src/renderer/src/runtime/web-runtime-terminal-placement-settlement.ts`
- `src/renderer/src/runtime/web-runtime-worktree-activation.ts`
- `src/renderer/src/runtime/web-session-browser-placement.test.ts`
- `src/renderer/src/runtime/web-session-browser-placement.ts`
- `src/renderer/src/runtime/web-session-client-owned-tab-placement.ts`
- `src/renderer/src/runtime/web-session-existing-tab-index.test.ts`
- `src/renderer/src/runtime/web-session-existing-tab-index.ts`
- `src/renderer/src/runtime/web-session-focus-intent-visible-tab.test.ts`
- `src/renderer/src/runtime/web-session-structured-tab-focus.test.ts`
- `src/renderer/src/runtime/web-session-tab-rpc-timeout.ts`
...
- `src/renderer/src/runtime/web-session-tabs-sync/agent-status-patch.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/agent-status-primitives.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/apply-active-state.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/apply-browser-records.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/apply-final-patch.ts`
...
- `src/renderer/src/runtime/web-session-tabs-sync/apply-preparation-groups.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/apply-preparation-unified.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/apply-snapshot.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/apply-terminal-records.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/apply-worktree-records.ts`
...
- `src/renderer/src/runtime/web-session-tabs-sync/global-session-subscription.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/layout-groups.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/load-initial.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/mirrored-browser-tabs.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/mirror-settle.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/publisher-identity-fences.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/session-tabs-inventory-absence.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/snapshot-api.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/state.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/state-equality-core.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/state-equality-files.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/state-equality-tabs.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/store-patch.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/tab-builders.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/tab-group-layout-tree.ts`
...
- `src/renderer/src/runtime/web-session-tabs-sync/tracking.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/tracking-decisions.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/tracking-lifecycle.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/tracking-mappings.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/use-web-session-tabs-sync.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/visibility-resume-batch.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/visibility-resume-coordinator.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/visibility-resume-inventory.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/visibility-resume-repair.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/visibility-resume-types.ts`
- `src/renderer/src/runtime/web-session-tabs-sync/visibility-types.ts`
- `src/renderer/src/runtime/web-session-tabs-sync-agent-handoff.test.ts`
- `src/renderer/src/runtime/web-session-tabs-sync-agent-status.test.ts`
- `src/renderer/src/runtime/web-session-tabs-sync-browser-tabs.test.ts`
- `src/renderer/src/runtime/web-session-tabs-sync-client-owned-page-content.test.ts`
- `src/renderer/src/runtime/web-session-tabs-sync-client-owned-placement.test.ts`
- `src/renderer/src/runtime/web-session-tabs-sync-diff-focus-steal.test.ts`
- `src/renderer/src/runtime/web-session-tabs-sync-editor-tabs.test.ts`
- `src/renderer/src/runtime/web-session-tabs-sync-focus-intent.test.ts`
- `src/renderer/src/runtime/web-session-tabs-sync-host-restart-browser-rows.test.ts`
- `src/renderer/src/runtime/web-session-tabs-sync-host-tab-retraction-ghost-rows.test.ts`
- `src/renderer/src/runtime/web-session-tabs-sync-html-preview-focus.test.ts`
- `src/renderer/src/runtime/web-session-tabs-sync-layout-duplicate-groups.test.ts`
- `src/renderer/src/runtime/web-session-tabs-sync-layout-groups.test.ts`
- `src/renderer/src/runtime/web-session-tabs-sync-restored-browser-rows.test.ts`
- `src/renderer/src/runtime/web-session-tabs-sync-snapshot-batch.test.ts`
- `src/renderer/src/runtime/web-session-tabs-sync-staged-browser-adoption.test.ts`
- `src/renderer/src/runtime/web-session-tabs-sync-staged-browser-authority.test.ts`
- `src/renderer/src/runtime/web-session-tabs-sync-terminal-bootstrap.test.ts`
...
- `src/renderer/src/runtime/web-session-tabs-sync-tracking-teardown.test.ts`
- `src/renderer/src/runtime/web-session-terminal-orphan-absence-across-republication.test.ts`
...
- `src/renderer/src/runtime/web-session-terminal-placement.ts`
- `src/renderer/src/startup/startup-degraded-recovery.ts`
- `src/renderer/src/startup/startup-ssh-connection-restore.ts`
- `src/renderer/src/store/active-terminal-chrome-selector.test.ts`
- `src/renderer/src/store/catalog-identity.ts`
- `src/renderer/src/store/folder-workspaces/folder-path-status.ts`
- `src/renderer/src/store/folder-workspaces/folder-path-status-actions.ts`
- `src/renderer/src/store/folder-workspaces/folder-workspace-catalog.test.ts`
- `src/renderer/src/store/folder-workspaces/folder-workspace-catalog.ts`
- `src/renderer/src/store/folder-workspaces/folder-workspace-catalog-actions.ts`
- `src/renderer/src/store/folder-workspaces/folder-workspace-mutations.ts`
- `src/renderer/src/store/folder-workspaces/folder-workspace-routing.ts`
- `src/renderer/src/store/github/cache-identity.ts`
- `src/renderer/src/store/github/cache-model.ts`
- `src/renderer/src/store/github/cache-persistence.ts`
- `src/renderer/src/store/github/cache-policy.ts`
- `src/renderer/src/store/github/check-actions.ts`
- `src/renderer/src/store/github/comment-fetch-actions.ts`
- `src/renderer/src/store/github/comment-mutation-actions.ts`
- `src/renderer/src/store/github/conversation-comment-actions.ts`
- `src/renderer/src/store/github/issue-actions.ts`
- `src/renderer/src/store/github/pr-check-status-cache.ts`
- `src/renderer/src/store/github/pr-comment-cache.ts`
- `src/renderer/src/store/github/project-actions.ts`
- `src/renderer/src/store/github/project-cache.ts`
- `src/renderer/src/store/github/project-row-actions.ts`
- `src/renderer/src/store/github/pr-refresh-state.ts`
- `src/renderer/src/store/github/pr-result-cache.ts`
- `src/renderer/src/store/github/pr-result-routing.ts`
- `src/renderer/src/store/github/pull-request-actions.ts`
- `src/renderer/src/store/github/pull-request-execution.ts`
- `src/renderer/src/store/github/refresh-event-actions.ts`
- `src/renderer/src/store/github/refresh-routing-actions.ts`
- `src/renderer/src/store/github/refresh-sweep-actions.ts`
- `src/renderer/src/store/github/repository-routing.ts`
- `src/renderer/src/store/github/request-coordination.ts`
- `src/renderer/src/store/github/review-thread-actions.ts`
- `src/renderer/src/store/github/slice-types.ts`
- `src/renderer/src/store/github/stale-worktree-refresh-actions.ts`
- `src/renderer/src/store/github/work-item-aggregate-actions.ts`
- `src/renderer/src/store/github/work-item-fetch-actions.ts`
- `src/renderer/src/store/github/work-item-mutation-actions.ts`
- `src/renderer/src/store/github/work-item-routing.ts`
- `src/renderer/src/store/github/worktree-refresh.ts`
- `src/renderer/src/store/host-catalog-fencing.ts`
...
- `src/renderer/src/store/project-groups/project-group-removal-state.ts`
- `src/renderer/src/store/project-host-setup-selector.test.ts`
- `src/renderer/src/store/projects/project-catalog-null-field-ingest.test.ts`
- `src/renderer/src/store/projects/project-compatibility-core.ts`
- `src/renderer/src/store/projects/project-compatibility-host-merge.ts`
- `src/renderer/src/store/projects/project-host-routing.ts`
- `src/renderer/src/store/projects/project-host-setup-actions.ts`
- `src/renderer/src/store/projects/project-profile-presence.ts`
- `src/renderer/src/store/projects/project-update.ts`
- `src/renderer/src/store/projects/project-wsl-filesystem-boundary-advisory.test.ts`
- `src/renderer/src/store/projects/project-wsl-filesystem-boundary-advisory.ts`
- `src/renderer/src/store/react-commit-cascade-write-probe.test.ts`
- `src/renderer/src/store/react-commit-cascade-write-probe.ts`
- `src/renderer/src/store/repos/all-host-repo-catalog-actions.ts`
- `src/renderer/src/store/repos/owner-routing.ts`
- `src/renderer/src/store/repos/repo-add-actions.ts`
- `src/renderer/src/store/repos/repo-catalog-actions.ts`
- `src/renderer/src/store/repos/repo-catalog-fencing.ts`
- `src/renderer/src/store/repos/repo-catalog-identity.ts`
- `src/renderer/src/store/repos/repo-catalog-merge.ts`
- `src/renderer/src/store/repos/repo-ordering.ts`
- `src/renderer/src/store/repos/repo-removal.ts`
- `src/renderer/src/store/repos/repo-state.ts`
- `src/renderer/src/store/repos/repo-update.ts`
- `src/renderer/src/store/repos/runtime-repo-catalog-actions.ts`
- `src/renderer/src/store/repos/safe-auto-fork-sync.test.ts`
- `src/renderer/src/store/repos/safe-auto-fork-sync.ts`
- `src/renderer/src/store/runtime-catalog-hosts.ts`
- `src/renderer/src/store/runtime-target-host.ts`
- `src/renderer/src/store/slices/agent-hibernation-live-anchor-e2e.test.ts`
- `src/renderer/src/store/slices/agent-status-authority-actions.ts`
- `src/renderer/src/store/slices/agent-status-batch.test.ts`
- `src/renderer/src/store/slices/agent-status-capacity-eviction.ts`
- `src/renderer/src/store/slices/agent-status-cleanup-actions.ts`
- `src/renderer/src/store/slices/agent-status-connection-worktree-scope.ts`
- `src/renderer/src/store/slices/agent-status-contract.ts`
- `src/renderer/src/store/slices/agent-status-drop-actions.ts`
- `src/renderer/src/store/slices/agent-status-drop-reducer.ts`
- `src/renderer/src/store/slices/agent-status-freshness-scheduler.test.ts`
- `src/renderer/src/store/slices/agent-status-launch-actions.ts`
- `src/renderer/src/store/slices/agent-status-launch-config.ts`
- `src/renderer/src/store/slices/agent-status-live-actions.ts`
- `src/renderer/src/store/slices/agent-status-live-entry-builder.ts`
- `src/renderer/src/store/slices/agent-status-live-facts.ts`
- `src/renderer/src/store/slices/agent-status-live-freshness-request.test.ts`
- `src/renderer/src/store/slices/agent-status-live-reducer.ts`
- `src/renderer/src/store/slices/agent-status-migration-unsupported-entries.ts`
- `src/renderer/src/store/slices/agent-status-observation-neutrality.test.ts`
- `src/renderer/src/store/slices/agent-status-orchestration-actions.ts`
...
- `src/renderer/src/store/slices/agent-status-pane-key-tab-binding.ts`
- `src/renderer/src/store/slices/agent-status-provider-session-actions.ts`
- `src/renderer/src/store/slices/agent-status-pr-refresh-handoff.test.ts`
...
- `src/renderer/src/store/slices/agent-status-recovery-equivalence.ts`
- `src/renderer/src/store/slices/agent-status-reminted-pane-key.test.ts`
- `src/renderer/src/store/slices/agent-status-retention-actions.ts`
- `src/renderer/src/store/slices/agent-status-retention-prefix-sweep.test.ts`
- `src/renderer/src/store/slices/agent-status-runtime.ts`
- `src/renderer/src/store/slices/agent-status-runtime-orchestration.test.ts`
- `src/renderer/src/store/slices/agent-status-session-boundary-done.test.ts`
...
- `src/renderer/src/store/slices/agent-status-test-harness.ts`
- `src/renderer/src/store/slices/agent-status-tool-assistant-fields.test.ts`
- `src/renderer/src/store/slices/agent-status-worktree-drop-actions.ts`
- `src/renderer/src/store/slices/browser/browser-close-actions.ts`
- `src/renderer/src/store/slices/browser/browser-cookie-import-actions.ts`
- `src/renderer/src/store/slices/browser/browser-history-actions.ts`
- `src/renderer/src/store/slices/browser/browser-host-actions.ts`
- `src/renderer/src/store/slices/browser/browser-host-state.ts`
- `src/renderer/src/store/slices/browser/browser-hydration-actions.ts`
- `src/renderer/src/store/slices/browser/browser-page-annotation.ts`
- `src/renderer/src/store/slices/browser/browser-page-conversion-actions.ts`
- `src/renderer/src/store/slices/browser/browser-page-create-actions.ts`
- `src/renderer/src/store/slices/browser/browser-page-focus-actions.ts`
- `src/renderer/src/store/slices/browser/browser-page-metadata-actions.ts`
- `src/renderer/src/store/slices/browser/browser-page-state-actions.ts`
- `src/renderer/src/store/slices/browser/browser-profile-import-actions.ts`
- `src/renderer/src/store/slices/browser/browser-profile-list-actions.ts`
- `src/renderer/src/store/slices/browser/browser-remote-close.ts`
...
- `src/renderer/src/store/slices/browser/browser-tab-focus-actions.ts`
- `src/renderer/src/store/slices/browser/create-browser-slice.ts`
- `src/renderer/src/store/slices/browser-cleanup-close.test.ts`
- `src/renderer/src/store/slices/browser-page-close-intent-recording.test.ts`
- `src/renderer/src/store/slices/browser-page-conversion.test.ts`
- `src/renderer/src/store/slices/browser-page-conversion.ts`
- `src/renderer/src/store/slices/browser-page-records.ts`
- `src/renderer/src/store/slices/browser-remote-page-lifecycle.test.ts`
- `src/renderer/src/store/slices/browser-remote-tab-creation.test.ts`
- `src/renderer/src/store/slices/browser-session-host-selection.test.ts`
- `src/renderer/src/store/slices/browser-session-profiles.test.ts`
- `src/renderer/src/store/slices/browser-slice-test-harness.ts`
- `src/renderer/src/store/slices/browser-workspace-doc-location.test.ts`
- `src/renderer/src/store/slices/browser-workspace-host-ownership.test.ts`
- `src/renderer/src/store/slices/diff-comment-persistence.ts`
- `src/renderer/src/store/slices/editor/actions/check-run-details-actions.ts`
- `src/renderer/src/store/slices/editor/actions/close-file-action.ts`
- `src/renderer/src/store/slices/editor/actions/editor-cursor-line.ts`
- `src/renderer/src/store/slices/editor/actions/editor-draft-state.ts`
- `src/renderer/src/store/slices/editor/actions/editor-reveal-focus-state.ts`
- `src/renderer/src/store/slices/editor/actions/explorer-dir-state.ts`
- `src/renderer/src/store/slices/editor/actions/file-search-actions.ts`
- `src/renderer/src/store/slices/editor/actions/git-branch-compare-actions.ts`
- `src/renderer/src/store/slices/editor/actions/git-remote-push-pull.ts`
- `src/renderer/src/store/slices/editor/actions/git-remote-status.ts`
- `src/renderer/src/store/slices/editor/actions/git-remote-sync.ts`
- `src/renderer/src/store/slices/editor/actions/git-status-actions.ts`
- `src/renderer/src/store/slices/editor/actions/hydrate-editor-session.ts`
- `src/renderer/src/store/slices/editor/actions/markdown-link-action.ts`
- `src/renderer/src/store/slices/editor/actions/markdown-preview-actions.test.ts`
- `src/renderer/src/store/slices/editor/actions/markdown-preview-actions.ts`
- `src/renderer/src/store/slices/editor/actions/open-combined-diff.ts`
- `src/renderer/src/store/slices/editor/actions/open-conflict-file.ts`
- `src/renderer/src/store/slices/editor/actions/open-conflict-review.ts`
- `src/renderer/src/store/slices/editor/actions/open-file-action.ts`
- `src/renderer/src/store/slices/editor/actions/open-file-apply.ts`
- `src/renderer/src/store/slices/editor/actions/open-file-mutations.ts`
- `src/renderer/src/store/slices/editor/actions/open-file-state.ts`
- `src/renderer/src/store/slices/editor/actions/open-history-diff.ts`
- `src/renderer/src/store/slices/editor/actions/open-unstaged-diff.ts`
- `src/renderer/src/store/slices/editor/actions/recently-closed-editor-tabs.ts`
- `src/renderer/src/store/slices/editor/actions/rekey-open-files-action.ts`
- `src/renderer/src/store/slices/editor/actions/restored-editor-owner.ts`
- `src/renderer/src/store/slices/editor/actions/restored-editor-owner-destination.ts`
- `src/renderer/src/store/slices/editor/actions/restored-editor-owner-transition.ts`
- `src/renderer/src/store/slices/editor/actions/right-sidebar-state.ts`
- `src/renderer/src/store/slices/editor/create-editor-slice.ts`
- `src/renderer/src/store/slices/editor/file-ids/editor-file-ids.ts`
- `src/renderer/src/store/slices/editor/file-ids/hydrated-editor-file-ids.ts`
- `src/renderer/src/store/slices/editor/file-ids/open-file-path-rekey.ts`
- `src/renderer/src/store/slices/editor/focus/editor-focus-reveal.ts`
- `src/renderer/src/store/slices/editor/git/branch-compare-state.ts`
- `src/renderer/src/store/slices/editor/git/diff-runtime-owner.ts`
- `src/renderer/src/store/slices/editor/git/git-status-reconciliation.ts`
- `src/renderer/src/store/slices/editor/search/file-search-state.ts`
- `src/renderer/src/store/slices/editor/tabs/editor-open-target-group.ts`
- `src/renderer/src/store/slices/editor/tabs/editor-tab-content-type.ts`
- `src/renderer/src/store/slices/editor/tabs/untitled-file-cleanup.ts`
- `src/renderer/src/store/slices/editor/tabs/workspace-editor-item.ts`
- `src/renderer/src/store/slices/editor/types/editor-files-slice.ts`
- `src/renderer/src/store/slices/editor/types/editor-git-slice.ts`
- `src/renderer/src/store/slices/editor/types/editor-set-get.ts`
- `src/renderer/src/store/slices/editor/types/editor-slice.ts`
- `src/renderer/src/store/slices/editor/types/file-search-worktree-state.ts`
- `src/renderer/src/store/slices/editor/types/git-runtime-operation.ts`
- `src/renderer/src/store/slices/editor/types/open-file.ts`
- `src/renderer/src/store/slices/editor/types/open-file-path-rekey.ts`
- `src/renderer/src/store/slices/editor/types/pending-editor-reveal.ts`
- `src/renderer/src/store/slices/editor/types/restored-editor-owner.ts`
- `src/renderer/src/store/slices/editor-branch-diff-snapshots.test.ts`
- `src/renderer/src/store/slices/editor-check-details-tabs.test.ts`
- `src/renderer/src/store/slices/editor-close-file-cleanup.test.ts`
- `src/renderer/src/store/slices/editor-git-status-reconciliation.test.ts`
- `src/renderer/src/store/slices/editor-markdown-link-activation.test.ts`
- `src/renderer/src/store/slices/editor-markdown-view-state.test.ts`
- `src/renderer/src/store/slices/editor-open-diff.test.ts`
- `src/renderer/src/store/slices/editor-read-only-tabs.test.ts`
- `src/renderer/src/store/slices/editor-recently-closed-tabs.test.ts`
- `src/renderer/src/store/slices/editor-remote-branch-actions.test.ts`
- `src/renderer/src/store/slices/editor-rich-markdown-size-override.test.ts`
- `src/renderer/src/store/slices/editor-right-sidebar-state.test.ts`
- `src/renderer/src/store/slices/editor-session-duplicate-restore.test.ts`
- `src/renderer/src/store/slices/editor-slice-test-harness.ts`
- `src/renderer/src/store/slices/editor-tab-placement.test.ts`
- `src/renderer/src/store/slices/folder-workspace-diff-comments.test.ts`
- `src/renderer/src/store/slices/github-branch-mismatched-linked-pr.test.ts`
- `src/renderer/src/store/slices/github-cache-eviction-and-bounds.test.ts`
- `src/renderer/src/store/slices/github-issue-source-indicator-suppression.test.ts`
- `src/renderer/src/store/slices/github-issue-state-machine.test.ts`
- `src/renderer/src/store/slices/github-pr-branch-coordinator-events.test.ts`
- `src/renderer/src/store/slices/github-pr-branch-direct-refresh-scope.test.ts`
- `src/renderer/src/store/slices/github-pr-branch-fallback-results.test.ts`
- `src/renderer/src/store/slices/github-pr-branch-hosted-review-cache.test.ts`
- `src/renderer/src/store/slices/github-pr-branch-linked-pr-divergence.test.ts`
- `src/renderer/src/store/slices/github-pr-checks-fetch.test.ts`
- `src/renderer/src/store/slices/github-pr-comments.test.ts`
- `src/renderer/src/store/slices/github-project-request-coordination.test.ts`
- `src/renderer/src/store/slices/github-project-view-tables.test.ts`
- `src/renderer/src/store/slices/github-provider-request-concurrency.test.ts`
- `src/renderer/src/store/slices/github-pr-refresh-hosted-review-cache-leak.test.ts`
- `src/renderer/src/store/slices/github-refresh-sweep.test.ts`
- `src/renderer/src/store/slices/github-review-thread-actions.test.ts`
- `src/renderer/src/store/slices/github-slice-test-harness.ts`
- `src/renderer/src/store/slices/github-work-item-cache-identity.test.ts`
- `src/renderer/src/store/slices/github-work-items-error-envelope.test.ts`
- `src/renderer/src/store/slices/github-work-items-pagination.test.ts`
- `src/renderer/src/store/slices/github-work-items-runtime-routing.test.ts`
- `src/renderer/src/store/slices/github-worktree-refresh-if-stale.test.ts`
- `src/renderer/src/store/slices/hosted-review-cache-state.ts`
- `src/renderer/src/store/slices/hosted-review-card-refresh.ts`
- `src/renderer/src/store/slices/hosted-review-pr-cache.ts`
- `src/renderer/src/store/slices/hosted-review-request-state.ts`
- `src/renderer/src/store/slices/jira-collection-read-actions.ts`
- `src/renderer/src/store/slices/jira-connection-actions.ts`
- `src/renderer/src/store/slices/jira-issue-patch-action.ts`
- `src/renderer/src/store/slices/jira-issue-read-actions.ts`
- `src/renderer/src/store/slices/jira-read-coordination.ts`
- `src/renderer/src/store/slices/jira-slice-contract.ts`
- `src/renderer/src/store/slices/linear/linear-cache.ts`
- `src/renderer/src/store/slices/linear/linear-custom-view-detail-actions.ts`
- `src/renderer/src/store/slices/linear/linear-custom-view-issue-actions.ts`
- `src/renderer/src/store/slices/linear/linear-custom-view-list-actions.ts`
- `src/renderer/src/store/slices/linear/linear-custom-view-project-actions.ts`
- `src/renderer/src/store/slices/linear/linear-invalidation-actions.ts`
- `src/renderer/src/store/slices/linear/linear-issue-cache-actions.ts`
- `src/renderer/src/store/slices/linear/linear-issue-detail-actions.ts`
- `src/renderer/src/store/slices/linear/linear-issue-list-actions.ts`
- `src/renderer/src/store/slices/linear/linear-project-detail-actions.ts`
- `src/renderer/src/store/slices/linear/linear-project-issue-actions.ts`
- `src/renderer/src/store/slices/linear/linear-project-list-actions.ts`
- `src/renderer/src/store/slices/linear/linear-slice-connection-actions.ts`
- `src/renderer/src/store/slices/linear/linear-slice-contract.ts`
- `src/renderer/src/store/slices/linear/linear-slice-request-state.ts`
- `src/renderer/src/store/slices/linear/linear-slice-scope.ts`
- `src/renderer/src/store/slices/linear/linear-slice-status-actions.ts`
- `src/renderer/src/store/slices/linear/linear-team-actions.ts`
- `src/renderer/src/store/slices/linear-credential-error-recovery.test.ts`
- `src/renderer/src/store/slices/linear-issue-cache-refresh.test.ts`
- `src/renderer/src/store/slices/linear-scoped-collection-cache.test.ts`
- `src/renderer/src/store/slices/linear-slice-test-harness.ts`
- `src/renderer/src/store/slices/linear-source-context-cache-scope.test.ts`
- `src/renderer/src/store/slices/local-agent-context-eviction.ts`
- `src/renderer/src/store/slices/local-agent-legacy-loading.ts`
- `src/renderer/src/store/slices/local-detected-agent-state.test.ts`
- `src/renderer/src/store/slices/local-detected-agent-state.ts`
- `src/renderer/src/store/slices/local-detected-agent-store-state.ts`
- `src/renderer/src/store/slices/modal-slot-dismissal.ts`
- `src/renderer/src/store/slices/persisted-ui-write-baseline.test.ts`
- `src/renderer/src/store/slices/persisted-ui-write-baseline.ts`
- `src/renderer/src/store/slices/project-group-owner-routing.ts`
- `src/renderer/src/store/slices/renderer-remove-worktree-result.ts`
- `src/renderer/src/store/slices/repo-filter-selection.ts`
- `src/renderer/src/store/slices/repos-add-races.test.ts`
...
- `src/renderer/src/store/slices/repos-module-lifetime-coordinators.test.ts`
- `src/renderer/src/store/slices/repos-nested-import-refresh-failures.test.ts`
...
- `src/renderer/src/store/slices/repos-runtime-visibility-defaults.test.ts`
- `src/renderer/src/store/slices/retired-terminal-tab-state-sweep.ts`
- `src/renderer/src/store/slices/runtime-environment-ssh-selectors.ts`
- `src/renderer/src/store/slices/runtime-status-catalog-identity.test.ts`
- `src/renderer/src/store/slices/runtime-status-connection-generation.ts`
- `src/renderer/src/store/slices/runtime-status-diagnostics.test.ts`
- `src/renderer/src/store/slices/runtime-status-diagnostics-generation.ts`
- `src/renderer/src/store/slices/runtime-status-diagnostics-publish.ts`
- `src/renderer/src/store/slices/runtime-status-recheck.test.ts`
- `src/renderer/src/store/slices/runtime-status-recheck.ts`
- `src/renderer/src/store/slices/runtime-status-refresh-diagnostics.test.ts`
...
- `src/renderer/src/store/slices/runtime-switch-settings-persistence.test.ts`
- `src/renderer/src/store/slices/settings-owner-hydration-publication.ts`
- `src/renderer/src/store/slices/settings-owner-hydration-write-fence.test.ts`
- `src/renderer/src/store/slices/store-active-worktree-selection.test.ts`
- `src/renderer/src/store/slices/store-active-worktree-split-groups.test.ts`
- `src/renderer/src/store/slices/store-active-worktree-tab-close.test.ts`
- `src/renderer/src/store/slices/store-active-worktree-terminal-creation.test.ts`
- `src/renderer/src/store/slices/store-cascades-test-harness.ts`
- `src/renderer/src/store/slices/store-create-tab-id-hint.test.ts`
- `src/renderer/src/store/slices/store-session-browser-hydration.test.ts`
- `src/renderer/src/store/slices/store-session-editor-hydration.test.ts`
- `src/renderer/src/store/slices/store-session-terminal-activity.test.ts`
- `src/renderer/src/store/slices/store-session-terminal-reconnect.test.ts`
- `src/renderer/src/store/slices/store-session-test-harness.ts`
- `src/renderer/src/store/slices/store-session-workspace-hydration.test.ts`
- `src/renderer/src/store/slices/store-sleep-agent-status-retention.test.ts`
- `src/renderer/src/store/slices/store-sleep-exact-runtime-stop.test.ts`
...
- `src/renderer/src/store/slices/store-sleep-shutdown-order.test.ts`
- `src/renderer/src/store/slices/store-worktree-removal-cascade.test.ts`
- `src/renderer/src/store/slices/tabs/create-tabs-slice.ts`
- `src/renderer/src/store/slices/tabs/tabs-bulk-close-actions.ts`
- `src/renderer/src/store/slices/tabs/tabs-close-actions.ts`
- `src/renderer/src/store/slices/tabs/tabs-create-actions.ts`
- `src/renderer/src/store/slices/tabs/tabs-drop-actions.ts`
- `src/renderer/src/store/slices/tabs/tabs-focus-actions.ts`
- `src/renderer/src/store/slices/tabs/tabs-group-actions.ts`
- `src/renderer/src/store/slices/tabs/tabs-host-mirroring.ts`
- `src/renderer/src/store/slices/tabs/tabs-label-actions.ts`
- `src/renderer/src/store/slices/tabs/tabs-layout.ts`
- `src/renderer/src/store/slices/tabs/tabs-move-actions.ts`
- `src/renderer/src/store/slices/tabs/tabs-reconciliation.ts`
- `src/renderer/src/store/slices/tabs/tabs-secondary-actions.ts`
- `src/renderer/src/store/slices/tabs/tabs-session-actions.ts`
- `src/renderer/src/store/slices/tabs/tabs-slice-contract.ts`
- `src/renderer/src/store/slices/tabs/tabs-surface.ts`
- `src/renderer/src/store/slices/tabs/tabs-tab-order.ts`
- `src/renderer/src/store/slices/tabs-empty-split-activation.test.ts`
- `src/renderer/src/store/slices/tabs-label-and-pin-state.test.ts`
- `src/renderer/src/store/slices/tabs-model-reconciliation.test.ts`
...
- `src/renderer/src/store/slices/tabs-session-hydration.test.ts`
- `src/renderer/src/store/slices/tabs-slice-test-harness.ts`
- `src/renderer/src/store/slices/tabs-unread-and-focus.test.ts`
...
- `src/renderer/src/store/slices/terminal-tab-owner-index.test.ts`
- `src/renderer/src/store/slices/terminal-tab-owner-index.ts`
- `src/renderer/src/store/slices/terminal-tab-title-batch.test.ts`
- `src/renderer/src/store/slices/terminal-tab-title-batch.ts`
- `src/renderer/src/store/slices/ui/ui-slice-agent-actions.ts`
- `src/renderer/src/store/slices/ui/ui-slice-agent-notification-acknowledgement.ts`
- `src/renderer/src/store/slices/ui/ui-slice-contextual-tour-progression.ts`
- `src/renderer/src/store/slices/ui/ui-slice-contract.ts`
- `src/renderer/src/store/slices/ui/ui-slice-contract-contextual.ts`
...
- `src/renderer/src/store/slices/ui/ui-slice-feature-actions.ts`
...
- `src/renderer/src/store/slices/ui/ui-slice-hydration-values.ts`
- `src/renderer/src/store/slices/ui/ui-slice-modal-actions.ts`
- `src/renderer/src/store/slices/ui/ui-slice-persistence-actions.ts`
- `src/renderer/src/store/slices/ui/ui-slice-preference-actions.ts`
- `src/renderer/src/store/slices/ui/ui-slice-settings-actions.ts`
- `src/renderer/src/store/slices/ui/ui-slice-surface-actions.ts`
- `src/renderer/src/store/slices/ui/ui-slice-task-actions.ts`
- `src/renderer/src/store/slices/ui/ui-slice-tour-actions.ts`
- `src/renderer/src/store/slices/ui/ui-slice-trust-actions.ts`
- `src/renderer/src/store/slices/ui/ui-slice-update-actions.ts`
- `src/renderer/src/store/slices/ui/ui-slice-view-actions.ts`
- `src/renderer/src/store/slices/ui-acknowledge-agents-clock-skew.test.ts`
- `src/renderer/src/store/slices/ui-agent-send-target.test.ts`
- `src/renderer/src/store/slices/ui-contextual-tours.test.ts`
- `src/renderer/src/store/slices/ui-feature-interactions.test.ts`
- `src/renderer/src/store/slices/ui-hydration-view-layout.test.ts`
- `src/renderer/src/store/slices/ui-hydration-workspace-cleanup-browse.test.ts`
- `src/renderer/src/store/slices/ui-hydration-workspace-preferences.test.ts`
- `src/renderer/src/store/slices/ui-modal-slot-dismissal.test.ts`
- `src/renderer/src/store/slices/ui-new-workspace-draft.test.ts`
- `src/renderer/src/store/slices/ui-notice-dismissals.test.ts`
- `src/renderer/src/store/slices/ui-page-navigation.test.ts`
- `src/renderer/src/store/slices/ui-slice-test-harness.ts`
- `src/renderer/src/store/slices/workspace-cleanup-broad-scan-registry.ts`
- `src/renderer/src/store/slices/workspace-cleanup-browse.test.ts`
- `src/renderer/src/store/slices/workspace-cleanup-browse.ts`
- `src/renderer/src/store/slices/workspace-cleanup-cache-hydration.test.ts`
- `src/renderer/src/store/slices/workspace-cleanup-cache-hydration.ts`
- `src/renderer/src/store/slices/workspace-cleanup-candidate-enrichment.ts`
- `src/renderer/src/store/slices/workspace-cleanup-enrichment-performance.test.ts`
- `src/renderer/src/store/slices/workspace-cleanup-host-qualified-list-state.test.ts`
- `src/renderer/src/store/slices/workspace-cleanup-local-evidence.ts`
- `src/renderer/src/store/slices/workspace-cleanup-local-evidence-invariants.test.ts`
- `src/renderer/src/store/slices/workspace-cleanup-preflight-failures.ts`
- `src/renderer/src/store/slices/workspace-cleanup-removal.ts`
- `src/renderer/src/store/slices/workspace-cleanup-removal-targets.ts`
- `src/renderer/src/store/slices/workspace-cleanup-scan-lifecycle.ts`
- `src/renderer/src/store/slices/workspace-cleanup-scan-progress.ts`
- `src/renderer/src/store/slices/workspace-cleanup-scan-progress-boundary.test.ts`
- `src/renderer/src/store/slices/workspace-cleanup-unverified-removal-consent.test.ts`
- `src/renderer/src/store/slices/workspace-cleanup-wrong-host-removal.test.ts`
- `src/renderer/src/store/slices/workspace-cleanup-wrong-host-removal-guard.test.ts`
- `src/renderer/src/store/slices/worktree-delete-state-types.ts`
- `src/renderer/src/store/slices/worktree-meta-update-application.test.ts`
- `src/renderer/src/store/slices/worktree-meta-update-application.ts`
- `src/renderer/src/store/slices/worktree-purge-target.ts`
- `src/renderer/src/store/slices/worktree-refresh-options.ts`
- `src/renderer/src/store/slices/worktree-removal-host-collision-fixture.ts`
- `src/renderer/src/store/slices/worktree-removal-options.ts`
- `src/renderer/src/store/slices/worktrees/create/created-worktree-state-merge.ts`
- `src/renderer/src/store/slices/worktrees/create/create-worktree.ts`
- `src/renderer/src/store/slices/worktrees/create/local-base-ref-refresh-toast.ts`
- `src/renderer/src/store/slices/worktrees/create/pending-worktree-creation.ts`
- `src/renderer/src/store/slices/worktrees/create/prefetch-worktree-create-base.ts`
- `src/renderer/src/store/slices/worktrees/create/worktree-create-parent-pick.ts`
- `src/renderer/src/store/slices/worktrees/create/worktree-create-payload.ts`
- `src/renderer/src/store/slices/worktrees/listing/authoritative-worktree-removal-memory.ts`
- `src/renderer/src/store/slices/worktrees/listing/detected-worktree-host-merge.ts`
- `src/renderer/src/store/slices/worktrees/listing/detected-worktree-meta.test.ts`
- `src/renderer/src/store/slices/worktrees/listing/detected-worktree-meta.ts`
- `src/renderer/src/store/slices/worktrees/listing/detected-worktree-provider-request.ts`
- `src/renderer/src/store/slices/worktrees/listing/detected-worktree-refresh.ts`
- `src/renderer/src/store/slices/worktrees/listing/detected-worktree-refresh-admission.ts`
- `src/renderer/src/store/slices/worktrees/listing/direct-ssh-authority.ts`
- `src/renderer/src/store/slices/worktrees/listing/fetch-all-worktrees.ts`
- `src/renderer/src/store/slices/worktrees/listing/fetch-detected-worktrees.ts`
...
- `src/renderer/src/store/slices/worktrees/listing/known-ssh-worktree-fetch.ts`
- `src/renderer/src/store/slices/worktrees/listing/runtime-scope-forbidden-toast.ts`
- `src/renderer/src/store/slices/worktrees/listing/runtime-worktree-rpc-errors.ts`
- `src/renderer/src/store/slices/worktrees/listing/worktree-catalog-visibility.ts`
- `src/renderer/src/store/slices/worktrees/listing/worktree-host-ownership.ts`
- `src/renderer/src/store/slices/worktrees/listing/worktree-meta-host-match.ts`
- `src/renderer/src/store/slices/worktrees/listing/worktree-owner-settings.ts`
- `src/renderer/src/store/slices/worktrees/listing/worktree-refresh-pool.ts`
- `src/renderer/src/store/slices/worktrees/listing/worktree-slice-constants.ts`
- `src/renderer/src/store/slices/worktrees/listing/worktree-slice-types.ts`
- `src/renderer/src/store/slices/worktrees/metadata/detached-head-display-name.ts`
- `src/renderer/src/store/slices/worktrees/metadata/hosted-review-link-mutation.ts`
- `src/renderer/src/store/slices/worktrees/metadata/hosted-review-link-update-normalization.ts`
- `src/renderer/src/store/slices/worktrees/metadata/hosted-review-push-target.ts`
- `src/renderer/src/store/slices/worktrees/metadata/hosted-review-push-target-ensure.ts`
- `src/renderer/src/store/slices/worktrees/metadata/update-worktree-meta.ts`
- `src/renderer/src/store/slices/worktrees/metadata/update-worktrees-meta.ts`
- `src/renderer/src/store/slices/worktrees/metadata/worktree-base-status.ts`
- `src/renderer/src/store/slices/worktrees/metadata/worktree-git-identity-update.ts`
- `src/renderer/src/store/slices/worktrees/metadata/worktree-lineage-actions.ts`
- `src/renderer/src/store/slices/worktrees/metadata/worktree-lineage-host-merge.ts`
- `src/renderer/src/store/slices/worktrees/metadata/worktree-lineage-refresh.ts`
- `src/renderer/src/store/slices/worktrees/metadata/worktree-meta-persist.test.ts`
- `src/renderer/src/store/slices/worktrees/metadata/worktree-meta-persist.ts`
- `src/renderer/src/store/slices/worktrees/session/activation-terminal-prep.ts`
- `src/renderer/src/store/slices/worktrees/session/active-worktree-surface.ts`
- `src/renderer/src/store/slices/worktrees/session/folder-workspace-activity.ts`
- `src/renderer/src/store/slices/worktrees/session/migrate-worktree-identity.ts`
- `src/renderer/src/store/slices/worktrees/session/set-active-folder-workspace.ts`
- `src/renderer/src/store/slices/worktrees/session/set-active-worktree.ts`
- `src/renderer/src/store/slices/worktrees/session/worktree-identity-rename-state.ts`
- `src/renderer/src/store/slices/worktrees/session/worktree-pin-reveal.ts`
- `src/renderer/src/store/slices/worktrees/session/worktree-slice-initial-state.ts`
...
- `src/renderer/src/store/slices/worktrees/session/worktree-visit-recency.ts`
- `src/renderer/src/store/slices/worktrees/teardown/dispatch-worktree-removal.ts`
- `src/renderer/src/store/slices/worktrees/teardown/force-delete-preserved-branch.ts`
- `src/renderer/src/store/slices/worktrees/teardown/host-qualified-removal-refusal.test.ts`
- `src/renderer/src/store/slices/worktrees/teardown/host-qualified-worktree-removal.ts`
- `src/renderer/src/store/slices/worktrees/teardown/host-qualified-worktree-row-removal.ts`
- `src/renderer/src/store/slices/worktrees/teardown/missing-worktree-terminal-teardown.ts`
- `src/renderer/src/store/slices/worktrees/teardown/orphaned-runtime-ssh-project-purge.ts`
- `src/renderer/src/store/slices/worktrees/teardown/preserved-branch-cleanup-target.ts`
- `src/renderer/src/store/slices/worktrees/teardown/purge-stale-runtime-host-state.ts`
- `src/renderer/src/store/slices/worktrees/teardown/removed-worktree-renderer-teardown.ts`
- `src/renderer/src/store/slices/worktrees/teardown/removed-worktree-snapshot-prune.ts`
- `src/renderer/src/store/slices/worktrees/teardown/remove-worktree.ts`
- `src/renderer/src/store/slices/worktrees/teardown/remove-worktree-store-cleanup.ts`
- `src/renderer/src/store/slices/worktrees/teardown/worktree-delete-state.ts`
- `src/renderer/src/store/slices/worktrees/teardown/worktree-purge-doomed-ids.ts`
- `src/renderer/src/store/slices/worktrees/teardown/worktree-purge-omitters.ts`
- `src/renderer/src/store/slices/worktrees/teardown/worktree-purge-state.ts`
- `src/renderer/src/store/slices/worktrees-activity-persistence.test.ts`
- `src/renderer/src/store/slices/worktrees-create-base-status.test.ts`
- `src/renderer/src/store/slices/worktrees-create-parent-pick.test.ts`
- `src/renderer/src/store/slices/worktrees-detected-listing-fixtures.ts`
- `src/renderer/src/store/slices/worktrees-fetch-listing-merge.test.ts`
- `src/renderer/src/store/slices/worktrees-fetch-owner-routing.test.ts`
- `src/renderer/src/store/slices/worktrees-fetch-persisted-metadata-fallback.test.ts`
- `src/renderer/src/store/slices/worktrees-fetch-refresh-coalescing.test.ts`
- `src/renderer/src/store/slices/worktrees-fetch-remote-lineage.test.ts`
- `src/renderer/src/store/slices/worktrees-fetch-removal-purge.test.ts`
- `src/renderer/src/store/slices/worktrees-git-identity-branch-title.test.ts`
- `src/renderer/src/store/slices/worktrees-git-identity-review-clear-persistence.test.ts`
- `src/renderer/src/store/slices/worktrees-hydration-purge.test.ts`
- `src/renderer/src/store/slices/worktrees-identity-migration.test.ts`
- `src/renderer/src/store/slices/worktrees-lineage-state.test.ts`
- `src/renderer/src/store/slices/worktrees-linked-review-push-target.test.ts`
- `src/renderer/src/store/slices/worktrees-metadata-persistence.test.ts`
- `src/renderer/src/store/slices/worktrees-pending-creation-state.test.ts`
- `src/renderer/src/store/slices/worktrees-purge-terminal-state.test.ts`
- `src/renderer/src/store/slices/worktrees-remote-runtime-create.test.ts`
- `src/renderer/src/store/slices/worktrees-remote-runtime-removal.test.ts`
- `src/renderer/src/store/slices/worktrees-removal-state-cleanup.test.ts`
- `src/renderer/src/store/slices/worktrees-runtime-host-metadata-retirement.test.ts`
- `src/renderer/src/store/slices/worktrees-slice-test-fixtures.ts`
- `src/renderer/src/store/slices/worktrees-slice-test-harness.ts`
- `src/renderer/src/store/slices/worktrees-terminal-pr-url-linking.test.ts`
- `src/renderer/src/store/slices/worktrees-unread-state.test.ts`
- `src/renderer/src/store/slices/worktrees-workspace-selection-state.test.ts`
- `src/renderer/src/store/slices/worktree-visibility-owner-settings.test.ts`
- `src/renderer/src/store/slices/worktree-visibility-owner-settings.ts`
- `src/renderer/src/store/slices/worktree-visibility-settings-write.test.ts`
- `src/renderer/src/store/slices/worktree-visibility-settings-write.ts`
- `src/renderer/src/store/terminals/direct-ssh-terminal-bindings.ts`
- `src/renderer/src/store/terminals/restored-relay-session-identity.test.ts`
- `src/renderer/src/store/terminals/terminal-actions.ts`
- `src/renderer/src/store/terminals/terminal-active-workspace-creation.ts`
- `src/renderer/src/store/terminals/terminal-contracts.ts`
...
- `src/renderer/src/store/terminals/terminal-pty-identities.ts`
- `src/renderer/src/store/terminals/terminal-pty-release.ts`
- `src/renderer/src/store/terminals/terminal-restart-state.ts`
...
- `src/renderer/src/store/terminals/terminal-state.ts`
...
- `src/renderer/src/store/terminals/terminal-tab-navigation.ts`
- `src/renderer/src/store/terminals/terminal-tab-presentation.ts`
- `src/renderer/src/store/terminals/terminal-unverified-pty-loss.ts`
- `src/renderer/src/store/terminals/terminal-workspace-routing.scale.test.ts`
...
- `src/renderer/src/store/terminals/workspace-terminal-hydration-patch.ts`
- `src/renderer/src/store/terminals/workspace-terminal-layout-plan.ts`
...
- `src/renderer/src/store/terminals/workspace-terminal-reconnect-plan.ts`
- `src/renderer/src/store/terminals/workspace-terminal-row-plan.ts`
- `src/renderer/src/store/terminals/workspace-terminal-ssh-placeholders.ts`
- `src/renderer/src/store/worktree-host-collision-index.test.ts`
- `src/renderer/src/store/worktree-visibility-defaults-by-host.test.ts`
- `src/renderer/src/store/worktree-visibility-defaults-by-host.ts`
- `src/renderer/src/web/preload-api/web-agent-accounts-api.ts`
- `src/renderer/src/web/preload-api/web-agent-status-api.ts`
- `src/renderer/src/web/preload-api/web-ai-vault-api.ts`
- `src/renderer/src/web/preload-api/web-app-api.ts`
- `src/renderer/src/web/preload-api/web-browser-api.ts`
- `src/renderer/src/web/preload-api/web-cli-api.ts`
- `src/renderer/src/web/preload-api/web-clipboard-api.ts`
- `src/renderer/src/web/preload-api/web-diagnostics-api.ts`
- `src/renderer/src/web/preload-api/web-e2e-api.ts`
- `src/renderer/src/web/preload-api/web-e2e-config.ts`
- `src/renderer/src/web/preload-api/web-fallback-api.ts`
- `src/renderer/src/web/preload-api/web-filesystem-api.ts`
- `src/renderer/src/web/preload-api/web-git-api.ts`
- `src/renderer/src/web/preload-api/web-github-api.ts`
- `src/renderer/src/web/preload-api/web-github-cache-api.ts`
- `src/renderer/src/web/preload-api/web-github-routes.ts`
- `src/renderer/src/web/preload-api/web-gitlab-api.test.ts`
- `src/renderer/src/web/preload-api/web-gitlab-api.ts`
- `src/renderer/src/web/preload-api/web-gitlab-routes.ts`
- `src/renderer/src/web/preload-api/web-host-capability-api.ts`
- `src/renderer/src/web/preload-api/web-keybinding-normalization.ts`
- `src/renderer/src/web/preload-api/web-keybindings-api.ts`
- `src/renderer/src/web/preload-api/web-macos-tcc-api.ts`
- `src/renderer/src/web/preload-api/web-memory-api.ts`
- `src/renderer/src/web/preload-api/web-mobile-api.ts`
- `src/renderer/src/web/preload-api/web-native-chat-api.ts`
- `src/renderer/src/web/preload-api/web-notifications-api.ts`
- `src/renderer/src/web/preload-api/web-onboarding-api.ts`
- `src/renderer/src/web/preload-api/web-orca-profiles-api.ts`
- `src/renderer/src/web/preload-api/web-platform-api.ts`
...
- `src/renderer/src/web/preload-api/web-repositories-api.ts`
- `src/renderer/src/web/preload-api/web-review-api.ts`
- `src/renderer/src/web/preload-api/web-runtime-api.ts`
- `src/renderer/src/web/preload-api/web-runtime-calls.ts`
- `src/renderer/src/web/preload-api/web-runtime-environments-api.ts`
- `src/renderer/src/web/preload-api/web-runtime-session.ts`
- `src/renderer/src/web/preload-api/web-runtime-worktree-catalog.ts`
- `src/renderer/src/web/preload-api/web-settings-api.ts`
- `src/renderer/src/web/preload-api/web-shell-api.ts`
- `src/renderer/src/web/preload-api/web-star-nag-api.ts`
- `src/renderer/src/web/preload-api/web-storage.ts`
- `src/renderer/src/web/preload-api/web-telemetry-api.ts`
- `src/renderer/src/web/preload-api/web-terminal-api.ts`
- `src/renderer/src/web/preload-api/web-ui-api.ts`
- `src/renderer/src/web/preload-api/web-updater-api.ts`
- `src/renderer/src/web/preload-api/web-workspace-ports-api.ts`
- `src/renderer/src/web/preload-api/web-workspace-session-api.ts`
- `src/renderer/src/web/preload-api/web-worktrees-api.ts`
- `src/renderer/src/web/web-preload-api-agent-providers.test.ts`
- `src/renderer/src/web/web-preload-api-clipboard.test.ts`
...
- `src/renderer/src/web/web-preload-api-github.test.ts`
- `src/renderer/src/web/web-preload-api-gitlab.test.ts`
- `src/renderer/src/web/web-preload-api-keybindings.test.ts`
- `src/renderer/src/web/web-preload-api-runtime-calls.test.ts`
- `src/renderer/src/web/web-preload-api-runtime-environment.test.ts`
- `src/renderer/src/web/web-preload-api-settings.test.ts`
- `src/renderer/src/web/web-preload-api-ssh.test.ts`
- `src/renderer/src/web/web-preload-api-test-harness.ts`
- `src/renderer/src/web/web-preload-api-ui.test.ts`
- `src/renderer/src/web/web-preload-api-workspace-catalog.test.ts`
...
- `src/renderer/src/web/web-runtime-connection-frame-router.test.ts`
- `src/renderer/src/web/web-runtime-connection-frame-router.ts`
- `src/renderer/src/web/web-runtime-connection-heartbeat.ts`
- `src/renderer/src/web/web-runtime-connection-heartbeat-unsendable-probe.test.ts`
- `src/renderer/src/web/web-runtime-connection-transport.ts`
- `src/renderer/src/web/web-runtime-connection-waiters.ts`
- `src/renderer/src/web/web-runtime-file-watch-subscription.ts`
- `src/renderer/src/web/web-runtime-request-registry.ts`
- `src/renderer/src/web/web-runtime-subscription-contract.ts`
- `src/renderer/src/web/web-runtime-subscription-registry.ts`
- `src/shared/__fixtures__/cli-runtime-pairing-allowlist.txt`
- `src/shared/__fixtures__/linux-process-table-kernel-rows.txt`
- `src/shared/abort-signal-reason.ts`
- `src/shared/agent-completion-time.ts`
- `src/shared/agent-hook-listener/command-code-transcript.ts`
- `src/shared/agent-hook-listener/endpoint-publication.ts`
- `src/shared/agent-hook-listener/grok-result-discovery.ts`
- `src/shared/agent-hook-listener/hook-envelope.ts`
- `src/shared/agent-hook-listener/interactive-tool.ts`
- `src/shared/agent-hook-listener/listener-event.ts`
- `src/shared/agent-hook-listener/listener-limits.ts`
- `src/shared/agent-hook-listener/listener-state.ts`
- `src/shared/agent-hook-listener/prompt-fields.ts`
- `src/shared/agent-hook-listener/provider-dispatch.ts`
- `src/shared/agent-hook-listener/provider-event-names.ts`
- `src/shared/agent-hook-listener/provider-event-routing.ts`
- `src/shared/agent-hook-listener/providers/amp-events.ts`
- `src/shared/agent-hook-listener/providers/amp-tool-fields.ts`
- `src/shared/agent-hook-listener/providers/antigravity-event-rules.ts`
- `src/shared/agent-hook-listener/providers/antigravity-events.ts`
- `src/shared/agent-hook-listener/providers/antigravity-tool-fields.ts`
...
- `src/shared/agent-hook-listener/providers/codex-tool-fields.ts`
- `src/shared/agent-hook-listener/providers/command-code-events.ts`
- `src/shared/agent-hook-listener/providers/command-code-tool-fields.ts`
- `src/shared/agent-hook-listener/providers/copilot-events.ts`
- `src/shared/agent-hook-listener/providers/copilot-tool-fields.ts`
- `src/shared/agent-hook-listener/providers/cursor-events.ts`
- `src/shared/agent-hook-listener/providers/cursor-tool-fields.ts`
- `src/shared/agent-hook-listener/providers/devin-events.ts`
- `src/shared/agent-hook-listener/providers/droid-events.ts`
- `src/shared/agent-hook-listener/providers/droid-tool-fields.ts`
- `src/shared/agent-hook-listener/providers/gemini-events.ts`
- `src/shared/agent-hook-listener/providers/gemini-tool-fields.ts`
- `src/shared/agent-hook-listener/providers/grok-events.ts`
- `src/shared/agent-hook-listener/providers/grok-tool-fields.ts`
- `src/shared/agent-hook-listener/providers/hermes-events.ts`
- `src/shared/agent-hook-listener/providers/hermes-tool-fields.ts`
- `src/shared/agent-hook-listener/providers/kimi-events.ts`
- `src/shared/agent-hook-listener/providers/opencode-family-events.ts`
- `src/shared/agent-hook-listener/providers/opencode-family-tool-fields.ts`
...
- `src/shared/agent-hook-listener/request-body.ts`
- `src/shared/agent-hook-listener/source-routing.ts`
- `src/shared/agent-hook-listener/tool-input-preview.ts`
- `src/shared/agent-hook-listener/transcript-entry-text.ts`
- `src/shared/agent-hook-listener/transcript-lines.ts`
- `src/shared/agent-hook-listener/transcript-reader.ts`
- `src/shared/agent-hook-listener-antigravity.test.ts`
- `src/shared/agent-hook-listener-claude-compatible-vendors.test.ts`
- `src/shared/agent-hook-listener-claude-subagents.test.ts`
- `src/shared/agent-hook-listener-claude-turn-state.test.ts`
- `src/shared/agent-hook-listener-command-code-transcript.test.ts`
- `src/shared/agent-hook-listener-extraction-characterization.test.ts`
- `src/shared/agent-hook-listener-grok.test.ts`
- `src/shared/agent-hook-listener-hermes-codex-droid.test.ts`
- `src/shared/agent-hook-listener-interactive-prompts.test.ts`
- `src/shared/agent-hook-listener-pi-compatible.test.ts`
- `src/shared/agent-hook-listener-relay-dependency.test.ts`
- `src/shared/agent-hook-listener-session-replacement.test.ts`
- `src/shared/agent-hook-listener-startless-child-lifecycle.test.ts`
- `src/shared/agent-hook-listener-test-harness.ts`
- `src/shared/agent-hook-listener-transport.test.ts`
- `src/shared/agent-hook-spool.ts`
- `src/shared/agent-hook-transport-interference.test.ts`
- `src/shared/agent-hook-transport-interference.ts`
- `src/shared/agent-resume-launch-command.test.ts`
...
- `src/shared/agent-session-lease-adjudication.test.ts`
- `src/shared/agent-session-lease-adjudication.ts`
- `src/shared/agent-session-mutation-envelope.test.ts`
- `src/shared/agent-session-mutation-envelope.ts`
- `src/shared/agent-session-next-fence.ts`
...
- `src/shared/agent-session-pty-write-admission.test.ts`
- `src/shared/agent-session-pty-write-admission.ts`
- `src/shared/agent-session-pty-write-refusal-copy.ts`
- `src/shared/agent-session-record.test-fixture.ts`
- `src/shared/agent-session-record.ts`
- `src/shared/agent-session-refusal-retry.ts`
- `src/shared/agent-session-wire.ts`
- `src/shared/agent-skill-sharing-contract.test.ts`
- `src/shared/agent-skill-sharing-contract.ts`
- `src/shared/agent-skill-sharing-gate.test.ts`
- `src/shared/agent-skill-sharing-gate.ts`
- `src/shared/agent-status-freshness.ts`
- `src/shared/agent-status-ipc-payload.ts`
- `src/shared/agent-status-observation.test.ts`
- `src/shared/agent-status-observation.ts`
- `src/shared/agent-terminal-status-equivalence.test.ts`
- `src/shared/agent-terminal-status-equivalence.ts`
- `src/shared/agent-title-agy-gemini-collision.test.ts`
- `src/shared/agent-title-evidence.test.ts`
- `src/shared/agent-title-evidence.ts`
- `src/shared/agent-title-identity-characterization.test.ts`
- `src/shared/ai-vault-scan-error-message.test.ts`
- `src/shared/ai-vault-scan-error-message.ts`
- `src/shared/app-environment.ts`
- `src/shared/automation-cron-occurrence.ts`
- `src/shared/automation-execution-target.test.ts`
- `src/shared/automation-execution-target.ts`
- `src/shared/automation-host-filter.test.ts`
- `src/shared/automation-host-filter.ts`
- `src/shared/automation-legacy-list-partition.test.ts`
- `src/shared/automation-legacy-list-partition.ts`
- `src/shared/automation-list-response.test.ts`
- `src/shared/automation-list-response.ts`
- `src/shared/automation-list-scope.test.ts`
- `src/shared/automation-list-scope.ts`
- `src/shared/automation-owner-conflict.ts`
- `src/shared/automation-owner-key.test.ts`
- `src/shared/automation-owner-key.ts`
- `src/shared/automation-owner-precondition.test.ts`
- `src/shared/automation-owner-precondition.ts`
- `src/shared/automation-owner-ref.ts`
- `src/shared/automation-schedule-occurrences.ts`
- `src/shared/automation-schedule-parsing.ts`
- `src/shared/automation-usage-summary.test.ts`
- `src/shared/automation-usage-summary.ts`
- `src/shared/automation-workspace-pin.ts`
- `src/shared/automation-workspace-repin.ts`
- `src/shared/binary-file-extensions.test.ts`
- `src/shared/binary-file-extensions.ts`
- `src/shared/bitbucket-credentials.ts`
- `src/shared/browser-client-automation-protocol.test.ts`
- `src/shared/browser-client-automation-protocol.ts`
- `src/shared/browser-client-file-channel-methods.ts`
- `src/shared/browser-client-file-channel-protocol.ts`
- `src/shared/browser-client-host-id-argument.test.ts`
- `src/shared/browser-client-host-id-argument.ts`
- `src/shared/browser-client-hosting-eligibility.test.ts`
- `src/shared/browser-client-hosting-eligibility.ts`
- `src/shared/browser-client-host-placement.ts`
...
- `src/shared/browser-client-page-creation-timeouts.ts`
- `src/shared/browser-client-page-metadata-protocol.ts`
- `src/shared/browser-client-page-renderer-protocol.ts`
- `src/shared/browser-download-filename.ts`
...
- `src/shared/browser-page-doc-location.ts`
- `src/shared/browser-webauthn-account.ts`
- `src/shared/browser-workspace-types.ts`
- `src/shared/capability-probe-cache.ts`
- `src/shared/child-process/__fixtures__/child-process-import-allowlist.txt`
- `src/shared/child-process/__fixtures__/windows-argument-corpus.ts`
...
- `src/shared/child-process/cancel-process-acquisition.ts`
- `src/shared/child-process/child-process-import-boundary.test.ts`
- `src/shared/child-process/child-termination-reporter.ts`
- `src/shared/child-process/close-process-registry.test.ts`
- `src/shared/child-process/close-process-registry.ts`
...
- `src/shared/child-process/run-process-termination-failure.test.ts`
...
- `src/shared/classified-error.ts`
- `src/shared/claude-compact-completion.ts`
- `src/shared/cli-app-status-projection.ts`
- `src/shared/cli-argument-boundary.test.ts`
- `src/shared/cli-argument-boundary.ts`
- `src/shared/client-environment-info.test.ts`
- `src/shared/client-environment-info.ts`
...
- `src/shared/cli-runtime-pairing-boundary.test.ts`
- `src/shared/closed-terminal-tab-tombstones.test.ts`
- `src/shared/closed-terminal-tab-tombstones.ts`
- `src/shared/code-search-types.ts`
- `src/shared/codex-subagent-poll-scheduler.test.ts`
- `src/shared/codex-subagent-poll-scheduler.ts`
- `src/shared/commit-message-agent-specs-primary.ts`
- `src/shared/commit-message-agent-specs-secondary.ts`
- `src/shared/commit-message-ai-types.ts`
- `src/shared/commit-message-model-parsers.ts`
- `src/shared/crash-breadcrumb-origin.ts`
- `src/shared/crash-report-attribution-lines.ts`
- `src/shared/crash-report-exit-code.ts`
- `src/shared/crash-report-redaction.ts`
- `src/shared/crash-report-signature-lines.ts`
- `src/shared/daemon-adoption-telemetry.test.ts`
- `src/shared/daemon-adoption-telemetry.ts`
- `src/shared/default-global-settings.ts`
- `src/shared/definitive-filesystem-absence.ts`
- `src/shared/diff-comment-schema.ts`
- `src/shared/diff-comment-types.ts`
- `src/shared/doc-preview-file-access.test.ts`
- `src/shared/doc-preview-file-access.ts`
- `src/shared/doc-preview-scheme.test.ts`
- `src/shared/doc-preview-scheme.ts`
- `src/shared/draft-paste-ready-timeout.ts`
- `src/shared/edit-distance.ts`
- `src/shared/ephemeral-vm-recipe-checkout-mode.test.ts`
- `src/shared/ephemeral-vm-recipe-checkout-mode.ts`
- `src/shared/ephemeral-vm-recipe-destroy-result.ts`
- `src/shared/ephemeral-vm-recipe-repo-url.test.ts`
- `src/shared/ephemeral-vm-recipe-repo-url.ts`
...
- `src/shared/export-let-function-initializer-ban.test.ts`
- `src/shared/external-automation-scope.ts`
- `src/shared/file-link-location.test.ts`
- `src/shared/file-link-location.ts`
- `src/shared/file-range-read.ts`
- `src/shared/filesystem-entry-types.ts`
- `src/shared/fish-binary-requirement.test.ts`
...
- `src/shared/git-diff-compare-types.ts`
- `src/shared/git-diff-transport-budget.test.ts`
- `src/shared/git-diff-transport-budget.ts`
- `src/shared/gitdir-marker-payload.ts`
- `src/shared/git-exec-mutation.test.ts`
- `src/shared/git-fetch-head-capability.test.ts`
- `src/shared/git-fetch-head-capability.ts`
- `src/shared/git-fetch-head-lock.test.ts`
- `src/shared/git-fetch-head-lock.ts`
- `src/shared/git-fetch-head-lock-key-derivation.test.ts`
- `src/shared/github/api-availability.test.ts`
- `src/shared/github/api-availability.ts`
- `src/shared/github/auth-types.ts`
- `src/shared/github/check-details-deadline.ts`
- `src/shared/github/check-types.ts`
- `src/shared/github/comment-types.ts`
- `src/shared/github/links.ts`
- `src/shared/github/project-group-sort.ts`
- `src/shared/github/project-identity.test.ts`
- `src/shared/github/project-identity.ts`
- `src/shared/github/project-ref-input.test.ts`
- `src/shared/github/project-ref-input.ts`
- `src/shared/github/project-request-types.ts`
- `src/shared/github/project-result-types.ts`
- `src/shared/github/project-types.ts`
- `src/shared/github/pull-request-auto-merge-availability.test.ts`
- `src/shared/github/pull-request-auto-merge-availability.ts`
- `src/shared/github/pull-request-for-branch-outcome.test.ts`
- `src/shared/github/pull-request-for-branch-outcome.ts`
- `src/shared/github/pull-request-merge-methods.test.ts`
- `src/shared/github/pull-request-merge-methods.ts`
- `src/shared/github/pull-request-refresh-types.ts`
- `src/shared/github/pull-request-types.ts`
- `src/shared/github/rate-limit-types.ts`
- `src/shared/github/repository-identity-key.test.ts`
- `src/shared/github/repository-identity-key.ts`
- `src/shared/github/work-items-query-bounds.test.ts`
- `src/shared/github/work-items-query-bounds.ts`
- `src/shared/github/work-item-types.ts`
- `src/shared/git-metadata-path.test.ts`
- `src/shared/git-metadata-path.ts`
- `src/shared/git-operation-lock.ts`
- `src/shared/git-remote-host-alias.ts`
- `src/shared/git-status-line-stat-inputs.test.ts`
- `src/shared/git-status-line-stat-inputs.ts`
- `src/shared/git-worktree-operation-lock.test.ts`
- `src/shared/git-worktree-operation-lock.ts`
- `src/shared/global-settings-types.ts`
- `src/shared/handled-wire-discriminant.test.ts`
- `src/shared/handled-wire-discriminant.ts`
- `src/shared/hosted-review-creation-providers.test.ts`
- `src/shared/hosted-review-ready-capabilities.test.ts`
- `src/shared/image-paste-following-text.test.ts`
- `src/shared/image-paste-following-text.ts`
- `src/shared/issue-mutation-types.ts`
...
- `src/shared/keybindings/definitions-support.ts`
- `src/shared/keybindings/effective.ts`
- `src/shared/keybindings/formatting.ts`
- `src/shared/keybindings/input.ts`
- `src/shared/keybindings/matching.ts`
- `src/shared/keybindings/matching-key.ts`
- `src/shared/keybindings/normalization.ts`
- `src/shared/keybindings/parser.ts`
- `src/shared/keybindings/types.ts`
- `src/shared/keybindings-conflicts.test.ts`
- `src/shared/keybindings-default-bindings.test.ts`
- `src/shared/keybindings-digit-index.test.ts`
- `src/shared/keybindings-double-tap.test.ts`
- `src/shared/keybindings-keyboard-layout.test.ts`
- `src/shared/keybindings-parsing.test.ts`
- `src/shared/keybindings-terminal-context.test.ts`
- `src/shared/keybindings-unassigned-actions.test.ts`
- `src/shared/keyboard-layout-events.ts`
- `src/shared/keyboard-layout-snapshot.ts`
- `src/shared/linear/agent-access.ts`
- `src/shared/linear/agent-result-types.ts`
- `src/shared/linear/inline-media.test.ts`
- `src/shared/linear/inline-media.ts`
- `src/shared/linear/issue-activity.ts`
- `src/shared/linear/issue-attribute-filter.test.ts`
- `src/shared/linear/issue-attribute-filter.ts`
- `src/shared/linear/issue-read-limits.ts`
- `src/shared/linear/issue-relation-write.ts`
- `src/shared/linear/issue-types.ts`
- `src/shared/linear/issue-view-resume-state.test.ts`
- `src/shared/linear/issue-view-resume-state.ts`
- `src/shared/linear/links.test.ts`
- `src/shared/linear/links.ts`
- `src/shared/linear/list-truncation-format.ts`
- `src/shared/linear/mcp-issue-list.ts`
- `src/shared/linear/priority-label.ts`
- `src/shared/linear/project-list-format.ts`
- `src/shared/linear/project-types.ts`
- `src/shared/linear/uuid.ts`
- `src/shared/linear/workspace-types.test.ts`
- `src/shared/linear/workspace-types.ts`
- `src/shared/loose-ref-count.test.ts`
- `src/shared/loose-ref-count.ts`
- `src/shared/macos-symbolic-hotkeys.test.ts`
- `src/shared/macos-symbolic-hotkeys.ts`
- `src/shared/main-process-ndjson-framer.ts`
- `src/shared/managed-account-types.ts`
- `src/shared/marine-creature-names-primary.ts`
- `src/shared/marine-creature-names-secondary.ts`
- `src/shared/native-chat-provider-frame-summary.ts`
- `src/shared/nested-worker-depth.test.ts`
- `src/shared/nested-worker-depth.ts`
- `src/shared/new-workspace/smart-workspace-linear-intent.ts`
- `src/shared/new-workspace/smart-workspace-source-query.ts`
- `src/shared/new-workspace/smart-workspace-url-source-results.test.ts`
- `src/shared/new-workspace/smart-workspace-url-source-results.ts`
- `src/shared/node-pty-spawn-helper.test.ts`
- `src/shared/node-pty-spawn-helper.ts`
- `src/shared/notification-settings-types.ts`
- `src/shared/nvm-default-alias.test.ts`
- `src/shared/omp-pi-semantic-title-preservation.test.ts`
- `src/shared/onboarding-state-types.ts`
- `src/shared/opencode-permission-status.test.ts`
- `src/shared/orcad-artifacts.ts`
- `src/shared/orca-yaml-hook-types.ts`
- `src/shared/orchestration-mutation-request.ts`
- `src/shared/orchestration-timing-budgets.test.ts`
- `src/shared/orchestration-timing-budgets.ts`
- `src/shared/packed-refs-lock-gate.ts`
...
- `src/shared/pane-key-alias.test.ts`
- `src/shared/pane-key-alias.ts`
- `src/shared/persisted-state-types.ts`
- `src/shared/persisted-ui-state-types.ts`
- `src/shared/pet-types.ts`
- `src/shared/pi-state-title-marker.test.ts`
- `src/shared/pi-state-title-marker.ts`
- `src/shared/posix-version-manager-bin-dirs.ts`
- `src/shared/posix-wait-status.test.ts`
- `src/shared/posix-wait-status.ts`
- `src/shared/priority-semaphore.test.ts`
- `src/shared/priority-semaphore.ts`
- `src/shared/process-stats-types.ts`
- `src/shared/project-catalog-row-normalization.test.ts`
- `src/shared/project-catalog-row-normalization.ts`
- `src/shared/project-group-types.ts`
- `src/shared/project-host-setup-lookup.ts`
- `src/shared/project-identity-succession.test.ts`
- `src/shared/project-identity-succession.ts`
- `src/shared/project-types.ts`
- `src/shared/promise-timeout-fallback.ts`
...
- `src/shared/pty-startup-reply-echo-shapes.ts`
- `src/shared/published-pane-agent-identity.test.ts`
- `src/shared/published-pane-agent-identity.ts`
- `src/shared/quick-open-filter.renderer-safety.test.ts`
- `src/shared/quick-open-path-search.ts`
- `src/shared/quick-open-transport-budget.test.ts`
- `src/shared/quick-open-transport-budget.ts`
- `src/shared/quit-teardown-deadline.ts`
- `src/shared/react-update-depth-attribution.test.ts`
- `src/shared/react-update-depth-attribution.ts`
- `src/shared/relay-artifacts.ts`
- `src/shared/relay-optional-artifacts.test.ts`
- `src/shared/relay-retry-after-header.ts`
- `src/shared/remote-rpc-content-budget.test.ts`
- `src/shared/remote-rpc-content-budget.ts`
...
- `src/shared/remote-runtime-pty-id.ts`
- `src/shared/remote-runtime-request-response-router.test.ts`
- `src/shared/remote-runtime-request-response-router.ts`
- `src/shared/remote-runtime-request-rpc-frame.ts`
- `src/shared/remote-runtime-request-socket.ts`
- `src/shared/remote-runtime-shared-control-connection-actions.ts`
- `src/shared/remote-runtime-shared-control-connection-frame.ts`
- `src/shared/remote-runtime-shared-control-diagnostics.ts`
- `src/shared/remote-runtime-shared-control-ready-wait.ts`
- `src/shared/remote-runtime-shared-control-refresh.ts`
- `src/shared/remote-runtime-shared-control-standing-intent.test.ts`
- `src/shared/remote-runtime-shared-control-test-server.ts`
- `src/shared/remote-runtime-subscription-frame-router.test.ts`
- `src/shared/remote-runtime-subscription-frame-router.ts`
- `src/shared/remote-runtime-subscription-outbound.ts`
- `src/shared/remote-runtime-subscription-request.test.ts`
- `src/shared/remote-runtime-subscription-request-channel.ts`
- `src/shared/remote-runtime-subscription-transport.ts`
- `src/shared/renderer-process-memory.ts`
- `src/shared/repo-host-identity.ts`
- `src/shared/repo-ref-maintenance.test.ts`
- `src/shared/repo-ref-maintenance.ts`
- `src/shared/repo-ref-maintenance-policy.ts`
- `src/shared/repo-search-limits.test.ts`
- `src/shared/repo-search-limits.ts`
- `src/shared/repo-types.ts`
- `src/shared/repro-13889-claude-quarter-circle-busy-title.test.ts`
- `src/shared/require-tui-agent-config.test.ts`
- `src/shared/require-tui-agent-config.ts`
- `src/shared/runtime-browser-contracts.ts`
- `src/shared/runtime-browser-placement.ts`
- `src/shared/runtime-capability-degradation.ts`
- `src/shared/runtime-client-export-parity.test.ts`
- `src/shared/runtime-environment-diagnostics.ts`
- `src/shared/runtime-file-contracts.ts`
- `src/shared/runtime-host-connection-state.ts`
- `src/shared/runtime-mobile-session-tab-contracts.ts`
- `src/shared/runtime-rpc-error-code.ts`
...
- `src/shared/serve-option-validation.test.ts`
- `src/shared/serve-option-validation.ts`
- `src/shared/session-tab-close.ts`
- `src/shared/sha256.ts`
- `src/shared/shell-path-hydration-types.ts`
- `src/shared/shell-process-readiness.test.ts`
- `src/shared/shell-process-readiness.ts`
- `src/shared/skill-bundle-install-contract.test.ts`
- `src/shared/skill-bundle-install-contract.ts`
- `src/shared/skill-bundle-manifest.ts`
- `src/shared/skill-bundle-name.test.ts`
- `src/shared/skill-bundle-name.ts`
- `src/shared/skill-cloud-contract.ts`
- `src/shared/skill-delete-contract.test.ts`
- `src/shared/skill-delete-contract.ts`
- `src/shared/skill-deletion-eligibility.test.ts`
- `src/shared/skill-deletion-eligibility.ts`
- `src/shared/skill-discovery-depth.ts`
- `src/shared/skill-install-capability.ts`
- `src/shared/skill-install-contract.test.ts`
- `src/shared/skill-install-contract.ts`
- `src/shared/skill-install-failure.test.ts`
- `src/shared/skill-install-failure.ts`
- `src/shared/skill-install-providers.ts`
- `src/shared/skill-package-manifest.test.ts`
- `src/shared/skill-package-manifest.ts`
- `src/shared/skill-path-containment.test.ts`
- `src/shared/skill-path-containment.ts`
- `src/shared/skill-share-link.ts`
- `src/shared/skill-sharing-contract.ts`
- `src/shared/skill-ssh-relay-contract.ts`
- `src/shared/skill-upload-session-contract.ts`
- `src/shared/source-control-ai-command-template.ts`
- `src/shared/source-control-ai-legacy-projection.ts`
- `src/shared/source-control-ai-legacy-reconciliation.ts`
- `src/shared/source-control-ai-model-selection.ts`
- `src/shared/source-control-ai-operation-policy.ts`
- `src/shared/source-control-ai-policy-regression.test.ts`
- `src/shared/source-control-ai-repo-settings.ts`
- `src/shared/source-control-ai-settings.ts`
- `src/shared/source-scan/source-tree-scan.test.ts`
- `src/shared/source-scan/source-tree-scan.ts`
- `src/shared/ssh-pending-pty-kill.test.ts`
- `src/shared/ssh-pending-pty-kill.ts`
- `src/shared/ssh-target-generation.test.ts`
- `src/shared/ssh-target-generation.ts`
- `src/shared/startup-shell-portability.live-shell.test.ts`
- `src/shared/structural-value-equality.test.ts`
- `src/shared/structural-value-equality.ts`
- `src/shared/structured-agent-session-coalescer.ts`
- `src/shared/structured-agent-session-composer.ts`
- `src/shared/structured-agent-session-mutation.test.ts`
...
- `src/shared/tab-types.ts`
- `src/shared/telemetry-app-event-schemas.ts`
- `src/shared/telemetry-daemon-event-schemas.ts`
- `src/shared/telemetry-event-classification.ts`
- `src/shared/telemetry-event-registry.ts`
- `src/shared/telemetry-feature-education-event-schemas.ts`
- `src/shared/telemetry-native-feature-event-schemas.ts`
- `src/shared/telemetry-onboarding-event-schemas.ts`
- `src/shared/telemetry-onboarding-foundation-schemas.ts`
- `src/shared/telemetry-property-schemas.ts`
- `src/shared/telemetry-repository-event-schemas.ts`
- `src/shared/terminal-color-overrides.ts`
- `src/shared/terminal-composer-draft.test.ts`
- `src/shared/terminal-composer-draft.ts`
- `src/shared/terminal-cursor-line-context.ts`
- `src/shared/terminal-execution-host.ts`
- `src/shared/terminal-exit-cause.test.ts`
- `src/shared/terminal-exit-cause.ts`
- `src/shared/terminal-kitty-keyboard-flags.ts`
- `src/shared/terminal-owner.ts`
- `src/shared/terminal-query-reply-delivery.ts`
- `src/shared/terminal-quick-command-types.ts`
- `src/shared/terminal-stream-end-verdict.ts`
- `src/shared/terminal-surface-tombstone-schema.ts`
- `src/shared/terminal-tab-id-schema.ts`
- `src/shared/terminal-tab-types.ts`
- `src/shared/terminal-unavailable-cause.ts`
- `src/shared/text-search-glob-patterns.ts`
- `src/shared/text-search-match-accumulator.ts`
- `src/shared/text-search-paths.ts`
- `src/shared/tui-agent.ts`
- `src/shared/tui-agent-config.test.ts`
- `src/shared/tui-agent-resume-startup.ts`
- `src/shared/tui-agent-startup-copilot-resume.test.ts`
- `src/shared/tui-agent-startup-hermes.test.ts`
- `src/shared/tui-agent-startup-script.test-fixture.ts`
- `src/shared/tui-agent-startup-shell.test.ts`
- `src/shared/ui-chrome-types.ts`
- `src/shared/update-status-types.ts`
- `src/shared/windows-command-line-budget.ts`
- `src/shared/windows-console-input.test.ts`
- `src/shared/windows-console-input.ts`
- `src/shared/window-shortcut-policy-agent-dashboard.test.ts`
- `src/shared/windows-interactive-login-spawn.test.ts`
- `src/shared/windows-interactive-login-spawn.ts`
- `src/shared/windows-lane-tree-removal-boundary.test.ts`
- `src/shared/windows-long-path-git-args.test.ts`
- `src/shared/windows-long-path-git-args.ts`
- `src/shared/windows-transient-lock-removal.test.ts`
- `src/shared/windows-transient-lock-removal.ts`
- `src/shared/workspace-cleanup-applied-filters.test.ts`
- `src/shared/workspace-cleanup-applied-filters.ts`
- `src/shared/workspace-cleanup-browse-state.ts`
- `src/shared/workspace-cleanup-browse-state-persistence.test.ts`
- `src/shared/workspace-cleanup-facet-rankings.ts`
- `src/shared/workspace-cleanup-filter-model.ts`
- `src/shared/workspace-cleanup-filter-state-codec.ts`
- `src/shared/workspace-cleanup-host-identity.ts`
- `src/shared/workspace-cleanup-ui-state.test.ts`
- `src/shared/workspace-cleanup-ui-state.ts`
- `src/shared/workspace-doc-history.test.ts`
- `src/shared/workspace-doc-history.ts`
- `src/shared/workspace-session-editor-schema.ts`
- `src/shared/workspace-session-schema-field-coverage.test.ts`
- `src/shared/workspace-session-state-types.ts`
- `src/shared/workspace-session-tab-focus-schema.test.ts`
- `src/shared/workspace-session-tab-type-schema.ts`
- `src/shared/worktree/base-ref.test.ts`
- `src/shared/worktree/base-ref.ts`
- `src/shared/worktree/base-ref-drift-types.ts`
- `src/shared/worktree/card-properties.test.ts`
- `src/shared/worktree/card-properties.ts`
- `src/shared/worktree/configured-worktree-base-path.ts`
- `src/shared/worktree/create-preparation.test.ts`
- `src/shared/worktree/create-preparation.ts`
- `src/shared/worktree/create-types.ts`
- `src/shared/worktree/display-name-provenance.ts`
- `src/shared/worktree/github-pr-suppression.test.ts`
- `src/shared/worktree/github-pr-suppression.ts`
- `src/shared/worktree/host-qualified-identity.test.ts`
- `src/shared/worktree/host-qualified-identity.ts`
- `src/shared/worktree/id.test.ts`
- `src/shared/worktree/id.ts`
- `src/shared/worktree/identity.test.ts`
- `src/shared/worktree/identity.ts`
- `src/shared/worktree/launch-types.ts`
- `src/shared/worktree/lineage-types.ts`
- `src/shared/worktree/meta-types.ts`
- `src/shared/worktree/ownership.test.ts`
- `src/shared/worktree/ownership.ts`
- `src/shared/worktree/ownership-configured-base-visibility.test.ts`
- `src/shared/worktree/ownership-worktree-base-path.test.ts`
- `src/shared/worktree/removal.ts`
- `src/shared/worktree/removal-fence-error.test.ts`
- `src/shared/worktree/removal-fence-error.ts`
- `src/shared/worktree/removal-force-classification.test.ts`
- `src/shared/worktree/retired-name-cache.test.ts`
- `src/shared/worktree/retired-name-cache.ts`
- `src/shared/worktree/retired-name-registry.test.ts`
- `src/shared/worktree/retired-name-registry.ts`
- `src/shared/worktree/sort-order-update.test.ts`
- `src/shared/worktree/sort-order-update.ts`
- `src/shared/worktree/submodule-removal.test.ts`
- `src/shared/worktree/submodule-removal.ts`
- `src/shared/worktree/types.ts`
- `src/shared/worktree/visibility-source-preferences.ts`
- `src/shared/worktree/visibility-sources.test.ts`
- `src/shared/worktree/visibility-sources.ts`
- `src/shared/worktree/worktree-catalog-availability.ts`
- `src/shared/worktree-name-suggestion.test.ts`
- `src/shared/worktree-name-suggestion.ts`
- `src/shared/worktree-visibility-resolution.ts`
- `src/shared/wsl-browser-network-relay-contract.ts`
- `src/shared/wsl-exec-mode-separator.test.ts`
- `tests/AGENTS.md`
- `tests/e2e/agent-dashboard-status-burst.spec.ts`
- `tests/e2e/alternate-screen-fixture-script.ts`
- `tests/e2e/alternate-screen-fixture-script.unit.test.ts`
- `tests/e2e/automation-prompt-disclosure.spec.ts`
- `tests/e2e/browser-fedcm-fallback.spec.ts`
- `tests/e2e/browser-reload-feedback.spec.ts`
- `tests/e2e/browser-settings-preview.spec.ts`
- `tests/e2e/browser-split-shortcuts.spec.ts`
- `tests/e2e/client-hosted-browser-tooltip-preview.spec.ts`
...
- `tests/e2e/cross-version-wire/release-checkout-tree.ts`
...
- `tests/e2e/dictation-indicator.spec.ts`
- `tests/e2e/editor-tab-selection-restore.spec.ts`
- `tests/e2e/ephemeral-vm-cleanup-retry.spec.ts`
- `tests/e2e/ephemeral-vm-provisioned-root.spec.ts`
- `tests/e2e/finished-agent-ghost-resume.spec.ts`
- `tests/e2e/fixtures/golden-stub-agent/claude`
- `tests/e2e/fixtures/golden-stub-agent/claude.cmd`
...
- `tests/e2e/fixtures/golden-stub-agent/grok`
- `tests/e2e/fixtures/golden-stub-agent/grok.cmd`
- `tests/e2e/fixtures/persisted-sessions/legacy-workspace-session-daemon-terminal.json`
- `tests/e2e/fixtures/terminal-link-mouse-owner-fixture.cjs`
- `tests/e2e/fixtures/windows-wsl-2set-hangul-dom-trace.json`
- `tests/e2e/git-history-tooltip-wrap.spec.ts`
...
- `tests/e2e/golden-file-open-edit-save.spec.ts`
- `tests/e2e/golden-fresh-profile-terminal.spec.ts`
- `tests/e2e/golden-posix-fresh-startup.spec.ts`
- `tests/e2e/golden-posix-profile-index-fsync.spec.ts`
- `tests/e2e/golden-quit-relaunch-session.spec.ts`
- `tests/e2e/golden-shell-after-agent-exit.spec.ts`
- `tests/e2e/golden-shell-command.spec.ts`
- `tests/e2e/golden-source-control-commit.spec.ts`
...
- `tests/e2e/golden-windows-fresh-startup.spec.ts`
- `tests/e2e/golden-worktree-create-switch.spec.ts`
- `tests/e2e/grok-hook-session-cleanup.spec.ts`
- `tests/e2e/headless-serve-cli-terminal-retention-parity.spec.ts`
- `tests/e2e/helpers/alt-screen-frame.unit.test.ts`
- `tests/e2e/helpers/browser-pane-mount-census.ts`
- `tests/e2e/helpers/client-hosted-browser-fixture.ts`
- `tests/e2e/helpers/client-hosted-browser-fixture.unit.test.ts`
- `tests/e2e/helpers/client-hosted-browser-observer.ts`
- `tests/e2e/helpers/client-hosted-runtime-relaunch.ts`
- `tests/e2e/helpers/docker-ssh-relay-faults.ts`
- `tests/e2e/helpers/docker-ssh-relay-terminal-tabs.ts`
- `tests/e2e/helpers/electron-main-evaluate-retry.ts`
- `tests/e2e/helpers/electron-main-evaluate-retry.unit.test.ts`
- `tests/e2e/helpers/fake-agent-command-override.ts`
- `tests/e2e/helpers/fake-agent-command-override.unit.test.ts`
- `tests/e2e/helpers/fake-agent-paste-end-scanner.ts`
- `tests/e2e/helpers/fake-agent-paste-end-scanner.unit.test.ts`
- `tests/e2e/helpers/golden-source-control.ts`
- `tests/e2e/helpers/golden-source-control.unit.test.ts`
- `tests/e2e/helpers/golden-stub-agent.ts`
- `tests/e2e/helpers/headless-paired-runtime-serve-readiness.ts`
- `tests/e2e/helpers/headless-paired-runtime-serve-readiness.unit.test.ts`
- `tests/e2e/helpers/host-created-terminal-retention-oracle.ts`
- `tests/e2e/helpers/host-session-tabs.ts`
- `tests/e2e/helpers/markdown-editor-fixture.ts`
- `tests/e2e/helpers/markdown-nested-toggle.ts`
- `tests/e2e/helpers/materialized-remote-browser-pane.ts`
- `tests/e2e/helpers/paired-browser-placement-fixture.ts`
- `tests/e2e/helpers/paired-client-host-session.ts`
...
- `tests/e2e/helpers/paired-html-preview-inventory.ts`
- `tests/e2e/helpers/paired-quick-open-large-tree-fixture.ts`
- `tests/e2e/helpers/paired-terminal-restart-renderer-probes.ts`
- `tests/e2e/helpers/remote-skill-cloud-fixture.ts`
- `tests/e2e/helpers/remote-terminal-lifecycle-observer.ts`
- `tests/e2e/helpers/renderer-console-forwarding.ts`
- `tests/e2e/helpers/ssh-remote-only-browser-fixture.ts`
- `tests/e2e/helpers/staging-skill-ssh-target.ts`
- `tests/e2e/helpers/startup-exec-readiness-oracle.ts`
- `tests/e2e/helpers/terminal-active-pane.ts`
- `tests/e2e/helpers/terminal-pane-geometry.ts`
- `tests/e2e/helpers/terminal-pane-identity.ts`
- `tests/e2e/helpers/terminal-pane-mount-readiness.ts`
- `tests/e2e/helpers/terminal-pane-operations.ts`
- `tests/e2e/helpers/terminal-pane-title-actions.ts`
- `tests/e2e/helpers/terminal-tab-menu.ts`
- `tests/e2e/helpers/terminal-tab-open.ts`
- `tests/e2e/helpers/wsl-golden-stub-agent.ts`
- `tests/e2e/host-cold-park-remote-subscriber.unit.test.ts`
- `tests/e2e/host-guest-paint-retention-remote-viewer.unit.test.ts`
- `tests/e2e/host-parked-pane-remote-viewer.spec.ts`
- `tests/e2e/linear-url-workspace-entry.spec.ts`
- `tests/e2e/local-cli-terminal-retention.spec.ts`
- `tests/e2e/local-ssh-browser-routing.spec.ts`
- `tests/e2e/macos-press-and-hold-startup.spec.ts`
- `tests/e2e/manual-worktree-order-persistence.spec.ts`
- `tests/e2e/markdown-nested-toggle.spec.ts`
...
- `tests/e2e/paired-client-hosted-browser-double-restart.spec.ts`
- `tests/e2e/paired-client-hosted-browser-ghost-close.spec.ts`
- `tests/e2e/paired-client-hosted-browser-host-strip.spec.ts`
- `tests/e2e/paired-client-hosted-browser-quit-survival.spec.ts`
- `tests/e2e/paired-client-hosted-browser-restart-survival.spec.ts`
- `tests/e2e/paired-client-hosted-browser-title-hold.spec.ts`
...
- `tests/e2e/paired-skill-installation.spec.ts`
- `tests/e2e/paired-split-pane-browser-placement.spec.ts`
- `tests/e2e/paired-startup-exec-readiness.spec.ts`
- `tests/e2e/paired-web-add-project-unavailable-host.spec.ts`
- `tests/e2e/persisted-session-production-upgrade.spec.ts`
- `tests/e2e/pet-status-segment-layout.spec.ts`
- `tests/e2e/renderer-blocked-navigation-graph-authority.spec.ts`
- `tests/e2e/session-tabs-empty-inventory-daemon-oracle.unit.test.ts`
...
- `tests/e2e/ssh-route-error-card-preview.spec.ts`
...
- `tests/e2e/staging-skill-sharing.spec.ts`
- `tests/e2e/tab-context-menu-session-id.spec.ts`
...
- `tests/e2e/terminal-ime-midline-occlusion-probe.ts`
- `tests/e2e/terminal-ime-preedit-overlay-probe.ts`
- `tests/e2e/terminal-ime-recorded-dom-trace-replay.ts`
...
- `tests/e2e/terminal-marker-echo-command.ts`
- `tests/e2e/terminal-option-composed-ascii.spec.ts`
- `tests/e2e/terminal-pane-binding-lifecycle.spec.ts`
- `tests/e2e/terminal-pane-content-retention.spec.ts`
- `tests/e2e/terminal-pane-layout-resize.spec.ts`
- `tests/e2e/terminal-pane-split-identity.spec.ts`
- `tests/e2e/terminal-pane-title-editing.spec.ts`
- `tests/e2e/terminal-pane-title-focus-handoff.spec.ts`
- `tests/e2e/terminal-pane-title-strip-placement.spec.ts`
...
- `tests/e2e/terminal-split-activation-latency-artifact.ts`
...
- `tests/e2e/terminal-split-activation-latency-report.ts`
...
- `tests/e2e/windows-wsl-terminal-restore.spec.ts`
- `tests/e2e/worktree-active-delete-scroll-position.spec.ts`
- `tests/e2e/worktree-card-downward-drag.spec.ts`
- `tests/e2e/worktree-delete-shortcut.spec.ts`
- `tests/tools/benchmarks/worktree-create-speculation-bench.mjs`
- `tests/tools/fish-mode2031-repro/capture-fish-mode2031-trace.mjs`
- `tests/tools/repro-terminal-send-submit.mjs`
- `tests/tools/windows-pty-native-capability-smoke/packaged-node-pty-capability-oracle.mjs`
- `tests/tools/windows-pty-native-capability-smoke/packaged-node-pty-capability-oracle.test.mjs`
...
- `tests/tools/windows-pty-native-capability-smoke/README.md`
- `tests/tools/windows-pty-native-capability-smoke/real-orca-detached-launcher.vbs`
- `tests/tools/windows-pty-native-capability-smoke/run.mjs`
- `tests/tools/windows-pty-native-capability-smoke/run.test.mjs`

---

## Deleted Files (423)

These files exist in orca-baseline but not in upstream-orca â€” removed upstream.
- `.husky/_/.gitignore`
...
- `.husky/_/pre-rebase`
- `.npmrc`
- `config/electron-vite-target.config.ts`
- `config/nsis/daemon-host-uninstall.nsh`
- `config/patches/@xterm__addon-ligatures@0.11.0-beta.287.patch`
- `config/patches/@xterm__addon-serialize@0.15.0-beta.287.patch`
...
- `docs/assets/wechat-qr-group7.jpg`
- `docs/mobile-relay-ux-findings.md`
- `mobile/.npmrc`
- `mobile/packages/expo-two-way-audio/android/.gradle/9.2.0/checksums/checksums.lock`
- `mobile/packages/expo-two-way-audio/android/.gradle/9.2.0/fileChanges/last-build.bin`
- `mobile/packages/expo-two-way-audio/android/.gradle/9.2.0/fileHashes/fileHashes.bin`
- `mobile/packages/expo-two-way-audio/android/.gradle/9.2.0/fileHashes/fileHashes.lock`
- `mobile/packages/expo-two-way-audio/android/.gradle/9.2.0/gc.properties`
- `mobile/packages/expo-two-way-audio/android/.gradle/buildOutputCleanup/buildOutputCleanup.lock`
- `mobile/packages/expo-two-way-audio/android/.gradle/buildOutputCleanup/cache.properties`
- `mobile/packages/expo-two-way-audio/android/.gradle/vcs-1/gc.properties`
- `mobile/src/terminal/terminal-live-hangul-mirror.test.ts`
- `mobile/src/terminal/terminal-live-hangul-mirror.ts`
- `mobile/src/transport/host-client-acquisition-count.ts`
- `mobile/src/transport/mobile-relay-focus-probe.ts`
- `mobile/src/transport/rpc-client-activity-probe.ts`
- `ORCA_WINDOWS_SETUP_GUIDE.md`
- `src/main/agent-hooks/server.test.ts`
- `src/main/ai-vault/remote-session-scan-issues.ts`
- `src/main/attribution/terminal-attribution.test.ts`
- `src/main/attribution/terminal-attribution.ts`
- `src/main/attribution/terminal-attribution-path-env-casing.test.ts`
- `src/main/attribution/terminal-attribution-win32-dash-argument.test.ts`
...
- `src/main/claude-accounts/service.test.ts`
- `src/main/cli/appimage-cli-wrapper.ts`
...
- `src/main/daemon/priority-semaphore.test.ts`
- `src/main/daemon/priority-semaphore.ts`
...
- `src/main/providers/windows-console-foreground.test.ts`
- `src/main/providers/windows-console-foreground.ts`
- `src/main/pty/prime-agent-shell-wrapper.test.ts`
- `src/main/pty/prime-agent-shell-wrapper.ts`
...
- `src/main/star-nag/service.test.ts`
- `src/main/startup/appimage-cli-redirect.test.ts`
- `src/main/startup/appimage-cli-redirect.ts`
- `src/main/startup/packaged-cli-entry-redirect.test.ts`
- `src/main/startup/packaged-cli-entry-redirect.ts`
- `src/main/stats/agent-detector.test.ts`
- `src/main/stats/agent-detector.ts`
- `src/main/stats/agent-detector-resurrection-leak.test.ts`
- `src/main/text-generation/commit-message-text-generation.test.ts`
- `src/main/updater.test.ts`
- `src/main/window/clipboard-remote-file-cleanup.test.ts`
- `src/relay/pty-handler.test.ts`
- `src/renderer/src/components/artifacts/ArtifactListPane.tsx`
- `src/renderer/src/components/automations/automation-detail-selection.test.ts`
- `src/renderer/src/components/automations/automation-detail-selection.ts`
- `src/renderer/src/components/automations/automation-list-row-interaction.test.ts`
- `src/renderer/src/components/automations/automation-list-row-interaction.ts`
...
- `src/renderer/src/components/browser-pane/browser-address-bar-expansion.test.ts`
- `src/renderer/src/components/browser-pane/browser-address-bar-expansion.ts`
- `src/renderer/src/components/browser-pane/BrowserAddressBarSuggestionList.tsx`
- `src/renderer/src/components/browser-pane/browser-address-bar-suggestions.test.ts`
- `src/renderer/src/components/browser-pane/browser-address-bar-suggestions.ts`
- `src/renderer/src/components/browser-pane/browser-annotation-output.test.ts`
...
- `src/renderer/src/components/browser-pane/BrowserAnnotationSendMenuContent.tsx`
- `src/renderer/src/components/browser-pane/browser-artifact-upload.test.ts`
- `src/renderer/src/components/browser-pane/browser-artifact-upload.ts`
...
- `src/renderer/src/components/browser-pane/browser-detected-browsers-summary.test.ts`
- `src/renderer/src/components/browser-pane/browser-detected-browsers-summary.ts`
- `src/renderer/src/components/browser-pane/BrowserFind.tsx`
- `src/renderer/src/components/browser-pane/browser-focus.test.ts`
- `src/renderer/src/components/browser-pane/browser-focus.ts`
- `src/renderer/src/components/browser-pane/browser-guest-worktree-retention.test.ts`
- `src/renderer/src/components/browser-pane/browser-guest-worktree-retention.ts`
- `src/renderer/src/components/browser-pane/BrowserImportHintButton.tsx`
- `src/renderer/src/components/browser-pane/browser-import-hint-visibility.test.ts`
- `src/renderer/src/components/browser-pane/browser-import-hint-visibility.ts`
- `src/renderer/src/components/browser-pane/browser-keyboard.test.ts`
- `src/renderer/src/components/browser-pane/browser-keyboard.ts`
...
- `src/renderer/src/components/browser-pane/browser-page-guest-recovery.test.ts`
- `src/renderer/src/components/browser-pane/browser-page-guest-recovery.ts`
- `src/renderer/src/components/browser-pane/browser-page-paintability.test.ts`
- `src/renderer/src/components/browser-pane/browser-page-paintability.ts`
...
- `src/renderer/src/components/browser-pane/browser-page-webview.ts`
- `src/renderer/src/components/browser-pane/browser-page-zoom.test.ts`
- `src/renderer/src/components/browser-pane/browser-page-zoom.ts`
- `src/renderer/src/components/browser-pane/BrowserPane.render-ipc.test.ts`
...
- `src/renderer/src/components/browser-pane/browser-pane-page-selection.test.ts`
- `src/renderer/src/components/browser-pane/browser-pane-page-selection.ts`
- `src/renderer/src/components/browser-pane/browser-reload-action.test.ts`
- `src/renderer/src/components/browser-pane/browser-reload-action.ts`
- `src/renderer/src/components/browser-pane/browser-runtime.test.ts`
- `src/renderer/src/components/browser-pane/browser-runtime.ts`
- `src/renderer/src/components/browser-pane/browser-system-resume.test.ts`
- `src/renderer/src/components/browser-pane/browser-system-resume.ts`
- `src/renderer/src/components/browser-pane/BrowserToolbarMenu.tsx`
- `src/renderer/src/components/browser-pane/browser-toolbar-menu-dropdown.tsx`
- `src/renderer/src/components/browser-pane/browser-toolbar-profile-dialogs.tsx`
- `src/renderer/src/components/browser-pane/chromium-error-page-polling.test.ts`
- `src/renderer/src/components/browser-pane/chromium-error-page-polling.ts`
- `src/renderer/src/components/browser-pane/context-menu-positioning.test.ts`
- `src/renderer/src/components/browser-pane/GrabConfirmationSheet.test.ts`
- `src/renderer/src/components/browser-pane/GrabConfirmationSheet.tsx`
...
- `src/renderer/src/components/browser-pane/markup/use-markup-draw-hint.ts`
- `src/renderer/src/components/browser-pane/markup/useMarkupEditor.test.ts`
...
- `src/renderer/src/components/browser-pane/markup/useMarkupPointerHandlers.test.ts`
- `src/renderer/src/components/browser-pane/markup/useMarkupPointerHandlers.ts`
- `src/renderer/src/components/browser-pane/remote-browser-frame-style.test.ts`
- `src/renderer/src/components/browser-pane/remote-browser-frame-style.ts`
- `src/renderer/src/components/browser-pane/remote-browser-keyboard.test.ts`
- `src/renderer/src/components/browser-pane/remote-browser-keyboard.ts`
- `src/renderer/src/components/browser-pane/remote-browser-page-session.ts`
- `src/renderer/src/components/browser-pane/remote-browser-screencast-subscription.ts`
- `src/renderer/src/components/browser-pane/remote-browser-stream-errors.test.ts`
- `src/renderer/src/components/browser-pane/remote-browser-stream-errors.ts`
- `src/renderer/src/components/browser-pane/remote-browser-stream-lifecycle.test.ts`
- `src/renderer/src/components/browser-pane/remote-browser-stream-lifecycle.ts`
- `src/renderer/src/components/browser-pane/remote-browser-stream-lifecycle-deps.ts`
- `src/renderer/src/components/browser-pane/remote-browser-stream-lifecycle-test-harness.ts`
- `src/renderer/src/components/browser-pane/remote-browser-stream-liveness.ts`
- `src/renderer/src/components/browser-pane/remote-browser-stream-restart-attempt.ts`
- `src/renderer/src/components/browser-pane/remote-browser-stream-restart-scheduler.test.ts`
- `src/renderer/src/components/browser-pane/remote-browser-stream-restart-scheduler.ts`
- `src/renderer/src/components/browser-pane/remote-browser-stream-status.test.ts`
- `src/renderer/src/components/browser-pane/remote-browser-stream-status.ts`
- `src/renderer/src/components/browser-pane/remote-browser-stream-tokens.ts`
- `src/renderer/src/components/browser-pane/useGrabMode.test.ts`
- `src/renderer/src/components/browser-pane/useGrabMode.ts`
- `src/renderer/src/components/browser-pane/use-remote-browser-stream-activation.test.ts`
- `src/renderer/src/components/browser-pane/use-remote-browser-stream-activation.ts`
- `src/renderer/src/components/browser-pane/webview-registry.test.ts`
- `src/renderer/src/components/browser-pane/webview-registry.ts`
- `src/renderer/src/components/dashboard/useNow.test.ts`
- `src/renderer/src/components/dashboard/useNow.ts`
- `src/renderer/src/components/dashboard-popout/useAgentMapStateFilter.ts`
- `src/renderer/src/components/editor/combined-diff-commit-message.test.ts`
- `src/renderer/src/components/editor/combined-diff-commit-message.ts`
- `src/renderer/src/components/editor/combined-diff-entries.test.ts`
- `src/renderer/src/components/editor/combined-diff-entries.ts`
- `src/renderer/src/components/editor/CombinedDiffFileTree.test.ts`
- `src/renderer/src/components/editor/CombinedDiffFileTree.tsx`
- `src/renderer/src/components/editor/combined-diff-file-tree-model.ts`
- `src/renderer/src/components/editor/combined-diff-file-tree-row.tsx`
- `src/renderer/src/components/editor/combined-diff-initial-section-load.test.ts`
- `src/renderer/src/components/editor/combined-diff-initial-section-load.ts`
- `src/renderer/src/components/editor/combined-diff-load-scheduler.test.ts`
- `src/renderer/src/components/editor/combined-diff-load-scheduler.ts`
- `src/renderer/src/components/editor/combined-diff-scrollbar-drag.test.ts`
- `src/renderer/src/components/editor/combined-diff-scrollbar-drag.ts`
- `src/renderer/src/components/editor/combined-diff-section-cache-match.test.ts`
- `src/renderer/src/components/editor/combined-diff-section-cache-match.ts`
- `src/renderer/src/components/editor/combined-diff-section-connection.test.ts`
- `src/renderer/src/components/editor/combined-diff-section-connection.ts`
- `src/renderer/src/components/editor/combined-diff-section-load-state.test.ts`
- `src/renderer/src/components/editor/combined-diff-section-load-state.ts`
- `src/renderer/src/components/editor/CombinedDiffViewer.tsx`
- `src/renderer/src/components/editor/use-combined-diff-file-tree-resize.test.tsx`
- `src/renderer/src/components/editor/use-combined-diff-file-tree-resize.ts`
- `src/renderer/src/components/floating-terminal/FloatingTerminalPanel.test.tsx`
- `src/renderer/src/components/right-sidebar/BulkActionBar.tsx`
- `src/renderer/src/components/right-sidebar/checks-panel-content.tsx`
...
- `src/renderer/src/components/right-sidebar/commit-failure-summary.ts`
- `src/renderer/src/components/right-sidebar/diff-comments-clear-dialog-state.ts`
...
- `src/renderer/src/components/right-sidebar/fork-push-target-label.ts`
- `src/renderer/src/components/right-sidebar/GitHistoryCommitContextMenu.tsx`
- `src/renderer/src/components/right-sidebar/GitHistoryCommitFiles.tsx`
- `src/renderer/src/components/right-sidebar/git-history-format.ts`
- `src/renderer/src/components/right-sidebar/GitHistoryGraphSvg.tsx`
- `src/renderer/src/components/right-sidebar/GitHistoryPanel.tsx`
- `src/renderer/src/components/right-sidebar/GitHistoryRow.tsx`
- `src/renderer/src/components/right-sidebar/hosted-review-header-chrome.tsx`
- `src/renderer/src/components/right-sidebar/source-control-action-error.ts`
- `src/renderer/src/components/right-sidebar/source-control-active-open-file-keys.ts`
- `src/renderer/src/components/right-sidebar/source-control-ai-controller-types.ts`
- `src/renderer/src/components/right-sidebar/source-control-ai-prompts.ts`
- `src/renderer/src/components/right-sidebar/source-control-ai-recipe-persistence.ts`
- `src/renderer/src/components/right-sidebar/source-control-ai-recovery-launch.ts`
- `src/renderer/src/components/right-sidebar/source-control-branch-context-row.tsx`
- `src/renderer/src/components/right-sidebar/source-control-branch-context-stats.ts`
- `src/renderer/src/components/right-sidebar/source-control-branch-line-total-chip.tsx`
- `src/renderer/src/components/right-sidebar/source-control-commit-message-rows.ts`
- `src/renderer/src/components/right-sidebar/source-control-create-pr-intent-flow.ts`
- `src/renderer/src/components/right-sidebar/source-control-create-pr-intent-state.ts`
- `src/renderer/src/components/right-sidebar/source-control-discard-confirmation.ts`
- `src/renderer/src/components/right-sidebar/source-control-discard-dialog.tsx`
...
- `src/renderer/src/components/right-sidebar/source-control-file-filter.ts`
- `src/renderer/src/components/right-sidebar/source-control-header-icon-button.tsx`
- `src/renderer/src/components/right-sidebar/source-control-header-overflow-menu.tsx`
- `src/renderer/src/components/right-sidebar/source-control-header-toolbar.tsx`
- `src/renderer/src/components/right-sidebar/source-control-hosted-review-creation-eligibility-snapshot.ts`
- `src/renderer/src/components/right-sidebar/source-control-hosted-review-push-target.ts`
- `src/renderer/src/components/right-sidebar/source-control-manual-review-url.ts`
- `src/renderer/src/components/right-sidebar/source-control-primary-create-pr-intent-action.ts`
- `src/renderer/src/components/right-sidebar/source-control-pull-policy-error-notice.tsx`
- `src/renderer/src/components/right-sidebar/source-control-push-recovery.ts`
- `src/renderer/src/components/right-sidebar/source-control-recovery-notice.tsx`
- `src/renderer/src/components/right-sidebar/source-control-remote-repo.ts`
- `src/renderer/src/components/right-sidebar/source-control-section-order.ts`
- `src/renderer/src/components/right-sidebar/source-control-split-open.ts`
- `src/renderer/src/components/right-sidebar/source-control-submodule-expansion.ts`
- `src/renderer/src/components/right-sidebar/source-control-text-generation-defaults.ts`
- `src/renderer/src/components/right-sidebar/SourceControlTextGenerationDialog.tsx`
- `src/renderer/src/components/right-sidebar/SourceControlTextGenerationDialogForm.tsx`
- `src/renderer/src/components/right-sidebar/SourceControlTextGenerationParams.ts`
- `src/renderer/src/components/right-sidebar/source-control-virtual-file-list.tsx`
- `src/renderer/src/components/right-sidebar/useGitHistoryCommitActions.ts`
- `src/renderer/src/components/right-sidebar/use-source-control-ai.ts`
- `src/renderer/src/components/right-sidebar/use-source-control-recovery-ai.ts`
- `src/renderer/src/components/right-sidebar/useSourceControlSelection.ts`
- `src/renderer/src/components/right-sidebar/useSourceControlSubmoduleStatus.ts`
- `src/renderer/src/components/sidebar/worktree-list-folder-reveal.test.ts`
- `src/renderer/src/components/sidebar/worktree-list-folder-reveal.ts`
...
- `src/renderer/src/components/sidebar/worktree-list-host-filtering.ts`
- `src/renderer/src/components/sidebar/worktree-list-imported-rows.test.ts`
- `src/renderer/src/components/sidebar/worktree-list-indentation.test.ts`
- `src/renderer/src/components/sidebar/worktree-list-indentation.ts`
- `src/renderer/src/components/sidebar/worktree-list-review-cache-inputs.test.ts`
- `src/renderer/src/components/sidebar/worktree-list-review-cache-inputs.ts`
- `src/renderer/src/components/sidebar/worktree-list-scroll-adjustment.test.ts`
- `src/renderer/src/components/sidebar/worktree-list-sticky-headers.test.ts`
- `src/renderer/src/components/sidebar/worktree-list-virtual-rows.test.ts`
- `src/renderer/src/components/sidebar/worktree-list-virtual-rows.ts`
- `src/renderer/src/components/sidebar/worktree-list-visible-refresh.test.ts`
...
- `src/renderer/src/components/terminal-pane/parked-terminal-mode2031-responder.test.ts`
...
- `src/renderer/src/components/terminal-pane/terminal-link-handlers.test.ts`
- `src/renderer/src/components/terminal-pane/use-terminal-pane-global-effects.test.ts`
- `src/renderer/src/components/ui/popover.test.tsx`
- `src/renderer/src/components/ui/popover-content-ref.ts`
- `src/renderer/src/components/workspace-cleanup/inactive-workspace-estimate.test.ts`
...
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-view-selection.test.ts`
- `src/renderer/src/components/workspace-cleanup/workspace-cleanup-view-selection.ts`
- `src/renderer/src/hooks/useIpcEvents.test.ts`
- `src/renderer/src/lib/active-agent-note-send.test.ts`
- `src/renderer/src/lib/cmd-j-match-relevance.test.ts`
- `src/renderer/src/lib/cmd-j-match-relevance.ts`
- `src/renderer/src/lib/pi-compatible-live-recovery-record.ts`
- `src/renderer/src/lib/typing-latency-census-probe.ts`
- `src/renderer/src/lib/typing-latency-diagnostic.ts`
- `src/renderer/src/lib/typing-latency-diagnostic-summary.test.ts`
- `src/renderer/src/lib/typing-latency-diagnostic-summary.ts`
...
- `src/shared/github-check-details-deadline.ts`
- `src/shared/github-links.ts`
- `src/shared/github-pr-auto-merge-availability.test.ts`
- `src/shared/github-pr-auto-merge-availability.ts`
- `src/shared/github-pr-for-branch-outcome.test.ts`
- `src/shared/github-pr-for-branch-outcome.ts`
- `src/shared/github-pr-merge-methods.test.ts`
...
- `src/shared/worktree-submodule-removal.test.ts`
- `src/shared/worktree-submodule-removal.ts`
- `tests/e2e/browser-split-find-shortcut.spec.ts`
...
These files differ between orca-baseline and upstream-orca.
- `.gitattributes`
...
- `config/scripts/benchmark-artifact-comparison.test.mjs`
...
- `config/scripts/check-react-doctor-changed.mjs`
...
- `config/scripts/daily-build-version.mjs`
...
- `config/scripts/git-binary-compatibility-workflow.test.mjs`
- `config/scripts/git-diff-blob-concurrency-benchmark.mjs`
- `config/scripts/install-electron-package-binary.mjs`
- `config/scripts/install-electron-package-binary.test.mjs`
- `config/scripts/legacy-worker-recovery-persistence-benchmark.mjs`
...
- `config/scripts/locale-translation-policy.es-pr.test.mjs`
- `config/scripts/locale-translation-policy.ja-relocalization.test.mjs`
- `config/scripts/locale-translation-policy.mjs`
- `config/scripts/locale-translation-policy.zh-round5.test.mjs`
- `config/scripts/locale-zh-phrase-fixes-round5.mjs`
- `config/scripts/locale-zh-value-overrides.mjs`
- `config/scripts/macos-computer-helper-owner-loss-benchmark.mjs`
- `config/scripts/mjpeg-frame-parser-alloc-benchmark.mjs`
...
- `config/scripts/plain-node-entry-guard.test.ts`
...
- `config/scripts/remote-shared-control-retirement-probe.ts`
...
- `config/scripts/terminal-e2e-helpers.mjs`
...
- `config/scripts/windows-apphang-repro/wsl-workspace-fixture.mjs`
- `config/scripts/windows-signing-workflow-contract.test.mjs`
- `config/scripts/worktree-refresh-churn-benchmark.mjs`
- `config/scripts/wsl-git-shell-benchmark.mjs`
...
- `mobile/scripts/repro-terminal-colors.ts`
...
- `mobile/src/browser/browser-url.test.ts`
...
- `mobile/src/components/MobileHostCard.test.tsx`
- `mobile/src/components/MobileHostCard.tsx`
...
- `mobile/src/components/WorktreeListRow.test.ts`
- `mobile/src/components/WorktreeListRow.tsx`
...
- `mobile/src/files/mobile-file-preview-route.test.ts`
...
- `mobile/src/hooks/use-mobile-dictation-source.test.ts`
- `mobile/src/host-list-action-sheet-actions.test.ts`
- `mobile/src/host-list-action-sheet-actions.ts`
- `mobile/src/session/ai-vault-resume-launch.test.ts`
...
- `mobile/src/session/mobile-native-chat-send.test.ts`
...
- `mobile/src/session/use-mobile-file-tap-handlers.test.ts`
...
- `mobile/src/tasks/setup-hook-trust.test.ts`
...
- `mobile/src/transport/mobile-relay-invite-director.test.ts`
- `mobile/src/transport/mobile-relay-invite-director.ts`
- `mobile/src/transport/mobile-relay-physical-client.test.ts`
...
- `mobile/src/transport/mobile-relay-resume-director.test.ts`
...
- `mobile/src/transport/pairing-relay-candidate.test.ts`
...
- `mobile/src/worktree/home-resume-card.test.ts`
- `mobile/src/worktree/host-worktree-rpc-types.ts`
- `mobile/src/worktree/mobile-workspace-lineage.test.ts`
...
- `mobile/src/worktree/workspace-list-sections.test.ts`
...
- `mobile/src/worktree/worktree-list-snapshot.test.ts`
...
- `src/cli/command-suggestion.ts`
- `src/cli/computer-format.ts`
- `src/cli/flags.ts`
- `src/cli/format.test.ts`
- `src/cli/format.ts`
- `src/cli/format-recovery.test.ts`
...
- `src/cli/handlers/file-absolute-paths.test.ts`
- `src/cli/handlers/linear.test.ts`
...
- `src/cli/linear-request-builders.ts`
...
- `src/cli/serve-electron-flag-parity.test.ts`
...
- `src/main/agent-hooks/first-work-branch-rename-test-harness.ts`
- `src/main/agent-hooks/first-work-folder-rename.test.ts`
- `src/main/agent-hooks/first-work-folder-rename.ts`
...
- `src/main/agent-hooks/restored-subagent-liveness-sweep.test.ts`
...
- `src/main/agent-hooks/server-grok-discovery.test.ts`
- `src/main/agent-hooks/wsl-hook-fs-adapter.ts`
- `src/main/agent-hooks/wsl-hook-relay-deps.ts`
- `src/main/agent-hooks/wsl-hook-relay-guest-install.ts`
...
- `src/main/ai-vault/session-scanner-background.ts`
...
- `src/main/artifacts/artifact-cloud-request.ts`
- `src/main/artifacts/artifact-cloud-service.ts`
- `src/main/artifacts/artifact-publisher.ts`
- `src/main/artifacts/artifact-share-record-store.ts`
...
- `src/main/automations/headless-workspace-create.ts`
- `src/main/automations/hermes-cron-output.ts`
...
- `src/main/bitbucket/client.test.ts`
...
- `src/main/browser/browser-backend.ts`
...
- `src/main/browser/browser-clicked-link-routing.test.ts`
- `src/main/browser/browser-clicked-link-routing.ts`
...
- `src/main/browser/browser-cookie-import-replacement.test.ts`
- `src/main/browser/browser-cookie-import-test-database.ts`
- `src/main/browser/browser-download-destination.test.ts`
...
- `src/main/browser/browser-session-permission-policy.ts`
...
- `src/main/claude-usage/scanner-large-directory.test.ts`
...
- `src/main/codex/codex-session-resume-home.ts`
- `src/main/codex/codex-session-source-home.ts`
- `src/main/codex/codex-stale-pane-accounts.test.ts`
- `src/main/codex/codex-stale-pane-accounts.ts`
- `src/main/codex/codex-state-db-backfill-recovery.test.ts`
...
- `src/main/codex/config-sync-stall.test.ts`
...
- `src/main/codex-accounts/legacy-shared-auth-migration.test.ts`
- `src/main/codex-accounts/legacy-shared-auth-migration.ts`
- `src/main/codex-accounts/managed-codex-auth-readiness.test.ts`
...
- `src/main/codex-accounts/runtime-home-windows-profile-ownership.test.ts`
...
- `src/main/codex-accounts/wsl-codex-command.test.ts`
- `src/main/codex-accounts/wsl-codex-command.ts`
- `src/main/codex-cli/command.test.ts`
- `src/main/codex-usage/scanner.test.ts`
- `src/main/codex-usage/scanner.ts`
- `src/main/codex-usage/scanner-large-directory.test.ts`
...
- `src/main/crash-reporting/crash-report-store.test.ts`
...
- `src/main/daemon/daemon-host-relocation.test.ts`
...
- `src/main/daemon/daemon-process-inspection.test.ts`
...
- `src/main/daemon/node-pty-error-hints.test.ts`
...
- `src/main/ghostty/index.ts`
- `src/main/ghostty/mapper.ts`
...
- `src/main/github/client-pr-local-runtime.test.ts`
...
- `src/main/github/github-repository-identity.ssh-host-alias.test.ts`
...
- `src/main/github/work-item-details-pr-files.test.ts`
...
- `src/main/gitlab/work-item-details.ts`
...
- `src/main/ipc/browser-session-profile-ipc.test.ts`
- `src/main/ipc/cli.ts`
- `src/main/ipc/codex-accounts.ts`
- `src/main/ipc/codex-config-sync.test.ts`
- `src/main/ipc/codex-config-sync.ts`
- `src/main/ipc/crash-reporting.test.ts`
...
- `src/main/ipc/ephemeral-vm.ts`
- `src/main/ipc/ephemeral-vm-recipe-context.ts`
- `src/main/ipc/ephemeral-vm-runtime-handlers.ts`
...
- `src/main/ipc/filesystem-import-ssh-path-safety.test.ts`
- `src/main/ipc/filesystem-list-files.test.ts`
- `src/main/ipc/filesystem-list-files.ts`
- `src/main/ipc/filesystem-list-files-git-directory-expansion.test.ts`
...
- `src/main/ipc/filesystem-watcher-real.test.ts`
...
- `src/main/ipc/floating-workspace-directory.test.ts`
...
- `src/main/ipc/parcel-watcher-entry-path.test.ts`
...
- `src/main/ipc/repos-add-linked-worktree.test.ts`
...
- `src/main/ipc/telemetry.test.ts`
...
- `src/main/ipc/workspace-cleanup.ts`
...
- `src/main/ipc/workspace-space.test.ts`
...
- `src/main/ipc/worktree-push-target-setup.test.ts`
- `src/main/ipc/worktree-push-target-setup.ts`
...
- `src/main/kimi/kimi-runtime-home.ts`
- `src/main/linear/client.test.ts`
- `src/main/linear/client.ts`
- `src/main/linear/issue-activity-raw.ts`
- `src/main/linear/issue-context.test.ts`
- `src/main/linear/issue-context.ts`
- `src/main/linear/issue-context-client.test.ts`
- `src/main/linear/issue-context-client.ts`
- `src/main/linear/issue-context-current.test.ts`
...
- `src/main/linear/issue-context-raw.ts`
...
- `src/main/linear/issue-relation-mutation.ts`
- `src/main/linear/issue-relation-write.test.ts`
- `src/main/linear/issue-relation-write.ts`
- `src/main/linear/issues.test.ts`
- `src/main/linear/linear-team-pages.ts`
- `src/main/linear/mappers.ts`
- `src/main/linear/mcp-issue-list.test.ts`
- `src/main/linear/mcp-issue-list.ts`
- `src/main/linear/projects.test.ts`
- `src/main/linear/projects.ts`
- `src/main/linear/teams.test.ts`
- `src/main/linear/teams.ts`
- `src/main/linux-package-install-command.test.ts`
- `src/main/linux-package-install-command.ts`
- `src/main/linux-package-install-diagnostic.test.ts`
...
- `src/main/linux-update-package-type.test.ts`
...
- `src/main/mimo/hook-service.test.ts`
...
- `src/main/observability/bundle.test.ts`
...
- `src/main/observability/redactor.test.ts`
...
- `src/main/persistence-duplicate-repo-id-host-scope.test.ts`
- `src/main/persistence-feature-interaction-broadcast.benchmark.test.ts`
- `src/main/persistence-protected-secret-fail-closed.test.ts`
- `src/main/persistence-protected-secret-write-race.test.ts`
- `src/main/persistence-proxy-secret-recovery.test.ts`
- `src/main/persistence-single-serialize.test.ts`
...
- `src/main/plugins/plugin-approved-vm-recipes.ts`
- `src/main/plugins/plugin-dev-watcher.ts`
- `src/main/plugins/plugin-enablement.test.ts`
...
- `src/main/plugins/plugin-vm-recipe-registry.ts`
...
- `src/main/powershell-osc133-bootstrap.test.ts`
...
- `src/main/providers/pty-process-info.ts`
...
- `src/main/pty/omp-shell-wrapper.ts`
- `src/main/pty/posix-pty-foreground-group.ts`
- `src/main/pty/shell-startup-env.test.ts`
...
- `src/main/rate-limits/minimax-request-context.ts`
...
- `src/main/runtime/fetch-remote-cache.test.ts`
...
- `src/main/runtime/headless-tab-group-split-layout.ts`
...
- `src/main/runtime/linear-save-issue.test.ts`
- `src/main/runtime/missing-worktree-terminal-reconciliation.test.ts`
- `src/main/runtime/missing-worktree-terminal-reconciliation.ts`
...
- `src/main/runtime/orchestration/__snapshots__/preamble.test.ts.snap`
...
- `src/main/runtime/orchestration/federation-ack-checkpoints.ts`
...
- `src/main/runtime/pty-waiver-source-invariant.test.ts`
...
- `src/main/runtime/relay/relay-session-broker-contract.ts`
...
- `src/main/runtime/repo-icon-fork-backfill.test.ts`
...
- `src/main/runtime/rpc/methods/artifact-sharing-capability-grant.test.ts`
...
- `src/main/runtime/rpc/methods/files-terminal-path-resolution.test.ts`
...
- `src/main/runtime/rpc/methods/linear-agent-access.test.ts`
- `src/main/runtime/rpc/methods/linear-agent-access.ts`
- `src/main/runtime/rpc/methods/linear-agent-project-access.test.ts`
...
- `src/main/runtime/rpc/methods/orchestration-federation-control-mail.test.ts`
- `src/main/runtime/rpc/methods/orchestration-federation-folder-placement.test.ts`
...
- `src/main/runtime/rpc/methods/orchestration-federation-setup.test.ts`
...
- `src/main/runtime/rpc/methods/orchestration-worker-release-completion.ts`
...
- `src/main/runtime/rpc/methods/session-tabs-move-validation.test.ts`
...
- `src/main/runtime/rpc/methods/ssh.test.ts`
- `src/main/runtime/rpc/methods/ssh.ts`
- `src/main/runtime/rpc/methods/task-resume-state-schema.ts`
...
- `src/main/runtime/rpc/methods/worktree-catalog-snapshot-method.test.ts`
- `src/main/runtime/rpc/methods/worktree-rm-pty-waiver.test.ts`
- `src/main/runtime/rpc/methods/worktree-schemas.test.ts`
- `src/main/runtime/rpc/methods/worktree-schemas.ts`
- `src/main/runtime/rpc/orchestration-11745-regression-verification.test.ts`
- `src/main/runtime/rpc/orchestration-contract-fence.test.ts`
...
- `src/main/runtime/rpc/orchestration-legacy-lifecycle.ts`
- `src/main/runtime/rpc/orchestration-legacy-mail.ts`
- `src/main/runtime/rpc/orchestration-legacy-question.ts`
...
- `src/main/runtime/rpc/runtime-close-attribution.test.ts`
...
- `src/main/runtime/rpc/terminal-subscribe-blank-mount.test.ts`
- `src/main/runtime/rpc/terminal-subscribe-buffer.test.ts`
- `src/main/runtime/rpc/terminal-subscribe-lease-only.test.ts`
- `src/main/runtime/rpc/terminal-subscribe-mount-replay.test.ts`
- `src/main/runtime/rpc/terminal-subscribe-renderer-recovery-output.test.ts`
...
- `src/main/runtime/runtime-remove-project-host-scope.test.ts`
...
- `src/main/runtime/terminal-model-query-authority.ts`
...
- `src/main/runtime/terminal-subscribe-exit-waiter-leak.test.ts`
...
- `src/main/runtime/worktree-teardown-unstopped-pty.test.ts`
- `src/main/server/serve-readiness.test.ts`
- `src/main/server/serve-readiness.ts`
...
- `src/main/skills/discovery.test.ts`
...
- `src/main/skills/skill-discovery-wsl-plugins.test.ts`
- `src/main/skills/skill-freshness-inventory.test.ts`
- `src/main/skills/skill-freshness-inventory.ts`
...
- `src/main/source-control/hosted-review-git-options.ts`
...
- `src/main/speech/model-manager-download-resume.test.ts`
...
- `src/main/ssh/ssh-config-host-picker.test.ts`
...
- `src/main/ssh/ssh-connection-sftp-namespace.test.ts`
...
- `src/main/ssh/ssh-relay-install-lock.ts`
- `src/main/ssh/ssh-relay-install-lock-commands.ts`
- `src/main/ssh/ssh-relay-install-namespace.ts`
- `src/main/ssh/ssh-relay-native-deps-install.test.ts`
- `src/main/ssh/ssh-relay-native-deps-install-fixture.ts`
- `src/main/ssh/ssh-relay-orphan-abandon-paths.test.ts`
...
- `src/main/ssh/ssh-remote-cli-host-passthrough.test.ts`
...
- `src/main/ssh/ssh-remote-linear-read-cli.ts`
- `src/main/ssh/ssh-remote-linear-relation-write.ts`
- `src/main/ssh/ssh-remote-linear-result-guards.ts`
- `src/main/ssh/ssh-remote-linear-write-support.ts`
- `src/main/ssh/ssh-remote-node-toolchain-probe.ts`
...
- `src/main/ssh/ssh-system-transport.integration.test.ts`
...
- `src/main/ssh/system-ssh-args.ts`
...
- `src/main/startup/dev-education-suppression.ts`
...
- `src/main/startup/serve-mode-argv.test.ts`
...
- `src/main/telemetry/client-test-harness.ts`
- `src/main/telemetry/cohort-classifier.test.ts`
- `src/main/telemetry/consent.test.ts`
...
- `src/main/terminal-history-async-delete.test.ts`
- `src/main/terminal-history-deletion.ts`
- `src/main/terminal-history-gc.ts`
- `src/main/terminal-history-paths.ts`
- `src/main/terminal-history-tombstone-retry.test.ts`
- `src/main/terminal-scrollback-snapshot-async-migration.ts`
- `src/main/terminal-scrollback-snapshots.ts`
- `src/main/text-generation/commit-message-agent-environment.test.ts`
- `src/main/text-generation/commit-message-agent-environment.ts`
...
- `src/main/updater-linux-package-recovery-actions.test.ts`
...
- `src/main/warp-themes/discovery.ts`
- `src/main/warp-themes/parser.ts`
- `src/main/win32-utils.test.ts`
...
- `src/main/window/clipboard-image-temp-file.ts`
- `src/main/window/clipboard-ipc-handlers.test.ts`
- `src/main/window/clipboard-ipc-handlers.ts`
- `src/main/window/clipboard-remote-file-copy.ts`
...
- `src/main/workspace-space-analysis-du-timeout.test.ts`
...
- `src/relay/git-exec-validator.test.ts`
...
- `src/renderer/src/assets/mobile-page.css`
...
- `src/renderer/src/components/artifacts/ArtifactCollection.test.tsx`
...
- `src/renderer/src/components/artifacts/ArtifactPreview.tsx`
- `src/renderer/src/components/artifacts/ArtifactPublishButton.test.tsx`
- `src/renderer/src/components/artifacts/ArtifactPublishButton.tsx`
- `src/renderer/src/components/artifacts/artifact-publish-flow.test.ts`
- `src/renderer/src/components/artifacts/artifact-publish-flow.ts`
- `src/renderer/src/components/artifacts/ArtifactsPage.test.tsx`
- `src/renderer/src/components/artifacts/ArtifactsPage.tsx`
...
- `src/renderer/src/components/automations/AutomationEditorDialogFooter.tsx`
- `src/renderer/src/components/automations/AutomationEditorDialogHeader.tsx`
- `src/renderer/src/components/automations/AutomationEditorPromptSection.tsx`
...
- `src/renderer/src/components/automations/automation-list-search.test.ts`
...
- `src/renderer/src/components/automations/AutomationMissedRunGraceField.tsx`
...
- `src/renderer/src/components/automations/automation-project-groups.test.ts`
- `src/renderer/src/components/automations/automation-project-groups.ts`
- `src/renderer/src/components/automations/automation-run-context.test.ts`
...
- `src/renderer/src/components/automations/AutomationSessionField.tsx`
- `src/renderer/src/components/automations/automation-setup-decision.test.ts`
- `src/renderer/src/components/automations/automation-setup-decision.ts`
- `src/renderer/src/components/automations/AutomationSetupDecisionField.tsx`
...
- `src/renderer/src/components/automations/automation-target-availability.test.ts`
...
- `src/renderer/src/components/cmd-j/palette-project-results.ts`
...
- `src/renderer/src/components/cmd-j/quick-action-context.ts`
...
- `src/renderer/src/components/crash-report/CrashReportDialogSurface.tsx`
...
- `src/renderer/src/components/dashboard/dashboard-worktree-launch-options.test.ts`
...
- `src/renderer/src/components/dashboard-popout/agent-map.css`
- `src/renderer/src/components/dashboard-popout/AgentMap.test.tsx`
...
- `src/renderer/src/components/dashboard-popout/agent-map-filter.test.ts`
...
- `src/renderer/src/components/dashboard-popout/agent-map-label-declutter.test.ts`
- `src/renderer/src/components/dashboard-popout/agent-map-label-declutter.ts`
- `src/renderer/src/components/dashboard-popout/agent-map-layout.test.ts`
...
- `src/renderer/src/components/dashboard-popout/AgentMapProjectLabel.test.tsx`
- `src/renderer/src/components/dashboard-popout/agent-map-render-test-harness.tsx`
...
- `src/renderer/src/components/dashboard-popout/preview-terminal-compatibility.ts`
...
- `src/renderer/src/components/diff-comments/DiffCommentCard.tsx`
- `src/renderer/src/components/diff-comments/useDiffCommentDecorator.tsx`
...
- `src/renderer/src/components/editor/editor-autosave.test.ts`
...
- `src/renderer/src/components/editor/markdown-doc-links.ts`
...
- `src/renderer/src/components/editor/MarkdownPreview.test.ts`
- `src/renderer/src/components/editor/MarkdownPreview.tsx`
- `src/renderer/src/components/editor/markdown-render-mode.ts`
...
- `src/renderer/src/components/editor/monaco-context-menu-paste.ts`
...
- `src/renderer/src/components/editor/rich-markdown-key-handler.ts`
...
- `src/renderer/src/components/editor/useEditorPanelContentState.test.tsx`
...
- `src/renderer/src/components/editor/useEditorPanelVisibilityContentState.test.tsx`
...
- `src/renderer/src/components/feature-wall/BrowserAnimatedVisual.tsx`
- `src/renderer/src/components/feature-wall/BrowserUseSkillSetupCard.tsx`
- `src/renderer/src/components/feature-wall/EditorAnimatedVisual.tsx`
...
- `src/renderer/src/components/feature-wall/feature-wall-setup-progress.test.ts`
- `src/renderer/src/components/feature-wall/feature-wall-setup-progress.ts`
...
- `src/renderer/src/components/feature-wall/WorkbenchAnimatedVisual.tsx`
...
- `src/renderer/src/components/floating-terminal/floating-terminal-panel-bounds.ts`
- `src/renderer/src/components/floating-terminal/floating-terminal-trigger-position.ts`
...
- `src/renderer/src/components/github/github-rate-limit-display.tsx`
...
- `src/renderer/src/components/github/IssueSourceIndicator.tsx`
...
- `src/renderer/src/components/github-project/GhAuthErrorHelp.test.ts`
- `src/renderer/src/components/github-project/GhAuthErrorHelp.tsx`
- `src/renderer/src/components/github-project/github-project-picker-filter.test.ts`
...
- `src/renderer/src/components/github-project/project-row-filtering.test.ts`
...
- `src/renderer/src/components/github-project/project-visible-table-cache.test.ts`
...
- `src/renderer/src/components/github-pr-reviewer-display.test.ts`
- `src/renderer/src/components/github-pr-reviewer-display.ts`
- `src/renderer/src/components/gitlab/gitlab-rate-limit-display.tsx`
...
- `src/renderer/src/components/landing-preflight-dismissal.test.ts`
- `src/renderer/src/components/landing-preflight-dismissal.ts`
- `src/renderer/src/components/landing-preflight-issues.test.ts`
- `src/renderer/src/components/landing-preflight-issues.ts`
- `src/renderer/src/components/landing-preflight-runtime-boundary.test.ts`
- `src/renderer/src/components/linear-api-key-dialog.tsx`
...
- `src/renderer/src/components/linear-issue-view-storage.test.ts`
- `src/renderer/src/components/linear-issue-view-storage.ts`
- `src/renderer/src/components/LinearIssueWorkspace.tsx`
- `src/renderer/src/components/linear-issue-workspace-text.test.ts`
...
- `src/renderer/src/components/LinuxPackageInstallRecoveryCard.test.tsx`
...
- `src/renderer/src/components/mobile/MobilePage.test.tsx`
...
- `src/renderer/src/components/native-chat/native-chat-pane-resolution.ts`
...
- `src/renderer/src/components/native-chat/native-chat-session-transport.test.ts`
...
- `src/renderer/src/components/native-chat/use-native-chat-composer-paste.test.tsx`
...
- `src/renderer/src/components/new-workspace/run-target-options.ts`
- `src/renderer/src/components/new-workspace/smart-workspace-command-value.test.ts`
- `src/renderer/src/components/new-workspace/SmartWorkspaceNameField.ime-enter.test.tsx`
- `src/renderer/src/components/new-workspace/SmartWorkspaceNameField.jira-accessibility.test.tsx`
...
- `src/renderer/src/components/new-workspace/smart-workspace-source-results.test.ts`
...
- `src/renderer/src/components/new-workspace/use-jira-url-source.test.tsx`
...
- `src/renderer/src/components/onboarding/show-onboarding-event.ts`
...
- `src/renderer/src/components/pet/pet-agent-state.test.ts`
...
- `src/renderer/src/components/right-sidebar/ai-vault-scope-paths.test.ts`
...
- `src/renderer/src/components/right-sidebar/ai-vault-session-refresh.test.ts`
- `src/renderer/src/components/right-sidebar/ai-vault-session-refresh.ts`
...
- `src/renderer/src/components/right-sidebar/ChecksPanel.review-header.test.tsx`
...
- `src/renderer/src/components/right-sidebar/checks-panel-review-state-model.ts`
...
- `src/renderer/src/components/right-sidebar/fork-push-target-label.test.ts`
...
- `src/renderer/src/components/right-sidebar/git-status-file-watch-refresh.ts`
...
- `src/renderer/src/components/right-sidebar/PortsPanel.test.tsx`
- `src/renderer/src/components/right-sidebar/PortsPanel.tsx`
...
- `src/renderer/src/components/right-sidebar/SourceControl.hosted-review-header-link.test.tsx`
...
- `src/renderer/src/components/right-sidebar/SourceControlAgentActionDialogForm.tsx`
...
- `src/renderer/src/components/right-sidebar/source-control-branch-context-row.test.tsx`
...
- `src/renderer/src/components/right-sidebar/source-control-dropdown-items.create-pr-intent.test.ts`
...
- `src/renderer/src/components/right-sidebar/source-control-manual-review-url.test.ts`
...
- `src/renderer/src/components/right-sidebar/useFileExplorerKeys.ts`
...
- `src/renderer/src/components/right-sidebar/use-hosted-review-actions.test.tsx`
...
- `src/renderer/src/components/settings/AdvancedNetworkSettingsSection.tsx`
- `src/renderer/src/components/settings/AdvancedPane.tsx`
- `src/renderer/src/components/settings/agent-awake-copy.ts`
...
- `src/renderer/src/components/settings/appearance-sidebar-search.ts`
...
- `src/renderer/src/components/settings/ArtifactsSettingsPane.tsx`
- `src/renderer/src/components/settings/AutomationsSettingsPane.tsx`
- `src/renderer/src/components/settings/AutoRenameBranchFromWorkSetting.tsx`
...
- `src/renderer/src/components/settings/BrowserLocalhostWorktreeLabelsSetting.tsx`
...
- `src/renderer/src/components/settings/DeveloperPermissionsPane.test.tsx`
...
- `src/renderer/src/components/settings/EphemeralVmRecipeRow.tsx`
...
- `src/renderer/src/components/settings/GeneralEditorSettingsSection.tsx`
...
- `src/renderer/src/components/settings/MobilePairingQrSection.test.tsx`
...
- `src/renderer/src/components/settings/mobile-settings-search.ts`
...
- `src/renderer/src/components/settings/notification-settings-copy.ts`
...
- `src/renderer/src/components/settings/PrivacyPane.test.ts`
- `src/renderer/src/components/settings/PrivacyPane.tsx`
...
- `src/renderer/src/components/settings/provider-account-visibility.ts`
- `src/renderer/src/components/settings/QuickCommandsList.tsx`
- `src/renderer/src/components/settings/QuickCommandsPane.tsx`
...
- `src/renderer/src/components/settings/ReleaseChannelSection.tsx`
- `src/renderer/src/components/settings/RemoteServerUpdateStatus.tsx`
- `src/renderer/src/components/settings/RepositoryForkSyncSection.tsx`
...
- `src/renderer/src/components/settings/repository-host-setup-options.ts`
...
- `src/renderer/src/components/settings/RepositoryHostSetupsSection.workspace-window.test.tsx`
...
- `src/renderer/src/components/settings/shortcut-definition-catalog.ts`
- `src/renderer/src/components/settings/shortcut-groups.test.ts`
- `src/renderer/src/components/settings/shortcut-groups.ts`
- `src/renderer/src/components/settings/ShortcutsPane.tsx`
- `src/renderer/src/components/settings/shortcuts-search.ts`
...
- `src/renderer/src/components/settings/SourceControlAiActionRecipeDefaults.tsx`
...
- `src/renderer/src/components/settings/TerminalCursorAppearanceSection.tsx`
...
- `src/renderer/src/components/settings/TerminalThemeSections.tsx`
...
- `src/renderer/src/components/settings/WorkspaceDirectorySetting.test.tsx`
...
- `src/renderer/src/components/sidebar/active-worktree-focus-after-delete.test.ts`
...
- `src/renderer/src/components/sidebar/add-remote-host-ssh-actions.test.ts`
...
- `src/renderer/src/components/sidebar/AddRepoNestedImportStep.test.tsx`
- `src/renderer/src/components/sidebar/AddRepoNestedImportStep.tsx`
...
- `src/renderer/src/components/sidebar/create-project-defaults.test.ts`
...
- `src/renderer/src/components/sidebar/delete-worktree-toast.test.ts`
...
- `src/renderer/src/components/sidebar/host-rename-remove.ts`
...
- `src/renderer/src/components/sidebar/imported-worktrees-card-candidates.test.ts`
- `src/renderer/src/components/sidebar/imported-worktrees-card-candidates.ts`
- `src/renderer/src/components/sidebar/ImportedWorktreesVisibilityLine.test.tsx`
...
- `src/renderer/src/components/sidebar/local-base-ref-suggestion-toast.tsx`
...
- `src/renderer/src/components/sidebar/new-external-worktrees-inbox-candidates.test.ts`
- `src/renderer/src/components/sidebar/new-external-worktrees-inbox-candidates.ts`
- `src/renderer/src/components/sidebar/NewExternalWorktreesInboxLine.test.tsx`
...
- `src/renderer/src/components/sidebar/preserved-branch-batch-toast.tsx`
- `src/renderer/src/components/sidebar/preserved-branch-toast.test.tsx`
- `src/renderer/src/components/sidebar/preserved-branch-toast.tsx`
- `src/renderer/src/components/sidebar/project-added-default-checkout.test.ts`
- `src/renderer/src/components/sidebar/project-added-default-checkout.ts`
- `src/renderer/src/components/sidebar/ProjectAddedDialog.test.tsx`
...
- `src/renderer/src/components/sidebar/SetupScriptPromptCard.test.ts`
...
- `src/renderer/src/components/sidebar/SidebarWorkspaceFilterSection.tsx`
- `src/renderer/src/components/sidebar/sidebar-workspace-option-items.ts`
...
- `src/renderer/src/components/sidebar/ssh-host-remove-workspaces.ts`
- `src/renderer/src/components/sidebar/ssh-workspace-forget-resolution.ts`
...
- `src/renderer/src/components/sidebar/useSetupScriptPromptRevalidation.ts`
...
- `src/renderer/src/components/sidebar/use-worktree-card-foundation.ts`
- `src/renderer/src/components/sidebar/use-worktree-card-lifecycle-effects.ts`
...
- `src/renderer/src/components/sidebar/use-worktree-card-secondary-details.ts`
...
- `src/renderer/src/components/sidebar/workspace-board-task-status-sync.test.ts`
...
- `src/renderer/src/components/sidebar/WorkspaceKanbanDrawerHeader.test.tsx`
...
- `src/renderer/src/components/sidebar/workspace-kanban-search.test.ts`
...
- `src/renderer/src/components/sidebar/WorktreeCardCliDetailSection.tsx`
...
- `src/renderer/src/components/sidebar/WorktreeCardIssueDetailSection.tsx`
- `src/renderer/src/components/sidebar/worktree-card-jira-issue-display.ts`
- `src/renderer/src/components/sidebar/WorktreeCardMeta.interaction.test.tsx`
- `src/renderer/src/components/sidebar/WorktreeCardMeta.test.tsx`
...
- `src/renderer/src/components/sidebar/worktree-card-meta-types.ts`
- `src/renderer/src/components/sidebar/worktree-card-model.ts`
- `src/renderer/src/components/sidebar/worktree-card-parent-content.tsx`
- `src/renderer/src/components/sidebar/worktree-card-pr-display.test.ts`
...
- `src/renderer/src/components/sidebar/WorktreeCardReviewDetailSection.tsx`
...
- `src/renderer/src/components/sidebar/WorktreeList.card-memo-stability.test.tsx`
...
- `src/renderer/src/components/sidebar/WorktreeMetaDialog.test.tsx`
- `src/renderer/src/components/sidebar/WorktreeMetaDialog.tsx`
- `src/renderer/src/components/sidebar/worktree-meta-updates.test.ts`
...
- `src/renderer/src/components/sidebar/WorktreeVisibilityDialog.tsx`
...
- `src/renderer/src/components/stats/usage-overview-model.test.ts`
...
- `src/renderer/src/components/status-bar/PetStatusSegment.tsx`
...
- `src/renderer/src/components/task-page-cache-selectors.test.ts`
...
- `src/renderer/src/components/task-page-github-status-actions.test.ts`
...
- `src/renderer/src/components/task-page-jira-item-source-context.test.ts`
...
- `src/renderer/src/components/terminal-pane/codex-detached-pane-restart.test.ts`
- `src/renderer/src/components/terminal-pane/codex-detached-pane-restart.ts`
...
- `src/renderer/src/components/terminal-pane/issue-12112-agent-pane-startup-color-reply-leak.repro.test.ts`
- `src/renderer/src/components/terminal-pane/issue-4631-terminal-hover-link-provider.repro.test.ts`
...
- `src/renderer/src/components/terminal-pane/pane-foreground-agent-tracker.ts`
...
- `src/renderer/src/components/terminal-pane/remote-hidden-output-restore-outcomes.test.ts`
...
- `src/renderer/src/components/terminal-pane/terminal-bracketed-paste.test.ts`
...
- `src/renderer/src/components/terminal-pane/terminal-clipboard-paste.test.ts`
...
- `src/renderer/src/components/terminal-pane/terminal-link-pty-mouse-suppression.ts`
- `src/renderer/src/components/terminal-pane/terminal-live-layout-reconciliation.test.ts`
- `src/renderer/src/components/terminal-pane/terminal-live-layout-reconciliation.ts`
- `src/renderer/src/components/terminal-pane/terminal-notification-pane-visibility.ts`
...
- `src/renderer/src/components/terminal-pane/terminal-url-link-click.test.ts`
...
- `src/renderer/src/components/ui/repo-multi-combobox.test.ts`
...
- `src/renderer/src/components/UpdateErrorCardContent.tsx`
...
- `src/renderer/src/components/workspace-cleanup/inactive-workspace-estimate.ts`
...
- `src/renderer/src/hooks/useComposerState-host-retarget.test.ts`
- `src/renderer/src/hooks/useDetectedAgents.test.tsx`
- `src/renderer/src/hooks/useDetectedAgents.ts`
- `src/renderer/src/hooks/useEditorExternalWatch.test.ts`
...
- `src/renderer/src/hooks/useEphemeralVmRecipeOptions.ts`
- `src/renderer/src/hooks/useGitHubSlugMetadata.ts`
- `src/renderer/src/hooks/useGlobalFileDrop.ts`
- `src/renderer/src/hooks/useInstalledAgentSkills.react.test.tsx`
...
- `src/renderer/src/hooks/useModalReturnFocus.test.tsx`
...
- `src/renderer/src/lib/agent-background-session-test-state.ts`
...
- `src/renderer/src/lib/agent-skill-nav-install-status.test.ts`
...
- `src/renderer/src/lib/ai-vault-resume-command.ts`
- `src/renderer/src/lib/ai-vault-resume-shell.ts`
- `src/renderer/src/lib/ai-vault-resume-target.ts`
- `src/renderer/src/lib/ai-vault-session-drag.ts`
- `src/renderer/src/lib/ai-vault-session-resume-preparation.test.ts`
...
- `src/renderer/src/lib/codex-pane-restart-eligibility.ts`
- `src/renderer/src/lib/codex-pane-selection-lane.ts`
- `src/renderer/src/lib/codex-session-restart.test.ts`
- `src/renderer/src/lib/codex-session-restart.ts`
...
- `src/renderer/src/lib/editor-file-operation-owner.test.ts`
- `src/renderer/src/lib/emulator-right-split-target.ts`
- `src/renderer/src/lib/ensure-hooks-confirmed.test.ts`
...
- `src/renderer/src/lib/ephemeral-vm-workspace-target.ts`
...
- `src/renderer/src/lib/feature-education-telemetry.ts`
...
- `src/renderer/src/lib/floating-workspace-terminal-actions.test.ts`
- `src/renderer/src/lib/floating-workspace-terminal-actions.ts`
- `src/renderer/src/lib/folder-workspace-connection.ts`
- `src/renderer/src/lib/folder-workspace-path-status.ts`
...
- `src/renderer/src/lib/i18n-jsx-spacing-guard.test.ts`
...
- `src/renderer/src/lib/launch-work-item-direct-preflight.ts`
...
- `src/renderer/src/lib/linear-agent-skill-update-command.test.ts`
- `src/renderer/src/lib/linear-issue-context-snapshot.test.ts`
- `src/renderer/src/lib/linear-issue-context-snapshot.ts`
- `src/renderer/src/lib/linear-issue-workspace-attachment.test.ts`
...
- `src/renderer/src/lib/markdown-document-templates.test.ts`
- `src/renderer/src/lib/markdown-document-templates.ts`
...
- `src/renderer/src/lib/new-workspace-composer-repo.test.ts`
- `src/renderer/src/lib/new-workspace-composer-repo.ts`
- `src/renderer/src/lib/new-workspace-project-options.test.ts`
- `src/renderer/src/lib/new-workspace-project-options.ts`
- `src/renderer/src/lib/notes-send-agent-targets.test.ts`
- `src/renderer/src/lib/notes-send-agent-targets.ts`
...
- `src/renderer/src/lib/open-mobile-emulator-tab.ts`
- `src/renderer/src/lib/orchestration-skill-coverage.test.ts`
...
- `src/renderer/src/lib/pane-manager/xterm-user-scrolling-contract.test.ts`
...
- `src/renderer/src/lib/pr-comment-action-state.ts`
- `src/renderer/src/lib/pr-comment-reactions.test.ts`
- `src/renderer/src/lib/pr-comment-reactions.ts`
- `src/renderer/src/lib/project-host-clone-url.test.ts`
- `src/renderer/src/lib/project-host-clone-url.ts`
- `src/renderer/src/lib/project-host-setup-options.test.ts`
- `src/renderer/src/lib/project-host-setup-options.ts`
- `src/renderer/src/lib/project-host-workspace-target.test.ts`
...
- `src/renderer/src/lib/react-error-boundary-reporting.ts`
...
- `src/renderer/src/lib/shutdown-checkpoint-guard.test.ts`
- `src/renderer/src/lib/shutdown-checkpoint-guard.ts`
...
- `src/renderer/src/lib/tab-agent.test.ts`
...
- `src/renderer/src/lib/terminal-quick-command-project-scope.test.ts`
...
- `src/renderer/src/lib/text-control-paste-ownership.test.ts`
- `src/renderer/src/lib/text-control-paste-ownership.ts`
...
- `src/renderer/src/lib/updater-beforeunload.test.ts`
...
- `src/renderer/src/lib/window-visibility-interval.ts`
...
- `src/renderer/src/lib/workspace-session-reconnect-targets.ts`
...
- `src/renderer/src/lib/worktree-activation-empty-remote.test.ts`
...
- `src/renderer/src/lib/worktree-palette-review-match.test.ts`
...
- `src/renderer/src/runtime/gitlab-job-trace-client.test.ts`
...
- `src/renderer/src/runtime/remote-host-file-open-repro.test.ts`
...
- `src/renderer/src/runtime/runtime-environment-ssh-state.ts`
...
- `src/renderer/src/runtime/runtime-skills-client.ts`
...
- `src/renderer/src/store/slices/cmd-j-create-actions.test.ts`
...
- `src/renderer/src/store/slices/editor-rekey-open-files.test.ts`
...
- `src/renderer/src/store/slices/github-project-row-owner.ts`
- `src/renderer/src/store/slices/github-pr-refresh-owner-routing.test.ts`
- `src/renderer/src/store/slices/github-pr-refresh-states-leak.test.ts`
...
- `src/renderer/src/store/slices/hosted-review-cache.test.ts`
...
- `src/renderer/src/store/slices/purge-stale-runtime-host-state.test.ts`
...
- `src/renderer/src/store/slices/repos.runtime-fallback.test.ts`
- `src/renderer/src/store/slices/repos.test.ts`
...
- `src/renderer/src/store/slices/repos-project-host-capability.test.ts`
- `src/renderer/src/store/slices/repos-project-host-lifecycle.test.ts`
- `src/renderer/src/store/slices/repos-project-runtime.test.ts`
- `src/renderer/src/store/slices/repos-remove-missing-remote-project.test.ts`
...
- `src/renderer/src/store/slices/repos-runtime-routing-fixture.ts`
...
- `src/renderer/src/store/slices/repos-shared-project-badge-color.test.ts`
...
- `src/renderer/src/store/slices/runtime-environment-ssh.ts`
...
- `src/renderer/src/store/slices/runtime-status-hydration.ts`
...
- `src/renderer/src/store/slices/workspace-space.test.ts`
...
- `src/renderer/src/web/web-runtime-direct-proxy-live.integration.test.ts`
...
- `src/shared/agent-scratch-worktrees.test.ts`
...
- `src/shared/agent-status-field-normalization.ts`
...
- `src/shared/ai-vault-session-deletion.ts`
...
- `src/shared/claude-model-list-probe.test.ts`
- `src/shared/claude-model-list-probe.ts`
- `src/shared/claude-subagent-roster.test.ts`
- `src/shared/claude-subagent-roster.ts`
- `src/shared/claude-subagent-row-lifecycle.test.ts`
- `src/shared/cli-workspace-provenance.ts`
- `src/shared/codex-config-sync-types.ts`
- `src/shared/codex-pet-sprite-defaults.ts`
...
- `src/shared/commit-message-agent-output.ts`
- `src/shared/commit-message-agent-spec.test.ts`
...
- `src/shared/ephemeral-vm-recipe-doctor.test.ts`
...
- `src/shared/ephemeral-vm-recipes.test.ts`
...
- `src/shared/external-worktree-inbox.test.ts`
...
- `src/shared/folder-workspace-worktree.test.ts`
...
- `src/shared/gitlab-job-trace-check-details.test.ts`
- `src/shared/gitlab-job-trace-check-details.ts`
- `src/shared/gitlab-pipeline-checks.test.ts`
- `src/shared/gitlab-pipeline-checks.ts`
- `src/shared/gitlab-projects.ts`
- `src/shared/gitlab-types.ts`
...
- `src/shared/hosted-review-github.test.ts`
...
- `src/shared/marine-creatures.ts`
...
- `src/shared/native-chat-image-transcript-markers.test.ts`
- `src/shared/native-chat-image-transcript-markers.ts`
- `src/shared/native-chat-session-option-commands.test.ts`
- `src/shared/native-chat-session-option-commands.ts`
...
- `src/shared/pane-agent-owner.ts`
...
- `src/shared/plugins/plugin-vm-recipe-artifact.ts`
- `src/shared/posix-command-path-lookup.test.ts`
- `src/shared/posix-command-path-lookup.ts`
...
- `src/shared/remote-runtime-request-connection.ts`
...
- `src/shared/remote-runtime-shared-control-protocol.ts`
...
- `src/shared/remote-runtime-transport-error-agreement.test.ts`
...
- `src/shared/renderer-restart-preparation.ts`
- `src/shared/renderer-shutdown-events.ts`
- `src/shared/repo-kind.ts`
- `src/shared/repro-7732-gitlab-job-id-dropped.test.ts`
- `src/shared/resolved-worktree-lineage.test.ts`
- `src/shared/resolved-worktree-lineage.ts`
- `src/shared/ripgrep-process-availability.test.ts`
...
- `src/shared/startup-command-submission.ts`
...
- `src/shared/terminal-fonts.test.ts`
...
- `src/shared/terminal-mode-2031-final-state.test.ts`
...
- `src/shared/terminal-restore-parity-fixture.ts`
...
- `src/shared/text-search.test.ts`
...
- `src/shared/workspace-linked-item-equality.test.ts`
...
- `tests/e2e/artificial-opencode-revisit-pressure-scenario.ts`
- `tests/e2e/artificial-opencode-terminal-load.spec.ts`
- `tests/e2e/browser-address-bar-narrow-toolbar.spec.ts`
- `tests/e2e/browser-guest-crash-recovery.spec.ts`
- `tests/e2e/browser-tab.spec.ts`
- `tests/e2e/chinese-ime-chat-input-repro.spec.ts`
- `tests/e2e/codex-composer-echo-latency-probe.ts`
...
- `tests/e2e/fixtures/daemon-generation-legacy-close-client.ts`
- `tests/e2e/fixtures/daemon-generation-reconnect-client.ts`
- `tests/e2e/fixtures/terminal-emoji-table.md`
- `tests/e2e/fixtures/visible-tui-scroll-fixture.cjs`
- `tests/e2e/floating-tab-rename.spec.ts`
- `tests/e2e/floating-workspace-shared-glyph-atlas.spec.ts`
- `tests/e2e/global-setup.ts`
- `tests/e2e/global-teardown.ts`
- `tests/e2e/helpers/alt-screen-frame.ts`
- `tests/e2e/helpers/completed-worker-retirement-fixture.ts`
...
- `tests/e2e/helpers/pr-comments-sidebar-fixture.ts`
...
- `tests/e2e/helpers/terminal-pty-write-spy.ts`
- `tests/e2e/helpers/worktree-registration.ts`
- `tests/e2e/issue-12656-terminal-link-tooltip.spec.ts`
- `tests/e2e/korean-ime-terminal-shift-enter-commit.spec.ts`
- `tests/e2e/large-diff-freeze-repro.spec.ts`
- `tests/e2e/multi-client-navigation-isolation.spec.ts`
- `tests/e2e/native-chat-ask-user-question-card.spec.ts`
- `tests/e2e/native-chat-first-flush-race.spec.ts`
...
- `tests/e2e/pr11346-selected-runtime-identity-oracle.ts`
...
- `tests/e2e/repo-icon-emoji-picker.spec.ts`
- `tests/e2e/session-tabs-decorative-title-fanout.unit.test.ts`
- `tests/e2e/settings-agent-awake.spec.ts`
- `tests/e2e/settings-display-name-ime.spec.ts`
- `tests/e2e/settings-search-responsiveness.spec.ts`
- `tests/e2e/settings-skill-detection.spec.ts`
- `tests/e2e/setup-guide-sidebar.spec.ts`
- `tests/e2e/source-control-create-pr.spec.ts`
- `tests/e2e/source-control-discard-confirmation.spec.ts`
- `tests/e2e/source-control-pr-generation-switch.spec.ts`
...
- `tests/e2e/status-bar-caffeinate.spec.ts`
- `tests/e2e/tab-create-entry-file-paths.spec.ts`
...
- `tests/e2e/terminal-ime-cdp-composition.ts`
- `tests/e2e/terminal-ime-pane-arena.ts`
- `tests/e2e/terminal-link-hover-after-worktree-return.spec.ts`
- `tests/e2e/terminal-osc8-cold-park-restore.spec.ts`
- `tests/e2e/terminal-output-scheduler.spec.ts`
- `tests/e2e/terminal-paste-ownership.spec.ts`
...
- `tests/e2e/terminal-windows-codex-multiline-paste.spec.ts`
- `tests/e2e/terminal-windows-shell-paste-ownership.spec.ts`
- `tests/e2e/voice-microphone-selection.spec.ts`
- `tests/e2e/workspace-back-forward-navigation.spec.ts`
- `tests/e2e/workspace-board-lane-virtualization.spec.ts`
- `tests/e2e/workspace-space-git-status.spec.ts`
- `tests/e2e/worktree-jump-palette-filter.spec.ts`
- `tests/e2e/worktree-lifecycle.spec.ts`
- `tests/e2e/worktree-smart-sort.spec.ts`
- `tests/e2e/worktree-switch-responsiveness.spec.ts`
- `tests/tools/daemon-relocation-spike/README.md`
- `tests/tools/google-signin-ua-probe.cjs`
- `tests/tools/repro-watcher-crash-7547/fixed-child.cjs`
- `tests/tools/repro-watcher-crash-7547/run.cjs`
- `tests/tools/win-crash-survival-e2e/cli-args.mjs`
- `tests/tools/win-update-e2e/app-driver.mjs`
- `tests/tools/win-update-e2e/cli-args.mjs`
- `tests/tools/win-update-e2e/daemon-processes.mjs`
